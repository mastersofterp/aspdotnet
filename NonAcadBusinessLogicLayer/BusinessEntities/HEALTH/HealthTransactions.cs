...
namespace IITMS
{
    namespace UAIMS
    {
        ...
        {
           public class HealthTransactions
            {
                ...
                private System.Nullable<int> _OPDNO;
              ...
              //  private int _AGE = 0;
                ...
                private string _CHIEF_COMPLAINT  = string.Empty;
                private string _PAST_HISTORY  = string.Empty;
                private string _FAMILY_HISTORY  = string.Empty;
                private string _CHRONIC_DIESEASE  = string.Empty;
                private string _SURGICAL_PROCEDURE  = string.Empty;
                private string _REFERRED_TO  = string.Empty;
                private int _ADMITTED_STATUS;

                private string _RANDOM_SUGAR_LEVEL;
                #endregion
                ...
                public System.Nullable<int> OPDNO
                {
                    get { return _OPDNO; }
                    set { _OPDNO = value; }
                }
                ...
                public string RANDOM_SUGAR_LEVEL
                {
                    get { return _RANDOM_SUGAR_LEVEL; }
                    set { _RANDOM_SUGAR_LEVEL = value; }
                }
                ...
                {
                    get { return _CHIEF_COMPLAINT; }
                    set { _CHIEF_COMPLAINT = value; }
                }

                public string PAST_HISTORY
                {
                    get { return _PAST_HISTORY; }
                    set { _PAST_HISTORY = value; }
                }
                ...
                public string CHRONIC_DIESEASE
                {
                    get { return _CHRONIC_DIESEASE; }
                    set { _CHRONIC_DIESEASE = value; }
                }

                public string SURGICAL_PROCEDURE
                {
                    get { return _SURGICAL_PROCEDURE; }
                    set { _SURGICAL_PROCEDURE = value; }
                }
                ...
                public int ADMITTED_STATUS
                {
                    get { return _ADMITTED_STATUS; }
                    set { _ADMITTED_STATUS = value; }
                }
