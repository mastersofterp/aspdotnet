...
namespace IITMS.UAIMS.BusinessLayer.BusinessLogic
{
    public class SmsController
    {
        ...
        public SmsController(string ConString)
        {
        ...
        public string SendSms(Sms objSms)
        {
        ...
        public string SendBulkSms(Sms objSms)//, string msg)
        {
            string status = string.Empty;
            try
            {
        ...
        public string PrepareSms(Sms objSms)
        {
        ...
        public int SaveSms(Sms objSms)
        {
            ...
            try
            {
                ...
                objParams[5] = new SqlParameter("@P_STATUS", objSms.Status);
        ...
        public int AddPendingSms(Sms objSms)
        {
            int retStatus = Convert.ToInt32(CustomStatus.Others);
            try
            {
        ...
        public string SetAuthentication(Sms objsms, string sms )
        {
        ...
        public string CreateUrl_Balance(Sms objsms, string sms)
        {
            string url = string.Empty;
            try
            {
        ...
        public string CheckMobileNo(Sms objSms)
        {
        ...
        public int AddSmsTemplate(Sms objSms)
        {
            int retStatus = Convert.ToInt32(CustomStatus.Others);
            try
            {
        ...
        public int UpdateSmsTemplate(Sms objSms)
        {
            int retStatus = Convert.ToInt32(CustomStatus.Others);
            try
            {
        ...
        public int AddSmsService(Sms objSms)
        {
            int retStatus = Convert.ToInt32(CustomStatus.Others);
            try
            {
        ...
        public int UpdateSmsService(Sms objSms)
        {
            int retStatus = Convert.ToInt32(CustomStatus.Others);
            try
            {
        ...
        public int AddMsgServer(Sms objSms)
        {
            int retStatus = Convert.ToInt32(CustomStatus.Others);
            try
            {
        ...
        public int UpdateMsgServer(Sms objSms)
        {
            int retStatus = Convert.ToInt32(CustomStatus.Others);
            try
            {
        ...
        #region addsmstostudent

        public int AddBulkSMS(string ua_no, string Mobile, string sms, int ua_type)
        {
            int retStatus = Convert.ToInt32(CustomStatus.Others);
            try
            {
                ...
                objParams[1] = new SqlParameter("@P_PHONENO", Mobile);
                objParams[2] = new SqlParameter("@P_SMS", sms);
                objParams[3] = new SqlParameter("@P_UA_TYPE", ua_type);
                objParams[4] = new SqlParameter("@P_OUT", SqlDbType.Int);
                objParams[4].Direction = ParameterDirection.Output;

                if (objSQLHelper.ExecuteNonQuerySP("PKG_BULK_SMS_INSERT_TO_STUDENT", objParams, false) != null)
                    retStatus = Convert.ToInt32(CustomStatus.RecordUpdated);
            ...
            {
                retStatus = Convert.ToInt32(CustomStatus.Error);
                throw new IITMSException("IITMS.SmsServer.SmsController.AddBulkSMS-> " + ex.ToString());
            }
            return retStatus;
        }

        #endregion Send Sms student

        //added by satish - 07082017
        public int AddBulkEMAIL(string ua_no, string email, string sms, int ua_type)
        {
            int retStatus = Convert.ToInt32(CustomStatus.Others);
            try
            {
                ...
                objParams = new SqlParameter[5];
                objParams[0] = new SqlParameter("@P_UA_NO", ua_no);
                objParams[1] = new SqlParameter("@P_EMAIL", email);
                objParams[2] = new SqlParameter("@P_TEXT", sms);
                objParams[3] = new SqlParameter("@P_UA_TYPE", ua_type);
                objParams[4] = new SqlParameter("@P_OUT", SqlDbType.Int);
                objParams[4].Direction = ParameterDirection.Output;

                if (objSQLHelper.ExecuteNonQuerySP("PKG_BULK_EMAIL_INSERT_TO_STUDENT", objParams, false) != null)
                    retStatus = Convert.ToInt32(CustomStatus.RecordUpdated);
            ...
            {
                retStatus = Convert.ToInt32(CustomStatus.Error);
                throw new IITMSException("IITMS.SmsServer.SmsController.AddBulkEMAIL-> " + ex.ToString());
            }
            return retStatus;
        }
