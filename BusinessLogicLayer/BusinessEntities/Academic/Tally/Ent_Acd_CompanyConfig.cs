...
{
    public class Ent_Acd_CompanyConfig
            {

                private int _TallyCompanyConfigId = 0;
                private int _CashBookId = 0;
                private int _TallyConfigId = 0;
                private string _TallyCompanyName = string.Empty;
                ...
                public int TallyCompanyConfigId { get { return _TallyCompanyConfigId; } set { _TallyCompanyConfigId = value; } }
                ...
                public string TallyCompanyName { get { return _TallyCompanyName; } set { _TallyCompanyName = value; } }
