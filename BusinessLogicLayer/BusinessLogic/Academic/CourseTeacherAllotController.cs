        ...
        namespace BusinessLayer.BusinessLogic
        {
            ...
            public partial class CourseTeacherAllotController
            {
               ...
               /// </summary>
                ...
                /// <summary>
                /// Modified by Dileep Kare
                /// Date:07-01-2020
                public DataSet Getroomsdepartment(int DEGREENO)
                {
                    DataSet ds = null;
                    try
                    {
                        SQLHelper objSQLHelper = new SQLHelper(connectionString);
                        SqlParameter[] objParams = new SqlParameter[1];
                        // objParams[0] = new SqlParameter("@P_BRANCH", branchno);COMENTED BY DILEEP KARE 07012020
                ...
                //public DataSet DisplayTimeTable(string course, string session)
                //{
                //    DataSet ds = null;
                //    try
                //    {
                ...
                //        ds = objSQLHelper.ExecuteDataSetSP("PKG_ACD_REPT_TIME_TABLE_UPDATED", objParams);
                //    }
                //    catch (Exception ex)
                //    {
                //        return ds;
                ...
                //public DataSet DisplayTimeTable(string session,string semester,string schemeno)
                //{
                //    DataSet ds = null;
                //    try
                //    {
                ...
                public long AddUpdateAllotment(AllotmentMaster objAM, ref string Message)
                {
                    ...
                    try
                    {
                        ...
                        objParams[29] = new SqlParameter("@P_ROOM6", objAM.ROOM6);
                        objParams[30] = new SqlParameter("@P_THEORYPRAC", objAM.THEORYPRAC);
                        objParams[31] = new SqlParameter("@P_SEMESTERNO", objAM.SEMESTERNO);
                        //objParams[18] = new SqlParameter("@P_IDNO", objAM.IDNO);
                        //@P_IDNO
                ...
                /// <returns></returns>
                public DataSet GetTeachernotAllot(int session, int colgCode, int deg, int branch, int sem)
                {
                    DataSet ds = null;
                    try
                    {
                        ...
                        SqlParameter[] objParams = new SqlParameter[4];
                        objParams[0] = new SqlParameter("@P_SESSIONNO", session);
                        objParams[1] = new SqlParameter("@P_DEGREENO", deg);
                        objParams[2] = new SqlParameter("@P_BRANCHNO", branch);
                        objParams[3] = new SqlParameter("@P_SEMESTERNO", sem);

                        ds = objSQLHelper.ExecuteDataSetSP("PKG_ACAD_TEACHER_NOT_ALLOTED", objParams);
                    }
                    catch (Exception ex)
                    {
                ...
                /// <summary>
                /// Added BY Dileep Kare on 23.02.2022
                /// </summary>
                /// <param name="session"></param>
                /// <param name="colgCode"></param>
                /// <param name="deg"></param>
                /// <param name="branch"></param>
                /// <param name="sem"></param>
                /// <returns></returns>
                public DataSet GetCourseTeachernotAllot(int session, int colgCode, int deg, int branch, int sem)
                {
                    DataSet ds = null;
                    try
                    {
                        ...
                        ds = objSQLHelper.ExecuteDataSetSP("PKG_ACAD_COURSE_TEACHER_NOT_ALLOTED", objParams);
                    }
                    catch (Exception ex)
                    {
                        throw new IITMSException("IITMS.UAIMS.BusinessLayer.BusinessLogic.CourseController.GetCourseTeachernotAllot-> " + ex.ToString());
                    }
                    return ds;
                }
                /// <summary>
                /// Added By Dileep Kare on 14.03.2022
                /// </summary>
                /// <param name="Sessionno"></param>
                /// <returns></returns>
                public DataSet GetCourseTeacherAllotmentDoneExcel(int Sessionno,int college_id,int semesterno)
                {
                    ...
                    try
                    {
                        ...
                        objParams[2] = new SqlParameter("@P_SEMESTERNO", semesterno);
                        ds = objSQLHelper.ExecuteDataSetSP("PKG_ACD_COURSE_TEACHER_ALLOTMENT_REPORT_EXCEL", objParams); 
                    }
                    catch (Exception ex)
                    {
                        throw new IITMSException("IITMS.UAIMS.BusinessLayer.BusinessLogic.CourseTeacherAllotment.GetCourseTeacherAllotmentDoneExcel-> " + ex.ToString());
                    }
                    return ds;
                }
