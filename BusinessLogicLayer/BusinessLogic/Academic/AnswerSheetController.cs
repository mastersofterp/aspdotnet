            ...
            public class AnswerSheetController
            {
                ...
                public int InsertAnswerSheetMarkIssuer(AnswerSheet objAnsSheet)
                {
                    ...
                    try
                    {
                        ...
                        objParams[11] = new SqlParameter("@P_RECEIVER_DATE", ((objAnsSheet.Receiver_Date != DateTime.MinValue) ? objAnsSheet.Receiver_Date as object : DBNull.Value as object));
                ...
                public DataSet GetAnswerSheetEvaluateDetails(AnswerSheet objAnsSheet, int scheme)
                {
                    DataSet ds = null;
                    try
                    {
                        ...
                        objParam[2] = new SqlParameter("@P_EXAM_STAFF_NO", objAnsSheet.FacultyNos);
                        objParam[3] = new SqlParameter("@P_EXAM_STAFF_TYPE", objAnsSheet.FacultyType);
                        objParam[4] = new SqlParameter("@P_SCHEME", scheme);
                ...
                /// <summary>
                /// Updated by Dilip Kare on date 07/10/2019
                /// </summary>
                /// <param name="objAnsSheet"></param>
                /// <returns></returns>
                ...
                public int InsertAnswerSheetEvaluator(AnswerSheet objAnsSheet)
                {
                    ...
                    try
                    {
                        ...
                        objParams[10] = new SqlParameter("@P_TO_DATE", objAnsSheet.To_Date);
                        if (objAnsSheet.To_Date == DateTime.MinValue)
                            objParams[10] = new SqlParameter("@P_TO_DATE", DBNull.Value);
                        else
                            objParams[10] = new SqlParameter("@P_TO_DATE", objAnsSheet.To_Date);
                        objParams[11] = new SqlParameter("@P_UANO", objAnsSheet.UANO);
                ...
                public int InsertAnswerSheetEvaluator(AnswerSheet objAnsSheet, string DeptNo, string ExamStaffNo, int ActiveStatus)
                {
                    int retStatus = Convert.ToInt32(CustomStatus.Others);
                    ...
                    try
                    {
                        ...
                        objParams[0] = new SqlParameter("@P_SESSIONNO", objAnsSheet.SessionNo);
                        objParams[1] = new SqlParameter("@P_BRANCHNO", objAnsSheet.BranchNo);
                        objParams[2] = new SqlParameter("@P_EXAM_STAFF_NO", ExamStaffNo);
                        objParams[3] = new SqlParameter("@P_EXAM_STAFF_TYPE", objAnsSheet.FacultyType);
                        objParams[4] = new SqlParameter("@P_EXAMNO", objAnsSheet.ExamNo);
                        objParams[5] = new SqlParameter("@P_SCHEMENO", objAnsSheet.SchemeNo);
                        objParams[6] = new SqlParameter("@P_SEMESTERNO", objAnsSheet.SemesterNo);
                        ...
                        objParams[11] = new SqlParameter("@P_TO_DATE", objAnsSheet.To_Date);
                        if (objAnsSheet.To_Date == DateTime.MinValue)
                            objParams[11] = new SqlParameter("@P_TO_DATE", DBNull.Value);
                        else
                            objParams[11] = new SqlParameter("@P_TO_DATE", objAnsSheet.To_Date);
                        objParams[12] = new SqlParameter("@P_APPROVE_STATUS", ActiveStatus);
                        objParams[13] = new SqlParameter("@P_UANO", objAnsSheet.UANO);
                        objParams[14] = new SqlParameter("@P_OUTPUT", SqlDbType.Int);
                        objParams[14].Direction = ParameterDirection.Output;

                        object ret = Convert.IsDBNull(objSQLHelper.ExecuteNonQuerySP("PKG_INSERT_ANSWERSHEET_EVALUATOR_DETAILS_CC", objParams, true));
                ...
                public int UpdateEvaluatorApproveStatus(AnswerSheet objAnsSheet, int ApproveStatus, int EVALAPPID)
                {
                    int retStatus = Convert.ToInt32(CustomStatus.Others);
                    ...
                    try
                    {
                        ...
                        objParams[4] = new SqlParameter("@P_SEMESTERNO", objAnsSheet.SemesterNo);
                        objParams[5] = new SqlParameter("@P_COURSENO", objAnsSheet.CourseNo);
                        objParams[6] = new SqlParameter("@P_EVAL_APPID", EVALAPPID);
                        objParams[7] = new SqlParameter("@P_EXAMTYPE", objAnsSheet.Examtype);
                        objParams[8] = new SqlParameter("@P_APPROVE_STATUS", ApproveStatus);
                        //objParams[9] = new SqlParameter("@P_APPROVE_DATE", Appdate);
                ...
                /// <summary>
                /// ADDED BY :- ROHIT KUMAR TIWARI ON 25-APRIL-2019
                /// </summary>
                ...
                /// <param name="branchno"></param>
                /// <param name="isotherfaculty"></param>
                /// <returns></returns>
                //public int AddSaveExam(string staffName, string colAddr, string mobileno, string emailid, string staff, int active, int branchno, int isotherfaculty)
                //{
                ...
                //        objParam[7] = new SqlParameter("@P_ISOTHER_FACULTY", isotherfaculty);

                //        objParam[8] = new SqlParameter("@P_EXAM_STAFF_NO", SqlDbType.Int);
                ...
                //    return retStat;
                //}
                public int AddSaveExam(string staffName, string colAddr, string mobileno, string emailid, string staff, int active, int deptno, int isotherfaculty, int uano)
                {
                    int retStat = Convert.ToInt32(CustomStatus.Others);
                    ...
                    try
                    {
                        ...
                        objParam[4] = new SqlParameter("@P_STAFF_TYPE", staff);
                        objParam[5] = new SqlParameter("@P_ACTIVE", active);
                        objParam[6] = new SqlParameter("@P_DEPTNO", deptno);
                        objParam[7] = new SqlParameter("@P_ISOTHER_FACULTY", isotherfaculty);
                        objParam[8] = new SqlParameter("@P_UA_NO", uano);

                        objParam[9] = new SqlParameter("@P_EXAM_STAFF_NO", SqlDbType.Int);
                        objParam[9].Direction = ParameterDirection.Output;

                        // object ret = Convert.IsDBNull(objSQL.ExecuteNonQuerySP("PKG_ACD_INS_EXAM_STAFF", objParam, true));
                        int ret = Convert.ToInt32(objSQL.ExecuteNonQuerySP("PKG_ACD_INS_EXAM_STAFF", objParam, true));
                        if (ret == -99)
                            retStat = Convert.ToInt32(CustomStatus.TransactionFailed);
                        else if (ret == -1001)
                            retStat = Convert.ToInt32(CustomStatus.DuplicateRecord);
                ...
                /// <param name="isotherfaculty"></param>
                /// <returns></returns>
                //public int UpdateExamStaff(string staffName, string colAddr, string mobileno, string emailid, string staff, int active, int branchno, int staffno, int isotherfaculty)
                //{
                //    int retStat = Convert.ToInt32(CustomStatus.Others);
                ...
                //        objParam[5] = new SqlParameter("@P_ACTIVE", active);
                //        objParam[6] = new SqlParameter("@P_BRANCHNO", branchno);
                //        objParam[7] = new SqlParameter("@P_EXAM_STAFF_NO", staffno);
                //        objParam[8] = new SqlParameter("@P_ISOTHER_FACULTY", isotherfaculty);
                ...
                //}
                public int UpdateExamStaff(string staffName, string colAddr, string mobileno, string emailid, string staff, int active, int deptno, int staffno, int isotherfaculty, int uano)
                {
                    //int retStat = Convert.ToInt32(CustomStatus.Others);
                    int retStat = 0;
                    try
                    {
                        ...
                        objParam[7] = new SqlParameter("@P_EXAM_STAFF_NO", staffno);
                        objParam[8] = new SqlParameter("@P_ISOTHER_FACULTY", isotherfaculty);
                        objParam[9] = new SqlParameter("@P_UA_NO", uano);

                        objParam[10] = new SqlParameter("@P_OUTPUT", SqlDbType.Int);
                        objParam[10].Direction = ParameterDirection.Output;
                        retStat = Convert.ToInt32(objSQL.ExecuteNonQuerySP("PKG_ACD_UPD_EXAM_STAFF", objParam, true));
                ...
                /// </summary>
                /// <param name="objAnsSheet"></param>
                /// <param name="totstudent"></param>
                /// <returns></returns>
                public int InsertAnswerSheetMark(AnswerSheet objAnsSheet, string totstudent)
                {
                    int retStatus = Convert.ToInt32(CustomStatus.Others);
                    ...
                    try
                    {
                        ...
                        objParams[13] = new SqlParameter("@P_TOT_STUD", totstudent);
                        objParams[14] = new SqlParameter("@P_OUTPUT", SqlDbType.Int);
                        objParams[14].Direction = ParameterDirection.Output;
