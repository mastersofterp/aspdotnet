    ...
    namespace UAIMS
    {
        namespace BusinessLayer.BusinessLogic
        {
            ...
            public class InstallmentController
            {
                ...
                //public DataSet GetStudentData(int sessiono, int degreeno, int branch, int scheme, int RECPTNO)
                //{
                //    DataSet ds = null;
                //    try
                //    {
                ...
                //public int AddStudentData(string IDNO, int REC, string INSTALL, int UA_NO, string COLL_CODE, string IP_ADD, int SESSIONNO)
                //{
                //    int retStatus = Convert.ToInt32(CustomStatus.Others);
                //    try
                //    {
                ...
                //        objParams[1] = new SqlParameter("@P_RECIPTNO", REC);
                //        objParams[2] = new SqlParameter("@P_NO_OF_INSTALL", INSTALL);
                //        objParams[3] = new SqlParameter("@P_UANO", UA_NO);
                //        objParams[4] = new SqlParameter("@P_COLLEGE_CODE", COLL_CODE);
                //        objParams[5] = new SqlParameter("@P_IP_ADDRESS", IP_ADD);
                //        objParams[6] = new SqlParameter("@P_SESSION", SESSIONNO);

                //        object ret = objSQLHelper.ExecuteNonQuerySP("PKG_ACAD_SAVE_UPDATE_INSTALLMENT_STUDENT", objParams, true);
                //        if (Convert.ToInt32(ret) == -99)
                //            retStatus = Convert.ToInt32(CustomStatus.TransactionFailed);
                //        else
                //            retStatus = Convert.ToInt32(CustomStatus.RecordSaved);
                ...
                //public int UpdateInstallment(int idno)
                //{
                //    int retStatus = Convert.ToInt32(CustomStatus.Others);
                ...
                //        objParams[0] = new SqlParameter("@P_INSTALLMENT", objSession.SessionNo);
