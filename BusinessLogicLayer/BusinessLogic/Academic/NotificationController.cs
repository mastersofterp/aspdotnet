...
namespace IITMS.UAIMS.BusinessLayer.BusinessLogic
{
    public class NotificationController
    {
        ...
        public int AddNotification(NotificationEntity NF)
        {
            ...
            try
            {
                ...
                objParams[0] = new SqlParameter("@P_NOTIFICATIONID", NF.Idno);
                objParams[1] = new SqlParameter("@P_TITLE", NF.Title);
                objParams[2] = new SqlParameter("@P_MESSAGE", NF.Details);
                objParams[3] = new SqlParameter("@P_FROMUSERID", NF.UANO);
                objParams[4] = new SqlParameter("@P_IP", NF.Ipaddress);
                objParams[5] = new SqlParameter("@P_EXPIRYDATE", NF.Expirydate);                
        ...
        public int SubmitNotificationDetails(NotificationEntity NF)
        {
            int retStatus = Convert.ToInt32(CustomStatus.Others);
            try
            {
                ...
                objParam[5] = new SqlParameter("@P_UA_TYPE", NF.UA_Type);
                objParam[6] = new SqlParameter("@P_FROMUSERID", NF.UANO);
                objParam[7] = new SqlParameter("@P_UA_NO", NF.UserNo);
                objParam[8] = new SqlParameter("@P_MESSAGE", NF.Title);
                objParam[9] = new SqlParameter("@P_DETAILS", NF.Details);
