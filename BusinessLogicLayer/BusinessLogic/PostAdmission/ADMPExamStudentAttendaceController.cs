...
{
   public class ADMPExamStudentAttendaceController
    {

  
       string _UAIMS_constr = string.Empty;
       public ADMPExamStudentAttendaceController()
                {
       ...
       public int INSERT_Update_STUDENTATTENDANCE(int admbatch, int ACNO, string ip_address, int userNo, bool IsAttend, int AttendanceNo) //int rollNo
       {
           ...
           try
           {
               ...
               object ret = objSQLHelper.ExecuteNonQuerySP("PKG_INSERT_UPDATE_EXAM_STUDENT_ATTENDANCE", objParams, false);
