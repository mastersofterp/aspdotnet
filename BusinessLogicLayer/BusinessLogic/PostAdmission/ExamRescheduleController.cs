...
{
   public class ExamRescheduleController
    {
        string _UAIMS_constr = string.Empty;
        public ExamRescheduleController()
                {
         ...
         public int Insert_Update_Reschedule(int admbatch, int userNo, string ip_address, int uano, string ExamSchedule, int ScheduleNO,bool IsReschedule) //int rollNo
         {
             //DataSet ds = null;
