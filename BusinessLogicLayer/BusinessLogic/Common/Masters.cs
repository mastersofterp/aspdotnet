        ...
        namespace BusinessLayer.BusinessLogic
            ...
            public class Masters
                ...
                private void GetCaptions(string[,] captions)
                    ...
                    switch (_tablename.ToLower())
                        ...
                        case "payroll_staff":    //payroll
                            ...
                            captions[0, 5] = "StaffNo,Staff,retirement_age,activestatus,College_code";      //FieldNames
                            ...
                            captions[1, 5] = "StaffNo,Staff,retirement_age,activestatus,College_code";      //FieldNames
                            ...
                            captions[2, 3] = "StaffNo";                          //ID
                            captions[2, 4] = "3";                               //No of Fields
                            captions[2, 5] = "StaffNo,Staff,retirement_age,activestatus,College_code"; //FieldNames
                            captions[2, 6] = "string";                          //Validation Type
                            captions[2, 7] = "20";                                //Max length
                            captions[2, 8] = "List of Staff";                 //Report Title
                            break;
                        ...
                        case "payroll_employeetype":    //payroll
                            ...
                            captions[0, 4] = "3";                               //No of Fields
                            captions[0, 5] = "emptypeno,employeetype,retirement_age,activestatus,College_code";      //FieldNames
                            captions[0, 6] = "string2";                          //Validation Type
                            captions[0, 7] = "50";                              //Max length
                            captions[0, 8] = "List of Staff";                   //Report Title
                            ...
                            captions[1, 4] = "3";                               //No of Fields
                            captions[1, 5] = "emptypeno,employeetype,retirement_age,activestatus,College_code";      //FieldNames
                            captions[1, 6] = "number";                          //Validation Type
                            captions[1, 7] = "2";                               //Max length
                            ...
                            captions[2, 1] = "checkbox";                        //Control
                            captions[2, 2] = "activestatus";                        //FieldName
                            captions[2, 3] = "emptypeno";                          //ID
                            captions[2, 4] = "3";                               //No of Fields
                            captions[2, 5] = "emptypeno,employeetype,retirement_age,activestatus,College_code"; //FieldNames
                            captions[2, 6] = "string";                          //Validation Type
                            captions[2, 7] = "20";                                //Max length
                            captions[2, 8] = "List of Employee Type";                 //Report Title
                            break;
                        ...
                        case "payroll_caste":       //payroll
                            ...
                            captions[0, 5] = "casteno,caste,activestatus,college_code";      //FieldNames
                            captions[0, 6] = "string2";                          //Validation Type
                            captions[0, 7] = "50";                              //Max length
                            ...
                            captions[1, 3] = "casteno";                          //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "casteno,caste,activestatus,college_code"; //FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                                //Max length
                            captions[1, 8] = "List of Caste";                 //Report Title
                            break;
                        ...
                        case "payroll_form12bamaster":       //payroll
                            ...
                            captions[0, 4] = "2";                               //No of Fields
                            captions[0, 5] = "FORM12BAID,PERQUISITES,activestatus,college_code";      //FieldNames
                            captions[0, 6] = "string2";                          //Validation Type
                            captions[0, 7] = "50";                              //Max length
                            ...
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "FORM12BAID";                          //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "FORM12BAID,PERQUISITES,activestatus,college_code"; //FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                                //Max length
                            captions[1, 8] = "List of Perquisites";                 //Report Title
                            break;
                        ...
                        case "payroll_employee_classification":               //payroll
                            ...
                            captions[0, 4] = "2";                               //No of Fields
                            captions[0, 5] = "clno,clname,activestatus,college_code";      //FieldNames
                            ...
                            captions[1, 1] = "checkbox";                         //Control
                            captions[1, 2] = "activestatus";                          //FieldName
                            captions[1, 3] = "clno";                            //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "clno,clname,activestatus,college_code";      //FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                              //Max length
                            captions[1, 8] = "List of Employee Classification";                   //Report Title
                            break;
                        ...
                        case "payroll_nationality":  //payroll
                            ...
                            captions[0, 4] = "2";                               //No of Fields
                            captions[0, 5] = "nationalityno,nationalitynm,activestatus,college_code";//FieldNames
                            captions[0, 6] = "string";                          //Validation Type
                            ...
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "nationalityno";                   //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "nationalityno,nationalitynm,activestatus,college_code";//FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                             //Max length
                            captions[1, 8] = "List of Nationality";             //Report Title
                            break;
                        case "payroll_loantype":  //payroll
                            ...
                            captions[0, 4] = "2";                               //No of Fields
                            captions[0, 5] = "loanno,loanname,activestatus,College_code";//FieldNames
                            captions[0, 6] = "string";                          //Validation Type
                            captions[0, 7] = "100";                             //Max length
                            ...
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "loanno";                          //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "loanno,loanname,activestatus,College_code";//FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                             //Max length
                            captions[1, 8] = "List of Loan Type";             //Report Title
                        ...
                        case "payroll_leave":  //payroll
                            ...
                            captions[0, 3] = "lno";                          //ID
                            captions[0, 4] = "2";                               //No of Fields
                            captions[0, 5] = "lno,leavename,activestatus,college_code";//FieldNames
                            captions[0, 6] = "string";                          //Validation Type
                            captions[0, 7] = "100";                             //Max length
                            ...
                            captions[1, 3] = "loanno";                          //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "lno,leavename,activestatus,college_code";//FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                             //Max length
                            captions[1, 8] = "List of Leave Type";             //Report Title
                            break;
                        case "payroll_photo_type":  //payroll
                            ...
                            captions[0, 4] = "2";                                   //No of Fields
                            captions[0, 5] = "photo_typeid,photo_type,activestatus,College_code";//FieldNames
                            captions[0, 6] = "string2";                              //Validation Type
                            captions[0, 7] = "100";                                 //Max length
                            ...
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "photo_typeid";                        //ID
                            captions[1, 4] = "2";                                   //No of Fields
                            captions[1, 5] = "photo_typeid,photo_type,activestatus,College_code";//FieldNames
                            captions[1, 6] = "string";                              //Validation Type
                            captions[1, 7] = "20";                                 //Max length
                            captions[1, 8] = "List of Image Name";                  //Report Title
                            break;
                        case "payroll_nominitype":  //payroll  
                            ...
                            captions[0, 4] = "2";                               //No of Fields
                            captions[0, 5] = "ntno,nominitype,activestatus,College_code";    //FieldNames
                            captions[0, 6] = "string";                          //Validation Type
                            captions[0, 7] = "100";                             //Max length
                            ...
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "ntno";                            //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "ntno,nominitype,activestatus,College_code";    //FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                             //Max length
                            captions[1, 8] = "List of Nominee Type";              //Report Title
                            break;
                        case "payroll_category":   //payroll
                            ...
                            captions[0, 4] = "2";                               //No of Fields
                            captions[0, 5] = "CategoryNo,Category,activestatus,College_code";//FieldNames
                            captions[0, 6] = "string";                          //Validation Type
                            captions[0, 7] = "50";                              //Max length
                            ...
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "CategoryNo,Category,activestatus,College_code";//FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                              //Max length
                            captions[1, 8] = "List of Category";                //Report Title
                            break;
                        case "payroll_religion":   //payroll
                            ...
                            captions[0, 4] = "2";                               //No of Fields
                            captions[0, 5] = "ReligionNo,Religion,activestatus,College_code";//FieldNames
                            captions[0, 6] = "string";                          //Validation Type
                            captions[0, 7] = "50";                              //Max length
                            ...
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "Religionno";                      //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "ReligionNo,Religion,activestatus,College_code";//FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                              //Max length
                            captions[1, 8] = "List of Religion";                //Report Title
                            break;
                        case "payroll_supplimentary_head":   //payroll
                            ...
                            captions[0, 4] = "2";                               //No of Fields
                            captions[0, 5] = "suplhno,suplhead,activestatus,College_code";    //FieldNames
                            captions[0, 6] = "string2";                          //Validation Type
                            captions[0, 7] = "50";                              //Max length
                            ...
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "suplhno";                          //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "suplhno,suplhead,activestatus,College_code";    //FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                              //Max length
                            captions[1, 8] = "List of Supplementary Head";       //Report Title
                            break;
                        case "payroll_city":       //payroll
                            ...
                            captions[0, 4] = "2";                           //No of Fields
                            captions[0, 5] = "cityno,city,activestatus,College_code";    //FieldNames
                            captions[0, 6] = "string";                      //Validation Type
                            ...
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "cityno";                      //ID
                            captions[1, 4] = "2";                           //No of Fields
                            captions[1, 5] = "cityno,city,activestatus,College_code";    //FieldNames
                            captions[1, 6] = "string";                      //Validation Type
                            captions[1, 7] = "20";                          //Max length
                            captions[1, 8] = "List of City";                //Report Title
                            break;
                        case "payroll_title":     //payroll
                            ...
                            captions[0, 4] = "2";                            //No of Fields
                            captions[0, 5] = "titleno,title,activestatus,College_code";   //FieldNames
                            captions[0, 6] = "string2";                       //Validation Type
                            captions[0, 7] = "50";                           //Max length
                            ...
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "titleno";                      //ID
                            captions[1, 4] = "2";                            //No of Fields
                            captions[1, 5] = "titleno,title,activestatus,College_code";   //FieldNames
                            captions[1, 6] = "string";                       //Validation Type
                            captions[1, 7] = "20";                           //Max length
                            captions[1, 8] = "List of Title";                //Report Title
                            break;
                        case "payroll_stafftype":   //payroll
                            ...
                            captions[0, 4] = "2";                               //No of Fields
                            captions[0, 5] = "stno,stafftype,activestatus,College_code";     //FieldNames
                            captions[0, 6] = "string2";                          //Validation Type
                            captions[0, 7] = "50";                              //Max length
                            ...
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "stno";                            //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "stno,stafftype,activestatus,College_code";     //FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                              //Max length
                            captions[1, 8] = "List of Staff Type";              //Report Title
                            break;
                        case "payroll_rule":       //payroll
                            ...
                            captions[0, 4] = "3";                               //No of Fields
                            captions[0, 5] = "ruleno,payrule,rulename,activestatus,College_code";     //FieldNames
                            captions[0, 6] = "string2";                          //Validation Type
                            ...
                            captions[1, 4] = "3";                               //No of Fields
                            captions[1, 5] = "ruleno,payrule,rulename,activestatus,College_code";     //FieldNames
                            ...
                            captions[2, 1] = "checkbox";                        //Control
                            captions[2, 2] = "activestatus";                        //FieldName
                            captions[2, 3] = "ruleno";                          //ID
                            captions[2, 4] = "3";                               //No of Fields
                            captions[2, 5] = "ruleno,payrule,rulename,activestatus,College_code";     //FieldNames
                            captions[2, 6] = "string";                          //Validation Type
                            captions[2, 7] = "20";                              //Max length
                            captions[2, 8] = "List of Pay Rule";                //Report Title
                            break;
                        ...
                        case "payroll_typetran":      //payroll
                            ...
                            captions[0, 4] = "3";                               //No of Fields
                            captions[0, 5] = "typetranno,typetran,shortname,activestatus,College_code";//FieldNames
                            captions[0, 6] = "string";                          //Validation Type
                            captions[0, 7] = "50";                              //Max length
                            ...
                            captions[1, 4] = "3";                               //No of Fields
                            captions[1, 5] = "typetranno,typetran,shortname,activestatus,College_code";//FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            ...
                            captions[2, 1] = "checkbox";                        //Control
                            captions[2, 2] = "activestatus";                        //FieldName
                            captions[2, 3] = "typetranno";                          //ID
                            captions[2, 4] = "3";                               //No of Fields
                            captions[2, 5] = "typetranno,typetran,shortname,activestatus,College_code";     //FieldNames
                            captions[2, 6] = "string";                          //Validation Type
                            captions[2, 7] = "20";                              //Max length
                            captions[2, 8] = "List of Transaction Type";                //Report Title
                            break;
                        ...
                        case "payroll_subdept":       //payroll
                            ...
                            captions[0, 4] = "3";                              //No of Fields
                            captions[0, 5] = "subdeptno,subdept,subsdept,activestatus,College_code";//FieldNames
                            captions[0, 6] = "string2";                         //Validation Type
                            captions[0, 7] = "50";                             //Max length
                            ...
                            captions[1, 4] = "3";                              //No of Fields
                            captions[1, 5] = "subdeptno,subdept,subsdept,activestatus,College_code";//FieldNames
                            captions[1, 6] = "string2";                         //Validation Type
                            ...
                            captions[2, 1] = "checkbox";                        //Control
                            captions[2, 2] = "activestatus";                        //FieldName
                            captions[2, 3] = "subdeptno";                      //ID
                            captions[2, 4] = "3";                              //No of Fields
                            captions[2, 5] = "subdeptno,subdept,subsdept,activestatus,College_code";//FieldNames
                            captions[2, 6] = "string";                         //Validation Type
                            captions[2, 7] = "20";                             //Max length 
                            captions[2, 8] = "List of Department";             //Report Title
                            break;
                        ...
                        case "payroll_pgcoursedepartment":       //payroll
                            ...
                            captions[0, 4] = "3";                              //No of Fields
                            captions[0, 5] = "pgsubdeptno,pgsubdept,pgsubsdept,activestatus,College_code";//FieldNames
                            captions[0, 6] = "string2";                         //Validation Type
                            captions[0, 7] = "50";                             //Max length
                            captions[0, 8] = "List of Department";             //Report Title
                            ...
                            captions[1, 4] = "3";                              //No of Fields
                            captions[1, 5] = "pgsubdeptno,pgsubdept,pgsubsdept,activestatus,College_code";//FieldNames
                            captions[1, 6] = "string2";                         //Validation Type
                            captions[1, 7] = "50";                             //Max length 
                            captions[1, 8] = "List of Department";             //Report Title
                            ...
                            captions[2, 1] = "checkbox";                        //Control
                            captions[2, 2] = "activestatus";                        //FieldName
                            captions[2, 3] = "pgsubdeptno";                      //ID
                            captions[2, 4] = "3";                              //No of Fields
                            captions[2, 5] = "pgsubdeptno,pgsubdept,pgsubsdept,activestatus,College_code";//FieldNames
                            captions[2, 6] = "string";                         //Validation Type
                            captions[2, 7] = "20";                             //Max length 
                            captions[2, 8] = "List of Department";             //Report Title
                            break;
                        ...
                        case "payroll_subdesig":    //payroll
                            ...
                            captions[0, 5] = "subdesigno,subdesig,subsdesig,seqno,activestatus,College_code";//FieldNames
                            captions[0, 6] = "string2";                          //Validation Type
                            captions[0, 7] = "50";                              //Max length
                            ...
                            captions[1, 5] = "subdesigno,subdesig,subsdesig,seqno,activestatus,College_code";//FieldNames
                            captions[1, 6] = "string2";                          //Validation Type
                            captions[1, 7] = "50";                              //Max length
                            ...
                            captions[2, 5] = "subdesigno,subdesig,subsdesig,seqno,activestatus,College_code";//FieldNames
                            captions[2, 6] = "number";                          //Validation Type
                            captions[2, 7] = "50";                              //Max length
                            captions[2, 8] = "List of Designation";             //Report Title

                            captions[3, 0] = "Active Status";                        //Label
                            captions[3, 1] = "checkbox";                        //Control
                            captions[3, 2] = "activestatus";                        //FieldName
                            captions[3, 3] = "subdesigno";                      //ID
                            captions[3, 4] = "4";                               //No of Fields
                            captions[3, 5] = "subdesigno,subdesig,subsdesig,seqno,activestatus,College_code";//FieldNames
                            captions[3, 6] = "string";                          //Validation Type
                            captions[3, 7] = "20";                              //Max length
                            captions[3, 8] = "List of Designation";             //Report Title
                            break;
                        ...
                        case "payroll_bank":      //payroll
                            ...
                            captions[0, 4] = "4";                               //No of Fields
                            captions[0, 5] = "bankno,bankcode,bankname,bankaddr,activestatus,College_code";//FieldNames
                            captions[0, 6] = "string";                          //Validation Type
                            captions[0, 7] = "50";                              //Max length
                            ...
                            captions[1, 4] = "4";                               //No of Fields
                            captions[1, 5] = "bankno,bankcode,bankname,bankaddr,activestatus,College_code";//FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "50";                              //Max length
                            ...
                            captions[2, 4] = "4";                               //No of Fields
                            captions[2, 5] = "bankno,bankcode,bankname,bankaddr,activestatus,College_code";//FieldNames
                            captions[2, 6] = "string";                          //Validation Type
                            captions[2, 7] = "50";                              //Max length
                            ...
                            captions[3, 4] = "4";                               //No of Fields
                            captions[3, 5] = "bankno,bankcode,bankname,bankaddr,activestatus,College_code";//FieldNames
                            captions[3, 6] = "string";                          //Validation Type
                            captions[3, 7] = "20";                              //Max length
                            captions[3, 8] = "List of Bank";             //Report Title
                        ...
                        case "payroll_pf_loan_type":      //payroll
                            ...
                            //captions[4, 0] = "Active Status";                        //Label
                            //captions[4, 1] = "checkbox";                        //Control
                            //captions[4, 2] = "status";                        //FieldName
                            //captions[4, 3] = "pfloantypeno";                          //ID
                            //captions[4, 4] = "5";                               //No of Fields
                            //captions[4, 5] = "pfloantypeno,name,shortname,deducted,amt,app_for,status,College_code";//FieldNames
                            //captions[4, 6] = "string";                          //Validation Type
                            //captions[4, 7] = "20";                              //Max length
                            //captions[4, 8] = "List of GPF/CPF";                 //Report Title
                            break;
                        ...
                        case "payroll_headacc":  //payroll
                            ...
                            captions[0, 3] = "ano";                             //ID
                            captions[0, 4] = "4";                               //No of Fields
                            captions[0, 5] = "ano,headac,accno,staff,activestatus,College_code";//FieldNames
                            captions[0, 6] = "string";                          //Validation Type
                            captions[0, 7] = "100";                             //Max length
                            ...
                            captions[1, 3] = "ano";                             //ID
                            captions[1, 4] = "4";                               //No of Fields
                            captions[1, 5] = "ano,headac,accno,staff,activestatus,College_code";//FieldNames
                            ...
                            captions[2, 3] = "ano";                             //ID
                            captions[2, 4] = "4";                               //No of Fields
                            captions[2, 5] = "ano,headac,accno,staff,activestatus,College_code";//FieldNames
                            captions[2, 6] = "string";                          //Validation Type
                            ...
                            captions[3, 3] = "ano";                             //ID
                            captions[3, 4] = "4";                               //No of Fields
                            captions[3, 5] = "ano,headac,accno,staff,activestatus,College_code";//FieldNames
                            captions[3, 6] = "string";                          //Validation Type
                            captions[3, 7] = "20";                             //Max length
                            captions[3, 8] = "List of Account Head";            //Report Title
                            break;
                        ...
                        case "payroll_designature":  //payroll
                            ...
                            captions[0, 4] = "3";                               //No of Fields
                            captions[0, 5] = "designatureno,designature,status,activestatus,College_code";//FieldNames
                            captions[0, 6] = "string2";                          //Validation Type
                            captions[0, 7] = "50";                              //Max length
                            ...
                            captions[1, 4] = "3";                               //No of Fields
                            captions[1, 5] = "designatureno,designature,status,activestatus,College_code";//FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            ...
                            captions[2, 1] = "checkbox";                        //Control
                            captions[2, 2] = "activestatus";                        //FieldName
                            captions[2, 3] = "designatureno";                   //ID
                            captions[2, 4] = "3";                               //No of Fields
                            captions[2, 5] = "designatureno,designature,status,activestatus,College_code";//FieldNames
                            captions[2, 6] = "string";                          //Validation Type
                            captions[2, 7] = "20";                               //Max length
                            captions[2, 8] = "List of Designature";             //Report Title
                            break;
                        ...
                        case "payroll_quarter_type":  //payroll
                            ...
                            captions[0, 4] = "4";                               //No of Fields
                            captions[0, 5] = "qrttypeno,qrttype,qarea,qrent,activestatus,College_code";//FieldNames
                            captions[0, 6] = "string";                          //Validation Type
                            ...
                            captions[1, 4] = "4";                               //No of Fields
                            captions[1, 5] = "qrttypeno,qrttype,qarea,qrent,activestatus,College_code";//FieldNames
                            captions[1, 6] = "string2";                                //Validation Type
                            captions[1, 7] = "50";                              //Max length
                            ...
                            captions[2, 4] = "4";                               //No of Fields
                            captions[2, 5] = "qrttypeno,qrttype,qarea,qrent,activestatus,College_code";//FieldNames
                            ...
                            captions[3, 1] = "checkbox";                        //Control
                            captions[3, 2] = "activestatus";                        //FieldName
                            captions[3, 3] = "qrttypeno";                             //ID
                            captions[3, 4] = "4";                               //No of Fields
                            captions[3, 5] = "qrttypeno,qrttype,qarea,qrent,activestatus,College_code";//FieldNames
                            captions[3, 6] = "string";                          //Validation Type
                            captions[3, 7] = "20";                             //Max length
                            captions[3, 8] = "List of Quarter Type";            //Report Title
                            break;
                        ...
                        case "payroll_quartermas":  //payroll
                            ...
                            captions[0, 4] = "3";                               //No of Fields
                            captions[0, 5] = "qrtno,qrtname,qrttypeno,activestatus,College_code";//FieldNames
                            captions[0, 6] = "string";                          //Validation Type
                            captions[0, 7] = "50";                              //Max length
                            ...
                            captions[1, 4] = "3";                                   //No of Fields
                            captions[1, 5] = "qrtno,qrtname,qrttypeno,activestatus,College_code";//FieldNames
                            captions[1, 6] = "number";                              //Validation Type
                            captions[1, 7] = "1";                                   //Max length
                            ...
                            captions[2, 1] = "checkbox";                        //Control
                            captions[2, 2] = "activestatus";                        //FieldName
                            captions[2, 3] = "qrtno";                               //ID
                            captions[2, 4] = "3";                                   //No of Fields
                            captions[2, 5] = "qrtno,qrtname,qrttypeno,activestatus,College_code";//FieldNames
                            captions[2, 6] = "string";                              //Validation Type
                            captions[2, 7] = "20";                                   //Max length
                            captions[2, 8] = "List of Quarter";                     //Report Title
                            break;
                        ...
                        case "payroll_qualilevel":  //payroll
                            ...
                            captions[0, 4] = "2";                                       //No of Fields
                            captions[0, 5] = "qualilevelno,qualilevelname,activestatus,College_code";//FieldNames
                            captions[0, 6] = "string2";                                 //Validation Type
                            captions[0, 7] = "50";                                      //Max length
                            ...
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "qualilevelno";                            //ID
                            captions[1, 4] = "2";                                       //No of Fields
                            captions[1, 5] = "qualilevelno,qualilevelname,activestatus,College_code";//FieldNames
                            captions[1, 6] = "string";                                 //Validation Type
                            captions[1, 7] = "20";                                      //Max length
                            captions[1, 8] = "List of Qualification Level";             //Report Title
                            break;
                        ...
                        case "payroll_pf_mast":  //gpf
                            ...
                            captions[0, 4] = "3";                                       //No of Fields
                            captions[0, 5] = "pfno,shortname,fullname,activestatus,College_code";   //FieldNames
                            captions[0, 6] = "string2";                                 //Validation Type
                            ...
                            captions[1, 4] = "3";                                       //No of Fields
                            captions[1, 5] = "pfno,shortname,fullname,activestatus,College_code";   //FieldNames
                            captions[1, 6] = "string2";                                 //Validation Type
                            captions[1, 7] = "50";                                      //Max length
                            ...
                            captions[2, 1] = "checkbox";                        //Control
                            captions[2, 2] = "activestatus";                        //FieldName
                            captions[2, 3] = "pfno";                                   //ID
                            captions[2, 4] = "3";                                       //No of Fields
                            captions[2, 5] = "pfno,shortname,fullname,activestatus,College_code";   //FieldNames
                            captions[2, 6] = "string";                                 //Validation Type
                            captions[2, 7] = "20";                                      //Max length
                            captions[2, 8] = "List of PF";                              //Report Title
                            break;
                        #endregion

                        #region ACADEMIC

                        //ADDED BY jay t  23062023
                        case "ACD_BLOB_STORAGE_ACTIVITY":                          //academic
                            captions[0, 0] = "Activity Name";                //label
                            captions[0, 1] = "textbox";                         //control
                            captions[0, 2] = "ACTIVITY_NAME";                    //fieldname
                            captions[0, 3] = "ACTIVITYNO";                      //id
                            captions[0, 4] = "2";                               //no of fields
                            captions[0, 5] = "ACTIVITYNO,ACTIVITY_NAME,ACTIVE_STATUS,college_code";        //fieldnames
                            captions[0, 6] = "string2";                          //validation type
                            captions[0, 7] = "100";                              //max length
                            captions[0, 8] = "List of Blob Storage Activity";                    //report title

                            captions[1, 0] = "Active Status";                        //Label
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "ACTIVE_STATUS";                        //FieldName
                            captions[1, 3] = "ACTIVITYNO";                          //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "ACTIVITYNO,ACTIVITY_NAME,ACTIVE_STATUS,college_code";      //FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                                //Max length
                            captions[1, 8] = "List of Blob Storage Activity";                 //Report Title
                            break;
                        //ADDED BY AASHNA  25-11-2022

                        case "acd_authority_approval_type_master":                          //academic
                            captions[0, 0] = "Authority Approval Type";                //label
                            captions[0, 1] = "textbox";                         //control
                            captions[0, 2] = "authority_approval_type";                    //fieldname
                            captions[0, 3] = "authority_approval_no";                      //id
                            captions[0, 4] = "2";                               //no of fields
                            captions[0, 5] = "authority_approval_no,authority_approval_type,activestatus,college_code";        //fieldnames
                            captions[0, 6] = "string2";                          //validation type
                            captions[0, 7] = "100";                              //max length
                            captions[0, 8] = "List of Authority Approval type";                    //report title

                            captions[1, 0] = "Active Status";                        //Label
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "authority_approval_no";                          //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "authority_approval_no,authority_approval_type,activestatus,college_code"; //FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                                //Max length
                            captions[1, 8] = "List of Authority Approval type";                 //Report Title
                            break;

                        case "acd_block":  //academic
                            captions[0, 0] = "Block";                     //Label
                            captions[0, 1] = "textbox";                          //Control
                            captions[0, 2] = "blockname";                          //FieldName
                            captions[0, 3] = "blockno";                            //ID
                            captions[0, 4] = "2";                                //No of Fields
                            captions[0, 5] = "blockno,blockname,activestatus,College_code";   //FieldNames
                            captions[0, 6] = "string2";                           //Validation Type
                            captions[0, 7] = "100";                               //Max length
                            captions[0, 8] = "List of Block";            //Report Title


                            captions[1, 0] = "Active Status";                     //Label
                            captions[1, 1] = "checkbox";                         //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "blockno";                     //ID
                            captions[1, 4] = "2";                              //No of Fields
                            captions[1, 5] = "blockno,blockname,activestatus,College_code";//FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                              //Max length
                            captions[1, 8] = "List of Block";                 //Report Title

                            break;

                        //Added By Sneha G for Grade Entry
                        //case "acd_grade_new": //academic
                        //    captions[0, 0] = "Grade"; //Label
                        //    captions[0, 1] = "textbox"; //Control
                        //    captions[0, 2] = "grade"; //FieldName
                        //    captions[0, 3] = "gradeno"; //ID
                        //    captions[0, 4] = "1"; //No of Fields
                        //    captions[0, 5] = "gradeno,grade,College_code";//FieldNames
                        //    captions[0, 6] = "string"; //Validation Type
                        //    captions[0, 7] = "100"; //Max length
                        //    captions[0, 8] = "List of Grade"; //Report Title
                        //    break;
                        ...
                        case "acd_grade_new":  //academic
                            ...
                            captions[0, 3] = "GRADENO";                      //ID
                            captions[0, 4] = "2";                               //No of Fields
                            captions[0, 5] = "gradeno,grade,activestatus,College_code";//FieldNames
                            captions[0, 6] = "string";                          //Validation Type
                            ...
                            captions[1, 1] = "checkbox";                         //Control
                            captions[1, 2] = "activestatus";                        //FieldName  
                            captions[1, 3] = "GRADENO";                            //ID
                            captions[1, 4] = "2";                              //No of Fields
                            captions[1, 5] = "gradeno,grade,activestatus,College_code";//FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                              //Max length
                            captions[1, 8] = "List of Grade";                 //Report Title
                            break;
                        case "acd_installment_master":                          //academic
                            captions[0, 0] = "Installment Type";                //label
                            captions[0, 1] = "textbox";                         //control
                            captions[0, 2] = "installment_type";                    //fieldname
                            captions[0, 3] = "installment_no";                      //id
                            captions[0, 4] = "2";                               //no of fields
                            captions[0, 5] = "installment_no,installment_type,activestatus,college_code";        //fieldnames
                            captions[0, 6] = "string2";                          //validation type
                            captions[0, 7] = "100";                              //max length
                            captions[0, 8] = "List of Installment type";                    //report title

                            //  By Diksha N 13/05/2022
                            captions[1, 0] = "Active Status";                        //Label
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "installment_no";                          //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "installment_no,installment_type,activestatus,college_code"; //FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                                //Max length
                            captions[1, 8] = "List of Installment type";                 //Report Title
                            break;
                        ...
                        case "acd_reciept_code":  //academic
                            captions[0, 0] = "Receipt Name";                     //Label
                            captions[0, 1] = "textbox";                          //Control
                            captions[0, 2] = "RC_NAME";                          //FieldName
                            captions[0, 3] = "rcno";                            //ID
                            captions[0, 4] = "3";                                //No of Fields
                            captions[0, 5] = "rcno,RC_NAME,RECIEPT_CODE,activestatus,College_code";   //FieldNames
                            captions[0, 6] = "string2";                           //Validation Type
                            captions[0, 7] = "10";                               //Max length
                            captions[0, 8] = "List of Receipt Code";            //Report Title


                            captions[1, 0] = "Receipt Code";                     //Label
                            captions[1, 1] = "textbox";                          //Control
                            captions[1, 2] = "RECIEPT_CODE";                          //FieldName
                            captions[1, 3] = "rcno";                            //ID
                            captions[1, 4] = "3";                                //No of Fields
                            captions[1, 5] = "rcno,RC_NAME,RECIEPT_CODE,activestatus,College_code";   //FieldNames
                            captions[1, 6] = "string2";                           //Validation Type
                            captions[1, 7] = "10";                               //Max length
                            captions[1, 8] = "List of Receipt Code";            //Report Title


                            captions[2, 0] = "Active Status";                     //Label
                            captions[2, 1] = "checkbox";                         //Control
                            captions[2, 2] = "activestatus";                        //FieldName
                            captions[2, 3] = "rcno";                     //ID
                            captions[2, 4] = "3";                              //No of Fields
                            captions[2, 5] = "rcno,RC_NAME,RECIEPT_CODE,activestatus,College_code";//FieldNames
                            captions[2, 6] = "string";                          //Validation Type
                            captions[2, 7] = "20";                              //Max length
                            captions[2, 8] = "List of Receipt Code";                 //Report Title

                            break;


                        case "acd_knowledge_partner":  //academic
                            captions[0, 0] = "Knowledge Partner";                            //Label
                            captions[0, 1] = "textbox";                          //Control
                            captions[0, 2] = "Knowledge_Partner";                            //FieldName
                            captions[0, 3] = "Knowledge_Partner_no";                          //ID
                            captions[0, 4] = "2";                                //No of Fields
                            captions[0, 5] = "Knowledge_Partner_no,Knowledge_Partner,activestatus,College_code";       //FieldNames
                            captions[0, 6] = "string";                           //Validation Type
                            captions[0, 7] = "100";                               //Max length
                            captions[0, 8] = "List of Knowledge Partners";                    //Report Title

                            //  By Diksha N 13/05/2022
                            captions[1, 0] = "Active Status";                        //Label
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "Knowledge_Partner_no";                          //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "Knowledge_Partner_no,Knowledge_Partner,activestatus,College_code";//FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                                //Max length
                            captions[1, 8] = "List of Knowledge Partners";                 //Report Title
                            break;

                        case "acd_specialisation":  //academic
                            captions[0, 0] = "Specialisation Name";                            //Label
                            captions[0, 1] = "textbox";                          //Control
                            captions[0, 2] = "specialisation_name";                            //FieldName
                            captions[0, 3] = "specialisationno";                          //ID
                            captions[0, 4] = "2";                                //No of Fields
                            captions[0, 5] = "specialisationno,specialisation_name,activestatus,College_code";       //FieldNames
                            captions[0, 6] = "string";                           //Validation Type
                            captions[0, 7] = "100";                               //Max length
                            captions[0, 8] = "List of Specialisation";                    //Report Title

                            //  By Diksha N 13/05/2022
                            captions[1, 0] = "Active Status";                        //Label
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "specialisationno";                          //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "specialisationno,specialisation_name,activestatus,College_code";//FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                                //Max length
                            captions[1, 8] = "List of Specialisation";                 //Report Title
                            break;
                        ...
                        case "acd_state":  //academic
                            ...
                            captions[0, 4] = "2";                                //No of Fields
                            captions[0, 5] = "stateno,statename,activestatus,College_code";   //FieldNames
                            captions[0, 6] = "string";                           //Validation Type
                            captions[0, 7] = "35";                               //Max length
                            captions[0, 8] = "List of State";                    //Report Title

                            //Added by Sneha G. on 23/05/2020
                            captions[1, 0] = "Active Status";                        //Label
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "stateno";                          //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "stateno,statename,activestatus,College_code"; //FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                                //Max length
                            captions[1, 8] = "List of State";                 //Report Title
                            break;

                        //Added by Pooja S. on 19/02/2022
                        case "acd_payment_activity_master":  //academic
                            captions[0, 0] = "Payment Activity";                            //Label
                            captions[0, 1] = "textbox";                          //Control
                            captions[0, 2] = "activityname";                        //FieldName
                            captions[0, 3] = "activityno";                          //ID
                            captions[0, 4] = "2";                                //No of Fields
                            captions[0, 5] = "activityno,activityname,activestatus,College_code";   //FieldNames
                            captions[0, 6] = "string";                           //Validation Type
                            captions[0, 7] = "200";                               //Max length
                            captions[0, 8] = "List of Payment Activity";                    //Report Title
                            ...
                            captions[1, 3] = "activityno";                          //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "activityno,activityname,activestatus,College_code"; //FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                                //Max length
                            captions[1, 8] = "List of Payment Activity";                 //Report Title
                            break;
                        ...
                        case "acd_course_category":  //academic
                            ...
                            captions[0, 3] = "categoryno";                         //ID
                            captions[0, 4] = "3";                                //No of Fields
                            captions[0, 5] = "categoryno,categoryname,shortname,activestatus,College_code";   //FieldNames
                            captions[0, 6] = "string";                           //Validation Type
                            ...
                            captions[1, 3] = "categoryno";                         //ID
                            captions[1, 4] = "3";                                //No of Fields
                            captions[1, 5] = "categoryno,categoryname,shortname,activestatus,College_code";   //FieldNames
                            captions[1, 6] = "string";                           //Validation Type
                            captions[1, 7] = "10";                               //Max length
                            ...
                            captions[2, 1] = "checkbox";                        //Control
                            captions[2, 2] = "activestatus";                        //FieldName
                            captions[2, 3] = "categoryno";                          //ID
                            captions[2, 4] = "3";                               //No of Fields
                            captions[2, 5] = "categoryno,categoryname,shortname,activestatus,College_code"; //FieldNames
                            captions[2, 6] = "string";                          //Validation Type
                            captions[2, 7] = "20";                                //Max length
                            captions[2, 8] = "List of Course Category";                 //Report Title
                            break;

                        case "acd_session_type":  //academic
                            captions[0, 0] = "Session Type";                             //Label
                            captions[0, 1] = "textbox";                          //Control
                            captions[0, 2] = "sessiontype";                         //FieldName
                            captions[0, 3] = "stno";                             //ID
                            captions[0, 4] = "2";                                //No of Fields
                            captions[0, 5] = "stno,sessiontype,activestatus,College_code";       //FieldNames
                            captions[0, 6] = "string2";                           //Validation Type
                            captions[0, 7] = "50";                                //Max length
                            captions[0, 8] = "List of Session Type";               //Report Title

                            captions[1, 0] = "Active Status";                        //Label
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "year";                          //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "stno,sessiontype,activestatus,College_code";//FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                                //Max length
                            captions[1, 8] = "List of Session Type";                 //Report Title
                            break;
                        ...
                        case "acd_idtype":  //academic
                            ...
                            captions[0, 4] = "2";                                //No of Fields
                            captions[0, 5] = "idtypeno,idtypedescription,activestatus,College_code";   //FieldNames
                            captions[0, 6] = "string";                           //Validation Type
                            captions[0, 7] = "35";                               //Max length
                            ...
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "idtypeno,idtypedescription,activestatus,College_code"; //FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                                //Max length
                        ...
                        case "acd_tc_conduct_character":  //academic
                            captions[0, 0] = "Conduct and Character";                             //Label
                            captions[0, 1] = "textbox";                          //Control
                            captions[0, 2] = "conduct_character";                         //FieldName
                            captions[0, 3] = "cno";                             //ID
                            captions[0, 4] = "2";                                //No of Fields
                            captions[0, 5] = "cno,conduct_character,activestatus,College_code";       //FieldNames
                            captions[0, 6] = "string2";                           //Validation Type
                            captions[0, 7] = "50";                                //Max length
                            captions[0, 8] = "List of Conduct and Character";               //Report Title
                            ...
                            captions[1, 3] = "CNO";                          //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "cno,conduct_character,activestatus,College_code";//FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                                //Max length
                            captions[1, 8] = "List of Conduct and Character";                 //Report Title
                            break;
                        ...
                        case "acd_bank":  //academic
                            ...
                            captions[0, 3] = "bankno";                          //ID
                            captions[0, 4] = "3";                               //No of Fields
                            captions[0, 5] = "bankno,bankname,bankcode,activestatus,College_code";//FieldNames
                            captions[0, 6] = "string";                          //Validation Type
                            captions[0, 7] = "50";                              //Max length
                            captions[0, 8] = "List of Bank";                    //Report Title
                            ...
                            captions[1, 3] = "bankno";                          //ID
                            captions[1, 4] = "3";                               //No of Fields
                            captions[1, 5] = "bankno,bankname,bankcode,activestatus,College_code";//FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "50";                              //Max length
                            captions[1, 8] = "List of Bank";                    //Report Title
                            ...
                            captions[2, 3] = "bankno";                          //ID
                            captions[2, 4] = "3";                               //No of Fields
                            captions[2, 5] = "bankno,bankname,bankcode,activestatus,College_code";//FieldNames
                            captions[2, 6] = "string";                          //Validation Type
                            captions[2, 7] = "20";                                //Max length
                            captions[2, 8] = "List of Bank";                 //Report Title
                        ...
                        case "acd_taluka":  //academic
                            captions[0, 0] = "Taluka";                            //Label
                            captions[0, 1] = "textbox";                         //Control
                            captions[0, 2] = "talukaname";                            //FieldName
                            captions[0, 3] = "talukano";                          //ID
                            captions[0, 4] = "2";                               //No of Fields
                            captions[0, 5] = "talukano,talukaname,activestatus,College_code";        //FieldNames
                            captions[0, 6] = "string";                          //Validation Type
                            captions[0, 7] = "25";                              //Max length
                            captions[0, 8] = "List of Taluka";                    //Report Title

                            //Added by Sneha G. on 23/05/2020
                            captions[1, 0] = "Active Status";                        //Label
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "talukano";                          //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "talukano,talukaname,activestatus,College_code"; //FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                                //Max length
                            captions[1, 8] = "List of Taluka";                 //Report Title
                            break;


                        case "acd_course_specialisation":  //academic
                            captions[0, 0] = "Specialization";                            //Label
                            captions[0, 1] = "textbox";                         //Control
                            captions[0, 2] = "specialisationname";                            //FieldName
                            captions[0, 3] = "specialisationno";                          //ID
                            captions[0, 4] = "2";                               //No of Fields
                            captions[0, 5] = "specialisationno,specialisationname,activestatus,College_code";        //FieldNames
                            captions[0, 6] = "string";                          //Validation Type
                            captions[0, 7] = "25";                              //Max length
                            ...
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "FeeItemId";                          //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "specialisationno,specialisationname,activestatus,College_code";//FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                                //Max length
                            captions[1, 8] = "List of Fee Items";                 //Report Title
                            break;
                        ...
                        case "acd_admbatch":  //academic
                            ...
                            captions[0, 3] = "batchno";                          //ID
                            captions[0, 4] = "2";                               //No of Fields
                            captions[0, 5] = "batchno,batchname,activestatus,College_code";        //FieldNames
                            captions[0, 6] = "string2";                          //Validation Type
                            captions[0, 7] = "30";                              //Max length
                            captions[0, 8] = "List of Admission Batch";                    //Report Title

                            //Added by Rishabh B. on 21/01/2022
                            captions[1, 0] = "Active Status";                        //Label
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "batchno";                          //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "batchno,batchname,activestatus,College_code"; //FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                                //Max length
                            captions[1, 8] = "List of Admission Batch";                 //Report Title
                            break;

                        case "acd_paytype":  //academic
                            captions[0, 0] = "Pay Type";                             //Label
                            captions[0, 1] = "textbox";                          //Control
                            captions[0, 2] = "PTYPENAME";                         //FieldName
                            captions[0, 3] = "PAYNO";                             //ID
                            captions[0, 4] = "3";                                //No of Fields
                            captions[0, 5] = "PAYNO,PTYPENAME,PTYPE_CODE,activestatus,College_code";       //FieldNames
                            captions[0, 6] = "string";                           //Validation Type
                            captions[0, 7] = "50";                                //Max length
                            captions[0, 8] = "List of Pay Type";               //Report Title

                            captions[1, 0] = "Pay Type Code";                       //Label
                            captions[1, 1] = "textbox";                         //Control
                            captions[1, 2] = "PTYPE_CODE";                        //FieldName
                            captions[1, 3] = "PAYNO";                          //ID
                            captions[1, 4] = "3";                               //No of Fields
                            captions[1, 5] = "PAYNO,PTYPENAME,PTYPE_CODE,activestatus,College_code";       //FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "50";                              //Max length
                            captions[1, 8] = "List of Pay Type";               //Report Title

                            //Added by Sneha G. on 23/05/2020
                            captions[2, 0] = "Active Status";                        //Label
                            captions[2, 1] = "checkbox";                        //Control
                            captions[2, 2] = "activestatus";                        //FieldName
                            captions[2, 3] = "PAYNO";                          //ID
                            captions[2, 4] = "3";                               //No of Fields
                            captions[2, 5] = "PAYNO,PTYPENAME,PTYPE_CODE,activestatus,College_code";//FieldNames
                            captions[2, 6] = "string";                          //Validation Type
                            captions[2, 7] = "20";                                //Max length
                            captions[2, 8] = "List of Pay Type";            //Report Title
                            break;
                        ...
                        case "acd_physical_handicapped":  //academic
                            ...
                            captions[0, 4] = "2";                                //No of Fields
                            captions[0, 5] = "handicap_no,handicap_name,activestatus,college_code";   //FieldNames
                            captions[0, 6] = "string2";                           //Validation Type
                            captions[0, 7] = "200";                               //Max length
                            ...
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "handicap_no";                          //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "handicap_no,handicap_name,activestatus,college_code"; //FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                                //Max length
                            captions[1, 8] = "List of Physical Handicap";                 //Report Title
                            break;
                        ...
                        case "acd_district":  //academic
                            ...
                            captions[0, 4] = "2";                               //No of Fields
                            captions[0, 5] = "districtno,districtname,activestatus,College_code";//FieldNames
                            captions[0, 6] = "string";                          //Validation Type
                            captions[0, 7] = "100";                             //Max length
                            ...
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "districtno";                          //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "districtno,districtname,activestatus,College_code"; //FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                                //Max length
                            captions[1, 8] = "List of District";                 //Report Title
                            break;

                        //Added by Rishabh on 27.07.2022
                        case "acd_calender_activity_type":  //academic
                            captions[0, 0] = "Activity Type";                             //Label
                            captions[0, 1] = "textbox";                          //Control
                            captions[0, 2] = "activity_type";                         //FieldName
                            captions[0, 3] = "cano";                             //ID
                            captions[0, 4] = "2";                                //No of Fields
                            captions[0, 5] = "cano,activity_type,activestatus,College_code";       //FieldNames
                            captions[0, 6] = "string2";                           //Validation Type
                            captions[0, 7] = "50";                                //Max length
                            captions[0, 8] = "List of Activity Type";               //Report Title

                            captions[1, 0] = "Active Status";                        //Label
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "cano";                          //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "cano,activity_type,activestatus,College_code";//FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                                //Max length
                            captions[1, 8] = "List of Activity Type";                 //Report Title
                            break;
                        ...
                        case "acd_bloodgrp":  //academic
                            ...
                            captions[0, 4] = "2";                               //No of Fields
                            captions[0, 5] = "bloodgrpno,bloodgrpname,activestatus,College_code";//FieldNames
                            captions[0, 6] = "string";                          //Validation Type
                            captions[0, 7] = "100";                             //Max length
                            ...
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "bloodgrpno";                          //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "bloodgrpno,bloodgrpname,activestatus,College_code";//FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                                //Max length
                            captions[1, 8] = "List of Blood Group";                 //Report Title
                            break;
                        ...
                        case "acd_nationality":  //academic
                            ...
                            captions[0, 3] = "nationalityno";                   //ID
                            captions[0, 4] = "2";                               //No of Fields
                            captions[0, 5] = "nationalityno,nationality,activestatus,College_code";//FieldNames
                            captions[0, 6] = "string";                          //Validation Type
                            captions[0, 7] = "100";                             //Max length
                            captions[0, 8] = "List of Nationality";             //Report Title
                            ...
                            captions[1, 3] = "nationalityno";                          //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "nationalityno,nationality,activestatus,College_code";//FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                                //Max length
                            captions[1, 8] = "List of Nationality";                 //Report Title
                            break;
                        ...
                        case "acd_mtongue":  //academic
                            ...
                            captions[0, 4] = "2";                               //No of Fields
                            captions[0, 5] = "mtongueno,mtongue,activestatus,College_code";  //FieldNames
                            captions[0, 6] = "string";                          //Validation Type
                            captions[0, 7] = "20";                              //Max length
                            ...
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "mtongueno";                          //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "mtongueno,mtongue,activestatus,College_code";//FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                                //Max length
                            captions[1, 8] = "List of Mother Tongue";                 //Report Title
                            break;
                        ...
                        case "acd_occupation":  //academic
                            ...
                            captions[0, 4] = "2";                               //No of Fields
                            captions[0, 5] = "occupation,occname,activestatus,College_code"; //FieldNames
                            captions[0, 6] = "string";                          //Validation Type
                            captions[0, 7] = "100";                             //Max length
                            ...
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "occupation";                          //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "occupation,occname,activestatus,College_code";//FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                                //Max length
                            captions[1, 8] = "List of Occupation";                 //Report Title
                            break;
                        ...
                        case "acd_paymenttype":  //academic
                            ...
                            captions[0, 4] = "3";                                //No of Fields
                            captions[0, 5] = "paytypeno,paytypename,remark,activestatus,College_code";   //FieldNames
                            captions[0, 6] = "string2";                           //Validation Type
                            captions[0, 7] = "50";                               //Max length
                            captions[0, 8] = "List of Payment Types";             //Report Title

                            captions[1, 0] = "Remark Shown on Fee Receipt";                     //Label
                            captions[1, 1] = "textbox";                          //Control
                            captions[1, 2] = "remark";                      //FieldName
                            captions[1, 3] = "paytypeno";                        //ID
                            captions[1, 4] = "3";                                //No of Fields
                            captions[1, 5] = "paytypeno,paytypename,remark,activestatus,College_code";   //FieldNames
                            captions[1, 6] = "string2";                           //Validation Type
                            ...
                            captions[2, 1] = "checkbox";                        //Control
                            captions[2, 2] = "activestatus";                        //FieldName
                            captions[2, 3] = "paytypeno";                          //ID
                            captions[2, 4] = "3";                               //No of Fields
                            captions[2, 5] = "paytypeno,paytypename,remark,activestatus,College_code";//FieldNames
                            captions[2, 6] = "string";                          //Validation Type
                            captions[2, 7] = "20";                                //Max length
                            captions[2, 8] = "List of Payment Types";                 //Report Title
                            break;
                        ...
                        case "acd_year":  //academic
                            ...
                            captions[0, 4] = "2";                                //No of Fields
                            captions[0, 5] = "year,yearname,activestatus,College_code";       //FieldNames
                            captions[0, 6] = "string2";                           //Validation Type
                            captions[0, 7] = "50";                                //Max length
                            ...
                            captions[1, 3] = "year";                          //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "year,yearname,activestatus,College_code";//FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                                //Max length
                            captions[1, 8] = "List of Class Year";                 //Report Title
                            break;
                        ...
                        case "acd_section":  //academic
                            ...
                            captions[0, 4] = "2";                                //No of Fields
                            captions[0, 5] = "sectionno,sectionname,activestatus,College_code";//FieldNames
                            captions[0, 6] = "string";                           //Validation Type
                            captions[0, 7] = "25";                               //Max length
                            ...
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "sectionno";                          //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "sectionno,sectionname,activestatus,College_code";//FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                                //Max length
                            captions[1, 8] = "List of Sections";                 //Report Title
                            break;
                        ...
                        case "acd_academic_roommaster":  //academic
                            ...
                            captions[0, 4] = "3";                                //No of Fields
                            captions[0, 5] = "Roomno,Roomname,intake,activestatus,College_code";   //FieldNames
                            captions[0, 6] = "string2";                           //Validation Type
                            captions[0, 7] = "50";                               //Max length
                            ...
                            captions[1, 4] = "3";                                //No of Fields
                            captions[1, 5] = "Roomno,Roomname,intake,activestatus,College_code";   //FieldNames
                            captions[1, 6] = "string2";                           //Validation Type
                            captions[1, 7] = "50";                               //Max length
                            ...
                            captions[2, 1] = "checkbox";                        //Control
                            captions[2, 2] = "activestatus";                        //FieldName
                            captions[2, 3] = "Roomno";                          //ID
                            captions[2, 4] = "3";                               //No of Fields
                            captions[2, 5] = "Roomno,Roomname,intake,activestatus,College_code";//FieldNames
                            captions[2, 6] = "string";                          //Validation Type
                            captions[2, 7] = "20";                                //Max length
                            captions[2, 8] = "List of Rooms";
                            break;
                        ...
                        case "acd_semester":  //academic
                            ...
                            captions[0, 4] = "4";                                //No of Fields
                            captions[0, 5] = "Semesterno,Semestername,Semfullname,odd_even,activestatus,College_code";   //FieldNames
                            captions[0, 6] = "string";                           //Validation Type
                            captions[0, 7] = "35";                               //Max length
                            ...
                            captions[1, 4] = "4";                                //No of Fields
                            captions[1, 5] = "Semesterno,Semestername,Semfullname,odd_even,activestatus,College_code";   //FieldNames
                            captions[1, 6] = "string";                           //Validation Type
                            captions[1, 7] = "35";                               //Max length
                            ...
                            captions[2, 4] = "4";                                //No of Fields
                            captions[2, 5] = "Semesterno,Semestername,Semfullname,odd_even,activestatus,College_code";   //FieldNames
                            captions[2, 6] = "string2";                           //Validation Type
                            ...
                            captions[3, 1] = "checkbox";                        //Control
                            captions[3, 2] = "activestatus";                        //FieldName
                            captions[3, 3] = "semesterno";                          //ID
                            captions[3, 4] = "4";                               //No of Fields
                            captions[3, 5] = "Semesterno,Semestername,Semfullname,odd_even,activestatus,College_code";//FieldNames
                            captions[3, 6] = "string";                          //Validation Type
                            captions[3, 7] = "20";                                //Max length
                            captions[3, 8] = "List of Semester";                 //Report Title
                            break;
                        ...
                        case "acd_subjecttype":  //academic
                            ...
                            captions[0, 4] = "2";                                //No of Fields
                            captions[0, 5] = "subid,subname,activestatus,College_code";   //FieldNames
                            captions[0, 6] = "string";                           //Validation Type
                            ...
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "subid";                          //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "subid,subname,activestatus,College_code";//FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                                //Max length
                            captions[1, 8] = "List of Subject Types";                 //Report Title
                            break;
                        ...
                        case "acd_scholorshiptype":  //ScholorshipType
                            ...
                            captions[0, 4] = "3";                                //No of Fields
                            captions[0, 5] = "scholorshiptypeno,scholorshipname,scholorshipcode,activestatus,College_code";   //FieldNames
                            captions[0, 6] = "string2";                          //Validation Type
                            captions[0, 7] = "50";                               //Max length
                            ...
                            captions[1, 4] = "3";                                //No of Fields
                            captions[1, 5] = "scholorshiptypeno,scholorshipname,scholorshipcode,activestatus,College_code";   //FieldNames
                            captions[1, 6] = "string2";                          //Validation Type
                            captions[1, 7] = "5";                                //Max length
                            ...
                            captions[2, 1] = "checkbox";                        //Control
                            captions[2, 2] = "activestatus";                        //FieldName
                            captions[2, 3] = "scholorshiptypeno";                          //ID
                            captions[2, 4] = "3";                               //No of Fields
                            captions[2, 5] = "scholorshiptypeno,scholorshipname,scholorshipcode,activestatus,College_code";//FieldNames
                            captions[2, 6] = "string";                          //Validation Type
                            captions[2, 7] = "20";                                //Max length
                            captions[2, 8] = "List of Scholarships";                 //Report Title
                            break;
                        ...
                        case "acd_admission_round":  //academic
                            ...
                            captions[0, 4] = "2";                                //No of Fields
                            captions[0, 5] = "admroundno,roundname,activestatus,College_code";   //FieldNames
                            captions[0, 6] = "string2";                           //Validation Type
                            captions[0, 7] = "20";                               //Max length
                            ...
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "admroundno";                          //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "admroundno,roundname,activestatus,College_code";//FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                                //Max length
                            captions[1, 8] = "List of Admission Round";                 //Report Title
                            break;
                        ...
                        case "acd_certificate_master":  //academic
                            ...
                            captions[0, 4] = "3";                               //No of Fields
                            captions[0, 5] = "cert_no,cert_name,cert_short_name,activestatus,College_code";//FieldNames
                            captions[0, 6] = "string2";                         //Validation Type
                            captions[0, 7] = "50";                              //Max length
                            ...
                            captions[1, 4] = "3";                               //No of Fields
                            captions[1, 5] = "cert_no,cert_name,cert_short_name,activestatus,College_code";//FieldNames
                            captions[1, 6] = "string2";                          //Validation Type
                            captions[1, 7] = "10";                               //Max length
                            ...
                            captions[2, 1] = "checkbox";                        //Control
                            captions[2, 2] = "activestatus";                        //FieldName
                            captions[2, 3] = "cert_no";                          //ID
                            captions[2, 4] = "3";                               //No of Fields
                            captions[2, 5] = "cert_no,cert_name,cert_short_name,activestatus,College_code"; //FieldNames
                            captions[2, 6] = "string";                          //Validation Type
                            captions[2, 7] = "20";                                //Max length
                            captions[2, 8] = "List of Certificates";                 //Report Title
                            break;
                        ...
                        case "acd_electgroup":  //academic
                            ...
                            captions[0, 3] = "groupno";                          //ID
                            captions[0, 4] = "3";                               //No of Fields
                            captions[0, 5] = "groupno,groupname,choicefor,activestatus,College_code";        //FieldNames
                            captions[0, 6] = "string2";                          //Validation Type
                            captions[0, 7] = "25";                              //Max length
                            ...
                            captions[1, 4] = "3";                               //No of Fields
                            captions[1, 5] = "groupno,groupname,choicefor,activestatus,College_code";        //FieldNames
                            captions[1, 6] = "numeric";                          //Validation Type
                            captions[1, 7] = "5";                              //Max length
                            ...
                            captions[2, 1] = "checkbox";                        //Control
                            captions[2, 2] = "activestatus";                        //FieldName
                            captions[2, 3] = "groupno";                          //ID
                            captions[2, 4] = "3";                               //No of Fields
                            captions[2, 5] = "groupno,groupname,choicefor,activestatus,College_code"; //FieldNames
                            captions[2, 6] = "string";                          //Validation Type
                            captions[2, 7] = "20";                                //Max length
                            captions[2, 8] = "List of Elective";                 //Report Title
                            break;
                        ...
                        case "acd_schemetype":  //academic
                            ...
                            captions[0, 4] = "3";                                //No of Fields
                            captions[0, 5] = "schemetypeno,schemetype,schemetype_code,activestatus,College_code";   //FieldNames
                            captions[0, 6] = "string";                           //Validation Type
                            captions[0, 7] = "100";                              //Max length
                            ...
                            captions[1, 4] = "3";                                //No of Fields
                            captions[1, 5] = "schemetypeno,schemetype,schemetype_code,activestatus,College_code";   //FieldNames
                            captions[1, 6] = "string";                           //Validation Type
                            captions[1, 7] = "10";                               //Max length
                            ...
                            captions[2, 3] = "groupno";                          //ID
                            captions[2, 4] = "3";                               //No of Fields
                            captions[2, 5] = "schemetypeno,schemetype,schemetype_code,activestatus,College_code"; //FieldNames
                            captions[2, 6] = "string";                          //Validation Type
                            captions[2, 7] = "20";                                //Max length
                            captions[2, 8] = "List of Elective";                 //Report Title
                            break;
                        ...
                        case "acd_floor":  //academic
                            ...
                            captions[0, 3] = "floorno";                            //ID
                            captions[0, 4] = "2";                                //No of Fields
                            captions[0, 5] = "floorno,floorname,activestatus,College_code";   //FieldNames
                            captions[0, 6] = "string2";                           //Validation Type
                            captions[0, 7] = "100";                               //Max length
                            captions[0, 8] = "List of Floors";            //Report Title
                            ...
                            captions[1, 1] = "checkbox";                         //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "floorno";                     //ID
                            captions[1, 4] = "2";                              //No of Fields
                            captions[1, 5] = "floorno,floorname,activestatus,College_code";//FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                              //Max length
                            captions[1, 8] = "List of Floors";                 //Report Title
                        ...
                        case "acd_convocation_master":
                            ...
                            captions[0, 3] = "conv_no";                     //ID
                            captions[0, 4] = "2";                               //No of Fields
                            captions[0, 5] = "conv_no,convocation_name,activestatus,college_code";//FieldNames
                            captions[0, 6] = "string2";                          //Validation Type
                            captions[0, 7] = "250";                              //Max length
                            captions[0, 8] = "List of Convocation";                 //Report Title
                            ...
                            captions[1, 1] = "checkbox";                         //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "conv_no";                     //ID
                            captions[1, 4] = "2";                              //No of Fields
                            captions[1, 5] = "conv_no,convocation_name,activestatus,College_code";//FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                              //Max length
                            captions[1, 8] = "List of Convocation";                 //Report Title
                        ...
                        case "acd_withheld_reason":  //withheld info
                            ...
                            captions[0, 4] = "2";                               //No of Fields
                            captions[0, 5] = "withheldno,withheld_name,activestatus,College_code";//FieldNames
                            captions[0, 6] = "string2";                          //Validation Type
                            //captions[0, 7] = "250";                              //Max length Commented by Injamam on 28-4-23
                            captions[0, 7] = "500";                              //Max length  Added for Injamam on 28-4-23
                            ...
                            captions[1, 1] = "checkbox";                         //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "withheldno";                     //ID
                            captions[1, 4] = "2";                              //No of Fields
                            captions[1, 5] = "withheldno,withheld_name,activestatus,College_code";//FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                              //Max length
                            captions[1, 8] = "List of WithHeld";                 //Report Title
                        ...
                        case "acd_exam_pattern":  //academic
                            ...
                            captions[0, 4] = "2";                                //No of Fields
                            captions[0, 5] = "patternno,pattern_name,activestatus,College_code";       //FieldNames
                            captions[0, 6] = "string";                           //Validation Type
                            captions[0, 7] = "50";                               //Max length
                            ...
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "patternno";                          //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "patternno,pattern_name,activestatus,College_code";//FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                                //Max length
                            captions[1, 8] = "List of Exam Pattern";                 //Report Title
                            break;
                        ...
                        case "acd_currency":  //academic
                            ...
                            captions[0, 4] = "3";                                //No of Fields
                            captions[0, 5] = "Cur_no,Cur_name,Cur_short,activestatus,College_code";   //FieldNames
                            captions[0, 6] = "string";                           //Validation Type
                            captions[0, 7] = "100";                              //Max length
                            ...
                            captions[1, 4] = "3";                                //No of Fields
                            captions[1, 5] = "Cur_no,Cur_name,Cur_short,activestatus,College_code";   //FieldNames
                            captions[1, 6] = "string";                           //Validation Type
                            captions[1, 7] = "10";                               //Max length
                            ...
                            captions[2, 1] = "checkbox";                        //Control
                            captions[2, 2] = "activestatus";                        //FieldName
                            captions[2, 3] = "Cur_No";                          //ID
                            captions[2, 4] = "3";                               //No of Fields
                            captions[2, 5] = "Cur_no,Cur_name,Cur_short,activestatus,College_code";//FieldNames
                            captions[2, 6] = "string";                          //Validation Type
                            captions[2, 7] = "20";                                //Max length
                            captions[2, 8] = "List of Currency";                 //Report Title
                            break;
                        ...
                        case "acd_ua_section":  //academic
                            ...
                            captions[0, 4] = "2";                                //No of Fields
                            captions[0, 5] = "UA_SECTION,UA_SECTIONNAME,ACTIVESTATUS,COLLEGE_CODE";   //FieldNames
                            captions[0, 6] = "string";                           //Validation Type
                            captions[0, 7] = "35";                               //Max length
                            ...
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "ACTIVESTATUS";                        //FieldName
                            captions[1, 3] = "UA_SECTION";                          //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "UA_SECTION,UA_SECTIONNAME,ACTIVESTATUS,COLLEGE_CODE";//FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                                //Max length
                            captions[1, 8] = "List of Degree Type";                 //Report Title
                            break;
                        ...
                        case "acd_fees_master":  //academic
                            ...
                            captions[0, 4] = "2";                                //No of Fields
                            captions[0, 5] = "FeeItemId,FeeItemName,activestatus,College_code";   //FieldNames
                            captions[0, 6] = "string2";                           //Validation Type
                            captions[0, 7] = "50";                               //Max length
                            ...
                            captions[1, 3] = "FeeItemId";                          //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "FeeItemId,FeeItemName,activestatus,College_code";//FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                                //Max length
                            captions[1, 8] = "List of Fee Items";                 //Report Title
                            break;
                        ...
                        case "acd_authority": //academic
                            ...
                            captions[0, 4] = "2";                                           //No  of Fields
                            captions[0, 5] = "authorityno,authorityname,activestatus,College_code";      //FieldNames
                            captions[0, 6] = "string";                                      //Validation Type
                            captions[0, 7] = "200";                                          //Max Length
                            ...
                            captions[1, 3] = "patternno";                          //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "authorityno,authorityname,activestatus,College_code";//FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                                //Max length
                            captions[1, 8] = "List of Exam Pattern";                 //Report Title
                            break;
                        ...
                        case "acd_hostel_type":  //Hostel Type
                            ...
                            captions[0, 4] = "2";                            //No of Fields
                            captions[0, 5] = "hostel_type_no,hostel_type_name,activestatus,College_code";//FieldNames
                            captions[0, 6] = "string2";                          //Validation Type
                            captions[0, 7] = "50";                              //Max length
                            ...
                            captions[1, 3] = "patternno";                          //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "hostel_type_no,hostel_type_name,activestatus,College_code";//FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                                //Max length
                            captions[1, 8] = "List of Exam Pattern";                 //Report Title
                            break;
                        ...
                        case "acd_transport":  //Transport
                            ...
                            captions[0, 4] = "2";                            //No of Fields
                            captions[0, 5] = "transport_no,transport_name,activestatus,College_code";//FieldNames
                            captions[0, 6] = "string";                          //Validation Type
                            captions[0, 7] = "50";                              //Max length
                            ...
                            captions[1, 3] = "qualilevelno";                          //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "transport_no,transport_name,activestatus,College_code";//FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                                //Max length
                            captions[1, 8] = "List of Qualification Level";                 //Report Title
                            break;
                        ...
                        case "acd_board":  //academic
                            ...
                            captions[0, 4] = "2";                                //No of Fields
                            captions[0, 5] = "boardno,board,activestatus,College_code";       //FieldNames
                            captions[0, 6] = "string";                           //Validation Type
                            captions[0, 7] = "100";                               //Max length
                            ...
                            captions[1, 3] = "patternno";                          //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "boardno,board,activestatus,College_code";//FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                                //Max length
                            captions[1, 8] = "List of Exam Pattern";                 //Report Title
                        ...
                        case "att_wieghtage":                                           //academic
                            ...
                            captions[0, 4] = "3";                                       //No of fields
                            captions[0, 5] = "ATT_WT_NO,attendance,weightage,activestatus,college_code";  //fieldsnames
                            captions[0, 6] = "string2";                                    //Validation Type
                            captions[0, 7] = "200";                                       //Max length
                            ...
                            captions[1, 4] = "3";                                       //No of fields
                            captions[1, 5] = "ATT_WT_NO,attendance,weightage,activestatus,college_code";  //fieldsnames
                            captions[1, 6] = "numeric";                                    //Validation Type
                            captions[1, 7] = "10";                                       //Max length
                            ...
                            captions[2, 1] = "checkbox";                        //Control
                            captions[2, 2] = "activestatus";                        //FieldName
                            captions[2, 3] = "apno";                          //ID
                            captions[2, 4] = "3";                               //No of Fields
                            captions[2, 5] = "ATT_WT_NO,attendance,weightage,activestatus,college_code";//FieldNames
                            captions[2, 6] = "string";                          //Validation Type
                            captions[2, 7] = "20";                                //Max length
                            captions[2, 8] = "List of Application Name ";                 //Report Title
                            break;

                        //Added by Nikhil L. on 09/02/2022 to add year of passing for online admission.
                        case "acd_qual_year":  //academic
                            captions[0, 0] = "Year";                            //Label
                            captions[0, 1] = "textbox";                          //Control
                            captions[0, 2] = "year_name";                            //FieldName
                            captions[0, 3] = "yearno";                          //ID
                            captions[0, 4] = "2";                                //No of Fields
                            captions[0, 5] = "yearno,year_name,activestatus,college_code";       //FieldNames
                            captions[0, 6] = "string2";                           //Validation Type
                            captions[0, 7] = "50";                               //Max length
                            captions[0, 8] = "List of Year Passing";                    //Report Title

                            captions[1, 0] = "Active Status";                        //Label
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "yearno";                          //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "yearno,year_name,activestatus,college_code";//FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                                //Max length
                            captions[1, 8] = "List of Year Passing";                 //Report Title
                            break;
                        //#region Sports
                        //case "sprt_unit":
                        ...
                        //Added By Sachin L for OrganizationType on 12-07-2022
                        case "acd_organizationtype":  //academic
                            captions[0, 0] = "OrganizationType";                            //Label
                            captions[0, 1] = "textbox";                         //Control
                            captions[0, 2] = "OrganizationType";                            //FieldName
                            captions[0, 3] = "OrganizationTypeID";                          //ID
                            captions[0, 4] = "2";                               //No of Fields
                            captions[0, 5] = "organizationtypeid,organizationtype,activestatus,college_code";        //FieldNames
                            captions[0, 6] = "string2";                          //Validation Type
                            captions[0, 7] = "100";                              //Max length
                            captions[0, 8] = "List of OrganizationType";                    //Report Title


                            captions[1, 0] = "Active Status";                            //Label
                            captions[1, 1] = "checkbox";                         //Control
                            captions[1, 2] = "activestatus";                            //FieldName
                            captions[1, 3] = "OrganizationTypeID";                          //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "organizationtypeid,organizationtype,activestatus,college_code";        //FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                              //Max length
                            captions[1, 8] = "List of OrganizationType";                    //Report Title
                        ...
                        case "acd_discount":                          //academic
                            ...
                            captions[0, 1] = "textbox";                         //control
                            captions[0, 2] = "discount";                    //fieldname
                            captions[0, 3] = "disc_no";                      //id
                            captions[0, 4] = "2";                               //no of fields
                            captions[0, 5] = "disc_no,discount,activestatus,college_code";        //fieldnames
                            captions[0, 6] = "string2";                          //validation type
                            captions[0, 7] = "100";                              //max length
                            captions[0, 8] = "List of Discount";                    //report title

                            captions[1, 0] = "Active Status";                        //Label
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "disc_no";                          //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "disc_no,discount,activestatus,college_code"; //FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                                //Max length
                            captions[1, 8] = "List of Discount";                 //Report Title
                            break;


                        case "acd_concession_type":                                    //academic
                            captions[0, 0] = "Concession Type ";                        //Label
                            captions[0, 1] = "textbox";                       //Control
                            captions[0, 2] = "Concession_Type";                  //FieldName
                            captions[0, 3] = "concession_typeno";                         //ID
                            captions[0, 4] = "2";                            //No of Fields
                            captions[0, 5] = "concession_typeno,Concession_Type,activestatus,college_code";             //FieldNames
                            captions[0, 6] = "string2";                       //Validation Type
                            captions[0, 7] = "35";                           //Max length
                            captions[0, 8] = "List of Concession Type";              //Report Title

                            captions[1, 0] = "Active Status";                        //Label
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "Concession_Type";                          //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "concession_typeno,Concession_Type,activestatus,college_code"; //FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                                //Max length
                            captions[1, 8] = "List of Concession Type";                 //Report Title
                            break;
                        ...
                        case "acd_examination_mode":        //Examination
                            ...
                            captions[0, 1] = "textbox";                          //Control
                            captions[0, 2] = "ModeEXAMNAME";                         //FieldName
                            captions[0, 3] = "ModeEXAMNO";                             //ID
                            captions[0, 4] = "2";                                //No of Fields
                            captions[0, 5] = "ModeEXAMNO,ModeEXAMNAME,ACTIVESTATUS,COLLEGE_CODE";       //FieldNames
                            captions[0, 6] = "string2";                           //Validation Type
                            captions[0, 7] = "100";                                //Max length
                            captions[0, 8] = "List of Examination Mode";               //Report Title

                            captions[1, 0] = "Active Status";                        //Label
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "ModeEXAMNO";                          //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "ModeEXAMNO,ModeEXAMNAME,ACTIVESTATUS,COLLEGE_CODE"; //FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                                //Max length
                            captions[1, 8] = "List of Examination Mode";                 //Report Title
                            break;
                        //Added By Shubham B for EXAMINATION_MODE on 18/01/2023 ended

                        //Added by Injamam A. for AUDIT_GRADE on 21-2-2023
                        case "acd_audit_grade":                                            //Audit Grade
                            captions[0, 0] = "Grade Name";                                 //Label
                            captions[0, 1] = "textbox";                                    //Control
                            captions[0, 2] = "GRADE_NAME";                                 //FieldName
                            captions[0, 3] = "ID";                                         //ID
                            captions[0, 4] = "2";                                          //Number of Fields
                            captions[0, 5] = "ID,GRADE_NAME,ACTIVESTATUS,College_code";    //FieldNames
                            captions[0, 6] = "string";                                     //Validation Type
                            captions[0, 7] = "25";                                         //Max Length
                            captions[0, 8] = "List of Grades";                             //Report Title

                            captions[1, 0] = "Active Status";                              //Label
                            captions[1, 1] = "checkbox";                                   //Control
                            captions[1, 2] = "activestatus";                              //FieldName
                            captions[1, 3] = "ID";                                         //ID
                            captions[1, 4] = "2";                                          //Number of Fields
                            captions[1, 5] = "ID,GRADE_NAME,ACTIVESTATUS,College_code";    //FieldNames
                            captions[1, 6] = "string";                                     //Validation Type
                            captions[1, 7] = "20";                                         //Max Length
                        ...
                        case "acd_global_elective_group_master":  //academic
                            captions[0, 0] = "Group Name";                            //Label
                            captions[0, 1] = "textbox";                         //Control
                            captions[0, 2] = "group_name";                            //FieldName
                            captions[0, 3] = "gmid";                          //ID
                            captions[0, 4] = "2";                               //No of Fields
                            captions[0, 5] = "gmid,group_name,activestatus,college_code";        //FieldNames
                            captions[0, 6] = "string2";                          //Validation Type
                            captions[0, 7] = "100";                              //Max length
                            captions[0, 8] = "List of Global Elective Group Master";                    //Report Title


                            captions[1, 0] = "Active Status";                            //Label
                            captions[1, 1] = "checkbox";                         //Control
                            captions[1, 2] = "activestatus";                            //FieldName
                            captions[1, 3] = "gmid";                          //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "gmid,group_name,activestatus,college_code";        //FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                              //Max length
                            captions[1, 8] = "List of Global Elective Group Master";                    //Report Title

                            break;

                        //Added By Jay  T  for acd_value_added_group_master on 21-06-2023
                        case "acd_value_added_group_master":        //academic 
                            captions[0, 0] = "Group Name";                             //Label
                            captions[0, 1] = "textbox";                          //Control
                            captions[0, 2] = "group_name";                         //FieldName
                            captions[0, 3] = "gmid";                             //ID
                            ...
                            captions[0, 6] = "string2";                           //Validation Type
                            captions[0, 7] = "100";                                //Max length
                            captions[0, 8] = "List of Value Added Group";               //Report Title
                        ...
                        case "acd_hostel":  //hostel info
                            ...
                            captions[0, 4] = "3";                               //No of Fields
                            captions[0, 5] = "hostel_no,hostel_name,hostel_address,activestatus,College_code";//FieldNames
                            captions[0, 6] = "string2";                          //Validation Type
                            captions[0, 7] = "50";                              //Max length
                            ...
                            captions[1, 4] = "3";                               //No of Fields
                            captions[1, 5] = "hostel_no,hostel_name,hostel_address,activestatus,College_code";//FieldNames
                            captions[1, 6] = "string2";                          //Validation Type
                            captions[1, 7] = "50";                              //Max length
                            captions[1, 8] = "List of Hostel";

                            captions[2, 0] = "Active Status";                        //Label
                            captions[2, 1] = "checkbox";                        //Control
                            captions[2, 2] = "activestatus";                        //FieldName
                            captions[2, 3] = "hostel_no";                          //ID
                            captions[2, 4] = "3";                               //No of Fields
                            captions[2, 5] = "hostel_no,hostel_name,hostel_address,activestatus,College_code";//FieldNames
                            captions[2, 6] = "string";                          //Validation Type
                            captions[2, 7] = "20";                                //Max length
                            captions[2, 8] = "List of Hostel";
                            //Report Title
                            break;
                        ...
                        case "acd_hostel_mess":                                 //Hostel Mess
                            ...
                            captions[0, 3] = "mess_no";                         //ID
                            captions[0, 4] = "4";                               //No of Fields
                            captions[0, 5] = "mess_no,mess_name,HBNO,CAPACITY,activestatus,college_code";  //FieldNames
                            captions[0, 6] = "string2";                         //Validation Type
                            captions[0, 7] = "50";                              //Max length
                            captions[0, 8] = "List of Hostel Mess";             //Report Title

                            captions[1, 0] = "HBNO";                       //Label
                            captions[1, 1] = "textbox";                         //Control
                            captions[1, 2] = "HBNO";                       //FieldName
                            captions[1, 3] = "mess_no";                         //ID
                            captions[1, 4] = "4";                             //No of Fields
                            captions[1, 5] = "mess_no,mess_name,HBNO,CAPACITY,activestatus,college_code";  //FieldNames
                            captions[1, 6] = "string2";                         //Validation Type
                            captions[1, 7] = "50";                              //Max length
                            captions[1, 8] = "List of Hostel Mess";             //Report Title

                            captions[2, 0] = "SEAT CPACITY";                       //Label
                            captions[2, 1] = "textbox";                         //Control
                            captions[2, 2] = "CAPACITY";                       //FieldName
                            captions[2, 3] = "mess_no";                         //ID
                            captions[2, 4] = "4";                               //No of Fields
                            captions[2, 5] = "mess_no,mess_name,HBNO,CAPACITY,activestatus,college_code";  //FieldNames
                            captions[2, 6] = "string2";                         //Validation Type
                            captions[2, 7] = "50";                              //Max length
                            captions[2, 8] = "List of Hostel Mess";             //Report Title

                            captions[3, 0] = "Active Status";                        //Label
                            captions[3, 1] = "checkbox";                        //Control
                            captions[3, 2] = "activestatus";                        //FieldName
                            captions[3, 3] = "mess_no";                         //ID
                            captions[3, 4] = "4";                            //No of Fields
                            captions[3, 5] = "mess_no,mess_name,HBNO,CAPACITY,activestatus,college_code";  //FieldNames
                            captions[3, 6] = "string";                          //Validation Type
                            captions[3, 7] = "20";                                //Max length
                            captions[3, 8] = "List of Hostel Mess";
                            break;
                        ...
                        case "acd_hostel_attendance_remark":  //Asset Type
                            ...
                            captions[0, 4] = "2";                            //No of Fields
                            captions[0, 5] = "remarkno,remark,activestatus,college_code";//FieldNames
                            captions[0, 6] = "string2";                          //Validation Type
                            ...
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "remarkno";                          //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "remarkno,remark,activestatus,college_code";//FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                                //Max length
                            captions[1, 8] = "List of Attendance Remark";
                            break;
                        case "acd_hostel_certificate_remark":               //Certifcate Type
                            ...
                            captions[0, 4] = "2";                            //No of Fields
                            captions[0, 5] = "crno,cert_remark,activestatus,college_code";//FieldNames
                            captions[0, 6] = "string2";                          //Validation Type
                            captions[0, 7] = "1000";                              //Max length
                            ...
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "crno";                          //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "crno,cert_remark,activestatus,college_code";//FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                                //Max length
                            captions[1, 8] = "List of Certificate Remark";
                            break;
                        ...
                        case "acd_hostel_floor":  //floor 
                            ...
                            captions[0, 4] = "3";                         //No of Fields
                            captions[0, 5] = "floor_no,floor_name,code,activestatus,College_code";//FieldNames
                            captions[0, 6] = "string2";                   //Validation Type
                            captions[0, 7] = "50";                        //Max length
                            ...
                            captions[1, 4] = "3";                        //No of Fields
                            captions[1, 5] = "floor_no,floor_name,code,activestatus,College_code";//FieldNames
                            captions[1, 6] = "string2";                  //Validation Type
                            captions[1, 7] = "50";                       //Max length
                            ...
                            captions[2, 1] = "checkbox";                        //Control
                            captions[2, 2] = "activestatus";                        //FieldName
                            captions[2, 3] = "floor_no";                          //ID
                            captions[2, 4] = "3";                               //No of Fields
                            captions[2, 5] = "floor_no,floor_name,code,activestatus,College_code";//FieldNames
                            captions[2, 6] = "string";                          //Validation Type
                            captions[2, 7] = "20";                                //Max length
                            captions[2, 8] = "List of Floor";
                            break;
                        ...
                        case "acd_tp_jobtype": //Job Type   
                            ...
                            captions[0, 4] = "2";                                       //No of Fields
                            captions[0, 5] = "jobno,jobtype,activestatus,College_code"; //FieldNames
                            captions[0, 6] = "string";                                  //Validation Type
                            captions[0, 7] = "50";                                      //Max length
                            ...
                            captions[1, 1] = "checkbox";                                //Control
                            captions[1, 2] = "activestatus";                            //FieldName
                            captions[1, 3] = "jobno";                                   //ID
                            captions[1, 4] = "2";                                       //No of Fields
                            captions[1, 5] = "jobno,jobtype,activestatus,College_code"; //FieldNames
                            captions[1, 6] = "string";                                  //Validation Type
                            captions[1, 7] = "20";                                      //Max length
                            captions[1, 8] = "List of Job Type";                        //Report Title
                            break;
                        ...
                        case "acd_tp_compcategory": //Company Category 
                            ...
                            captions[0, 4] = "2";                               //No of Fields
                            captions[0, 5] = "catno,catname,activestatus,college_code";      //FieldNames
                            captions[0, 6] = "string";                         //Validation Type
                            captions[0, 7] = "50";                              //Max length
                            ...
                            captions[1, 1] = "checkbox";                                //Control
                            captions[1, 2] = "activestatus";                            //FieldName
                            captions[1, 3] = "catno";                                   //ID
                            captions[1, 4] = "2";                                       //No of Fields
                            captions[1, 5] = "catno,catname,activestatus,college_code"; //FieldNames
                            captions[1, 6] = "string";                                  //Validation Type
                            captions[1, 7] = "20";                                      //Max length
                            captions[1, 8] = "List of Company Category";                        //Report Title
                            break;
                        ...
                        case "acd_tp_selectiontype": //Selection Type
                            ...
                            captions[0, 4] = "2";                               //No of Fields
                            captions[0, 5] = "selectno,selectname,activestatus,college_code";      //FieldNames
                            captions[0, 6] = "string";                         //Validation Type
                            captions[0, 7] = "50";                              //Max length
                            ...
                            captions[1, 1] = "checkbox";                                //Control
                            captions[1, 2] = "activestatus";                            //FieldName
                            captions[1, 3] = "selectno";                                   //ID
                            captions[1, 4] = "2";                                       //No of Fields
                            captions[1, 5] = "selectno,selectname,activestatus,college_code"; //FieldNames
                            captions[1, 6] = "string";                                  //Validation Type
                            captions[1, 7] = "20";                                      //Max length
                            captions[1, 8] = "List of Selection Type";
                            break;
                        ...
                        case "store_state":  //store
                            ...
                            captions[1, 8] = "List of City";                //Report Title
                            break;
                        case "store_budget_head	":  //store
                            captions[0, 0] = "Budget Head";                     //Label
                            captions[0, 1] = "textbox";                          //Control
                            captions[0, 2] = "bhname";                          //FieldName
                            captions[0, 3] = "bhno";                            //ID
                            captions[0, 4] = "2";                                //No of Fields
                            captions[0, 5] = "bhno,bhname,activestatus,College_code";       //FieldNames
                            captions[0, 6] = "string";                           //Validation Type
                            captions[0, 7] = "100";                               //Max length
                            ...
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "bhno";                            //ID
                            captions[1, 4] = "2";                                //No of Fields
                            captions[1, 5] = "bhno,bhname,activestatus,College_code";       //FieldNames
                            captions[1, 6] = "string";                           //Validation Type
                            captions[1, 7] = "20";                               //Max length
                            captions[1, 8] = "Budget Head";                     //Report Title
                            break;
                        case "store_approval_level":  //store
                            ...
                            captions[0, 4] = "2";                                                  //No of Fields
                            captions[0, 5] = "aplno,aplt,activestatus,College_code";       //FieldNames
                            captions[0, 6] = "string";                                             //Validation Type
                            captions[0, 7] = "100";                                                 //Max length
                            ...
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "aplno";                            //ID
                            captions[1, 4] = "2";                                //No of Fields
                            captions[1, 5] = "aplno,aplt,activestatus,College_code";       //FieldNames
                            captions[1, 6] = "string";                           //Validation Type
                            captions[1, 7] = "20";                               //Max length
                            captions[1, 8] = "Approval Level";                     //Report Title
                            break;
                        case "store_financial_year":  //store
                            ...
                            captions[0, 3] = "fno";                                  //ID
                            captions[0, 4] = "2";                                                  //No of Fields
                            captions[0, 5] = "fno,fname,activestatus,College_code";       //FieldNames
                            captions[0, 6] = "string2";                                             //Validation Type
                            captions[0, 7] = "100";                                                 //Max length
                            ...
                            captions[1, 3] = "fno";                                  //ID
                            captions[1, 4] = "2";                                                  //No of Fields
                            captions[1, 5] = "fno,fname,activestatus,College_code";       //FieldNames
                            captions[1, 6] = "string";                                             //Validation Type
                            captions[1, 7] = "20";                                                 //Max length
                            captions[1, 8] = "Financial Year ";                                     //Report Title
                            break;
                        #endregion
                        ...
                        case "admn_io_post_type":
                            ...
                            captions[0, 4] = "2";
                            captions[0, 5] = "POSTTYPENO,POSTTYPENAME,activestatus,college_code";
                            captions[0, 6] = "string2";
                            captions[0, 7] = "25";
                            ...
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "POSTTYPENO";                                  //ID
                            captions[1, 4] = "2";                                                  //No of Fields
                            captions[1, 5] = "POSTTYPENO,POSTTYPENAME,activestatus,college_code";       //FieldNames
                            captions[1, 6] = "string";                                             //Validation Type
                            captions[1, 7] = "20";                                                 //Max length
                            captions[1, 8] = "List of Post Type";                                     //Report Title
                            break;
                        case "admn_io_department":       //payroll
                            ...
                            captions[0, 3] = "deptno";                      //ID
                            captions[0, 4] = "3";                              //No of Fields
                            captions[0, 5] = "deptno,departmentname,deptcode,activestatus,College_code";//FieldNames
                            captions[0, 6] = "string2";                         //Validation Type
                            captions[0, 7] = "50";                             //Max length
                            captions[0, 8] = "List of Department";             //Report Title
                            ...
                            captions[1, 3] = "deptno";                      //ID
                            captions[1, 4] = "3";                              //No of Fields
                            captions[1, 5] = "deptno,departmentname,deptcode,activestatus,College_code";//FieldNames
                            captions[1, 6] = "string2";                         //Validation Type
                            captions[1, 7] = "5";                             //Max length 
                            captions[1, 8] = "List of Department";             //Report Title
                            ...
                            captions[2, 1] = "checkbox";                        //Control
                            captions[2, 2] = "activestatus";                        //FieldName
                            captions[2, 3] = "deptno";                      //ID
                            captions[2, 4] = "3";                              //No of Fields
                            captions[2, 5] = "deptno,departmentname,deptcode,activestatus,College_code";//FieldNames
                            captions[2, 6] = "string";                         //Validation Type
                            captions[2, 7] = "20";                             //Max length 
                            captions[2, 8] = "List of Department";             //Report Title
                            ...
                            // Created By Swati---------------------************
                            // Date:11-03-14
                            captions[3, 0] = "deptcode"; // 1st Field Name    
                            captions[3, 1] = "departmentname";//2nd FieldName
                            captions[3, 2] = "activestatus";
                            // ---------------------    **************            
                            break;
                        case "admn_io_letter_type":
                            ...
                            captions[0, 4] = "3";                              //No of Fields
                            captions[0, 5] = "lettertypeno,lettertype,lettertypecode,activestatus,College_code";//FieldNames
                            captions[0, 6] = "string2";                         //Validation Type
                            captions[0, 7] = "25";                             //Max length
                            ...
                            captions[1, 4] = "3";                              //No of Fields
                            captions[1, 5] = "lettertypeno,lettertype,lettertypecode,activestatus,College_code";//FieldNames
                            captions[1, 6] = "string2";                         //Validation Type
                            captions[1, 7] = "5";                             //Max length 
                            ...
                            captions[2, 1] = "checkbox";                        //Control
                            captions[2, 2] = "activestatus";                        //FieldName
                            captions[2, 3] = "lettertypeno";                      //ID
                            captions[2, 4] = "3";                              //No of Fields
                            captions[2, 5] = "lettertypeno,lettertype,lettertypecode,activestatus,College_code";//FieldNames
                            captions[2, 6] = "string";                         //Validation Type
                            captions[2, 7] = "20";                             //Max length 
                            captions[2, 8] = "List of Letter Type";             //Report Title
                            // Created By Swati---------------------************
                            // Date:11-03-14
                            captions[3, 0] = "lettertypecode"; // 1st Field Name    
                            captions[3, 1] = "lettertype";//2nd FieldName
                            captions[3, 2] = "activestatus";
                            //---------------------************
                        ...
                        case "health_bloodgroup":                                  //HEALTH
                            ...
                            captions[0, 4] = "2";                               //No of Fields
                            captions[0, 5] = "bloodgrno,bloodgr,activestatus,College_code";      //FieldNames
                            captions[0, 6] = "string";                          //Validation Type
                            captions[0, 7] = "50";                              //Max length
                            ...
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "bloodgrno";                         //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "bloodgrno,bloodgr,activestatus,College_code";      //FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                              //Max length
                            captions[1, 8] = "List of Blood Groups";                   //Report Title
                            break;
                        ...
                        case "health_dosagemaster":                                //HEALTH
                            ...
                            captions[0, 3] = "dno";                         //ID
                            captions[0, 4] = "3";                               //No of Fields
                            captions[0, 5] = "dno,dname,dqty,activestatus,College_code";      //FieldNames
                            captions[0, 6] = "string2";                          //Validation Type
                            captions[0, 7] = "50";                              //Max length
                            ...
                            captions[1, 3] = "dno";                         //ID
                            captions[1, 4] = "3";                               //No of Fields
                            captions[1, 5] = "dno,dname,dqty,activestatus,College_code";      //FieldNames
                            ...
                            captions[2, 3] = "dno";                         //ID
                            captions[2, 4] = "3";                               //No of Fields
                            captions[2, 5] = "dno,dname,dqty,activestatus,College_code";      //FieldNames
                            captions[2, 6] = "string";                          //Validation Type
                            captions[2, 7] = "20";                              //Max length
                            captions[2, 8] = "List of Dosage";                   //Report Title
                        ...
                        case "health_mgroup":                                  //HEALTH
                            ...
                            captions[0, 4] = "2";                               //No of Fields
                            captions[0, 5] = "mgid,mgname,activestatus,College_code";      //FieldNames
                            captions[0, 6] = "string";                          //Validation Type
                            captions[0, 7] = "30";                              //Max length
                            ...
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "mgid";                         //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "mgid,mgname,activestatus,College_code";      //FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                              //Max length
                            captions[1, 8] = "List of MGroups";                   //Report Title
                            break;
                        ...
                        case "health_patienttype":                                  //HEALTH
                            ...
                            captions[0, 3] = "typeno";                         //ID
                            captions[0, 4] = "2";                               //No of Fields
                            captions[0, 5] = "typeno,typename,activestatus,College_code";      //FieldNames
                            captions[0, 6] = "string";                          //Validation Type
                            captions[0, 7] = "30";                              //Max length
                            ...
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "typeno";                         //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "typeno,typename,activestatus,College_code";      //FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                              //Max length
                            captions[1, 8] = "List of Patient Type";                   //Report Title
                            break;
                        ...
                        case "health_sgroup":                                      //HEALTH
                            ...
                            captions[0, 4] = "3";                               //No of Fields
                            captions[0, 5] = "sgid,sgname,mgid,activestatus,College_code";      //FieldNames
                            captions[0, 6] = "string";                          //Validation Type
                            captions[0, 7] = "100";                              //Max length
                            ...
                            captions[1, 4] = "3";                               //No of Fields
                            captions[1, 5] = "sgid,sgname,mgid,activestatus,College_code";      //FieldNames
                            ...
                            captions[2, 1] = "checkbox";                        //Control
                            captions[2, 2] = "activestatus";                        //FieldName
                            captions[2, 3] = "sgid";                         //ID
                            captions[2, 4] = "3";                               //No of Fields
                            captions[2, 5] = "sgid,sgname,mgid,activestatus,College_code";      //FieldNames
                            captions[2, 6] = "string";                          //Validation Type
                            captions[2, 7] = "20";                              //Max length
                            captions[2, 8] = "List of SGroup";                   //Report Title
                            break;
                        ...
                        case "health_medtype":                                  //HEALTH
                            ...
                            captions[0, 4] = "3";                               //No of Fields
                            captions[0, 5] = "med_no,med_type,fix_qty,activestatus,College_code";      //FieldNames
                            captions[0, 6] = "string";                          //Validation Type
                            captions[0, 7] = "20";                              //Max length
                            captions[0, 8] = "List of Patient Type";                   //Report Title
                            ...
                            captions[1, 4] = "3";                               //No of Fields
                            captions[1, 5] = "med_no,med_type,fix_qty,activestatus,College_code";      //FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "2";                              //Max length
                            ...
                            captions[2, 1] = "checkbox";                        //Control
                            captions[2, 2] = "activestatus";                        //FieldName
                            captions[2, 3] = "med_no";                         //ID
                            captions[2, 4] = "3";                               //No of Fields
                            captions[2, 5] = "med_no,med_type,fix_qty,activestatus,College_code";      //FieldNames
                            captions[2, 6] = "string";                          //Validation Type
                            captions[2, 7] = "20";                              //Max length
                            captions[2, 8] = "List of Medicine Type";                   //Report Title
                            break;
                        ...
                        case "vehicle_workshop":      //payroll
                            ...
                            captions[0, 4] = "5";                               //No of Fields
                            captions[0, 5] = "wsno,workshop_name,add1,phone,personname,activestatus,college_code";//FieldNames
                            captions[0, 6] = "string2";                          //Validation Type
                            ...
                            captions[1, 4] = "5";                               //No of Fields
                            captions[1, 5] = "wsno,workshop_name,add1,phone,personname,activestatus,college_code";//FieldNames
                            captions[1, 6] = "string2";                          //Validation Type
                            ...
                            captions[2, 4] = "5";                               //No of Fields
                            captions[2, 5] = "wsno,workshop_name,add1,phone,personname,activestatus,College_code";//FieldNames
                            captions[2, 6] = "number";
                            ...
                            captions[3, 4] = "5";                               //No of Fields
                            captions[3, 5] = "wsno,workshop_name,add1,phone,personname,activestatus,College_code";//FieldNames
                            ...
                            captions[4, 0] = "Active Status";                        //Label
                            captions[4, 1] = "checkbox";                        //Control
                            captions[4, 2] = "activestatus";                        //FieldName
                            captions[4, 3] = "wsno";                          //ID
                            captions[4, 4] = "5";                               //No of Fields
                            captions[4, 5] = "wsno,workshop_name,add1,phone,personname,activestatus,College_code";//FieldNames
                            captions[4, 6] = "string";
                            captions[4, 7] = "20";                          //Validation Type
                            captions[4, 8] = "List of Workshop";
                            break;
                        ...
                        case "vehicle_unit":
                            ...
                            captions[0, 3] = "unit_id";
                            captions[0, 4] = "2";
                            captions[0, 5] = "unit_id,unit_name,activestatus,college_code";
                            captions[0, 6] = "string2";
                            captions[0, 7] = "20";
                            captions[0, 8] = "List Of Unit Name";
                            ...
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "activestatus";                        //FieldName
                            captions[1, 3] = "unit_id";
                            captions[1, 4] = "2";
                            captions[1, 5] = "unit_id,unit_name,activestatus,college_code";
                            captions[1, 6] = "string";
                            captions[1, 7] = "20";
                            captions[1, 8] = "List Of Unit Name";
                            break;
                        #endregion
                        ...
                        case "sprt_unit":
                            ...
                            captions[1, 0] = "Active Status";                        //Label
                            captions[1, 1] = "checkbox";                        //Control
                            captions[1, 2] = "activestatus";
                            captions[1, 3] = "unit_id";                         //ID
                            captions[1, 4] = "2";                               //No of Fields
                            captions[1, 5] = "unit_id,unit_name,activestatus,College_code";      //FieldNames
                            captions[1, 6] = "string";                          //Validation Type
                            captions[1, 7] = "20";                              //Max length
                            captions[1, 8] = "List Of Unit Name";                   //Report Title
                            break;
                        #endregion
                ...
                public GridView CreateGridView(string where)
                    ...
                    gvbut.ImageUrl = "~/Images/edit.png";
