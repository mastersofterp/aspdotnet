<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="AbstractBillReport.aspx.cs"
    Inherits="ESTATE_Report_AbstractBillReport" Title="" %>
                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title">ABSTRACT BILL REPORT</h3>
                        </div>
                        <div class="box-body">
                            <div class="col-md-12">
