<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="Copy (2) of FileReceive.aspx.cs" Inherits="FileMovementTracking_Transaction_FileReceive" %>
                            ...
                            <asp:UpdatePanel ID="updActivity" runat="server">
                                <ContentTemplate>
                                    <div class="form-group col-lg-3 col-md-6 col-12">
                                        ...
                                        <asp:TextBox ID="txtSectionUserName" runat="server" CssClass="form-control" TabIndex="1" AutoPostBack="true" OnTextChanged="txtSectionUserName_TextChanged"
