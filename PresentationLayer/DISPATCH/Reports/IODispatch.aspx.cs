...
public partial class DISPATCH_Reports_IODispatch : System.Web.UI.Page
{
    ...
    private void ShowReport(string reportTitle, string rptFileName)
    {
        try
        {
            ...
            if (radlSelect.SelectedValue == "I")
            {
                url += "&param=@P_FROM_DATE=" + Convert.ToDateTime(txtFrmDate.Text).ToString("yyyy-MM-dd") + ",@P_TO_DATE=" + Convert.ToDateTime(txtToDate.Text).ToString("yyyy-MM-dd") + ",@P_DEPTNO=" + Convert.ToInt32(ddlDepartment.SelectedValue) + ",@P_USERNO=" + Convert.ToInt32(ddlFrmTo.SelectedValue) + ",@P_POSTTYPE=" + Convert.ToInt32(ddlPostType.SelectedValue) + ",@P_CHEQUE=" + Convert.ToInt32(ddlCheque.SelectedValue) + ",@P_USERTYPE=" + Convert.ToChar(ddlUserType.SelectedValue) + ",@P_TYPE=1";
                //url += "&param=@P_FROM_DATE=" + Convert.ToDateTime(txtFrmDate.Text).ToString("yyyy-MM-dd") + ",@P_TO_DATE=" + Convert.ToDateTime(txtToDate.Text).ToString("yyyy-MM-dd") + ",@P_DEPTNO=" + Convert.ToInt32(ddlDepartment.SelectedValue) + ",@P_type=1,@P_USERNO=" + Convert.ToInt32(ddlFrmTo.SelectedValue) + ",@P_POSTTYPE=" + Convert.ToInt32(ddlPostType.SelectedValue) + ",@P_CHEQUE=" + Convert.ToInt32(ddlCheque.SelectedValue) + ",@P_USERTYPE=" + Session["userfullname"].ToString();   //17-03-2022 gayatri
                
            }
            else if (radlSelect.SelectedValue == "O")
            {
                url += "&param=@P_FROM_DATE=" + Convert.ToDateTime(txtFrmDate.Text).ToString("yyyy-MM-dd") + ",@P_TO_DATE=" + Convert.ToDateTime(txtToDate.Text).ToString("yyyy-MM-dd") + ",@P_DEPTNO=" + Convert.ToString(ddlDepartment.SelectedValue) + ",@P_USERNO=" + Convert.ToInt32(ddlFrmTo.SelectedValue) + ",@P_POSTTYPE=" + Convert.ToInt32(ddlPostType.SelectedValue) + ",@P_CARRIERNO=" + Convert.ToInt32(ddlCarrier.SelectedValue) + ",@P_LETTERCAT=" + Convert.ToInt32(ddlLCat.SelectedValue) + ",@P_CHEQUE=" + Convert.ToInt32(ddlCheque.SelectedValue) + ",username=" + Session["userfullname"].ToString() + ",@P_TYPE=1";  //17-03-2022 gayatri
            }
