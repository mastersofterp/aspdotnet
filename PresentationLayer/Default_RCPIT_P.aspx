<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default_RCPIT_P.aspx.cs" Inherits="Default_RCPIT_P" %>
...
<head id="Head1" runat="server">
    ...
    <link href="plugins/newbootstrap/css/login_rcpit_pharma.css" rel="stylesheet" />
                            ...
                            <div class="side-background pt-2 pb-0 pt-sm-5 pb-sm-5">
                                <div class="text-center pt-lg-4 pb-lg-5 pt-md-2 pb-md-4">
                                    ...
                                    <div class="college-name">
                                        <h2 class="mt-2 mt-md-3 mb-2 mb-md-2">R. C. Patel Institute of Pharmaceutical Education and Research</h2>
                                    </div>
                                    <div class="clg-address pb-md-3">
                                        <p>
                                            Karwand Naka, Taluka Shirpur, District Dhule, Maharashtra 425405
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-8 offset-md-2 col-lg-5 offset-lg-2 col-xl-4 offset-xl-2 mt-lg-4 mt-xl-0 mb-4 mb-md-0">
                            ...
                            <div class="login-form">
                                        ...
                                        <ContentTemplate>
                                            <div class="input-group">
                                                <cc1:CaptchaControl ID="Captcha1" runat="server" CaptchaBackgroundNoise="Low" CaptchaLength="4"
                                                    CaptchaHeight="35" CaptchaWidth="120" CaptchaLineNoise="None" CaptchaMinTimeout="5" Font-Size="12px"
                                ...
                                <div class="play-store">
                                    <a href="https://play.google.com/store/apps/details?id=com.iitms.rcpiper" target="_blank" style="cursor: pointer;">
                                        <span>
                                ...
                                <div class="Qr-code">
                                    <a href="#" target="_blank" style="cursor: pointer;">
                                            <img src="Images/QR_Code/rcpiper.png" alt="App Downloads" width="50px" />
                                    </a>
                                </div>
