...
function initializePivotTable(tableID) {
    ...
    <button type="button" class="btn btn-outline-info pivotTableBtn" data-toggle="modal" data-target="#pivotTableFor-${tableID}">
...
function makeModalForPivotTable(tableID) {
    ...
    <div class="modal fade" id="pivotTableFor-${tableID}" tabindex="-1" aria-labelledby="pivotTableLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            ...
            <div class="modal-body p-0" style="height: 455px;">                
...
function initializeCustomFilter(tableID, actualColNames, showColumnNames) {
   // console.log(showColumnNames)
    ...
    <button type="button" class="btn btn-outline-success filterTableBtn" data-toggle="modal" data-target="#filterTableFor-${tableID}">
...
function makeSavedFilters(tableID, tableToolBar) {
    ...
    element.innerHTML = `
        <button class="btn btn-outline-primary dropdown-toggle savedFilters" type="button" id="savedFilterForTable-${tableID}" data-toggle="dropdown" aria-expanded="false">
   ...
   // console.log(showColumnNames)
    ...
    const optionNameArray = nameArray.map((name, i) => {
       ...
       // console.log(option.split("'")[1])
        ...
        return showColumnNames.includes((option.split("'")[1]));
