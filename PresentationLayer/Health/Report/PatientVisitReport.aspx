<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="PatientVisitReport.aspx.cs" Inherits="Health_Report_PatientVisitReport" %>
                ...
                <div class="col-md-12 col-sm-12 col-12">
                    <div class="box box-primary">
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title">PATIENT'S VISIT REGISTER</h3>
                        </div>
                        <div class="box-body">
                            <asp:Panel ID="pnlPatientReport" runat="server">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-3 col-md-6 col-12">
                                            ...
                                            <div class="input-group date">
                                                ...
                                                <asp:TextBox ID="txtFDate" runat="server" MaxLength="10" CssClass="form-control" ToolTip="Please Select From Date"
                                                    Style="z-index: 0;" TabIndex="13" />
                                                <%--onchange="Cleardate()"--%>
                                                ...
                                                <ajaxToolKit:MaskedEditValidator ID="mevFromdt" runat="server"
                                                    ControlExtender="meeFromdt" ControlToValidate="txtFDate" Display="None"
                                ...
                                <div class="col-12 btn-footer">
                                    <asp:Button ID="btnRport" runat="server" Text="Report" TabIndex="3"
