...
public partial class Health_Report_MedicineExpiry : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        catch (Exception ex)
        {
            if (Convert.ToBoolean(Session["error"]) == true)
                objUCommon.ShowError(Page, "Health_Report_MedicineExpiry.Page_Load -> " + ex.Message + " " + ex.StackTrace);
            else
    ...
    protected void btnRport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ShowReport("MedicineExpiryReport", "rptExpiryReport.rpt");
        }
        catch (Exception ex)
        {
            if (Convert.ToBoolean(Session["error"]) == true)
                objCommon.ShowError(Page, "Health_Report_MedicineExpiry.btnReport_Click-> " + ex.Message + " " + ex.StackTrace);
            else
    ...
    private void ShowReport(string reportTitle, string rptFileName)
    {
        ...
        {
            if (Convert.ToBoolean(Session["error"]) == true)
                objUCommon.ShowError(Page, "Health_Report_MedicineExpiry.ShowReport() --> " + ex.Message + " " + ex.StackTrace);
            else
                objUCommon.ShowError(Page, "Server Unavailable.");
        }
    }
