...
public partial class Health_Report_PatientVisitReport : System.Web.UI.Page
{
    ...
    protected void btnRport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ShowReport("PatientVisitRegister", "rptPatientVisitRegister.rpt");
        }
        catch (Exception ex)
        {
            if (Convert.ToBoolean(Session["error"]) == true)
    ...
    private void ShowReport(string reportTitle, string rptFileName)
    {
        ...
        {
            if (Convert.ToBoolean(Session["error"]) == true)
                objUCommon.ShowError(Page, "Health_Report_PatientVisitReport.ShowReport() --> " + ex.Message + " " + ex.StackTrace);
            else
                objUCommon.ShowError(Page, "Server Unavailable.");
        }
    }
