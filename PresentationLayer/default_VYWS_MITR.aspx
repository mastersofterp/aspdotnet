<%@ Page Language="C#" AutoEventWireup="true" CodeFile="default_VYWS_MITR.aspx.cs" Inherits="default_VYWS_MITR" %>
...
<head id="Head1" runat="server">
    ...
    <link href="plugins/newbootstrap/css/login_VYWS_MITR.css" rel="stylesheet" />
...
<body>
    <form id="frmDefault" runat="server" defaultbutton="btnLogin">
        ...
        <div class="login">
                            ...
                            <div class="carousel-caption">
                                <div class="txt-clg animationss a1">
                                    ...
                                    <p class="slide__text mb-0 animation a2">
                                        Prof. Ram Meghe Institute of <br />Technology and Research
            ...
            <section class="login__right">
                ...
                <div class="signin-details mt-2">
                    <h5 class="text-center">Vidarbha Youth Welfare Society's </h5>
                      <h3 class="text-center mb-3">Prof. Ram Meghe Institute of Technology and Research Badnera - Amravati
                    </h3>
                    <h4 class="heading mb-2">Sign In</h4>
                    <!-- User Name Start -->
                    ...
                    <div class="forget-pass text-center">
                        ...
                        <div class="play-store">
                            <a href="https://play.google.com/store/apps/details?id=com.iitms.prmitr" target="_blank" style="cursor: pointer;">
                        ...
                        <div class="Qr-code">
                            <a href="#" target="_blank" style="cursor: pointer;">
                                <img src="Images/QR_Code/PRMITR.png" alt="App Downloads" width="50px" />
                            </a>
                        </div>
                        <!-- Google Play END -->
                           <!-- G Sign in Start -->
            ...
            <div class="modal fade" id="ModelPopUp" role="dialog" data-backdrop="static">
