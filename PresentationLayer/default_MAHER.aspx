<%@ Page Language="C#" AutoEventWireup="true" CodeFile="default_MAHER.aspx.cs" Inherits="default_MAHER" %>
...
<head id="Head1" runat="server">
    ...
    <title>MAHER – Meenakshi Academy of Higher Education and Research</title>
    <link rel="shortcut icon" href="Images/Login/maher_log.png" type="image/x-icon">
    ...
    <link href="plugins/newbootstrap/css/login_maher.css" rel="stylesheet" />
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-xl-5 col-md-8 offset-md-2 offset-lg-0 mb-0 mb-md-0">
                            <div class="side-background pt-2 pb-0 pt-sm-5 pb-sm-5">
                                <div class="pt-lg-4 pb-lg-5 pt-md-2 pb-md-4">
                                    <div class="logo in-left a2">
                                        <asp:Image ID="imglogo" runat="server" ImageUrl="~/Images/Login/maher_logo.png" />
                                    ...
                                    <div class="clg-address pt-2 pb-md-3 in-left a3 text-center mr-lg-4 pr-lg-5">
                                        <p>
                                            12, Vembuliamman Koil St, Annaji Nagar, KK Nagar West, K. K. Nagar, Chennai, Tamil Nadu - 600078
                                        </p>
                                    </div>
                                </div>
                            </div>
