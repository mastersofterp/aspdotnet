<%@ Page Language="C#" AutoEventWireup="true" CodeFile="default_cpu_h.aspx.cs" Inherits="default_cpu_h" StylesheetTheme="Theme1" Theme="Theme1" %>
...
<head id="Head1" runat="server">
    ...
    <link rel="shortcut icon" href="Images/Login/logo_hamirpur.png" type="image/x-icon">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-5 col-12 bg-mobile">
                    <div class="college-details text-white d-block align-items-center ">
                        <div class="logo">
                            <%--<img src="Images/Login/CPUF.png"  alt="logo" />--%>
                            <asp:Image ID="imagelogo" runat="server" ImageUrl="~/Images/Login/CPUF.png" />
                        </div>
                        <div class="college-name" style="margin-top: 140px;">
                            <h6>Welcome to    </h6>
                            <h2>Career Point University Hamirpur
                            </h2>
                            <h4>Bhoranj (Tikker - Kharwarian), Hamirpur,<br />
                                Himachal Pradesh - 176041</h4>
                        </div>
                    ...
                    <form id="frmDefault" runat="server" defaultbutton="btnLogin">
                        ...
                        <div class="signin-details ">
                            ...
                            <div class="row  align-items-center mb-0">
                                ...
                                <div class="form-group mb-0 col-lg-6 col-md-6 col-6">
                            ...
                            <div class="d-flex justify-content-sm-between flex-wrap justify-content-center align-items-center mt-1">
                              ...
                              <div class="d-flex justify-content-between align-items-center mt-1">
                                ...
                                <div class="play-store">
                                    <a href="https://play.google.com/store/apps/details?id=com.iitms.cpuhamirpur" target="_blank" style="cursor: pointer;">
                                        <span>
                                ...
                                <div class="Qr-code">
                                    <a href="#" target="_blank" style="cursor: pointer;">
                                            ...
                                            <img src="Images/QR_Code/CPU%20Hamirpur.png" alt="App Downloads" width="50px" />
