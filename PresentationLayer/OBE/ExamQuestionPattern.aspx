<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="ExamQuestionPattern.aspx.cs" Inherits="OBE_ExamQuestionPattern" %>
                                ...
                                <div class="col-12" id="divAddPattern" runat="server">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-3 col-md-6 col-12">
                                            ...
                                            <asp:DropDownList runat="server" ID="ddlQueLevel" TabIndex="8" CssClass="form-control" data-select2-enable="true" ClientIDMode="Static">
                                        ...
                                        <div class="form-group col-lg-3 col-md-6 col-12">
                                            ...
                                            <asp:DropDownList runat="server" ID="ddlParentQuestion" TabIndex="8" AppendDataBoundItems="true" CssClass="form-control" data-select2-enable="true">
                                                <asp:ListItem Selected="True" Value="0">Please Select</asp:ListItem>
                                            </asp:DropDownList>
                                        </div>
                                        <div class="form-group col-lg-3 col-md-6 col-12">
                                            ...
                                            <asp:DropDownList runat="server" ID="ddlQueOrWith" TabIndex="8" AppendDataBoundItems="true" CssClass="form-control" data-select2-enable="true">
                                                <asp:ListItem Selected="True" Value="0">Please Select</asp:ListItem>
                                            </asp:DropDownList>
                                        </div>
                                        <div class="form-group col-lg-3 col-md-6 col-12">
                                        ...
                                        <div class="form-group col-lg-3 col-md-6 col-12 " runat="server" visible="false"><%--ADDED ON 311022--%>
                                            <div class="label-dynamic">
