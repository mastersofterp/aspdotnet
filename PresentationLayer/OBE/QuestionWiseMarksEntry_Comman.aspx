<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="QuestionWiseMarksEntry_Comman.aspx.cs" Inherits="OBE_QuestionWiseMarksEntry" %>
        ...
        <div class="col-md-12 col-sm-12 col-12" id="div2">
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    <h3 class="box-title">Question Wise Mark Entry</h3>
                </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $(".quetext").keyup(function () {
              ...
              // c $(this).parent().parent().find('input[type=text]').eq(txtLen - 1).val(total);
