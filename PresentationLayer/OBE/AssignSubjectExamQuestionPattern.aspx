<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="AssignSubjectExamQuestionPattern.aspx.cs" Inherits="OBE_AssignSubjectExamQuestionPattern" %>
                            ...
                            <div id="divBody">
                                ...
                                <div id="divlowerpanel" runat="server" visible="false">
                                    <div class="col-12">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-lg-3 col-md-6 col-12">
                                                ...
                                                <asp:TextBox ID="txtMaximumMarks" runat="server" CssClass="form-control" Enabled="false" TabIndex="7"></asp:TextBox>
                                    ...
                                    <div class="col-12 btn-footer" id="dvSubmitData" runat="server" visible="false">
                                        <asp:Button ID="btnSave" runat="server" class="btn btn-primary" Text="Submit" OnClick="btnSave_Click" TabIndex="16" Enabled="true" />
