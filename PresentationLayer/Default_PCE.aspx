<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default_PCE.aspx.cs" Inherits="Default_PCE" %>
...
<head id="Head1" runat="server">
    ...
    <title>PCE - PRIYDARSHANI COLLEGE OF ENGG.</title>
    <link rel="shortcut icon" href="Images/Login/pce-logo.png" type="image/x-icon">
        ...
        <div class="bg-video-wrap">
            ...
            <div class="sign-in-video scrollbar" id="style-1">
                ...
                <div class="container-fluid force-overflow ">
                    <div class="row">
                        <div class="col-lg-6 col-xl-5 col-md-8 offset-md-2 offset-lg-0 mb-0 mb-md-0">
                            <div class="side-background pt-2 pb-0 pt-sm-5 pb-sm-5">
                                <div class="pt-lg-2 pb-lg-5 pt-md-2 pb-md-4">
                                    <div class="logo in-left text-center a2">
                                        <asp:Image ID="imglogo" runat="server" ImageUrl="~/Images/Login/pce-logo.png" />
                                        <%--<img src="Images/Login/DAIICT_logo.png"  alt="logo"/>--%>
                                    </div>

                                    <div class="college-name in-left a3 text-center mt-1">
                                        <span class="clg-heading" style="">LOKMANYA TILAK JANKALYAN SHIKSHAN SANSTHA'S</span>
                                        <h2 class="">PRIYADARSHINI COLLEGE OF ENGINEERING </h2>

                                    </div>
                                    <div class="clg-address  pb-md-3 in-left a3 text-center mt-0 pt-0">
                                        <%--<p>(Approved by A.I.C.T.E., New Delhi & Govt. Of Maharashtra, Affiliated to R.T.M. Nagpur University, Nagpur)</p>--%>
                                        <p>
                        ...
                        <div class="col-md-8 offset-md-2 col-lg-5 offset-lg-2 col-xl-4 offset-xl-1 mt-lg-4 mt-xl-0 mb-4 mb-md-0">
                                        ...
                                        <ContentTemplate>
                                            <div class="input-group">
                                                <cc1:CaptchaControl ID="Captcha1" runat="server" CaptchaBackgroundNoise="Low" CaptchaLength="4"
                                                    ...
                                                    NoiseColor="#D9261C" CaptchaInputCSS="BlackTextInput" EnableTheming="true" CaptchaChars="123456789" CaptchaMaxTimeout="240" FontColor="#007bff" class="img-responsive" />
