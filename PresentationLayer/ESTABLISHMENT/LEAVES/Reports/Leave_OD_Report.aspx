<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true"
    CodeFile="Leave_OD_Report.aspx.cs" Inherits="ESTABLISHMENT_LEAVES_Reports_Leave_OD_Report" %>
                            ...
                            <table>
                                    ...
                                    <td style="width: 850px">
                                        ...
                                        <table cellpadding="0" cellspacing="0" width ="100%">
                                            ...
                                            <tr>
                                                ...
                                                To Date :
                                                &nbsp;
                                                <asp:TextBox ID="txtTodt" runat="server" AutoPostBack="true" MaxLength="10" Width="80px" />
                                            ...
                                            <tr id="trchkod" runat ="server">
                                                ...
                                                <td class="form_left_text">
                                                    <asp:CheckBox ID="chkODPurpose" Text ="OD Purpose wise " runat="server"  AutoPostBack ="true" 
                                                        oncheckedchanged="chkODPurpose_CheckedChanged" />
                                                </td>
                                                <td class="form_left_label">
                                            ...
                                            <tr id="trddlOD" runat ="server" visible ="false">
                                                <td class="form_left_label">
                                                    Select OD Purpose
                                                </td>
                                                <td class="form_left_label">
                                                ...
                                                <td class="form_left_text">
                                                    <asp:DropDownList ID="ddlODPurpose" runat="server"  AppendDataBoundItems ="true" Width ="80%">
                                                    </asp:DropDownList>
                                                </td>
                                                <td class="form_left_label">
                                            ...
                                            <tr>
                                                ...
                                                <td class="form_left_text">
                                                    <asp:RadioButtonList ID="rblODAppSlip" runat="server" 
                                                        RepeatDirection ="Horizontal" Width ="70%" 
                                                         AutoPostBack ="true">
                                                    <asp:ListItem Enabled ="true" Selected ="True" Text ="OD Application" Value ="0"></asp:ListItem>
                                                    <asp:ListItem Enabled ="true"  Text ="OD Slip" Value ="1"></asp:ListItem>
                                                    </asp:RadioButtonList>
                                                </td>
                                                <td class="form_left_label">
                                            ...
                                            <%--<tr>
                                                ...
                                                <td class="form_left_text" >
                                                    <asp:DropDownList ID="ddlNoOfDay" runat="server" AppendDataBoundItems ="true" Width ="80%">
                                ...
                                <tr>
                                    <td class="form_button" align="center" style="width: 599px">
                                        <asp:Button ID="btnReport" runat="server" Text="OD Report" ValidationGroup="Leaveapp"
                                            Width="80px" onclick="btnReport_Click" />
                                        &nbsp;
                                         <asp:Button ID="btnLeaveRpt" runat="server" Text="Leave Report" 
                                            Width="90px" onclick="btnLeaveRpt_Click"/>
                                        &nbsp;
