<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Permission_Report.aspx.cs" MasterPageFile="~/SiteMasterPage.master" Inherits="ESTABLISHMENT_LEAVES_Reports_Permission_Report" %>
                ...
                <div class="col-md-12 col-sm-12 col-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">PERMISSION REPORT</h3>
                        </div>
                        ...
                        <div class="box-body">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="sub-heading">
                                                <h5>Select Criteria for PERMISSION REPORT</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group col-lg-3 col-md-6 col-12" id="divfromdate" runat="server">
                                            ...
                                            <div class="input-group date">
                                                ...
                                                <asp:RequiredFieldValidator ID="rfvfdate" runat="server" ControlToValidate="txtFromdt"
                                                    ...
                                                    ValidationGroup="Permission"></asp:RequiredFieldValidator>
                                                ...
                                                <ajaxToolKit:MaskedEditValidator ID="mevFromDate" runat="server" ControlExtender="meFromDate"
                                                    ...
                                                    InvalidValueBlurredMessage="Invalid Date" ValidationGroup="Permission" SetFocusOnError="True" IsValidEmpty="false" InitialValue="__/__/____" />
                                            </div>
                                        </div>
                                        <div class="form-group col-lg-3 col-md-6 col-12" id="divtodate" runat="server">
                                            ...
                                            <div class="input-group date">
                                                ...
                                                <asp:TextBox ID="txtTodt" runat="server" MaxLength="7" Style="z-index: 0;"
                                                    CssClass="form-control" TabIndex="7" ToolTip="Enter Leave To Date" AutoPostBack="true" OnTextChanged="txtTodt_TextChanged" />
                                                <asp:RequiredFieldValidator ID="rfvTodt" runat="server" ControlToValidate="txtTodt"
                                                    Display="None" ErrorMessage="Please Enter To Date" SetFocusOnError="true" ValidationGroup="Permission">
                                                </asp:RequiredFieldValidator>
                            ...
                            <div class="col-12 btn-footer">
                                <asp:Button ID="btnReport" runat="server" Text="Report" ValidationGroup="Permission" TabIndex="9"
                                ...
                                <asp:ValidationSummary ID="ValidationSummary1" runat="server" ValidationGroup="Permission"
