<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="MonthlyLateComingReport.aspx.cs" Inherits="ESTABLISHMENT_LEAVES_Reports_MonthlyLateComingReport"  %>
                                        ...
                                        <table cellpadding="0" cellspacing="0" width ="100%">
                                            ...
                                            <tr>
                                                ...
                                                <td class="form_left_text">
                                                    <asp:TextBox ID="txtMonthYear" runat="server" AutoPostBack="True"
                                                    ...
                                                    <%--<ajaxToolKit:MaskedEditExtender ID="meeMonthYear" runat="server" Mask="LLL9999" TargetControlID="txtMonthYear"></ajaxToolKit:MaskedEditExtender>--%>
                                                </td>
