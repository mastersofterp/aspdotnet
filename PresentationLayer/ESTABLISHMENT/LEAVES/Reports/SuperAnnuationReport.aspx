<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true"
    CodeFile="SuperAnnuationReport.aspx.cs" Inherits="SuperAnnuationReport"
    Title="" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <%--<asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <fieldset class="fieldsetPay">
            <legend class="legendPay">SUPERANNUATION REPORT</legend>
                   ...
                   <td style="width:2%">
                    ...
                    <asp:TextBox ID="txtdate" runat="server" Width="80px"></asp:TextBox>
                        ...
                        <ajaxToolKit:MaskedEditValidator ID="mvFdate" runat="server" ControlExtender="meDate"
                            ControlToValidate="txtdate" Display="None" EmptyValueMessage="Please Select Superannuation Date."
