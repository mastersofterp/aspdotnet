<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="Leave_WorkingStatusEmp.aspx.cs" Inherits="ESTABLISHMENT_LEAVES_Reports_Leave_WorkingStatusEmp" Title="" %>
                ...
                <asp:Panel ID="pnlAdd" runat="server" Width="613px">
                    <div style="text-align: left; width: 87%; padding-left: 10px;">
                        <fieldset class="fieldsetPay">
                            <legend class="legendPay">Approval</legend>
                            <table>
                                <tr>
                                        ...
                                        <table cellpadding="0" cellspacing="0">
                                            ...
                                            <tr id = "trdept" runat ="server">
                                                ...
                                                <td class="form_left_text">
                                                  ...
                                                  <%--  <asp:RequiredFieldValidator ID="rfvDept" runat="server" ControlToValidate="ddlstatus"
                                ...
                                <tr>
                                    <td class="form_button" align="center" style="width: 499px">
                                        <asp:Button ID="btnSave" runat="server" Text="Show" ValidationGroup="Shift" 
                    ...
                    <table cellpadding="0" cellspacing="0" style="width: 90%; text-align: center">
                        <tr>
                            <td style="text-align: left; padding-left: 10px; padding-top: 10px;">
                                ...
                                <asp:Button ID="btnShowReport" runat="server" Text="Show Report" Width="90px" OnClick="btnShowReport_Click"  Visible ="false"/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td align="center">
                                <asp:ListView ID="lvEmpList" runat="server">
                                            <EmptyDataTemplate>
                                                <br />
                                                <center>
                                                    <asp:Label ID="lblerr" SkinID="Errorlbl" runat="server" Text="No late Comers" /></center>
                                            </EmptyDataTemplate>
                                            <LayoutTemplate>
