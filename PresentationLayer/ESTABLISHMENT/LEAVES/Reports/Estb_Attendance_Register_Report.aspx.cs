...
//PURPOSE: TO DISPLAY MONTHWISE ATTENDANCE register REPORT
//=====================================================================
using System;
...
public partial class Estb_Attendance_Register_Report : System.Web.UI.Page
{
        ...
        try
        {
          ...
          //  string frmdt = Convert.ToDateTime(txtMonthYear.Text).ToString("yyyy-MM-dd");
           // string todt = Convert.ToDateTime(txtToDate.Text).ToString("yyyy-MM-dd");
            ...
            ShowReport("List", "Estb_Attendance_Register_Report.rpt");
