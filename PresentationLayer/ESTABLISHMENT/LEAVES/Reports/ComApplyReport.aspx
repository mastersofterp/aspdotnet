<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ComApplyReport.aspx.cs" Inherits="ESTABLISHMENT_LEAVES_Reports_ComApplyReport" MasterPageFile="~/SiteMasterPage.master" %>
                ...
                <div class="col-md-12 col-sm-12 col-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">COM OFF CREDITED REPORT</h3>
                        </div>
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-12 btn-footer">
                                ...
                                <asp:Button ID="btnExport" runat="server" Text="Export To Excel" ValidationGroup="Leaveapp" TabIndex="10"
                                    CssClass="btn btn-info" ToolTip="Click here to Show Report" OnClick="btnExport_Click" />
