<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="EmployeeListReport.aspx.cs" Inherits="ESTABLISHMENT_LEAVES_Reports_EmployeeListReport" Title="" %>
       ...
       <center>
                ...
                <asp:Panel ID="pnlAdd" runat="server" Width="70%">
                        ...
                        <fieldset class="fieldset">
                            <legend class="legend">Employee List Report</legend>                            
                                ...
                                <tr align="center" >
                                   ...
                                   <td style ="width:1%"><b>:</b></td>
                                    <td style="width: 15%" align="left">
                                       <asp:DropDownList ID="ddlSchool" runat="server" Width="70%" AppendDataBoundItems="true" OnSelectedIndexChanged="ddlSchool_SelectedIndexChanged" AutoPostBack="true">
                ...
                <center>
                    <asp:Panel ID="pnlbutton" runat="server" Width="90%" >
                        <asp:Button ID="btnReport" runat="server" OnClick="btnReport_Click" Text="Report" ValidationGroup="School" Width="80px" />
                        &nbsp;
                        <asp:Button ID="btnCancel" runat="server" CausesValidation="false" Text="Cancel" Width="80px" OnClick="btnCancel_Click" />
                        &nbsp;                        
                        <asp:ValidationSummary ID="ValidationSummary1" runat="server" DisplayMode="List" ShowMessageBox="true" ShowSummary="false" ValidationGroup="School" />
                    </asp:Panel>
                </center>
