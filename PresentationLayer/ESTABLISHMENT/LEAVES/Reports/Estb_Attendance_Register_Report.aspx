<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="Estb_Attendance_Register_Report.aspx.cs" Inherits="Estb_Attendance_Register_Report" Title="" %>
       ...
       <center>
                ...
                <asp:Panel ID="pnlAdd" runat="server" Width="50%">
                        ...
                        <fieldset class="fieldset">
                            <legend class="legend">Monthly Attendance Register Report</legend>                            
                              <table width="100%" cellpadding="1" cellspacing="1" border="0">
                                <tr align="center" >
                                   <td style="width: 15%; padding-left:20%" align="left" >
                                  Month & Year <span style="color: #FF0000">*</span>
                                   </td>
