<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="DirectLeaveApproval.aspx.cs" Inherits="ESTABLISHMENT_LEAVES_Transactions_RegistrarLeaveApproval" Title="" %>
        ...
        <div class="col-md-12 col-sm-12 col-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">DIRECT APPROVAL OF LEAVE</h3>
                </div>
                <div class="box-body">
                    <asp:Panel ID="pnlAdd" runat="server">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="sub-heading">
                                        <h5>Direct Leave Approval Details</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="row">
                                ...
                                <div class="form-group col-lg-3 col-md-6 col-12" id="divSort" runat="server">
                                    <div class="label-dynamic">
                                        <label>Sorted By</label>
                                    </div>
                                    <asp:DropDownList ID="ddlSort" runat="server" AppendDataBoundItems="true" TabIndex="4" data-select2-enable="true"
                                        ToolTip="Select Sorted by" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlSort_SelectedIndexChanged">
                                        <asp:ListItem Enabled="true" Selected="True" Text="Please Select" Value="0"></asp:ListItem>
                                        <asp:ListItem Enabled="true" Text="Name" Value="1"></asp:ListItem>
                                        <asp:ListItem Enabled="true" Text="Leave Name" Value="2"></asp:ListItem>
                                        <asp:ListItem Enabled="true" Text="Joining date" Value="3"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                                <div class="form-group col-lg-5 col-md-12 col-12">
                                    <div class=" note-div">
                                        <h5 class="heading">Note</h5>
                                        <p><i class="fa fa-star" aria-hidden="true"></i><span style="color: #FF0000">Please Check Mark Checkbox Option for Bulk Leave Approval. </span> </p>
                    ...
                    <div class="col-12 btn-footer">
                        <asp:Button ID="btnShow" runat="server" Text="Show" ValidationGroup="Leaveapp" TabIndex="6"
                            OnClick="btnShow_Click" ToolTip="Click here to Show" CssClass="btn btn-primary" />
                        <asp:Button ID="btnCancelAdd" runat="server" Text="Cancel" ValidationGroup="Leaveapp" TabIndex="7"
                        ...
                        <asp:Button ID="btnBulkApprove" runat="server" Text="Bulk Leave Approve" TabIndex="8"
                        ...
                        <div class="col-12">
                            <asp:ListView ID="lvPendingList" runat="server">
                                ...
                                <LayoutTemplate>
                                    ...
                                    <table class="table table-striped table-bordered nowrap display" style="width: 100%" tabindex="8">
                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Button ID="btnApproval" runat="server" Text="Select" CommandArgument='<%# Eval("LETRNO")%>'
                                                ToolTip="Select to Approve/Reject" OnClick="btnApproval_Click" CssClass="btn btn-primary" TabIndex="9" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="9" style="text-align: left; padding-left: 10px; padding-right: 10px">
                                            <asp:Panel ID="pnlQues" runat="server" CssClass="collapsePanel" TabIndex="10">
                                                <table class="table table-bordered table-hover">
                                                    <tr>
                                                        <%--<th align="left">--%>
                                                        <th>Reason
                                                        </th>
                                                        <th>Alternate Arrangement
                                                        </th>
                                                    </tr>
                                                    <tr>
                                                        <td>
                    ...
                    <asp:Panel ID="pnlApprove" runat="server">
                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class="col-12">
                                    <div class="sub-heading">
                                        <h5>Select Criteria for Leave Approval</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <ul class="list-group list-group-unbordered">
                                        ...
                                        <li class="list-group-item"><b>Alternate arrangement :</b>
                                            <a class="sub-label">
                                                <asp:Label ID="lblAltrArng" runat="server" ToolTip="Alternate arrangement" Enabled="false"></asp:Label></a>
                                        </li>
                                        ...
                                        <li class="list-group-item" style="display: none"><b>Total no.of Leaves :</b>
                                            <a class="sub-label">
                            ...
                            <asp:ListView ID="lvStatus" runat="server">
                                <EmptyDataTemplate>
                                    <div class="text-center">
                                        <asp:Label ID="ibler" runat="server" Text="No More Leave Approval List"></asp:Label>
                                    </div>
                                </EmptyDataTemplate>
                                <LayoutTemplate>
                                    <div class="sub-heading">
