<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="Comp_Off_Approval.aspx.cs" Inherits="ESTABLISHMENT_LEAVES_Transactions_Comp_Off_Approval" Title="Untitled Page" %>
        ...
        <div class="col-md-12 col-sm-12 col-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">COMPENSATORY LEAVE APPROVAL</h3>
                </div>
                <div class="box-body">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="sub-heading">
                                            <h5>Compensatory Leave Approval</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-3 col-md-6 col-12">
                                        ...
                                        <asp:TextBox ID="lblLeaveName" runat="server" Enabled="false" CssClass="form-control" />
                                    </div>
                                    <div class="form-group col-lg-3 col-md-6 col-12">
                                        <div class="label-dynamic">
                                    ...
                                    <div class="form-group col-lg-3 col-md-6 col-12">
                                        ...
                                        <asp:TextBox ID="lblHour" runat="server" Enabled="false" CssClass="form-control" />
                                    </div>
                                    <div class="form-group col-lg-3 col-md-6 col-12">
                                        <div class="label-dynamic">
                                            <label>Reason</label>
                            ...
                            <asp:Repeater ID="lvPendingList" runat="server">
                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Button ID="btnApproval" runat="server" Text="Select" CommandArgument='<%# Eval("RNO")%>'
