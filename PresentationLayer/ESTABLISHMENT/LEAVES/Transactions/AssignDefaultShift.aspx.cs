...
public partial class ESTABLISHMENT_LEAVES_Transactions_AssignDefaultShift : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            else
            {
               ...
               // this.BindListViewEmployees(Convert.ToInt32(rblEmp.SelectedValue) ,0);
            }           
        }
        //blank div tag
    ...
    private void FillCollege()
    {
        ...
        //}
        //FillShift(); COMMENTED on 26-09-2022 as shift will fill on college selection      
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            for (i = 0; i <= strTitleNo.Length - 1; i++)
            {
                ...
                CustomStatus cs = (CustomStatus)objShift.UpdateDefaultShift(objShifts);
    ...
    protected void ddlDept_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (ddlCollege.SelectedIndex >= 0 && (ddlStafftype.SelectedIndex > 0))
        {
            BindListViewEmployees(Convert.ToInt32(ddlCollege.SelectedValue), Convert.ToInt32(ddlDept.SelectedValue), Convert.ToInt32(ddlStafftype.SelectedValue), 1);
        }
        else
        {
