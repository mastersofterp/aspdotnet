...
public partial class ESTABLISHMENT_LEAVES_Transactions_LeaveShiftManagement : System.Web.UI.Page
{
    ...
    private void ShowReport(string reportTitle, string rptFileName)
    {
        try
        {
            ...
            url += "&param=@P_FROMDT=" + frmdt + ",@P_TODT=" + todt + ",@P_INCHARGEEMPLOYEEIDNO=" + Convert.ToInt32(ddlIncharge.SelectedValue) + ",@P_COLLEGE_CODE=" + Convert.ToInt32(ddlCollege.SelectedValue) + ",@P_COLLEGE_NO=" + Convert.ToInt32(ddlCollege.SelectedValue);
