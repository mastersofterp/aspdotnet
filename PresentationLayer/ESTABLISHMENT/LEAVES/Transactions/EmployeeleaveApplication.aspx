<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EmployeeleaveApplication.aspx.cs" MasterPageFile="~/SiteMasterPage.master"
    Inherits="ESTABLISHMENT_LEAVES_Transactions_EmployeeleaveApplication" Title="" %>
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            <div class="form-group col-lg-3 col-md-6 col-12">
                                                ...
                                                <asp:RadioButtonList ID="rblleavetype" runat="server" TabIndex="1" AutoPostBack="true" RepeatDirection="Horizontal">
                                            ...
                                            <div class="form-group col-lg-3 col-md-6 col-12">
                                                ...
                                                <asp:TextBox ID="txtReason" runat="server" CssClass="form-control" TabIndex="13"
                                                    ToolTip="Enter Reason" onkeypress="return CheckAlphabet(event,this);" />
                                            ...
                                            <div class="form-group col-lg-3 col-md-6 col-12">
                                                ...
                                                <asp:TextBox ID="txtPath" runat="server" Enabled="false" CssClass="form-control"
                                                    ToolTip="Path" TabIndex="26" TextMode="MultiLine"></asp:TextBox>
                                            </div>
