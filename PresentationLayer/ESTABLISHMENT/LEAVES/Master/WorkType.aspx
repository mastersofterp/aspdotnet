<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="WorkType.aspx.cs" Inherits="ESTABLISHMENT_LEAVES_Master_WorkType" Title="" %>
                                        ...
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td class="form_left_text">
                                                    <asp:TextBox ID="txtWorkType" runat="server" MaxLength="50" Width="300px" />
                                                    
                                                    <asp:RequiredFieldValidator ID="rfvHolyType" runat="server" ControlToValidate="txtWorkType"
                                                        Display="None" ErrorMessage="Please Enter Holyday Type" ValidationGroup="HolyType"
                                ...
                                <asp:ListView ID="lvWorkType" runat="server">
                                    ...
                                    <ItemTemplate>
                                        <tr class="item" onmouseover="this.style.backgroundColor='#FFFFAA'" onmouseout="this.style.backgroundColor='#FFFFFF'">
                                            <td>
                                                <asp:ImageButton ID="btnEdit" runat="server" ImageUrl="~/images/edit.gif" CommandArgument='<%# Eval("WTNO") %>'
                                                    AlternateText="Edit Record" ToolTip="Edit Record" OnClick="btnEdit_Click" />&nbsp;
                                                <%--<asp:ImageButton ID="btnDelete" runat="server" ImageUrl="~/images/delete.gif" CommandArgument='<%# Eval("WTNO") %>'
