<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true"
    CodeFile="OD_Passing_Path.aspx.cs" Inherits="ESTABLISHMENT_LEAVES_Master_OD_Passing_Path" %>
                ...
                <div class="col-md-12 col-sm-12 col-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">ON DUTY PASSING AUTHORITY PATH</h3>
                        </div>
                        <div class="box-body">
                                    ...
                                    <%--   <div class="row">
                                        <div class="col-12">
                                            <div class="sub-heading">
                                                <h5>Add/Edit OD Passing Authority/ Path </h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>--%>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-lg-6 col-md-10 col-12">
                                                <div class=" note-div">
                                                    ...
                                                    <p><i class="fa fa-star" aria-hidden="true"></i><span>Selection of 'Passing Authority 01' is mandatory.</span></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <asp:Panel ID="pnlPAPaList" runat="server">
                                    <table class="table table-striped table-bordered nowrap display" style="width: 100%">
                                        <asp:Repeater ID="lvPAPath" runat="server">
                                            <HeaderTemplate>
                                                <div class="sub-heading">
                                                    <h5>OD Passing Authority/ Sectional Head Path</h5>
                                                </div>
                                                <thead>
                                                    <tr class="bg-light-blue">
                                                        <th>Action</th>
