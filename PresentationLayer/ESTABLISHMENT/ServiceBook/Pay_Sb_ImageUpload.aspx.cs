...
public partial class ESTABLISHMENT_ServiceBook_Pay_Sb_ImageUpload : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                if (fuUploadImage.FileContent.Length >= 1024 * 10000)
                {

                    MessageBox("File Size Should Not Be Greater Than 10 Mb");
                    fuUploadImage.Dispose();
                    fuUploadImage.Focus();
                    return;
                }
            }
            ...
            if (ViewState["action"] != null)
            {
                ...
                {
                    if (ViewState["File"] == null && Session["IMAGE"] == null)
                    {
    ...
    protected void btnEdit_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            objCommon.DisplayMessage("Please Upload Image", this.Page);
        }
        catch (Exception ex)
        {
            if (Convert.ToBoolean(Session["error"]) == true)
