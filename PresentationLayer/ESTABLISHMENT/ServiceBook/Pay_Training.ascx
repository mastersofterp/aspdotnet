<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Pay_Training.ascx.cs"
    Inherits="PayRoll_Pay_Training" %>
                    ...
                    <div class="col-md-6">
                        <asp:Panel ID="pnlAdd" runat="server">
                            <div class="panel panel-info">
                                <div class="panel panel-heading">Training/Short Term Course/Conference Attended</div>
                                <div class="panel panel-body">
                                    <div class="form-group col-md-12">
                                        <label>Name of the Course :</label>
                                        <asp:TextBox ID="txtCourse" runat="server" CssClass="form-control"
                                            ToolTip="Enter Name of the Course" TabIndex="4"></asp:TextBox>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <asp:TextBox ID="txtInstitute" runat="server" CssClass="form-control"
                                            ToolTip="Enter Name of the Institute" TabIndex="5"></asp:TextBox>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group date">
                                            ...
                                            <asp:TextBox ID="txtFromDate" runat="server" CssClass="form-control"
                                                ToolTip="Enter From Date" TabIndex="6" Style="z-index: 0;"></asp:TextBox>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group date">
                                            ...
                                            <asp:TextBox ID="txtToDate" runat="server" CssClass="form-control"
                                                ToolTip="Enter TO Date" TabIndex="7" Style="z-index: 0;"></asp:TextBox>
                    ...
                    <div class="col-md-6">
                        <asp:Panel ID="pnlList" runat="server" ScrollBars="Auto">
                            <asp:ListView ID="lvTraning" runat="server">
                                ...
                                <LayoutTemplate>
                                    <div id="lgv1">
                                        <h4 class="box-title">Training/Short Term Course/Conference Attended
                                        </h4>
        ...
        <td valign="top" width="50%">
            <%--<asp:Panel ID="pnlAdd" runat="server" Style="text-align: left; width: 95%; padding-left: 15px;">
                <fieldset class="fieldsetPay">
                    <legend class="legendPay">Training/Short Term Course/Conference Attended</legend>
                    <br />
