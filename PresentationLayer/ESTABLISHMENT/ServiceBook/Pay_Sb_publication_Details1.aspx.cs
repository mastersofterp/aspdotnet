...
public partial class ESTABLISHMENT_ServiceBook_Pay_Sb_publication_Details : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                objSevBook.PUBLICATIONDATE = null;
            }
            ...
            {
                objSevBook.DETAILS = string.Empty;
            }
            ...
            objSevBook.AUTHOR4 = txtAuthor4.Text != (string.Empty) ? txtAuthor4.Text : string.Empty;
                ...
                else
                {
                    ...
                    if (ViewState["PUBTRXNO"] != null)
                    {
                        ...
                        if (cs.Equals(CustomStatus.RecordUpdated))
                        {
                            ...
                            this.Clear();
                            this.BindListViewPublicationDetails();
                            //.objCommon.DisplayMessage(updpersonaldetails, "Record Updated Successfully", this.Page);
    ...
    private void ShowDetails(int PUBTRXNO)
    {
        ...
        try
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                txtAuthor4.Text = ds.Tables[0].Rows[0]["AUTHOR4"].ToString();
