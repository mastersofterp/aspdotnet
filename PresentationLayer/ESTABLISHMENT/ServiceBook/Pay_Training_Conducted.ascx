<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Pay_Training_Conducted.ascx.cs"
    Inherits="PAYROLL_TRANSACTIONS_Pay_Training_Conducted" %>
                    ...
                    <div class="col-md-6">
                        <asp:Panel ID="pnlAdd" runat="server">
                            <div class="panel panel-info">
                                <div class="panel panel-heading">Training/Short Term Course/Conference Conducted</div>
                                <div class="panel panel-body">
                                    <div class="form-group col-md-12">
                                        <label>Name of the Course :</label>
                                        <asp:TextBox ID="txtCourse" runat="server" CssClass="form-control" ToolTip="Enter Name of the Course" TabIndex="4"></asp:TextBox>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <asp:TextBox ID="txtInstitute" runat="server" CssClass="form-control" ToolTip="Enter Name of the Institute" TabIndex="5"></asp:TextBox>
                    ...
                    <div class="col-md-6">
                        <asp:Panel ID="pnlList" runat="server" ScrollBars="Auto">
                            <asp:ListView ID="lvTraning" runat="server">
                                ...
                                <LayoutTemplate>
                                    <div id="lgv1">
                                        <h4 class="box-title">Training/Short Term Course/Conference Conducted
                                        </h4>
