<%@ Page Title="" Language="C#" MasterPageFile="~/ServiceBookMaster.master" AutoEventWireup="true" CodeFile="Pay_Sb_Admin_Responsibilities.aspx.cs"
    Inherits="ESTABLISHMENT_ServiceBook_Pay_Sb_Admin_Responsibilities" %>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="sub-heading">
                                                <h5>Administrative Responsibilities</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-3 col-md-6 col-12">
                                            ...
                                            <asp:TextBox ID="txtResponsibility" runat="server" CssClass="form-control"
                                                ToolTip="Enter Responsibility" TabIndex="1" MaxLength="50" onkeypress="return CheckAlphabet(event,this);"></asp:TextBox>
                                        ...
                                        <div class="form-group col-lg-3 col-md-6 col-12">
                                            ...
                                            <asp:TextBox ID="txtOrganization" runat="server" CssClass="form-control" MaxLength="300"
                                                ToolTip="Enter Organization" TabIndex="2" onkeypress="return CheckAlphabet(event,this);"></asp:TextBox>
                                        ...
                                        <div class="form-group col-lg-3 col-md-6 col-12">
                                            ...
                                            <asp:FileUpload ID="flupld" runat="server" ToolTip="Click here to Upload Document" TabIndex="6" />
                                    ...
                                    <asp:ListView ID="lvAdminResponsibilities" runat="server">
                                        <EmptyDataTemplate>
                                            ...
                                            <p class="text-center text-bold">
                                                <asp:Label ID="lblErrMsg" runat="server" SkinID="Errorlbl" Text="No Rows Administrative Responsibilities"></asp:Label>
                                            </p>
                                        </EmptyDataTemplate>
                                        <LayoutTemplate>
                                            <div class="sub-heading">
                                                <h5>Administrative Responsibilities Details</h5>
                                            </div>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                <td>
                                                    <asp:ImageButton ID="btnEdit" runat="server" ImageUrl="~/Images/edit.png" CommandArgument='<%# Eval("ADMINTRXNO")%>'
                                                        AlternateText="Edit Record" ToolTip="Edit Record" OnClick="btnEdit_Click" />
                                                    <asp:ImageButton ID="btnDelete" runat="server" ImageUrl="~/Images/delete.png" CommandArgument='<%# Eval("ADMINTRXNO") %>'
