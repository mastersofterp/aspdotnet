<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OtherMiscelDetail.aspx.cs" MasterPageFile="~/ServiceBookMaster.master"
    Inherits="ESTABLISHMENT_ServiceBook_OtherMiscelDetail" %>
                                ...
                                <asp:Panel ID="pnl" runat="server">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        ControlToValidate="txtToDate" Operator="GreaterThanEqual" Type="Date"></asp:CompareValidator>--%>
                                                ...
                                                <asp:Panel ID="divServiceDetails" runat="server">
                                                    <div class="col-12">
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <div class="sub-heading">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group col-lg-3 col-md-6 col-12">
                                                                <label>Ph.D Under Guidance :<span style="color: Red">*</span></label>
                                                                ...
                                                                <%--</div>--%>
                                                                <asp:RequiredFieldValidator ID="rfvGuidance" runat="server" ControlToValidate="txtphdgui"
                                                                    Display="None" ErrorMessage="Please Enter Ph.D Under Guidance" ValidationGroup="PhdDetails"
                                                                    SetFocusOnError="True"></asp:RequiredFieldValidator>
                                                            </div>
                                                            <%--  <div class="form-group col-md-6">
                                                                   <div class="form-group col-md-10">--%>
                                                            <div class="form-group col-lg-3 col-md-6 col-12">
                                                                <label>Ph.D Awarded :<span style="color: Red">*</span></label>
                                                                ...
                                                                <%-- </div>--%>
                                                                <asp:RequiredFieldValidator ID="rfvAward" runat="server" ControlToValidate="txtphdawd"
                                                                    Display="None" ErrorMessage="Please Enter Ph.D Awarded" ValidationGroup="PhdDetails"
                                                                    SetFocusOnError="True"></asp:RequiredFieldValidator>
                                                            </div>
                                                            ...
                                                            <div class="form-group col-lg-3 col-md-6 col-12">
                                                                ...
                                                                <asp:TextBox ID="txtThesis" runat="server" CssClass="form-control" onkeypress="return CheckAlphabet(event,this);" ToolTip="Enter title of Thesis"
                                                                    MaxLength="50" TabIndex="24"></asp:TextBox>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group col-lg-3 col-md-6 col-12">
                                                                ...
                                                                <asp:TextBox ID="txtThesisTitle" runat="server" CssClass="form-control" ToolTip="Enter Thesis title"
                                                                    MaxLength="150" TabIndex="31"></asp:TextBox>
