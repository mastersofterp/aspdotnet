...
<%@ Register Src="~/Establishment/ServiceBook/Pay_PersonalMemoranda.ascx" TagName="PersonalMemoranda"
    TagPrefix="uc1" %>
<%@ Register Src="~/Establishment/ServiceBook/Pay_FamilyParticulars.ascx" TagName="FamilyParticulars"
    TagPrefix="uc1" %>
<%@ Register Src="~/Establishment/ServiceBook/PAY_Qualification.ascx" TagName="Qualification"
    TagPrefix="uc1" %>
<%@ Register Src="~/Establishment/ServiceBook/Pay_Training.ascx" TagName="Training" TagPrefix="uc1" %>
<%@ Register Src="~/Establishment/ServiceBook/Pay_DepartmentalExam.ascx" TagName="DepartmentalExam"
    TagPrefix="uc1" %>
<%@ Register Src="~/Establishment/ServiceBook/Pay_PreviousService.ascx" TagName="PreviousService"
    TagPrefix="uc1" %>
<%@ Register Src="~/Establishment/ServiceBook/Pay_ForeginService.ascx" TagName="ForeginService"
    TagPrefix="uc1" %>
<%@ Register Src="~/Establishment/ServiceBook/Pay_LoansAndAdvance.ascx" TagName="LoansAndAdvance"
    TagPrefix="uc1" %>
<%@ Register Src="~/Establishment/ServiceBook/Pay_Nomination.ascx" TagName="Nomination"
    TagPrefix="uc1" %>
<%@ Register Src="~/Establishment/ServiceBook/Pay_Leave.ascx" TagName="Leave" TagPrefix="uc1" %>
<%@ Register Src="~/Establishment/ServiceBook/Pay_Matters.ascx" TagName="Matters" TagPrefix="uc1" %>
<%@ Register Src="~/Establishment/ServiceBook/Pay_PayRevision.ascx" TagName="PayRevision"
    TagPrefix="uc1" %>
<%@ Register Src="~/Establishment/ServiceBook/Pay_Increment_Termination.ascx" TagName="Increment_Termination"
    TagPrefix="uc1" %>
<%@ Register Src="~/Establishment/ServiceBook/Pay_ImageUpload.ascx" TagName="ImageUpload"
    TagPrefix="uc1" %>
<%@ Register Src="~/Establishment/ServiceBook/Pay_publication_Details.ascx" TagName="PublicationDetails"
    TagPrefix="uc1" %>
<%@ Register Src="~/Establishment/ServiceBook/Pay_Invited_Talks.ascx" TagName="InvitedTalks"
    TagPrefix="uc1" %>
<%@ Register Src="~/Establishment/ServiceBook/Pay_Admin_Responsibilities.ascx" TagName="AdminResponsibilities"
    TagPrefix="uc1" %>
<%@ Register Src="~/Establishment/ServiceBook/Pay_Training_Conducted.ascx" TagName="Traningconducted"
    TagPrefix="uc1" %>
                                                    ...
                                                    <div class="form-group col-md-12">
                                                      ...
                                                      <%--  <div class="form-group col-md-4">
                                                            ...
                                                            <asp:DropDownList ID="ddlCollege" AppendDataBoundItems="true" runat="server" CssClass="form-control"
                                                                ...
                                                                TabIndex="3" ToolTip="Select College Name">
                                                    ...
                                                    <asp:Menu ID="mainMenu" Height="10px" runat="server" Orientation="Horizontal">
                                                        ...
                                                        <Items>
                                                            <asp:MenuItem Text="Personal" Value="Personal" Selected="true">
                                                                <asp:MenuItem Text="Personal Memoranda" NavigateUrl="~/Establishment/ServiceBook/Pay_ServiceBookEntry.aspx?refno=1" />
                                                                <asp:MenuItem Text="Family Particulars" NavigateUrl="~/Establishment/ServiceBook/Pay_ServiceBookEntry.aspx?refno=2" />
                                                               <%-- <asp:MenuItem Text="Nomination" NavigateUrl="~/Establishment/ServiceBook/Pay_ServiceBookEntry.aspx?refno=9" />
                                                                <asp:MenuItem Text="Matters" NavigateUrl="~/Establishment/ServiceBook/Pay_ServiceBookEntry.aspx?refno=11" />
                                                                <asp:MenuItem Text="Image Upload" NavigateUrl="~/Establishment/ServiceBook/Pay_ServiceBookEntry.aspx?refno=14" />--%>
                                                            </asp:MenuItem>
                                                            <asp:MenuItem Text="Academic" Value="Academic">
                                                                <asp:MenuItem Text="Qualification" NavigateUrl="~/Establishment/ServiceBook/Pay_ServiceBookEntry.aspx?refno=3" />
                                                                <%--<asp:MenuItem Text="Dept. Examination" NavigateUrl="~/Establishment/ServiceBook/Pay_ServiceBookEntry.aspx?refno=5" />--%>
                                                            </asp:MenuItem>
                                                            <asp:MenuItem Text="Professional" Value="Professional">
                                                                <asp:MenuItem Text="Previous Experience" NavigateUrl="~/Establishment/ServiceBook/Pay_ServiceBookEntry.aspx?refno=6" />
                                                               <%-- <asp:MenuItem Text="Administrative Responsibilities" NavigateUrl="~/Establishment/ServiceBook/Pay_ServiceBookEntry.aspx?refno=16" />--%>
                                                                <asp:MenuItem Text="Publication Details" NavigateUrl="~/Establishment/ServiceBook/Pay_ServiceBookEntry.aspx?refno=15" />
                                                                <asp:MenuItem Text="Invited Talks" NavigateUrl="~/Establishment/ServiceBook/Pay_ServiceBookEntry.aspx?refno=17" />
                                                                <asp:MenuItem Text="Training/Short Term Course/Conference Attended" NavigateUrl="~/Establishment/ServiceBook/Pay_ServiceBookEntry.aspx?refno=4" />
                                                                <asp:MenuItem Text="Training/Short Term Course/Conference Conducted" NavigateUrl="~/Establishment/ServiceBook/Pay_ServiceBookEntry.aspx?refno=7" />
                                                            </asp:MenuItem>
                                                            <asp:MenuItem Text="Financial" Value="Financial">
                                                                <asp:MenuItem Text="Loan & Advance" NavigateUrl="~/Establishment/ServiceBook/Pay_ServiceBookEntry.aspx?refno=8" />
                                                                <asp:MenuItem Text="Leave" NavigateUrl="~/Establishment/ServiceBook/Pay_ServiceBookEntry.aspx?refno=10" />
                                                                <asp:MenuItem Text="Pay Revision" NavigateUrl="~/Establishment/ServiceBook/Pay_ServiceBookEntry.aspx?refno=12" />
                                                                <asp:MenuItem Text="Transaction Type Details" NavigateUrl="~/Establishment/ServiceBook/Pay_ServiceBookEntry.aspx?refno=13" />
                                                            </asp:MenuItem>
