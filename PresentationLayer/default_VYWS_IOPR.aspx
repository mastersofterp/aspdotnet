<%@ Page Language="C#" AutoEventWireup="true" CodeFile="default_VYWS_IOPR.aspx.cs" Inherits="default_VYWS_IOPR" %>
...
<head id="Head1" runat="server">
    ...
    <link href="plugins/newbootstrap/css/Login_VYWS_IOPR.css" rel="stylesheet" />
        ...
        <div class="login">
            ...
            <section class="login__right">
                ...
                <div class="signin-details mt-2">
                    ...
                    <h3 class="text-center mb-4">Institute of Pharmacy & Research Badnera - Amravati
                    </h3>
                                        ...
                                        <asp:Panel ID="pnlEmail" runat="server" Visible="false">
                                            <div id="dvEmail">
                                                ...
                                                <div class="form-group" runat="server" visible="false" id="divEloginId">
                                                    ...
                                                    <asp:TextBox ID="txtEusername" runat="server" placeholder="Enter User Name" CssClass="form-control mt-1" MaxLength="20" Enabled="false"></asp:TextBox>
