<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true"
    CodeFile="CommitteMaster.aspx.cs" Inherits="MEETING_MGT_Master_CommitteMaster" %>
                    ...
                    <div class="box box-primary">
                      <div id="div1" runat="server"></div>
                        ...
                        <div class="box-body">
                                ...
                                <asp:Panel ID="pnlDesig" runat="server">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-3 col-md-6 col-12">
                                            ...
                                            <asp:TextBox ID="txtname" runat="server" onkeypress="return CheckAlphabet(event,this);"
                                        ...
                                        <div class="form-group col-lg-3 col-md-6 col-12">
                                            ...
                                            <asp:TextBox ID="txtcode" runat="server" ValidationGroup="Submit" MaxLength="10"
                            ...
                            <asp:Button ID="btnPrint" runat="server" Text="Report" CssClass="btn btn-info" ToolTip="Click to get Report" CausesValidation="false" TabIndex="7" OnClick="btnPrint_Click" />
