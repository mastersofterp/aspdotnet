<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="CheckEmailStatusForMinutes.aspx.cs" Inherits="MEETING_MANAGEMENT_TRANSACTION_CheckEmailStatusForMinutes" %>
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title">MoM Draft Email Received Confirmation</h3>
                    </div>
                    <div>
                        <form role="form">
                            <div class="box-body">
                                <div class="col-md-12"> 
                                    ...
                                    <asp:Panel ID="pnlDesig" runat="server">
                                        <div class="panel panel-info">
                                            <div class="panel panel-heading">MoM Draft Email Confirmation</div>
                                    ...
                                    <asp:RequiredFieldValidator ID="rfvcommitee" runat="server" ErrorMessage="Please Select Committee"
                                        ...
                                        Text="*"></asp:RequiredFieldValidator>
                                                ...
                                                <div class="form-group col-md-4">
                                                    <label><span style="color: #FF0000">*</span>Committee Code :</label>
                                                    <asp:DropDownList ID="ddlpremeeting" runat="server" AutoPostBack="true" AppendDataBoundItems="true"
                                        CssClass="form-control" ToolTip="Enter Committee Code"  TabIndex="2" OnSelectedIndexChanged="ddlpremeeting_SelectedIndexChanged">                                     
                                    </asp:DropDownList>       
                                                 </div>
                                        </div>
                                    </asp:Panel>
                        ...
                        <div class="col-md-12">
                            <asp:Panel ID="pnlList" runat="server" ScrollBars="Auto">
                                <asp:ListView ID="lvReceivedList" runat="server" Visible="false">
                                    <LayoutTemplate>
                                        <div id="lgv1">
                                            <h4 class="box-title">MoM Draft Received Confirmation List
                                            </h4>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            <td>
                                                    ...
                                                    <td>
                                                        <%# Eval("DRAFT_RECEIVE_STATUS")%>
                                                    </td>
                                                    <td>
                                                        <%# Eval("DRAFT_RECEIVE_DATE","{0:dd-MMM-yyyy}")%>
                                                    </td>
                                            </tr>
                                    </ItemTemplate>
                                </asp:ListView>
