<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="MeetingDraftSuggestedByMembers.aspx.cs" Inherits="MEETING_MANAGEMENT_TRANSACTION_MeetingDraftSuggestedByMembers" %>
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title">COMMENTS ON MEETING DRAFT BY MEMBERS</h3>
                    </div>
                    <div>
                        <form role="form">
                            <div class="box-body">
                                <div class="col-md-12">
                                    ...
                                    <asp:Panel ID="Panel2" runat="server">
                                        <div class="panel panel-info">
                                            <div class="panel panel-heading">Comments By Committee Members</div>
                                            <div class="panel panel-body">
                                                ...
                                                <div id="trCollegeName" runat="server" visible="false" class="form-group col-md-4">
                                                    ...
                                                    <asp:DropDownList ID="ddlCollege" runat="server" CssClass="form-control" ToolTip="Select Institute" AppendDataBoundItems="true" TabIndex="2"
                                                        AutoPostBack="true" OnSelectedIndexChanged="ddlCollege_SelectedIndexChanged">
                                                        <asp:ListItem Value="0">Please Select</asp:ListItem>
                                                    </asp:DropDownList>
                                                    <asp:RequiredFieldValidator ID="rfvCollege" runat="server" ControlToValidate="ddlCollege"
                                                        Display="None" ErrorMessage="Please Select College" ValidationGroup="Submit" SetFocusOnError="True" InitialValue="0"></asp:RequiredFieldValidator>
                                                </div>
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <asp:DropDownList ID="ddlpremeeting" runat="server" AutoPostBack="true" AppendDataBoundItems="true"
                                                        CssClass="form-control" ToolTip="Select Meeting" TabIndex="4" OnSelectedIndexChanged="ddlpremeeting_SelectedIndexChanged">
                                                        <asp:ListItem Value="0">Please Select</asp:ListItem>
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
                    ...
                    <div class="box-footer">
                        <p class="text-center">
                              ...
                              <asp:Button ID="btnReport" runat="server" Text="Suggestions Report"  CssClass="btn btn-info" ToolTip="Click to get Report" OnClick="btnReport_Click" CausesValidation="false" TabIndex="4" />
                        ...
                        <div class="col-md-12">
                            <asp:Panel ID="Panel1" runat="server" ScrollBars="Auto">
                                <asp:ListView ID="lvAgenda" runat="server" Visible="false">
                                    <LayoutTemplate>
                                        <div id="lgv1">
                                            <h4 class="box-title">List Of Comments Given By Selected Member
                                            </h4>
                                            <table class="table table-bordered table-hover">
                                                <thead>
                                                    <tr class="bg-light-blue">
