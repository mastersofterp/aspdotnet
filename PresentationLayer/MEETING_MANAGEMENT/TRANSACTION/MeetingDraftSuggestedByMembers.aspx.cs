...
// DESCRIPTION : USED TO SEE SUGGESTIONS ON MEETING DRAFT GIVEN BY COMMITTEE MEMBERS 
// MODIFY DATE :    
// ================================================================================
...
public partial class MEETING_MANAGEMENT_TRANSACTION_MeetingDraftSuggestedByMembers : System.Web.UI.Page
{
    ...
    private void BindlistView()
    {
        ...
        {  
            ...
            DataSet ds = OBJmc.GetMembersWithDraftSuggestions(Convert.ToInt32(ddlCommitee.SelectedValue));
    ...
    private void ShowDetails(int UserId)
    {
        try
        {
            DataSet ds = OBJmc.GetSuggestionsOnDraft(UserId, ddlpremeeting.SelectedItem.Text);
            ...
            else
            {
                ...
                lvAgenda.DataBind();
                pnlList.Visible = false;
                objCommon.DisplayMessage(this.updActivity, "Suggestions On MoM Draft Is Not Given.", this.Page);
            }
    ...
    protected void btnReport_Click(object sender, EventArgs e)
    {
...

        {
            ...
            {
                ShowReport("pdf", "DraftMoMSuggestionsReport.rpt");
            }
            else
            {
