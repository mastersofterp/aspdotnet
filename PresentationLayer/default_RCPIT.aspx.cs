...
public partial class _default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DataSet ds = objCommon.FillDropDown("REFF", "isnull(MAINTENANCE,1)MAINTENANCE", "MAINTENANCE_STIME,CollegeName", "", "");
...
StringComparison.OrdinalIgnoreCase) >= 0))
    ...
    //        var fromAddress = new System.Net.Mail.MailAddress(dsconfig.Tables[0].Rows[0]["COMPANY_EMAILSVCID"].ToString(), "ERP");
