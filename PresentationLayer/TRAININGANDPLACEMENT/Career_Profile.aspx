<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="Career_Profile.aspx.cs" Inherits="EXAMINATION_Projects_Career_Profile" %>
                                        ...
                                        <div class="tab-content">
                                                    ...
                                                    <asp:ListView ID="lvWORKEXPERIENCE" runat="server">
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td><asp:ImageButton ID="imgbtnWorkExpPreview" runat="server" OnClick="imgbtnWorkExpPreview_Click" Text="Preview" ImageUrl="~/Images/action_down.png" ToolTip='<%# Eval("RelevantDocument") %>'
                                                    ...
                                                    <asp:ListView ID="lvProject" runat="server">
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td><asp:ImageButton ID="imgbtnProjectPreview" runat="server" OnClick="imgbtnProjectPreview_Click" Text="Preview" ImageUrl="~/Images/action_down.png" ToolTip='<%# Eval("UPLOAD_RELEVANT_DOCUMENT") %>'
                                                    ...
                                                    <div class="12">
                                                        ...
                                                        <asp:TextBox ID="txtToDate" runat="server" CssClass="form-control" type="date" />
                                                            ...
                                                            <div class="form-group col-lg-4 col-md-6 col-12 pr-0">
                                                                ...
                                                                <asp:CheckBox ID="chkCertification" runat="server" Text="I am currently doing this Certification" OnCheckedChanged="chkCertification_CheckedChanged" AutoPostBack="true" />
                                                            </div>
                                                    ...
                                                    <asp:ListView ID="lvcertfication" runat="server">
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td><%# Eval("GRADE")%></td>
                                                                <td> <asp:ImageButton ID="imgbtnCertificationPreview" runat="server" OnClick="imgbtnCertificationPreview_Click" Text="Preview" ImageUrl="~/Images/action_down.png" ToolTip='<%# Eval("UPLOAD_RELEVANT_DOCUMENT") %>'
                                                                    CommandArgument='<%# Eval("UPLOAD_RELEVANT_DOCUMENT") %>' Visible='<%# Convert.ToString(Eval("UPLOAD_RELEVANT_DOCUMENT"))==string.Empty?false:true %>'></asp:ImageButton></td>
                                                            </tr>
                                                        </ItemTemplate>
                                                        <AlternatingItemTemplate>
                                            ...
                                            <div class="tab-pane fade" id="tab_11">
                                                ...
                                                <div class="col-12 btn-footer">
                                                    ...
                                                    <asp:LinkButton ID="btnCancelResume" runat="server" CssClass="btn btn-outline-danger">Cancel</asp:LinkButton>
                                                </div>
