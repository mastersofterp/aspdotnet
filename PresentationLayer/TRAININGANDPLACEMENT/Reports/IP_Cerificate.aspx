...
AutoEventWireup="true" CodeFile="IP_Cerificate.aspx.cs" Inherits="TRAININGANDPLACEMENT_Reports_IP_Cerificate" Title="" %>
...
<table cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td class="vista_page_title_bar" valign="top" style="height: 30px">
                CERTIFICATE FOR INPLANT TRAINING &nbsp;
                            ...
                            <tr>
                                    <td class="form_button" colspan="2" align="center">
                                        ...
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="btnShow" runat="server" Text="Show" ValidationGroup="Report" OnClick="btnShow_Click"
                                            Width="80px" />
                                            &nbsp;&nbsp;
                                            <asp:Button ID="btnIndustrial" runat="server" Text="Industrial Visit report" OnClick="btnIndustrial_Click"
                                            Width="150px" />
