    ...
    protected void btnExcel_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (radlTransfer.SelectedValue == "I")
            {
                ...
                ds = objStud.GetStudentsForInterview(Convert.ToInt32(ddlSchedule.SelectedValue), 1);
                ds.Tables[0].Columns.Remove("IDNO"); 
                ds.Tables[0].Columns.Remove("LIVE_BACKLOG"); 
                ds.Tables[0].Columns.Remove("INTVSELECT");
                ds.Tables[0].Columns.Remove("LPHONE");
                ds.Tables[0].Columns.Remove("RES_DECL_STATUS_CNT");
                //don't show cgpa until required
                ds.Tables[0].Columns.Remove("CGPA");
            ...
            else if (radlTransfer.SelectedValue == "A")
            {
                ...
                ds = objStud.GetStudentsForInterview(Convert.ToInt32(ddlSceduleAll.SelectedValue), 0);
                ds.Tables[0].Columns.Remove("IDNO");
                ds.Tables[0].Columns.Remove("LIVE_BACKLOG");
                ds.Tables[0].Columns.Remove("INTVSELECT");
                ds.Tables[0].Columns.Remove("LPHONE");
