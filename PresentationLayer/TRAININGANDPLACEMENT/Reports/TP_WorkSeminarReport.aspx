<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true"
    CodeFile="TP_WorkSeminarReport.aspx.cs" Inherits="TRAININGANDPLACEMENT_Reports_TP_WorkSeminarReport"
    Title="Untitled Page" %>
                            ...
                            <table>
                                ...
                                <tr>
                                    <td class="form_left_text" colspan="2">
                                        <asp:RadioButton ID="rdoSchedule" runat="server" Checked="True" GroupName="Seminar"
                                            Text="Workshop Schedule" 
                                            />
                                        <asp:RadioButton ID="rdoApplicant" runat="server" GroupName="Seminar" Text="Workshop Applicant"
                                            />
                                    </td>
                                </tr>
                                <tr>
