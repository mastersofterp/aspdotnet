<%@ Page Language="C#" AutoEventWireup="true" CodeFile="default.aspx.cs" Inherits="_default" StylesheetTheme="Theme1" Theme="Theme1" %>
...
<html lang="en">
    ...
    <head id="Head1" runat="server">
        ...
        <title>RCPIT</title>
        <link rel="shortcut icon" href="Images/rc-patel-institute-of-technology-dhule-logo.png" type="image/x-icon">
    ...
    <body>
        <div class="sign-in">
            ...
            <div class="container-fluid">
                <div class="row">
                    <!-- College Details -->
                    <div class="col-lg-4 col-md-5 col-12 pl-0 pr-0">
                        <div class="college-details text-center text-white d-block align-items-center pt-lg-5 pl-3 pr-3">
                            <div class="logo mt-lg-5 pt-lg-5">
                                <img src="Images/rc-patel-institute-of-technology-dhule-logo.png" alt="logo"/>
                            </div>
                            <h1 class="college-name">
                                R. C. Patel Institute of Technology
                            </h1>
                            <div class="college-address pl-lg-5 pr-lg-5 pb-3">
                                <span style="text-shadow: 0px 5px 8px #000; font-weight:600; font-size:16px; color: #edd28f;">(An Autonomous Institute)</span> <br/>
                    ...
                    <!-- Sign In Details -->
                    <div class="col-xl-4 offset-xl-2 col-lg-6 offset-lg-1 col-md-7 col-12 mt-md-5 pt-md-4 pl-md-4 pr-md-4 mt-3">
                        <form id="frmDefault" runat="server" defaultbutton="btnLogin">
                            ...
                            <div class="signin-details p-lg-5 p-md-4 mt-lg-4 p-3">
                                            ...
                                            <ContentTemplate>
                                                <div class="input-group">
                                                    <cc1:CaptchaControl ID="Captcha1" runat="server" CaptchaBackgroundNoise="Low" CaptchaLength="4"
                                                        CaptchaHeight="50" CaptchaWidth="150" CaptchaLineNoise="None" CaptchaMinTimeout="5" Font-Size="12px"
                                ...
                                <div class="d-flex justify-content-between align-items-center mt-1">
                                    ...
                                    <div class="d-none">
                                        <a href="" target="_blank" style="cursor: pointer;">
                                            <span><img alt="App Downloads" src="Images/GPlayImg.png" /></span>
                                        </a>
                                    </div>
                                    <!-- Google Play END -->
                                </div>
            ...
            <asp:Panel ID="Panel5" runat="server" Style="display: none; box-shadow: rgba(0, 0, 0, 0.2) 1px 5px 5px; padding: 20px; margin-bottom:25px; border-radius: 10px;" CssClass="modalPopup" Height="150px">
