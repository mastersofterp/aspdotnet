                    ...
                    <div class="col-12">
                        <div class="row" id ="adminsearch" runat="server" Visible="False">
                          ...
                          <div class="row">
                            ...
                            <div class="form-group col-lg-3 col-md-6 col-12">
                                            ...
                                            <asp:DropDownList ID="ddlHostel" runat="server" TabIndex="1" ToolTip="Please Select Hostel." AppendDataBoundItems="true" AutoPostBack="true"
                                                CssClass="form-control" data-select2-enable="true">
                                                <asp:ListItem Value="0">Please Select</asp:ListItem>
                                            </asp:DropDownList>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-2 col-md-4 col-12">
                                ...
                                <asp:DropDownList ID="ddlAM_PM1" AppendDataBoundItems="true" runat="server" TabIndex="4" CssClass="form-control" data-select2-enable="true">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-2 col-md-4 col-12">
                                ...
                                <asp:DropDownList ID="ddlAM_PM2" AppendDataBoundItems="true" runat="server" TabIndex="8" CssClass="form-control" data-select2-enable="true">
                                    <asp:ListItem Value="0" Selected="True">Please Select</asp:ListItem>
                                    <asp:ListItem Value="AM">AM</asp:ListItem>
                                    <asp:ListItem Value="PM">PM</asp:ListItem>
                                </asp:DropDownList>
