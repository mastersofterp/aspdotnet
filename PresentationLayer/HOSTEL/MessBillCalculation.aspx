<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true"
    CodeFile="MessBillCalculation.aspx.cs" Inherits="HOSTEL_MessBillCalculation" %>
    ...
    <asp:UpdatePanel ID="pnlFeeTable" runat="server">
        <ContentTemplate>
            <table width="100%" cellpadding="2" cellspacing="2" border="0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvMonth" runat="server" ErrorMessage="Please Select Month"
                                                ControlToValidate="ddlMonth" InitialValue="0" SetFocusOnError="True" ValidationGroup="Show"
                                                Display="None"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <ajaxToolKit:MaskedEditValidator ID="MaskedEditValidator3" runat="server" ControlExtender="meeTo"
                                                ...
                                                InvalidValueMessage="Date is invalid" EmptyValueBlurredText="*" InvalidValueBlurredMessage="*"
                                                Display="Dynamic" ValidationGroup="Show" />
                                                <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="From date must be earlier than To date" ControlToCompare="txtToDate" ControlToValidate="txtFromDate" CultureInvariantValues="True" ValidationGroup="Show" Type="Date" SetFocusOnError="True" Operator="LessThanEqual" Display="None"></asp:CompareValidator>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 150px">
                ...
                <tr>
                    <td>
                        <asp:ListView ID="lvStudents" runat="server" Visible="False" OnDataBound="lvStudents_DataBound">
                            <LayoutTemplate>
                                <div id="demo-grid" class="vista-grid">
                                    ...
                                    <table id="tblFeeEntryGrid" cellpadding="0" cellspacing="0" class="datatable" width="100%">
                                        <tr class="header">
                                            ...
                                            <th align="center">
                                                &nbsp; Days
                                                <asp:Button ID="btnDays" runat="server" Text="Clear" OnClick="btnDays_Click" />
                                            </th>
                                            <th>
                            ...
                            <ItemTemplate>
                                <tr class="item" onmouseout="this.style.backgroundColor='#FFFFFF'" onmouseover="this.style.backgroundColor='#FFFFAA'">
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtDays" runat="server" Text='<%# Eval("DAYNO")%>' onkeyup="UpdateTotalAmounts(this)"
