<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="Hostel_PG_Configuration.aspx.cs" Inherits="HOSTEL_Default" %>
...
width: max-content !important;
    ...
    <script src="<%=Page.ResolveClientUrl("~/jquery/jquery-3.2.1.min.js")%>"></script>
                ...
                <div class="col-md-12 col-sm-12 col-12">
                    <div class="box box-primary">
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title"><b>HOSTEL PG CONFIGURATION</b></h3>
                        </div>
                        ...
                        <div class="box-body">
                            ...
                            <asp:Panel ID="pnlPay_master" runat="server" Visible="false">
                                ...
                                <div class="col-12">
                                    ...
                                    <asp:ListView ID="lvPayMaster" runat="server" OnSelectedIndexChanged="lvPayMaster_SelectedIndexChanged">
                                        <LayoutTemplate>
                                            <div id="demo-grid">
                            ...
                            <div id="pnlPayConfig" runat="server" visible="false">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-3 col-md-6 col-12">
                                            ...
                                            <asp:DropDownList ID="ddlpayment" runat="server" AppendDataBoundItems="True"
                                                TabIndex="1" AutoPostBack="true" CssClass="form-control" data-select2-enable="true" OnSelectedIndexChanged="ddlpayment_SelectedIndexChanged">
                                        ...
                                        <div class="form-group col-lg-3 col-md-6 col-12">
                                            ...
                                            <asp:DropDownList ID="ddlinstance" runat="server" AppendDataBoundItems="True"
                                                TabIndex="5" AutoPostBack="true" CssClass="form-control" data-select2-enable="true" OnSelectedIndexChanged="ddlinstance_SelectedIndexChanged">
                                                <asp:ListItem Value="0">Please Select</asp:ListItem>
                                        ...
                                        <div class="form-group col-lg-3 col-md-6 col-12">
                                            ...
                                            <asp:DropDownList ID="ddlActivityname" runat="server" AppendDataBoundItems="True"
                                                TabIndex="6" AutoPostBack="true" CssClass="form-control" data-select2-enable="true" OnSelectedIndexChanged="ddlActivityname_SelectedIndexChanged">
                                                <asp:ListItem Value="0">Please Select</asp:ListItem>
                                         ...
                                         <div class="form-group col-lg-3 col-md-6 col-12">
                                            ...
                                            <asp:DropDownList ID="ddlCollege" runat="server" AppendDataBoundItems="True"
                                                TabIndex="6" AutoPostBack="true" CssClass="form-control" data-select2-enable="true" OnSelectedIndexChanged="ddlCollege_SelectedIndexChanged">
                                                <asp:ListItem Value="0">Please Select</asp:ListItem>
                                        ...
                                        <%--    <asp:RequiredFieldValidator ID="rfvDegree" runat="server" ControlToValidate="ddlDegree"
                                           ...
                                           <div class="form-group col-lg-3 col-md-6 col-12">
                                            ...
                                            <asp:DropDownList ID="ddlDegree" runat="server" AppendDataBoundItems="True"
                                                TabIndex="7" AutoPostBack="true" CssClass="form-control" data-select2-enable="true" OnSelectedIndexChanged="ddlDegree_SelectedIndexChanged">
                                                <asp:ListItem Value="0">Please Select</asp:ListItem>
                                ...
                                <asp:Panel ID="pnlPGCongig" runat="server" Visible="false">
                                    <div class="col-12">
                                        <asp:ListView ID="lvPayConfig" runat="server" OnSelectedIndexChanged="lvPayConfig_SelectedIndexChanged">
                                            <LayoutTemplate>
                                            ...
                                            <ItemTemplate>
                                                <contenttemplate>
                                                        <tr>
                                                        <td style="text-align: center">
                                                            <asp:ImageButton ID="btnEditrecords" runat="server" ImageUrl="~/Images/edit1.png" OnClick="btnEditrecords_Click" CommandArgument='<%# Eval("CONFIG_ID") %>'
                                                               CausesValidation="false" AlternateText="Edit Record" ToolTip="Edit Record" TabIndex="12" />
