...
public partial class HOSTEL_REPORT_HostelFineReport : System.Web.UI.Page
{
        ...
        try
        {
            if (!Page.IsPostBack)
            {
                ...
                else
                {
                    ...
                    btnSubmit.Visible = false;  //Added by Saurabh L on 03/10/2022
                    btnReport.Visible = false;  //Added by Saurabh L on 03/10/2022
                }
            }
    ...
    //Below function Added by Saurabh L on 03/10/2022 Purpose: To add separate 
    private void ShowData()
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            lvDetails.DataBind();
            btnSubmit.Visible = true; //Added by Saurabh L on 03/10/2022
            btnReport.Visible = true; //Added by Saurabh L on 03/10/2022
        }
        else
        {
    ...
    {
        this.ShowData(); //Added by Saurabh L on 03/10/2022
    }
