<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true"
    CodeFile="Credit_DebitReport.aspx.cs" Inherits="HOSTEL_REPORT_Credit_DebitReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div>
        <fieldset class="fieldset">
            <legend class="legend">Selection Cateria</legend>
            <table cellpadding="2" cellspacing="2" width="60%">
                ...
                <td style="width: 11%"></td>
                    ...
                    <td style="width: 10%">
                        <asp:TextBox ID="txtFromDate" runat="server" TabIndex="1" Width="100px"/>
                        <asp:Image ID="imgCalAllotmentDate" runat="server" ImageUrl="~/IMAGES/calendar.png" Style="cursor: hand" />
                        <ajaxToolKit:CalendarExtender ID="CalendarExtender2" runat="server" Format="dd/MM/yyyy"
                            TargetControlID="txtFromDate" PopupButtonID="imgCalAllotmentDate" />
                    ...
                    <td style="width: 10%">
                         <asp:TextBox ID="txtTodate" runat="server" TabIndex="1" Width="100px"/>
                ...
                <td style="width: 11%"></td>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlMessNo" runat="server" AppendDataBoundItems="True" ToolTip="Please Select Mess Type" Width="125px">
