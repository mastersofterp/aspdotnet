...
public partial class HOSTEL_MessBillCalculation : System.Web.UI.Page
{
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        ...
        int dayno = (tdate.Date - fdate.Date).Days+1;
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            foreach (ListViewDataItem item in lvStudents.Items)
            {
                ...
                objME.Total_expence = Convert.ToDecimal(txtExpenditure.Text);
                objME.Attend_days = Convert.ToInt32(txtDays.Text);
                objME.Total_balance = Convert.ToDecimal(txtBalance.Text);
    ...
    private void Calculate()
    {
        try
        {
            ...
            foreach (ListViewDataItem item in lvStudents.Items)
            {
                ...
                //Balance
                if (Convert.ToDecimal(txtExpenditure.Text)>0)
