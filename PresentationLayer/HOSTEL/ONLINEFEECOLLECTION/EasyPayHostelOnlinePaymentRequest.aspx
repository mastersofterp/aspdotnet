<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EasyPayHostelOnlinePaymentRequest.aspx.cs" Inherits="HOSTEL_ONLINEFEECOLLECTION_EasyPayHostelOnlinePaymentRequest" %>
                            ...
                            <div class="col-12">
                                <div class="row">
                                    ...
                                    <div class="col-12 btn-footer mt-3">
                                        <asp:Button ID="btnPay" runat="server" Text="Pay"  CausesValidation="false" CssClass="btn btn-primary" OnClick="btnPay_Click" />
...
<script>
    $(document).ready(function () {
        //  Encryptedurl(encrptedurl);
    });

    function Encryptedurl(encryptredirecturl) {
        window.open(encryptredirecturl);
    }
