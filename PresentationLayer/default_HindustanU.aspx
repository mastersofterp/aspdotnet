<%@ Page Language="C#" AutoEventWireup="true" CodeFile="default_HindustanU.aspx.cs" Inherits="default_HindustanU" %>
...
<head id="Head1" runat="server">
    ...
    <title>Hindustan University</title>
    <link rel="shortcut icon" href="Images/Login/Hindustan_log.png" type="image/x-icon">
    ...
    <link href="plugins/newbootstrap/css/login_hindustan.css" rel="stylesheet" />
    ...
    <form id="frmDefault" runat="server" defaultbutton="btnLogin">
        ...
        <div class="login">
                ...
                <div id="loginCarousel" class="carousel slide" data-ride="carousel" data-interval="4000" data-pause="hover">
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
                            ...
                            <div class="slide" style="background-image: url('Images/Login/hindustan2.jpg'); background-size: cover;"></div>
                            <div class="carousel-caption">
                                <div class="txt-clgs animationss a1">
                                    <h1 class="slide__title college-name animations a2">Hindustan University</h1>
                        ...
                        <div class="carousel-item">
                            <div class="background-overlay"></div>
                            <div class="slide" style="background-image: url('Images/Login/hindustan1.jpg'); background-size: cover;"></div>
                            <div class="carousel-caption">
                                <div class="txt-clgs animationss a1">
                                    <h1 class="slide__title college-name animations a2">Hindustan University</h1>
            ...
            <section class="login__right">
                <div class="college-details text-center mt-4 mt-lg-5 pt-lg-5 logo">
                    <%--<img src="Images/Login/utkalu_logo.png" alt="logo" />--%>
                    <asp:Image ID="imgLogo" runat="server" ImageUrl="~/Images/Login/Hindustan_logo.png" AlternateText="logo" />
                </div>

                <div class="signin-details mt-2">
                    <%--<h2 class="text-center mb-1">Hindustan University </h2>--%>
                    <h5 class="text-center mb-4">Rajiv Gandhi Salai (OMR), Padur, Kelambakkam, Tamil Nadu 603103</h5>
                                ...
                                <ContentTemplate>
                                    <div class="input-group">
                                        ...
                                        <cc1:CaptchaControl ID="Captcha1" runat="server" CaptchaBackgroundNoise="Low" CaptchaLength="4"
                                            ...
                                            NoiseColor="#666699" CaptchaInputCSS="BlackTextInput" EnableTheming="true" CaptchaChars="123456789" CaptchaMaxTimeout="240" FontColor="#233340" class="img-responsive" />
