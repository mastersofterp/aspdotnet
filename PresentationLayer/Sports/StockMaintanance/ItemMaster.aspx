                                        ...
                                        <ContentTemplate>
                                            <div class="box-body">
                                                ...
                                                <div class="col-12 btn-footer">
                                                    ...
                                                    <asp:Button ID="btnRport" runat="server" Text="Item Wise Summary Report" TabIndex="12" CssClass="btn btn-info" ToolTip="Click To Show Report" OnClick="btnRport_Click" visible="false"/>
                                                ...
                                                <div class="col-12">
                                                    <asp:Panel ID="Panel4" runat="server">
                                                        <div class="row">
                                                            ...
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtSubShortname" Display="None" ErrorMessage="Please Enter Item Group Short Name" SetFocusOnError="True" ValidationGroup="storesub"></asp:RequiredFieldValidator>
