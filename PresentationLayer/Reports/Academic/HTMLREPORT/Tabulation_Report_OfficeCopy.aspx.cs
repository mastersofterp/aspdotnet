...
public partial class Reports_Tabulation_Report_OfficeCopy : System.Web.UI.Page
{
        ...
        string reportContent = @"
            <div class='text-dark'>
                <div class='col-12 text-center'>
                    ...
                    <label>" + ds1.Tables[0].Rows[0]["DCODE"] + @" " + ds1.Tables[0].Rows[0]["LONGNAME"] + @" SEMESTER " + ds1.Tables[0].Rows[0]["SEMESTERNAME"] + @" </label><br />
                    <label>SEMESTER EXAMINATION RESULT - OFFICE COPY</label>
                </div>
                        ...
                        for (int k = 1; k < ccode.Length; k++)
                        {
                            ...
                            reportContent += @"
                                         <td class='text-center'>" + ds1.Tables[0].Rows[i]["CCODE" + k] + @"
                                            ...
                                            <span>" + ds1.Tables[0].Rows[i]["EXTERMARK" + k] + @"</span>
                                            <span>" + ds1.Tables[0].Rows[i]["MARKTOT" + k] + @"</span>
