<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="Tabulation_Report.aspx.cs" Inherits="Reports_Tabulation_Report" %>
        ...
        <div class="col-md-12 col-sm-12 col-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Tabulation Report Dept-Copy</h3>
        ...
        html2pdf(contentToDownload, {
            ...
            <script>
                ...
                const lastFooterP = element.querySelector('.html2pdf__page-break:last-of-type');
                    ...
                    var opt = {
                        margin: [20, 30, 20, 20],
                        filename: 'TabulationReport_Dep.pdf',
                        image: { type: 'jpeg', quality: 0.5 },
                        html2canvas: { scale: 1.5, scrollY: 0 },
                        jsPDF: { unit: 'mm', format: 'a4', orientation: 'landscape' }
                        //jsPDF: { unit: 'mm', format: 'a4', orientation: 'portrait' }
