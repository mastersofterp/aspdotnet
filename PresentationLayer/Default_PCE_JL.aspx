<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default_PCE_JL.aspx.cs" Inherits="Default_PCE_JL" %>
...
<head runat="server">
    ...
    <title>PJLCE</title>
    <link rel="shortcut icon" href="Images/Login/PJLCE-Logo.jpg" type="image/x-icon">
    <!-- Bootstrap -->
    ...
    <link href="plugins/newbootstrap/css/login_PCE_JL.css" rel="stylesheet" />
    ...
    <form id="frmDefault" runat="server" defaultbutton="btnLogin">
        ...
        <div class="login">
                ...
                <div id="loginCarousel" class="carousel slide" data-ride="carousel" data-interval="4000" data-pause="hover">
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
                            ...
                            <div class="slide" style="background-image: url('Images/Login/BG_PJLCE.jpg'); background-size: cover;"></div>
                            <div class="carousel-caption">
                                <div class="txt-clgs animationss a1">
                                    <h1 class="slide__title college-name animations a2">PJLCE </h1>
                                    <%--    <p class="slide__text mb-0 animation a2">Tulsiramji Gaikwad-Patil College of Engineering and Technology.</p>--%>
                                </div>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <div class="background-overlay"></div>
                            <div class="slide" style="background-image: url('Images/Login/bg_pjlce1.jpg'); background-size: cover;"></div>
                            <div class="carousel-caption">
                                <div class="txt-clgs animationss a1">
                                    <h1 class="slide__title college-name animations a2">PJLCE </h1>
                                    <%--      <p class="slide__text mb-0 animation a2">Tulsiramji Gaikwad-Patil College of Engineering and Technology.</p>--%>
            ...
            <section class="login__right">
                ...
                <div class="college-details text-center  mb-0">
                    <img src="Images/Login/PJLCE-Logo.jpg" alt="logo" />
                </div>

                <div class="signin-details mt-2">
                    <h5 class="text-center mb-4">846, New Nandanvan Layout, Nagpur - 440 009</h5>
                                ...
                                <ContentTemplate>
                                    <div class="input-group">
                                        ...
                                        <cc1:CaptchaControl ID="Captcha1" runat="server" CaptchaBackgroundNoise="Low" CaptchaLength="4"
                                            ...
                                            NoiseColor="#D9261C" CaptchaInputCSS="BlackTextInput" EnableTheming="true" CaptchaChars="123456789" CaptchaMaxTimeout="240" FontColor="#446120" class="img-responsive" />
                    ...
                    <div class="text-center">
                        <div class="forget-pass">
                            <a data-toggle="modal" data-target="#ModelPopUp" id="lbtForgePass" runat="server" style="cursor: pointer; color: #000;"><span>Forgot Password 
                            </span></a>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-2">
                        <div class="play-store">
                            <a href="https://play.google.com/store/apps/details?id=com.iitms.pjlce" target="_blank" style="cursor: pointer;">
                                <span>
                                    <asp:Image ID="imgApp" runat="server" ImageUrl="~/Images/GPlayImg.png" AlternateText="App" /></span>
                            </a>
                        </div>

                        <div class="Qr-code">
                            <a href="#" target="_blank" style="cursor: pointer;">
                                <asp:Image ID="imgqr" runat="server" ImageUrl="~/Images/QR_Code/PJLCE.png" AlternateText="AppCode" Width="50px" />
                            </a>
                        </div>
                    </div>
