...
// PAGE NAME       : PG Configuration
// CREATION DATE   : 17-DECEMBER-2021
...
public partial class ACADEMIC_PG_Configuration_aspx : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ViewState["ACTION"] != null && ViewState["ACTION"].Equals("Edit"))
            {
                ...
                CustomStatus cs = (CustomStatus)objconfig.UpdateadmFeeDeduction(congno, Convert.ToInt32(ddlpayment.SelectedValue), txtmerchantid.Text,
            ...
            else
            {
                ...
                CustomStatus cs = (CustomStatus)objconfig.InsertPaymentgateway_config(Convert.ToInt32(ddlpayment.SelectedValue), txtmerchantid.Text, txtaccesscode.Text,
    ...
    private void ShowData()
    {
        try
        {
            ...
            ds = objconfig.GetData_Payment_gateway_config();
    ...
    protected void btnEditrecords_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            DataSet ds = objconfig.GetData_Payment_gateway_config(configid);
            if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                DataRow dr = ds.Tables[0].Rows[0];
                objCommon.FillDropDownList(ddlpayment, "ACD_PAYMENT_GATEWAY", "PAYID", "PAY_GATEWAY_NAME", "PAYID > 0", "PAYID DESC");
    ...
    //protected void btnEditrecords_Click1(object sender, ImageClickEventArgs e)
    //{
    //    //objCommon.DisplayMessage(this.Page, "hii", this.Page);
    //    //return;
    //}
}