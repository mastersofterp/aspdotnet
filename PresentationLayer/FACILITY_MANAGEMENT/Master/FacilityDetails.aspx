<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="FacilityDetails.aspx.cs" Inherits="FacilityDetails" Title="" %>
                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title">CENTRALIZE FACILITY DETAILS</h3>
                        </div>
                        ...
                        <form role="form">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="row">
                                                            ...
                                                            <asp:ListBox ID="lstMinorFacility" runat="server" SelectionMode="Multiple" AppendDataBoundItems="true" CssClass="form-control"
                                                                                ...
                                                                                <asp:RequiredFieldValidator ID="rfvEmployee" runat="server" ControlToValidate="lstMinorFacility"
                                                                                    Display="None" ErrorMessage="Please Select Minor Facility" InitialValue="" ValidationGroup="Facility"></asp:RequiredFieldValidator>
                            ...
                            <LayoutTemplate>
                                <div id="listViewGrid" class="vista-grid">
                                    ...
                                    <table id="tblSearchResults" class="datatable">
                                        <tr class="header">  
                                            <th style="width: 10px">Srno
                                            </th>                                              
                                            <th style="width: 10px">Action
                                            </th>
                                            <th>Centralize Facility Name
                                            </th>
                                            <th style="width: 50px">Detail
                                            </th>
                            ...
                            <ItemTemplate>
                                <tr class="item" onmouseover="this.style.backgroundColor='#FFFFAA'" onmouseout="this.style.backgroundColor='#FFFFFF'">
                                    ...
                                    <td>
                                        <asp:ImageButton ID="btnEdit" runat="server" ImageUrl="~/images/edit.gif" CommandArgument='<%#Eval("CentralizeDetailNo") %>'
                                            AlternateText="Edit Record" ToolTip="Edit Record" OnClick="btnEdit_Click" />&nbsp;
                                    <asp:ImageButton ID="btnDelete" Visible="false" runat="server" ImageUrl="~/images/delete.gif" CommandArgument='<%# Eval("CentralizeDetailNo") %>'
