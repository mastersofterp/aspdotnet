<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true"
    CodeFile="FeeAccountTransferrefund.aspx.cs" Inherits="FeeAccountTransferrefund" Title="" %>
                    ...
                    <div class="box box-primary">
                        <div id="div1" runat="server">
                            ...
                            <div class="box-header with-border">
                                <h3 class="box-title"> FEE-ACCOUNT REFUND</h3>
                            </div>
                            ...
                            <div class="box-body">
                                <asp:Panel ID="pnl" runat="server">
                                    ...
                                    <div class="panel panel-info">
                                        <div class="panel-heading"> FEE-ACCOUNT REFUND</div>
                                        <div class="panel-body">
                                            <div class="col-md-12">
                                                ...
                                                <br />
                                                <div id="row18" class="row" runat="server">
                                                    <div class="col-md-3">
                                                        <label>Degree : </label>
                                                    </div>
                                                    <div class="col-md-5">
                                            ...
                                            <div id="Div5" class="row" runat="server">
                                                ...
                                                <div id="row4" class="row" runat="server">
                                                    <div class="col-md-3">
                                              ...
                                              <%--  <div id="TrPaytype" runat="server" visible="false" class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <asp:Panel ID="Panel1" Height="300px" runat="server" ScrollBars="Both">
