...
public partial class ACCOUNT_AccBudgetHeadCreation : System.Web.UI.Page
{
    ...
    string _CCMS = ConfigurationManager.ConnectionStrings["CCMS"].ConnectionString.ToString();
