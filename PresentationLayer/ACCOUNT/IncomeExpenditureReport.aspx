<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true"
    CodeFile="IncomeExpenditureReport.aspx.cs" Inherits="IncomeExpenditureReport"
    Title="" %>
            ...
            <div class="col-md-12 col-sm-12 col-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">INCOME EXPENDITURE REPORT</h3>
                    </div>
                    <div class="box-body">
                        <div class="col-12">
                            ...
                            <asp:Panel ID="pnlIncExpReport" runat="server">
                                <div class="col-12 mt-3">
                                    <div class="row">
                                        <div class="form-group col-lg-3 col-md-6 col-12" id="dvRbnGroup" runat="server">
                                            <div class="label-dynamic">
                                                <sup></sup>
                                                <label></label>
                                            </div>
                                            <asp:RadioButton runat="server" ID="rdbDefaultGroup" Text="Print With Default Heads"
                                                GroupName="Print" />
                                ...
                                <div class="col-12 btn-footer">
                                    <asp:Button ID="btnPL" runat="server" Text="Show Income Exp" CssClass="btn btn-primary" OnClick="btnPL_Click" />
                                </div>
