<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="SupplimentaryDeleteTransfer.aspx.cs" Inherits="ACCOUNT_SupplimentaryDeleteTransfer" %>
                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title">DELETE SUPPLIMENTRY TRANSFER</h3>
                        </div>
                        <div class="box-body">
                            <div class="col-md-12">
                                ...
                                <asp:Panel ID="pnlShow" runat="server">
                                    <div class="panel panel-info">
                                        <div class="panel-heading">DELETE SUPPLIMENTRY TRANSFER</div>
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group row" id="Tr8" runat="server" visible="false">
                                                ...
                                                <div class="col-md-10">
                                                    <asp:Button ID="btnDelete" runat="server" Text="Delete Transfer" CssClass="btn btn-danger" ValidationGroup="Validation"
