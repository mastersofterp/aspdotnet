...
//=================================================================================
// PROJECT NAME  :UAIMS                                                  
// MODULE NAME   :ACCOUNTING RECEIPT VOUCHERS  FOR STORE                                                    
...
public partial class ACCOUNT_AccReceiptVoucherForStore : System.Web.UI.Page
{
    ...
    public static string LookupProduct(string Username)
    {
        ...
        var thisPage = new ACCOUNT_AccReceiptVoucherForStore();
    ...
    private void ClearAll()
    {
        ...
        lblBalAmount.Text = lblCondSaleAmount.Text = string.Empty;
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (hdnAskSave.Value == "1")
            {
                ...
                //{
                int V = objPC1.AddTransactionReceiptStore(Session["comp_code"].ToString().Trim(), Convert.ToString(voucherno), "R", Convert.ToInt32(ViewState["CISID"]));
                if (V > 0)
                {
                }
                else
    ...
    private void BindCondmnedSaleList()
    {
        DataSet ds = objPC1.GetApprovedCondmnedSaleDetails();
        if (ds.Tables[0].Rows.Count > 0)
        {
    ...
    protected void btnSelect_Click(object sender, EventArgs e)
    {
        ...
        int CisId = Convert.ToInt32(btnEdit.CommandArgument);
        ViewState["CISID"] = CisId;

        DataSet dsVP = objPC1.GetCondmnedSaleAmountById(CisId);
        lblCondSaleTrno.Text = dsVP.Tables[0].Rows[0]["COND_SALE_TRNO"].ToString();
        lblCondSaleAmount.Text = dsVP.Tables[0].Rows[0]["SALE_VALUE"].ToString();//BILL_AMT
        lblBalAmount.Text = dsVP.Tables[0].Rows[0]["SALE_VALUE"].ToString();//BALANCE_AMT
