<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/SiteMasterPage.master" CodeFile="PendingBillForward.aspx.cs" Inherits="ACCOUNT_PendingBillForward" %>
                ...
                <div class="col-md-12 col-sm-12 col-12">
                    <div class="box box-primary">
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title">RAISING PAYMENT BILL FORWARD</h3>
                        </div>
                        ...
                        <div class="box-body">
                            <asp:Panel ID="Panel1" runat="server">
                                        ...
                                        <asp:ListView ID="lvPendingList" runat="server">
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td><%--<asp:HiddenField  ID="hdBillNo" runat="server"  Value='<%# Eval("BILL_NO")%>' />
                                                        ...
                                                        <asp:Label ID="lblBillNo" runat="server" Text='<%# Eval("BILL_NO")%>' Visible="false"></asp:Label>
                                ...
                                <asp:Panel ID="pnlBillDetails" runat="server" Visible="false">
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-2">
                                                <label><span style="color: red; font-weight: bold">*</span> Select Company :</label>
                                            </div>
                                            <div class="col-md-6">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-2">
                                                <label>Department/Branch<span style="color: red">*</span></label>
                                            </div>
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-4">
                                                <div class="input-group date">
                                                    <asp:DropDownList ID="ddlBudgethead" runat="server" AppendDataBoundItems="true" AutoPostBack="true"
                                                        ToolTip="Please Select Budget" Width="89%" data-select2-enable="true" TabIndex="7" OnSelectedIndexChanged="ddlBudgethead_SelectedIndexChanged">
                                                        <asp:ListItem Value="0">Please select</asp:ListItem>
                                                    </asp:DropDownList>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <asp:TextBox ID="txtNatureOfService" runat="server" CssClass="form-control" TabIndex="9" TextMode="MultiLine"></asp:TextBox>
                                            ...
                                            <div class="col-md-4">
                                                <asp:TextBox ID="txtServiceName" TextMode="MultiLine" runat="server" CssClass="form-control" TabIndex="10"></asp:TextBox>
                                        ...
                                        <div class="row mt-2">
                                            ...
                                            <div class="col-md-4">
                                                <asp:TextBox ID="txtPayeeNameAddress" TextMode="MultiLine" TabIndex="11" runat="server" CssClass="form-control"></asp:TextBox>
                                            </div>
                                            <div class="col-md-2">
                                                <label>GSTIN NO :-</label>
                                            </div>
                                            <div class="col-md-4">
                                                <asp:TextBox ID="txtGSTINNo" runat="server" MaxLength="15" Style="text-transform: uppercase" CssClass="form-control" TabIndex="12"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-md-3">
                                    ...
                                    <div id="dvSection" runat="server" visible="false" class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <asp:TextBox ID="txtTDSPer" runat="server" TabIndex="18" CssClass="form-control" Style="text-align: right"
                                    ...
                                    <div class="col-12">
                                        <div class="row mt-2">
                                            <div class="form-group col-md-3" runat="server" visible="true">
                                                <label><span style="color: red">*</span> GST Amount :</label>
                                                <asp:TextBox ID="txtGSTAmount" runat="server" TabIndex="19" CssClass="form-control" MaxLength="13" Style="text-align: right"
                                    ...
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-11">
                                                <asp:TextBox TextMode="MultiLine" runat="server" TabIndex="21" ID="txtRemark" CssClass="form-control"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-4">
                                                <asp:DropDownList ID="ddlSelect" runat="server" CssClass="form-control" data-select2-enable="true" ToolTip="Select Approve/Reject"
                                                    AppendDataBoundItems="true" TabIndex="28" AutoPostBack="true">
                                            ...
                                            <div class="col-md-4">
                                                <asp:TextBox ID="txtApproveRemarks" runat="server" TextMode="MultiLine" CssClass="form-control" TabIndex="29"
                                ...
                                <div class="row" id="dvbuttons" runat="server">
                                    <div class="col-12 btn-footer">
                                        <asp:Button ID="btnSave" runat="server" Text="Submit" CssClass="btn btn-primary" OnClientClick="return AskSave();" OnClick="btnSave_Click" />
