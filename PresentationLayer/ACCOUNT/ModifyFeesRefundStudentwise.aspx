<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true"
    CodeFile="ModifyFeesRefundStudentwise.aspx.cs" Inherits="ACCOUNT_ModifyFeesRefundStudentwise"
    Title="Untitled Page" %>
        ...
        <table cellpadding="0" cellspacing="0" width="99%">
            <tr>
                <td class="vista_page_title_bar" style="height: 30px">
                    MODIFY FEES REFUND STUDENTWISE
    ...
    <asp:UpdatePanel ID="updBank" runat="server">
        <ContentTemplate>
            <fieldset class="vista-grid" style="width: auto">
                <legend class="titlebar">Modify Fees Refund</legend>
                    ...
                    <tr>
                        ...
                        <td class="auto-style2" colspan="2">
                            <asp:DropDownList ID="ddlVoucher" runat="server" AppendDataBoundItems="true" ValidationGroup="Submit"
                                AutoPostBack="true" Width="250px" OnSelectedIndexChanged="ddlVoucher_SelectedIndexChanged">
                            </asp:DropDownList>
                                            ...
                                            <asp:ListView ID="lvFeeTransfer" runat="server">
                                                    ...
                                                    <div class="vista-grid">
                                                        <table id="tblHead" class="vista-grid" cellpadding="0" cellspacing="0" style="width: 100%;">
                                                            <thead class="datatable" style="font-size: 13px">
                                                                <th style="text-align: left; width: 4%; padding-left: 0px">
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <tr class="item" onmouseover="this.style.backgroundColor='#FFFFAA'" onmouseout="this.style.backgroundColor='#FFFFFF'">
                                                        ...
                                                        <td colspan="9" style="text-align: left; width: 90%">
