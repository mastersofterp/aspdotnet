...
public partial class IncomeExpenditureReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            SetFinancialYear();
            rdbDefaultGroup.Checked = true;
        }
        //Response.Redirect("IncomeExpenditureConfiguration_Pre.aspx?obj=" + txtFrmDate.Text.ToString().Trim() + "," + txtUptoDate.Text.ToString().Trim() + "");
        //btnPL_Click(sender, e);

        divMsg.InnerHtml = string.Empty;
        dvRbnGroup.Visible = false;
    }
    ...
    protected void GenerateTrialBalanceFormatNew3()
    {
        try
        {
            DataSet dsLdg = objCommon.FillDropDown("TEMP_TRIAL_BALANCE_TRAN", "*", "", "PARTYNAME <> ''", string.Empty);
    ...
    protected void btnPL_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (rdbDefaultGroup.Checked)
                Response.Redirect("IncomeExpenditureConfiguration_Pre.aspx?obj=" + txtFrmDate.Text.ToString().Trim() + "," + txtUptoDate.Text.ToString().Trim() + "", false);
    ...
    protected void btnPL_Click1(object sender, EventArgs e)
    {
