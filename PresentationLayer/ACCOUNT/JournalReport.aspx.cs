...
//===============================================================
    ...
    protected void btnRP_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ShowReportJournal("Journal", "JournalBookReport.rpt");
        }
        catch (Exception ex)
        {
            if (Convert.ToBoolean(Session["error"]) == true)
    ...
    private void ShowReportJournal(string reportTitle, string rptFileName)
    {
        try
        {
            ...
            {
                url += "&param=@P_CompanyName=" + Session["comp_name"].ToString().Trim().ToUpper() + ",@P_PERIOD=" + txtFrmDate.Text.ToString().Trim() + " to " + txtUptoDate.Text.ToString().Trim() + ",@P_CODE_YEAR=" + Session["comp_code"].ToString() + "," + "@P_FROMDATE=" + Convert.ToDateTime(txtFrmDate.Text).ToString("dd-MMM-yyyy") + "," + "@P_TODATE=" + Convert.ToDateTime(txtUptoDate.Text).ToString("dd-MMM-yyyy") + ",@P_COLLEGE_CODE=" + Session["colcode"].ToString() + ",@P_NV=0";
            }
            else
            {
                url += "&param=@P_CompanyName=" + Session["comp_name"].ToString().Trim().ToUpper() + ",@P_PERIOD=" + txtFrmDate.Text.ToString().Trim() + " to " + txtUptoDate.Text.ToString().Trim() + ",@P_CODE_YEAR=" + Session["comp_code"].ToString() + "," + "@P_FROMDATE=" + Convert.ToDateTime(txtFrmDate.Text).ToString("dd-MMM-yyyy") + "," + "@P_TODATE=" + Convert.ToDateTime(txtUptoDate.Text).ToString("dd-MMM-yyyy") + ",@P_COLLEGE_CODE=" + Session["colcode"].ToString() + ",@P_NV=1";
            }
            Script += " window.open('" + url + "','" + reportTitle + "','addressbar=no,menubar=no,scrollbars=1,statusbar=no,resizable=yes');";
