...
CodeFile="AbstractBillApprove.aspx.cs" Inherits="ACCOUNT_AbstractBillApprove" Title="Untitled Page" %>
             ...
             <tr>
                <td>
                    <fieldset class="vista-grid" style="width: 75%; height:515px">
                        <legend class="titlebar">Abstract Bill Approve</legend>
                                ...
                                <asp:Repeater ID="RptData" runat="server" OnItemCommand="RptData_ItemCommand">
                                    ...
                                    <ItemTemplate>
                                        <tr style="background-color: ThreeDShadow; height: 2Px">
                                            ...
                                            <td rowspan="2" style="font-weight: bold" valign="top" align="Center">
                                                Bill Approve<br />
                                                <br />

                                                <asp:Button ID="btnApprove" runat="server" Text="Approve" CommandArgument='<%# Eval("ABS_BILL_NO")%>' CommandName="VoucherApprove"/>    
                                                 <asp:HiddenField ID="hdnIstransfered" runat="server" Value='<%#Eval("IsTransfered_ToTrans")%>' />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="5">
                                                    ...
                                                    <asp:ListView ID="lvGrp" runat="server">
                                                        ...
                                                        <ItemTemplate>
                                                            <tr class="item" onmouseout="this.style.backgroundColor='#FFFFFF'" onmouseover="this.style.backgroundColor='#FFFFAA'">
                                                                ...
                                                                <td style="width: 10%">
                                                                    <%# Eval("TRAN_TYPE")%>
                                                                    <asp:HiddenField ID="hdnIstransferable" runat="server" Value='<%#Eval("IsTransferable")%>' />
                                                                </td>
                                                            </tr>
                                                        </ItemTemplate>
