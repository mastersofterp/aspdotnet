...
public partial class ACCOUNT_BudgetUtilizationReport : System.Web.UI.Page
{
    ...
    private void CheckPageAuthorization()
    {
        if (Request.QueryString["pageno"] != null)
        {
            ...
            {
                Response.Redirect("~/notauthorized.aspx?page=BudgetUtilizationReport.aspx");
            }
        }
        else
        {
    ...
    protected void btnrpt_Click(object sender, EventArgs e)
    {
        ...
        ShowReport("Budget Utilization Report", "BudgetUtilizationReport.rpt");
    ...
    private void ShowReport(string reportTitle, string rptFileName)
    {
        try
        {
            ...
            url += "&param=@P_COLLEGE_CODE=" + Session["colcode"].ToString() + ",@P_FROM_DATE=" + Convert.ToDateTime(txtFrmDate.Text.ToString()).ToString("yyyy-MM-dd") + ",@P_TO_DATE=" + Convert.ToDateTime(txtUptoDate.Text.ToString()).ToString("yyyy-MM-dd") + ",@P_DEPT_ID=" + ddldept.SelectedValue ;
