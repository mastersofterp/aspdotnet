...
// MODIFIED DESC : ADD GROUP REPORT HEADWISE
//=================================================================================
using System;
...
public partial class TrialBalanceReportClass : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        rdbShortTrailBalanec.Visible = false;
        rdbConsolidateTrialBalance.Visible = false;
    }
    ...
    protected void rdbGroup_CheckedChanged(object sender, EventArgs e)
    {
        ...
        objCommon.FillDropDownList(ddlFAGroup, "ACC_" + Session["comp_code"].ToString() + "_" + "MAIN_GROUP", "MGRP_NO", "UPPER(MGRP_NAME) AS MGRP_NAME", "MGRP_NO > 0  AND PRNO = 0", "MGRP_NAME");
