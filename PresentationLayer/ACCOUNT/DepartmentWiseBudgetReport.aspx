<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="DepartmentWiseBudgetReport.aspx.cs" Inherits="ACCOUNT_DepartmentWiseBudgetReport" %>
                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title">BUDGET REPORT FOR DEPARTMENT WISE</h3>
                        </div>
                        <div class="box-body">
                            <div class="col-md-12">
                                ...
                                <asp:Panel ID="pnl" runat="server">
                                    <div class="panel panel-info">
                                        <div class="panel-heading">Budget Report For Department Wise</div>
                                        <div class="panel-body">
                                              <div class="row">
                                                ...
                                                <div class="form-group col-md-3">
                                                    <asp:DropDownList ID="ddldept" runat="server" CssClass="form-control" AppendDataBoundItems="true"></asp:DropDownList>
                                                    </div>
                                                  </div>
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <asp:Button ID="btnrpt" runat="server" Text="REPORT" CssClass="btn btn-primary" ValidationGroup="budget" OnClick="btnrpt_Click" />
