<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="AdvanceVoucher.aspx.cs" Inherits="ACCOUNT_AdvanceVoucher" UICulture="auto" %>
                                        ...
                                        <div class="panel panel-info">
                                            ...
                                            <div class="panel-body">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div style="visibility:hidden">
                                                            ...
                                                            <asp:CheckBox ID="chkTDSApplicable" runat="server" Text="&nbsp;Is TDS Applicable" AutoPostBack="true"
                                                              ...
                                                              <asp:CheckBox ID="chkTDSonGST" runat="server" Text="&nbsp;Is TDS on GST Applicable" AutoPostBack="true"
                                                    ...
                                                    <div id="dvTDSonGST" runat="server" visible="false" class="row">
                                                        <br />

                                                        <div class="col-md-2">
                                                        </div>
                                                        <div class="col-md-3">
                                                            <label>TDS on GST Account:</label>
                                                            <asp:TextBox ID="txtTDSonGSTLedger" runat="server" CssClass="form-control" ToolTip="Please Enter TDS Ledger" OnTextChanged="txtTDSonGSTLedger_TextChanged"></asp:TextBox>
                                                            <ajaxToolKit:AutoCompleteExtender ID="AutoCompleteExtender6" runat="server" TargetControlID="txtTDSonGSTLedger"
                                                                MinimumPrefixLength="1" EnableCaching="true" CompletionSetCount="1" CompletionInterval="1"
                                                                ServiceMethod="GetAccount" OnClientShowing="clientShowing">
                                                            </ajaxToolKit:AutoCompleteExtender>
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator22" runat="server"
                                                                ControlToValidate="txtTDSonGSTLedger" Display="None"
                                                                ErrorMessage="Please Select TDS Account" SetFocusOnError="true"
                                                                ValidationGroup="AccMoney">
                                                            </asp:RequiredFieldValidator>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <label>TDS-GST On Amount:</label>
                                                            <asp:TextBox ID="txtTDSGSTonAmount" runat="server" CssClass="form-control" ToolTip="Please Enter TDS(GST) on Amount" Style="text-align: right" onkeypress="CheckAmount(this);" onblur="CalPerAmountforTDS(this)"></asp:TextBox>
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator23" runat="server"
                                                                ControlToValidate="txtTDSGSTonAmount" Display="None"
                                                                ErrorMessage="Please Enter TDS On Amount" SetFocusOnError="true"
                                                                ValidationGroup="AccMoney">
                                                            </asp:RequiredFieldValidator>
                                                            <ajaxToolKit:FilteredTextBoxExtender ID="FilteredTextBoxExtender12" runat="server" TargetControlID="txtTDSGSTonAmount" FilterType="Numbers" ValidChars="."></ajaxToolKit:FilteredTextBoxExtender>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <label>Section :</label>
                                                            <asp:DropDownList ID="ddlTDSonGSTSection" runat="server" AppendDataBoundItems="true" AutoPostBack="true" CssClass="form-control"
                                                                OnSelectedIndexChanged="ddlTDSonGSTSection_SelectedIndexChanged" onblur="CalPerAmountforTDS(this);">
                                                            </asp:DropDownList>
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator24" runat="server"
                                                                ControlToValidate="ddlTDSonGSTSection" Display="None"
                                                                ErrorMessage="Please Select TDS Section" SetFocusOnError="true" InitialValue="0"
                                                                ValidationGroup="AccMoney">
                                                            </asp:RequiredFieldValidator>
                                                        </div>
                                                        <div class="col-md-1">
                                                            <label>Per (%) :</label>
                                                            <asp:TextBox ID="txtTDSonGSTPer" runat="server" CssClass="form-control" Style="text-align: right" MaxLength="2"
                                                                ToolTip="Please Enter TDS Percentage" AutoPostBack="false" onblur="calTdsamount()"></asp:TextBox>
                                                            <ajaxToolKit:FilteredTextBoxExtender ID="FilteredTextBoxExtender13" runat="server" TargetControlID="txtTDSonGSTPer"
                                                                FilterType="Custom, Numbers" ValidChars="." Enabled="True" />
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator25" runat="server"
                                                                ControlToValidate="txtTDSonGSTPer" Display="None"
                                                                ErrorMessage="Please Enter TDS Percentage1" SetFocusOnError="true" 
                                                                ValidationGroup="AccMoney">
                                                            </asp:RequiredFieldValidator>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <label>TDS on GST Amount :</label>
                                                            <asp:TextBox ID="txtTDSonGSTAmount" runat="server" MaxLength="7" CssClass="form-control" Style="text-align: right"
                                                                ToolTip="Can be Edited"></asp:TextBox>
                                                            <ajaxToolKit:FilteredTextBoxExtender ID="FilteredTextBoxExtender14" runat="server" TargetControlID="txtTDSonGSTAmount"
                                                                FilterType="Custom, Numbers" ValidChars="." Enabled="True" />
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator26" runat="server"
                                                                ControlToValidate="txtTDSonGSTAmount" Display="None"
                                                                ErrorMessage="Please Enter TDS on GST Amount" SetFocusOnError="true"
                                                                ValidationGroup="AccMoney">
                                                            </asp:RequiredFieldValidator>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row" runat="server" id="trBudgetHead" visible="false">
                                                      ...
                                                      <div class="row" runat="server" id="Div10" >
                                                        ...
                                                        <div class="col-md-5">
                                                            ...
                                                            <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator27" runat="server" ControlToValidate="ddlBudgetHead"
                                                                Display="None" ErrorMessage="Please Select Budget Head" SetFocusOnError="True"
                                                                ValidationGroup="AccMoney"></asp:RequiredFieldValidator>--%>
                                                             </div>
                                                        <div class="col-md-3">                                                   
                                                                ...
                                                                <asp:GridView ID="GridData" runat="server" CellPadding="4" GridLines="Vertical"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:BoundField DataField="Mode" HeaderText="Mode" HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg">
                                                                         ...
                                                                         <asp:BoundField DataField="EmployeeName" HeaderText="Employee" HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg">
                                                                            <HeaderStyle HorizontalAlign="Right" Width="10%" />
                                                                            <ItemStyle HorizontalAlign="Right" Width="10%" />
                                                                        </asp:BoundField>
                                                                        <asp:TemplateField>
                                                                            <ItemTemplate>
                                                                                ...
                                                                                <asp:HiddenField ID="hdnTDSonGSTsection" runat="server" Value='<%# Eval("TDSonGSTSection")%>' />
                                                                                <asp:HiddenField ID="hdnTDSGSTonAmount" runat="server" Value='<%# Eval("TDSonGSTAMOUNT")%>' />
                                                                                <asp:HiddenField ID="hdnTDSonGSTPersentage" runat="server" Value='<%# Eval("TDSonGSTpercentage")%>' />
