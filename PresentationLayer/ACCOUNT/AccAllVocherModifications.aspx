<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="AccAllVocherModifications.aspx.cs" Inherits="ACCOUNT_AccAllVocherModifications" %>
            ...
            <div class="box box-primary">
                <div id="div1" runat="server">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title">TEMPORARY VOUCHERS MODIFICATION</h3>
                    </div>
                    <div class="box-body">
                        <asp:Panel ID="UPDLedger" runat="server">
                            ...
                            <div class="box-body">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-lg-2 col-md-6 col-12">
                                                ...
                                                <asp:TextBox ID="lblCurBal" runat="server"
                                            ...
                                            <div class="form-group col-lg-3 col-md-6 col-12">
                                                ...
                                                <asp:RadioButtonList ID="rdblistbill" runat="server" RepeatDirection="Horizontal" OnSelectedIndexChanged="rdblistbill_SelectedIndexChanged">
                                                    ...
                                                    <ItemTemplate>
                                                        <tr style="background-color: ActiveBorder">
                                                            <td>
                                                                ...
                                                                <asp:Label ID="lbltemptest" Style="font-weight: bold; width: 15%" align="center" runat="server" Visible="false" Text="Temp Voucher No"> </asp:Label>
                                                                <asp:Label ID="lblTempVoucher" Style="font-weight: bold; width: 15%" align="center" runat="server" Visible="false" Text='<%#Eval("TEMP_VOUCHER_NO")%>'> </asp:Label>

                                                            </td>
                                                            <td>Tran No./Voucher No.
                                                                                    <%#Eval("VOUCHER_NO")%>
                                                            </td>
                                                            ...
                                                            <td runat="server" id="tdviewbill" >View/Add Bill
                                                                                   <asp:ImageButton ID="btnViewBill" ToolTip="Click For Add and View Bill. " runat="server"
                                                                                       CommandArgument='<%# Eval("VOUCHER_NO")%>' CommandName="ViewAddBill" ImageUrl="~/Images/view2.png" />
                                                            </td>
                                                            <td runat="server" id="tdCopyVoucher" visible="false">Copy Voucher
                                ...
                                <asp:Panel ID="pnlupload" runat="server" Visible="false">
                                    <div class="col-12" id="div7" style="display: block;">
                                        <div class="sub-heading">
                                            <h5>Upload Bills  </h5>
                                        </div>
                                        <div class="row">
                                        ...
                                        <asp:Panel ID="pnlNewBills" runat="server">
                                            ...
                                            <div class="col-12 btn-footer">
                                                <asp:Button ID="btnSave" runat="server" Text="Save" TabIndex="27" CssClass="btn btn-primary" OnClick="btnSave_Click" />
