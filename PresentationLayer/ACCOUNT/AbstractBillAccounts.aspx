<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="AbstractBillAccounts.aspx.cs" Inherits="AbstractBillAccounts"
    Title="" %>
                    ...
                    <asp:UpdatePanel ID="updBank" runat="server">
                        <ContentTemplate>
                            <fieldset class="vista-grid" style="width: 75%;">
                                <legend class="titlebar">Account Details</legend>
                                  <table width="100%" cellpadding="3" cellspacing="0">
                                    <tr>
                                        ...
                                        <td  style="width:25%">
                                            <asp:TextBox ID="txtAccountName" runat="server" Width="207px" ValidationGroup="submit"></asp:TextBox>
                                            <ajaxToolKit:FilteredTextBoxExtender FilterType="Custom" ID="flt1" FilterMode="InvalidChars" InvalidChars="1234567890" runat="server"  TargetControlID="txtAccountName"/>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:25%">
                                            <asp:CheckBox runat="server" ID="IsTransfer" Text="Is Transferable" />
                                            ...
                                            <table cellpadding="0" cellspacing="0" style="width: 60%">
                                                <tr>
                                                    <td style="vertical-align: top; padding: 5px">
                                                        <asp:ListView ID="lvAccount" runat="server" >
                                                            <LayoutTemplate>
                                                            ...
                                                            <ItemTemplate>
                                                                <tr class="item" onmouseover="this.style.backgroundColor='#FFFFAA'" onmouseout="this.style.backgroundColor='#FFFFFF'">
                                                                    ...
                                                                    <td style="text-align: left; width: 0%">
                                                                        <asp:Label ID="lblBankNo" runat="server" Text='<%# Eval("ACC_ID") %>' Visible="false" ></asp:Label>
                                                                    </td>
                                                                    <td style="text-align: left; width: 70%">
                                                                        <asp:Label ID="lblAccountName" runat="server" Text='<%# Eval("Acc_Name") %>'></asp:Label>
                                                                    </td>
                                                                    <td style="text-align: left; width: 20%">
                                                                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("IsTransferable") %>'></asp:Label>
                                                                    </td>
                                                                </tr>
                                                            </ItemTemplate>
                                                        </asp:ListView>
