<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/SiteMasterPage.master" CodeFile="BillCheckApproval.aspx.cs" Inherits="ACCOUNT_BillCheckApproval" %>
                    ...
                    <div class="col-md-12">
                        <div class="box box-primary">
                            ...
                            <div class="box-header with-border">
                                <h3 class="box-title">BILL CHEQUE APPROVAL</h3>
                            </div>
                            <div id="divCompName" runat="server" style="text-align: center; font-size: x-large"></div>
                            <div class="box-body">
                                <asp:Panel ID="Panel1" runat="server">
                                    <div class="panel panel-info">
                                        <div class="panel-heading">Bill Cheque Approval</div>
                                            ...
                                            <div class="panel panel-primary">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-8">
                                                            <asp:Label ID="lblBillCheckNo" Font-Bold="true" runat="server" Text="JSS S&TU/FB/32/CHQ/173/2018-19"></asp:Label>
                                                        </div>
                                                                        ...
                                                                        <table id="tblHead" class="table table-responsive table-bordered">
                                                                            <thead style="font-size: 13px">
                                                                                ...
                                                                                <asp:CheckBox ID="chkBoxFeesTransfer" runat="server" onclick="totAllSubjects(this);" />
                                                                                    ...
                                                                                    <th style="text-align: center">Name to which Cheque is to be issued in favour of
                                                                                    </th>
                                                                                    ...
                                                                                    <th style="text-align: center">Cheque Number
                                                                                    </th>
