<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="AccReceiptVoucherForStore.aspx.cs" Inherits="ACCOUNT_AccReceiptVoucherForStore" %>
                        ...
                        <div class="box box-primary">
                            <div id="div1" runat="server">
                                ...
                                <div class="box-header with-border">
                                    <h3 class="box-title">RECEIPT VOUCHER CREATION FOR STORE</h3>
                                </div>
                                ...
                                <div class="box-body">
                                    <asp:Panel ID="pnlVPList" runat="server">
                                        <asp:ListView ID="lvVPEntry" runat="server">
                                            <LayoutTemplate>
                                                <div>
                                                    <h4>Condmned Sale Approved List</h4>
                                                    <table class="table table-bordered table-hover">
                                                        <thead>
                                                            <tr class="bg-light-blue">
                                                                <th>Condmned Sale Number</th>
                                                                <th>Condmned Date</th>
                                                                <th>Sale Date</th>
                                                                <th>Sale Amount</th>
                                                                <th>Profit/Loss</th>
                                        ...
                                        <div class="panel panel-info">
                                            ...
                                            <div class="panel-body">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-2">
                                                            <label>Condmned Tran.No. <span style="color: red">*</span></label>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <asp:Label ID="lblCondSaleTrno" runat="server" Style="font-weight: bold" Text=""></asp:Label>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <label>Condmned Sale Amt : </label>

                                                            <asp:Label ID="lblCondSaleAmount" runat="server" Style="font-weight: bold" Text=""></asp:Label>
                                                        </div>
                                                        <div class="col-md-1">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                            <asp:Label ID="lblTransType" runat="server" Text="Receipt" CssClass="form-control"></asp:Label>
                                                            <asp:DropDownList ID="ddlTranType" runat="server" AppendDataBoundItems="True" AutoPostBack="True" Visible="false"
                                                                ...
                                                                <asp:ListItem Value="R" Selected="True" Text="Receipt"></asp:ListItem>
