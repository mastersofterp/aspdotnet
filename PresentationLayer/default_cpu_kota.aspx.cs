...
public partial class default_cpu_kota : System.Web.UI.Page
{
    /// <summary>
    /// Google Sign In
    /// </summary>
...
StringComparison.OrdinalIgnoreCase) >= 0))
    ...
    public static List<Packet> GetData(string SLOGINDATA, string IDTOKEN)
    {
        ...
        default_cpu_kota objdefault = new default_cpu_kota();
        Common objCommon = new Common();
                ...
                if (txtEmail.Text != string.Empty)
                {
                    try
                    {
                        ...
                        if (status == 1)
                        {
                            ...
                            //* objCommon.DisplayMessage(updLog,"Your Password successfully reset and forwarded to your registered email id or Mobile No.", this.Page);
                            Showmessage(" OTP is verified.....And Your and forwarded to your registered email id .");
