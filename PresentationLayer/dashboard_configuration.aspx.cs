...
public partial class dashboard_configuration : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            else
            {
                ...
                DataSet ds = objCommon.FillDropDown("ACD_DASHBOARD_MASTER", "ID", "NAME", "ID>0 and status=1", "NAME");
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            int ret = objUACC.InsertDashboardconfigdetails(usertype, dashboard);
            if (ret == 1)
            {
    ...
    private void bindchkdash()
    {
        ...
        DataSet ds = objCommon.FillDropDown("ACD_DASHBOARD_CONFIGURATION", "USERTYPE", "DASHBOARD", "USERTYPE=" + ddlusertype.SelectedValue, "DASHBOARD");
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            foreach (string value in dashboard.Split(','))
            {
                ...
                DataSet ds1 = objCommon.FillDropDown("ACD_DASHBOARD_MASTER", "ID", "NAME", "ID=" + value + " and status=1", "NAME");
