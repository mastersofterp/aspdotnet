...
// PAGE NAME     : PENDING COMPLAINT REPORT                                             
// CREATION DATE : 10-April-2009                                                        
// CREATED BY    : SANJAY RATNAPARKHI                                                   
// MODIFIED by:   nitin surkar
// MODIFIED DESC :
//======================================================================================
...
public partial class Estate_Pending_Complaint : System.Web.UI.Page
{
    ...
    private void ShowPendingComplaintReport()
    {
        ...
        string reportPath = Server.MapPath("~\\Reports\\Repair and Maintenance\\" + "rptPendingComplaint.rpt");
    ...
    {       
        ShowReport("Pending Complaints Report", "rptPendingComplaint.rpt");    
    }
