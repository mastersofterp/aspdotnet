<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="Pending_Complaint.aspx.cs"
    Inherits="Estate_Pending_Complaint" Title="" %>
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    <h3 class="box-title">PENDING SERVICES REQUEST</h3>
                </div>
                <div class="box-body">
                    <div class="col-md-12">
                        <asp:Panel ID="pnl" runat="server">
                            <div class="panel panel-info">
                                        ...
                                        <div class="col-md-3">
                                            <div class="input-group date">
                                                <div class="input-group-addon">
                                                    <asp:Image ID="imgSDate" runat="server" ImageUrl="~/images/calendar.png" CausesValidation="False" Style="cursor: pointer" />
                                                </div>
                                                <asp:TextBox ID="txtSDate" runat="server" CssClass="form-control" ValidationGroup="Pending" AutoPostBack="true" />
                                                <ajaxToolKit:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd-MMM-yyyy" TargetControlID="txtSDate" PopupButtonID="imgSDate"></ajaxToolKit:CalendarExtender>
                                                <asp:RequiredFieldValidator ID="rfvSDate" runat="server" ControlToValidate="txtSDate" Display="None" ErrorMessage="Start Date is Required"
                             ...
                             <ajaxToolKit:MaskedEditValidator ID="mevBillToDate" runat="server" EmptyValueMessage="Please Enter Valid Event Start Date"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="input-group date">
                                                <div class="input-group-addon">
                                                    <asp:Image ID="imgEDate" runat="server" ImageUrl="~/images/calendar.png" CausesValidation="False" Style="cursor: pointer" />
                                                </div>
                                                <asp:TextBox ID="txtEndDate" runat="server" CssClass="form-control" ValidationGroup="Pending" AutoPostBack="true" />
                                                <ajaxToolKit:CalendarExtender ID="CalendarExtender2" runat="server" Format="dd-MMM-yyyy" TargetControlID="txtEndDate" PopupButtonID="imgEDate"></ajaxToolKit:CalendarExtender>
                                                <asp:RequiredFieldValidator ID="rfvEDate" runat="server" ControlToValidate="txtEndDate" ErrorMessage="End Date is Required"
                                                    ValidationGroup="Pending" Display="None"></asp:RequiredFieldValidator>
    ...
    <%-- <tr>
        <td colspan="2" style="text-align:left;padding:10px">
            <CR:CrystalReportViewer ID="crViewer" runat="server" AutoDataBind="true" 
                ...
                HasViewList="False" EnableDatabaseLogonPrompt="False" 
                HasZoomFactorList="False" Width="350px" BorderColor="Black" BorderStyle="solid" BorderWidth="1" />
        </td>
    </tr>    --%>
