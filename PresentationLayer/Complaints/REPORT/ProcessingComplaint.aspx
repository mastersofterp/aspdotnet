<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="ProcessingComplaint.aspx.cs" Inherits="Complaints_REPORT_ProcessingComplaint" %>
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">PROCESSING SERVICE REQUEST</h3>
                </div>
                <div class="box-body">
                    <div class="col-md-12">
