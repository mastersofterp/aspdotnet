...
public partial class notice : System.Web.UI.Page
{
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            DataSet dsStudent = objCommon.FillDropDown("ACD_STUDENT S LEFT JOIN SELECTED_STUDENT_NEWS N ON (S.IDNO=N.IDNO) LEFT JOIN NEWS NE ON(NE.NEWSID=N.NEWSID)", "DISTINCT S.IDNO", "REGNO,STUDNAME,S.COLLEGE_ID,S.DEGREENO,S.BRANCHNO,S.SEMESTERNO,0 AS SPECIAL_STUD,2 AS Flag", "S.COLLEGE_ID =" + Convert.ToInt32(ddlCollege.SelectedValue) + " AND S.DEGREENO=" + Convert.ToInt32(ddlDegree.SelectedValue) + " AND S.BRANCHNO= " + Convert.ToInt32(ddlBranch.SelectedValue) + " AND S.SEMESTERNO= " + Convert.ToInt32(ddlSemester.SelectedValue) +" AND CAN=0", "");
