...
<%@ Page Language="C#" AutoEventWireup="true" MaintainScrollPositionOnPostback="true"
    CodeFile="testpage.aspx.cs" Inherits="Itle_testpage" %>
...
<head id="Head1" runat="server">
    <title>Centralised college managment system</title>
                                    ...
                                    <table style="width: 100%" id="Table_Main">
                                        ...
                                        <tr id="tr" runat="server" visible="false">
                                            ...
                                            <td colspan="3" style="width: 100px; height: 1px;">
                                                <asp:Label ID="lblQueNo" Font-Bold="true" runat="server" Width="232px" Visible="false"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td colspan="2" style="font-family: Verdana; font-weight: normal; text-align: center">
                                                <asp:Button ID="Button3" OnClientClick="return confirm('Are you sure you want to Submit Test, Once it is submmited you will not be able to modify it?');"
                                                    runat="server" OnClick="Button3_Click" Text="Submit" />
