<%@ Page Language="C#" AutoEventWireup="true" CodeFile="default_UTKALU.aspx.cs" Inherits="default_UTKALU" %>
...
<head id="Head1" runat="server">
    ...
    <title>Utkal University</title>
    <link rel="shortcut icon" href="Images/Login/utkalu_logo.png" type="image/x-icon">
    ...
    <link href="plugins/newbootstrap/css/login_utkalu.css" rel="stylesheet" />
    ...
    <form id="frmDefault" runat="server" defaultbutton="btnLogin">
        ...
        <div class="login">
                ...
                <div id="loginCarousel" class="carousel slide" data-ride="carousel" data-interval="4000" data-pause="hover">
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
                            ...
                            <div class="slide" style="background-image: url('Images/Login/utkalu_1.png'); background-size: cover;"></div>
                            <div class="carousel-caption">
                                <div class="txt-clgs animationss a1">
                                    <h1 class="slide__title college-name animations a2">Utkal University</h1>
                                    <p class="slide__text mb-0 animation a2">1st University of Odisha</p>
                                </div>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <div class="background-overlay"></div>
                            <div class="slide" style="background-image: url('Images/Login/utkalu_2.png'); background-size: cover;"></div>
                            <div class="carousel-caption">
                                <div class="txt-clgs animationss a1">
                                    <h1 class="slide__title college-name animations a2">Administrative Building</h1>
                                    <p class="slide__text mb-0 animation a2">Utkal University</p>
                                </div>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <div class="background-overlay"></div>
                            <div class="slide" style="background-image: url('Images/Login/utkalu_3.png'); background-size: cover;"></div>
                            <div class="carousel-caption">
                                <div class="txt-clgs animationss a1">
                                    <h1 class="slide__title college-name animations a2">Parija Library</h1>
                                    <p class="slide__text mb-0 animation a2">E-Library</p>
                                </div>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <div class="background-overlay"></div>
                            <div class="slide" style="background-image: url('Images/Login/utkalu_4.png'); background-size: cover;"></div>
                            <div class="carousel-caption">
                                <div class="txt-clgs animationss a1">
                                    <h1 class="slide__title college-name animations a2">Mahatma Gandhi Memorial Park</h1>
                                    <p class="slide__text mb-0 animation a2">Ahimsa Sthal</p>
                                </div>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <div class="background-overlay"></div>
                            <div class="slide" style="background-image: url('Images/Login/utkalu_5.png'); background-size: cover;"></div>
                            <div class="carousel-caption">
                                <div class="txt-clgs animationss a1">
                                    <h1 class="slide__title college-name animations a2">Centre For Innovation And Incubation (CII)</h1>
                                    <p class="slide__text mb-0 animation a2">Utkal Entrepreneurship and Career Hub (UECH)</p>
                                </div>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <div class="background-overlay"></div>
                            <div class="slide" style="background-image: url('Images/Login/utkalu_6.png'); background-size: cover;"></div>
                            <div class="carousel-caption">
                                <div class="txt-clgs animationss a1">
                                    <h1 class="slide__title college-name animations a2">Sailabala Chhatri Nibas</h1>
                                    <p class="slide__text mb-0 animation a2">New Ladies Hostel</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section class="login__right">
                <div class="college-details text-center mt-lg-4 logo">
                    <%--<img src="Images/Login/utkalu_logo.png" alt="logo" />--%>
                    <asp:Image ID="imgLogo" runat="server" ImageUrl="~/Images/Login/utkalu_logo.png" AlternateText="logo" />
                </div>

                <div class="signin-details mt-lg-2">
                    <h2 class="text-center mb-1">Utkal University <%--<span>Bhubaneswar, Odisha</span>--%></h2>
                    <%--<h2 class="text-center mb-1">ଉତ୍କଳ ବିଶ୍ୱବିଦ୍ୟାଳୟ, <span>ଭୁବନେଶ୍ୱର, ଓଡ଼ିଶା</span></h2>--%>
                    <h5 class="text-center">Vani Vihar, Bhubaneswar, Odisha 751004</h5>
                    <h6 class="text-center mb-3">Estd 1943 | UGC Category 1 University</h6>
                                ...
                                <ContentTemplate>
                                    <div class="input-group">
                                        ...
                                        <cc1:CaptchaControl ID="Captcha1" runat="server" CaptchaBackgroundNoise="Low" CaptchaLength="4"
                                            ...
                                            NoiseColor="#666699" CaptchaInputCSS="BlackTextInput" EnableTheming="true" CaptchaChars="123456789" CaptchaMaxTimeout="240" FontColor="#092f56" class="img-responsive" />
                    ...
                    <div class="forget-pass text-center mt-3">
                        <a data-toggle="modal" data-target="#ModelPopUp" id="lbtForgePass" runat="server" style="cursor: pointer; color: #2467a5;"><span>Forgot Password 
                        </span></a>
                    </div>
