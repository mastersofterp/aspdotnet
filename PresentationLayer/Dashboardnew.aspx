    ...
    CodeFile="Dashboardnew.aspx.cs" Inherits="Dashboardnew" Title="" %>
...
<%--    <script src="https://code.highcharts.com/modules/exporting.js"></script>--%>
                ...
                <div class="info-box bg-aqua wrong-item item bot">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number sss"><b>
                            <asp:Label ID="lblUGTotalStudent" runat="server"></asp:Label></b></span>
 ...
 <%--<div class="col-md-6 col-sm-6 col-xs-12 san animated rubberBand beauty" id="pgfemale" runat="server" visible="false">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12 san animated rubberBand beauty" id="paytotalemp" runat="server" visible="false">
                <div class="info-box bg-aqua wrong-item item bot">
                    <span class="info-box-icon"><i class="fa fa-users"></i></span>
                    <div class="info-box-content">
                        <span class="info-box-text"> Employees</span>
                        <span class="info-box-number sss"><b>
                            <asp:Label ID="lblTotalEmployees" runat="server"></asp:Label></b></span>
                        <span class="progress-description"></span>
                    </div>
                </div>
            </div>
<div class="col-md-6 col-sm-6 col-xs-12 san animated rubberBand beauty" id="ugfemale" runat="server" visible="false">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12 san animated rubberBand beauty" id="paytotalempMale" runat="server" visible="false">
                <div class="info-box bg-green wrong-item item bot">
                    <span class="info-box-icon"><i class="fa fa-male"></i></span>
                    <div class="info-box-content">
                        <span class="info-box-text">Male Employees </span>
                        <span class="info-box-number sss"><b>
                            <asp:Label ID="lblTotalEmpMale" runat="server"></asp:Label></b></span>
                        <span class="progress-description"></span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-sm-6 col-xs-12 san animated rubberBand beauty" id="nopaidug" runat="server" visible="false">
                <div class="info-box bg-yellow wrong-item item bot">
                    <span class="info-box-icon"><i class="fa fa-inr"></i></span>

                    <div class="info-box-content">
                        <span class="info-box-text">No. of Paid<br />
                            Applicants(U.G)</span>
                        <span class="info-box-number sss"><b>
                            <asp:Label ID="lblUGStudentVist" runat="server"></asp:Label></b></span>
            ...
            <div class="col-md-12 beauty" id="ugstatewise" runat="server" visible="false">
                <div class="box box-primary wrong-item item top" id="one1">
                    ...
                    <div class="box-header with-border">
                        ...
                        <h3 class="box-title">Admission Statewise Count</h3>
                       <span> <asp:ImageButton ID="btnimg" runat="server" ToolTip="Export to Excel" OnClick="btnimg_Click" style="width:30px;height:25px;margin-left:20px" ImageUrl="IMAGES/ICON_EX.png" /></span>
...
<%--                        <input type="button" value="Print" onclick="javascript: PrintDivContent('ctl00_ContentPlaceHolder1_carousel');"  />--%>
                       <%--  <button id="button">Export chart</button>--%>
                        <%--<img src="IMAGES/ICON_EX.png" style="width:30px;height:25px" />--%>
                ...
                <div class="box box-primary wrong-item item top" id="Div38">
                    ...
                    <div class="box-header with-border">
                        ...
                        <h3 class="box-title">Branch Wise Registration Count</h3>
                         <span> <asp:ImageButton ID="btnbranchwise" runat="server" ToolTip="Export to Excel" OnClick="btnbranchwise_Click" style="width:30px;height:25px;margin-left:20px" ImageUrl="IMAGES/ICON_EX.png" /></span>
            ...
            <div class="col-md-12 beauty" id="Div14" runat="server" visible="false">
                <div class="box box-primary wrong-item item top" id="one11">
                    ...
                    <div class="box-header with-border">
                       ...
                       <span> <asp:ImageButton ID="btnFeeCollection" runat="server" ToolTip="Export to Excel" OnClick="btnFeeCollection_Click" style="width:30px;height:25px;margin-left:20px" ImageUrl="IMAGES/ICON_EX.png" /></span>
                ...
                <div class="box box-primary wrong-item item top" id="Div51">
                    ...
                    <div class="box-header with-border">
                       ...
                       <%-- <div class="box-tools pull-right">
                         ...
                         <div class="col-md-1">
                              <asp:ImageButton ID="btnyearwise" runat="server" ToolTip="Export to Excel" OnClick="btnyearwise_Click"  style="width:25px;height:20px;margin-left:-30px" ImageUrl="IMAGES/ICON_EX.png" />
...
<%--                              <asp:ImageButton ID="ImageButton1" runat="server" ToolTip="Export to Excel" OnClick="btnyearwise_Click"  style="width:25px;height:20px;margin-left:-30px" ImageUrl="IMAGES/ICON_EX.png" />
                         ...
                         <div class="col-md-4">
                              <asp:DropDownList ID="ddlbranch" runat="server" AppendDataBoundItems="true" AutoPostBack="true" OnSelectedIndexChanged="ddlbranch_SelectedIndexChanged" CssClass="form-control" >
...
<%-- <div class="col-md-6 col-sm-6 col-xs-12 san animated rubberBand beauty" id="paytotalemp" runat="server" visible="false">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12 san animated rubberBand beauty" onclick="__doPostBack('loadReport','')" id="nopaidpg" runat="server" visible="false">
                <div class="info-box bg-yellow wrong-item item bot">
                    <span class="info-box-icon"><i class="fa fa-inr"></i></span>
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number sss"><b>
                            <asp:Label ID="lblPGStudentVist" runat="server"></asp:Label></b></span>
            ...
            <div class="col-md-12 beauty" id="divcategory" runat="server">
                <div class="box box-primary wrong-item item top" id="Div42">
                    ...
                    <div class="box-header with-border">
                        ...
                        <span><asp:ImageButton ID="btncategorywise" runat="server" ToolTip="Export to Excel" OnClick="btncategorywise_Click" Style="width:30px;height:25px;margin-left:20px" ImageUrl="IMAGES/ICON_Ex.png" /></span>
               ...
               <div class="col-md-12 beauty" id="divcommegewiseadmcount" runat="server" visible="false">
                <div class="box box-primary wrong-item item top" id="Div57">
                    <div id="Div59" class="l"></div>
                    <div class="box-header with-border">
                        <i class="fa fa-pie-chart"></i>

                        <h3 class="box-title">College Wise Admission Count</h3>
                         <span> <asp:ImageButton ID="ImageButton1" runat="server" ToolTip="Export to Excel"  style="width:30px;height:25px;margin-left:20px" ImageUrl="IMAGES/ICON_EX.png" /></span>
                        <img src="../IMAGES/ICON_IMG.png" title="Download image" style="width:30px;height:25px;margin-top:-18px" onclick="javascript: PrintDivContent('ctl00_ContentPlaceHolder1_Div90');" />
                        <div class="box-tools pull-right">
                            <button type="button" class="btn btn-box-tool" data-widget="collapse">
                                <i class="fa fa-minus"></i>
                            </button>
            ...
            <div class="col-md-12 beauty" id="divBankwisedd" runat="server" visible="false">
                <div class="box box-primary wrong-item item top" id="Div46">
                    ...
                    <div class="box-header with-border">
                        ...
                        <span> <asp:ImageButton ID="btnbankwise" runat="server" ToolTip="Export to Excel" OnClick="btnbankwise_Click" Style="width:30px;height:25px;margin-left:20px" ImageUrl="IMAGES/ICON_Ex.png" /></span>
                ...
                <div class="box box-primary wrong-item item top" id="Div55">
                    ...
                    <div class="box-header with-border">
                       ...
                       <%-- <div class="box-tools pull-right">
                        ...
                        <div class="col-md-1">
                             <span> <asp:ImageButton ID="feecollection" runat="server" ToolTip="Export to Excel" OnClick="feecollection_Click" style="width:25px;height:20px;margin-left:-30px" ImageUrl="IMAGES/ICON_Ex.png" /></span>
...
<%--                            <asp:ImageButton ID="ImageButton1" runat="server" ToolTip="Export to Excel" OnClick="btnyearwise_Click"  style="width:25px;height:20px;margin-left:-30px" ImageUrl="IMAGES/ICON_EX.png" />
                        ...
                        <div class="col-md-4">
                            <asp:DropDownList ID="ddlbranchfees" runat="server" AppendDataBoundItems="true" AutoPostBack="true" OnSelectedIndexChanged="ddlbranchfees_SelectedIndexChanged" CssClass="form-control">
                                <asp:ListItem Value="0">Please Select</asp:ListItem>
                            </asp:DropDownList>
                        </div>
            ...
            <div class="col-md-12 beauty" id="Div24" runat="server" visible="false">
                <div class="box box-primary wrong-item item top" id="one101">
                    ...
                    <div class="box-header with-border">
                        ...
                        <span><asp:ImageButton ID="btnstaffdetails" runat="server" ToolTip="Export to Excel" OnClick="btnstaffdetails_Click" Style="width:30px;height:25px;margin-left:20px" ImageUrl="IMAGES/ICON_Ex.png" /></span>
                ...
                <div class="box box-primary wrong-item item top" id="one103">
                    ...
                    <div class="box-header with-border">
                        ...
                        <%--<asp:UpdatePanel ID="updpayrule" runat="server">
                                <ContentTemplate>--%>
                        <div class="col-md-2">
                             <span> <asp:ImageButton ID="btnshiftemployees" runat="server" ToolTip="Export to Excel" OnClick="btnshiftemployees_Click" style="width:25px;height:20px;margin-left:-30px" ImageUrl="IMAGES/ICON_Ex.png" /></span>
