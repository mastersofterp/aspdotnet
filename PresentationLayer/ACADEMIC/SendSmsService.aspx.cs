...
public partial class ACADEMIC_EXAMINATION_RevaluationMarkEntry : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            result = (CustomStatus)objSmsC.UpdateSmsService(objsms);
        }
        else
        {
            result = (CustomStatus)objSmsC.AddSmsService(objsms);
        }
    ...
    protected void btnAddMessageServer_Click(object sender, EventArgs e)
    {
        ...
        CustomStatus result = (CustomStatus)objSmsC.AddMsgServer(objsms);
        if (result == CustomStatus.RecordSaved)
        {
