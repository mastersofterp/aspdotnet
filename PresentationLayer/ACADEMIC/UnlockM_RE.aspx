<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="UnlockM_RE.aspx.cs" Inherits="ACADEMIC_UnlockM_RE" %>
                      ...
                      <%--      <h3 class="box-title"><b>LOCK/UNLOCK MARK ENTRY</b> </h3>--%>
                        ...
                        <div class="box-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-3 col-md-6 col-12">
                                        ...
                                        <asp:DropDownList ID="ddlSubType" runat="server" AppendDataBoundItems="True" TabIndex="7" AutoPostBack="true" OnSelectedIndexChanged="ddlSubType_SelectedIndexChanged"
                                            ...
                                            <asp:ListItem Value="4">Lab Integrated</asp:ListItem>
                                        </asp:DropDownList>
                                    ...
                                    <div class="form-group col-lg-3 col-md-6 col-12 d-none" runat="server" id="divSubExamType" visible="true">
                                        <div class="label-dynamic">
                                            <sup>* </sup>
                                    ...
                                    <div class="form-group col-lg-3 col-md-6 col-12" runat="server" id="trSubexam" visible="false">
                                     ...
                                     <div class="form-group col-lg-3 col-md-6 col-12" runat="server" id="divremark">
                                        <div class="label-dynamic">
                                            <sup>* </sup>
                                            <label>Remark</label>
                                        </div>
                                         <asp:TextBox ID="txtremark" runat="server" TextMode="MultiLine" Height="50" ValidationGroup="save"></asp:TextBox>   
                                          <asp:RequiredFieldValidator ID="rfvremark" runat="server" ControlToValidate="txtremark" Display="None" ErrorMessage="Please Enter Remark for Unlocking.."
                            ...
                            <div class="col-12 btn-footer">
                              ...
                              <%--  <asp:Button ID="btnlock" runat="server" CssClass="btn btn-primary" Text="Lock/Unlock Report" OnClick="btnlock_Click" />--%>
                                 <asp:Button ID="btnlock" runat="server" OnClick="btnlock_Click" Text="Lock/Unlock Report" ValidationGroup="save" CausesValidation="false" CssClass="btn btn-primary" />
                                    ...
                                    <asp:ListView ID="lvCourse" runat="server" Visible="false">
                                        ...
                                        <ItemTemplate>
                                            <tr id="trCurRow">
                                                ...
                                                <td>
                                                     <asp:CheckBox ID="chklock" runat="server" TabIndex="10" ToolTip='Select to Lock' Checked='<%# Convert.ToInt32(Eval("LOCK")) == 1 ? true : false  %>' Enabled='<%#(Convert.ToInt32(Eval("LOCK"))==1 ? true : false)%>' />
                                                     <asp:HiddenField ID="hidStudentId" runat="server" Value='<%# Eval("FACULTY_NO")%>' />
                                                     <asp:Label ID="lblPstudent" runat="server" Visible="false" Text='<%# Eval("COURSENAME")%>'></asp:Label>
                                                     <asp:Label ID="lblSEC" runat="server" Visible="false" Text='<%#  Eval("SECTIONNAME")%>'></asp:Label>
                                                </td>   
                                            </tr>
                                            </tr>
                                        </ItemTemplate>
