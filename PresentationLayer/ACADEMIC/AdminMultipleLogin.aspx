                                ...
                                <div class="col-lg-6 col-12" id="pnlStudent" runat="server" visible="false">
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-12">
                                            ...
                                            <asp:TextBox ID="txtSearch" runat="server" MaxLength="20" CssClass="form-control" TabIndex="1"></asp:TextBox>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-12 mt-3">
                                            <asp:Button ID="btnSearch" runat="server" Text="Search" OnClick="btnSearch_Click" ValidationGroup="studSearch" CssClass="btn btn-primary" TabIndex="1" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="text-center d-flex align-items-center">
                                                <asp:DropDownList ID="ddlPurpose" runat="server" AppendDataBoundItems="true" OnSelectedIndexChanged="ddlPurpose_SelectedIndexChanged">
                                                ...
                                                <%--<br />
                                                <font size="1">(Maximum characters: 200)<br/>You have <input readonly type="text" name="countdown" size="3" value="200"> characters left.</font>
                                               <asp:LinkButton ID="btnAddReason" runat="server" CommandArgument='<%# Eval("UA_NAME") %>' ToolTip='<%# Eval("UA_NO")%>' OnClick="btnAddReason_Click" TabIndex="1"> </asp:LinkButton>--%>

                                                <asp:Button ID="btnAddReason" runat="server" Text="Add New Purpose" CommandArgument='<%# Eval("UA_NAME") %>' CssClass="btn btn-primary ml-2"
                                        ...
                                        <td class="text-center">
                                            ...
                                            <%--<asp:ImageButton ID="btnLogin" runat="server" ImageUrl="~/Images/Login5.png" CommandArgument='<%# Eval("UA_NAME") %>'
                                                AlternateText="Login As" ToolTip='<%# Eval("UA_NO")%>' OnClick="btnLogin_Click" TabIndex="1" />--%>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                            </asp:ListView>
                    ...
                    <div class="col-12" id="dvOTP" runat="server">
                        <div class="row">
                            ...
                            <div class="col-12 text-center">
                                <asp:Button ID="btnVerifyOTP" runat="server" Text="Verify OTP" OnClick="btnVerifyOTP_Click" CssClass="btn btn-primary" />
                                <asp:Button ID="btnResndOTP" runat="server" Text="Resend OTP" OnClick="btnResndOTP_Click" CssClass="btn btn-primary" />
