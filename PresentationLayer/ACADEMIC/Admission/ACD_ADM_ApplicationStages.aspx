<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="ACD_ADM_ApplicationStages.aspx.cs" Inherits="ACADEMIC_Admission_ACD_ADM_ApplicationStages" %>
                        ...
                        <asp:Panel ID="pnlAppStages" runat="server" Visible="true">
                            <asp:ListView ID="lvApplicationStages" runat="server" Visible="true">
                                ...
                                <ItemTemplate>
                                    <tr>
                                        <td>
                                            <asp:ImageButton ID="btnEdit" runat="server" OnClick="btnEdit_Click" CommandArgument='<%# Eval("Stage_Id")%>'
                                                ImageUrl="~/Images/edit.png" />
                                        </td>
                                        <td id="participate" runat="server">
                                            <asp:Label runat="server" ID="lblStageName" Text='<%#Eval("Stage_Name") %>'></asp:Label>
                                        </td>
                                        <td>
