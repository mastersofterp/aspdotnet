                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="col-12">
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-3 col-md-6 col-12">
                                        ...
                                        <asp:DropDownList ID="ddlSession" runat="server" AppendDataBoundItems="true" Font-Bold="True" AutoPostBack="True" OnSelectedIndexChanged="ddlSession_OnSelectedIndexChanged" CssClass="form-control" data-select2-enable="true">
                                    ...
                                    <div class="form-group col-lg-3 col-md-6 col-12" id="divDegree" runat="server" style="display: none">
                                        <div class="label-dynamic">
                                            <sup>* </sup>
                                            <%--<label>Degree</label>--%>
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvDegree" runat="server" ControlToValidate="ddlDegree"
                                            Display="None" InitialValue="0" Visible="false" ErrorMessage="Please Select Degree" ValidationGroup="teacherallot">
                                        </asp:RequiredFieldValidator>

                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="ddlDegree"
                                            Display="None" InitialValue="0" Visible="false" ErrorMessage="Please Select Degree" ValidationGroup="Report">
                                        </asp:RequiredFieldValidator>
                                    </div>
                                    ...
                                    <div class="form-group col-lg-3 col-md-6 col-12" id="divBranch" runat="server" style="display: none">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvBranch" runat="server" ControlToValidate="ddlBranch"
                                            Display="None" InitialValue="0" Visible="false" ErrorMessage="Please Select Programme/Branch" ValidationGroup="Report">
                                        </asp:RequiredFieldValidator>
                                    </div>
                                    ...
                                    <div class="form-group col-lg-3 col-md-6 col-12" style="display: none">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvScheme" runat="server" ControlToValidate="ddlScheme"
                                            Display="None" InitialValue="0" Visible="false" ErrorMessage="Please Select Scheme" ValidationGroup="teacherallot">
                                        </asp:RequiredFieldValidator>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="ddlScheme"
                                            Display="None" InitialValue="0" Visible="false" ErrorMessage="Please Select Scheme" ValidationGroup="Report">
                                        </asp:RequiredFieldValidator>
                                    </div>
                                    ...
                                    <div class="form-group col-lg-3 col-md-6 col-12">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvSubjectType" runat="server" ControlToValidate="ddlSubjectType"
                                            Display="None" InitialValue="0" ErrorMessage="Please Select Course Type" ValidationGroup="teacherallot">
                                        </asp:RequiredFieldValidator>
                                    </div>
                                    ...
                                    <div class="form-group col-lg-3 col-md-6 col-12" id="divTutorial" runat="server" visible="false">
                                        ...
                                        <asp:DropDownList ID="ddlTutorial" runat="server" AppendDataBoundItems="true" ValidationGroup="teacherallot" TabIndex="6"
                                    ...
                                    <div class="form-group col-lg-3 col-md-6 col-12" id="trthprteacher" runat="server" style="display: none">
                                        <div class="label-dynamic">
                                            <sup>* </sup>
                                        ...
                                        <%-- <asp:RequiredFieldValidator ID="rfvThpr" runat="server" ControlToValidate="ddltheorypractical"
                                                Display="None" InitialValue="0" ErrorMessage="Please Select theory or practical or tutorial course" ValidationGroup="teacherallot">
                                                </asp:RequiredFieldValidator>--%>
                                    </div>
                                    <div class="form-group col-lg-3 col-md-6 col-12" id="dvBatch" runat="server" visible="false">
                                        ...
                                        <asp:DropDownList ID="ddlBatch" runat="server" AppendDataBoundItems="true" ValidationGroup="teacherallot"
                                            AutoPostBack="True" OnSelectedIndexChanged="ddlbatch_SelectedIndexChanged" CssClass="form-control" data-select2-enable="true">
                                            <asp:ListItem Value="0">Please Select</asp:ListItem>
                                        </asp:DropDownList>
                                    ...
                                    <div id="Div2" class="form-group col-lg-3 col-md-6 col-12" runat="server">
                                        ...
                                        <asp:DropDownList ID="ddladteacher" runat="server" AppendDataBoundItems="true" CssClass="form-control" data-select2-enable="true"
                            ...
                            <div class="col-12 btn-footer">
                                ...
                                <asp:Button ID="btnReport" runat="server" Text="Report" OnClick="btnReport_Click" CssClass="btn btn-info" ValidationGroup="Report" Visible="false" />
                                    ...
                                    <asp:ListView ID="lvStudents" runat="server" OnItemDataBound="lvStudents_ItemDataBound">
                                            ...
                                            <table class="table table-striped table-bordered nowrap display" style="width: 100%" id="tblStudents">
                                                <thead class="bg-light-blue">
                                                    <tr>
                                                        ...
                                                        <th>Additional Teacher[PR]
                                                        </th>
                                                        <th>Teacher Name [TU]
                                                        </th>
                                                        <th>Additional Teacher [TU]
                                                        </th>
                                                        <th>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td>
                                                    <%# Eval("ADDITIONAL_TEACHER_TH")%>
                                                </td>
                                                <td>
                                                    <%# Eval("UA_FULLNAME_PRAC")%>
                                                </td>
                                                <td>
                                                    <%# Eval("ADDITIONAL_TEACHER_PR")%>
                                                </td>
                                                <td>
                                                    <%# Eval("UA_FULLNAME_TUTR")%>
                                                </td>
                                                 <td>
                                                    <%# Eval("ADDITIONAL_TEACHER_TUTR")%>
                                                </td>
                                                <td>
                                                    <%# Eval("BATCHNAME")%>
                                                </td>
