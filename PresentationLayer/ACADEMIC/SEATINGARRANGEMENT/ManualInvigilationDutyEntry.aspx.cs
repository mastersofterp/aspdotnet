...
public partial class ACADEMIC_ManualInvigilationDutyEntry : System.Web.UI.Page
{
    ...
    private void PopulateDropDownList()
    {
        ...
        objCommon.FillDropDownList(ddlSlot, "ACD_EXAM_TT_SLOT", "SLOTNO", "SLOTNAME", "SLOTNO > 0", "SLOTNAME");
    }
    ...
    protected void BindGridview()
    {
        try
        {
            ...
            if (ds != null && ds.Tables[0].Rows.Count > 0)
            {
                ...
                {
                    string deptcode = objCommon.LookUp("acd_department", "deptcode", "DEPTNO = (SELECT UA_DEPTNO FROM user_acc WHERE UA_NO=" + Convert.ToInt32(ds.Tables[0].Rows[i]["UA_NO"].ToString()) + ")");
                    ds.Tables[0].Rows[i]["Faculty"] = ds.Tables[0].Rows[i]["Faculty"].ToString() + "(" + deptcode + ")";
                }
    ...
    protected void BindGridCount()
    {
        DataSet ds = objCommon.FillDropDown("ACD_INVIGILATION_DUTY id", "id.dayno,id.slotno", "convert(nvarchar(25),(select distinct ed.examdate from acd_exam_date ed where ed.sessionno=61 and id.dayno = ed.dayno),103)as examdate,COUNT(*) as facultycnt,(select COUNT(*) from acd_student_result sr where sr.sessionno=61 and sr.exam_registered = 1 and (sr.detaind is null or sr.detaind =0 ) and sr.courseno in (select courseno from acd_exam_date where dayno=id.dayno and sessionno = 61 )) as totstud", "id.sessionno=" + Convert.ToInt32(ddlSession.SelectedValue) + "and id.slotno="+Convert.ToInt32(ddlSlot.SelectedValue)+"group by id.dayno,id.slotno", "");
        if (ds.Tables[0].Rows.Count > 0)
        {
            pnlGrdCount.Visible = true;
            grdNoofStud.DataSource = ds;
            grdNoofStud.DataBind();
        }
        else
        {
            pnlGrdCount.Visible = false;
            grdNoofStud.DataSource = null;
            grdNoofStud.DataBind();
        }
    }
    ...
    private void Export(string type)
    {
        try
        {
            //gvInvig1.Visible = true;
            if (gvInvig.Rows.Count > 0)
            {
                for (int i = 0; i < gvInvig.Rows.Count; i++)
                {
                    CheckBox chk1 = (CheckBox)gvInvig.Rows[i].FindControl("CHK1");
                    CheckBox chk2 = (CheckBox)gvInvig.Rows[i].FindControl("CHK2");
                    CheckBox chk3 = (CheckBox)gvInvig.Rows[i].FindControl("CHK3");
                    CheckBox chk4 = (CheckBox)gvInvig.Rows[i].FindControl("CHK4");
                    CheckBox chk5 = (CheckBox)gvInvig.Rows[i].FindControl("CHK5");
                    CheckBox chk6 = (CheckBox)gvInvig.Rows[i].FindControl("CHK6");
                    CheckBox chk7 = (CheckBox)gvInvig.Rows[i].FindControl("CHK7");
                    CheckBox chk8 = (CheckBox)gvInvig.Rows[i].FindControl("CHK8");
                    CheckBox chk9 = (CheckBox)gvInvig.Rows[i].FindControl("CHK9");
                    CheckBox chk10 = (CheckBox)gvInvig.Rows[i].FindControl("CHK10");
                    CheckBox chk11 = (CheckBox)gvInvig.Rows[i].FindControl("CHK11");
                    CheckBox chk12 = (CheckBox)gvInvig.Rows[i].FindControl("CHK12");
                    CheckBox chk13 = (CheckBox)gvInvig.Rows[i].FindControl("CHK13");
                    CheckBox chk14 = (CheckBox)gvInvig.Rows[i].FindControl("CHK14");
                    CheckBox chk15 = (CheckBox)gvInvig.Rows[i].FindControl("CHK15");
                    CheckBox chk16 = (CheckBox)gvInvig.Rows[i].FindControl("CHK16");
                    CheckBox chk17 = (CheckBox)gvInvig.Rows[i].FindControl("CHK17");
                    CheckBox chk18 = (CheckBox)gvInvig.Rows[i].FindControl("CHK18");
                    CheckBox chk19 = (CheckBox)gvInvig.Rows[i].FindControl("CHK19");
                    CheckBox chk20 = (CheckBox)gvInvig.Rows[i].FindControl("CHK20");
                    CheckBox chk21 = (CheckBox)gvInvig.Rows[i].FindControl("CHK21");
                    CheckBox chk22 = (CheckBox)gvInvig.Rows[i].FindControl("CHK22");
                    CheckBox chk23 = (CheckBox)gvInvig.Rows[i].FindControl("CHK23");
                    CheckBox chk24 = (CheckBox)gvInvig.Rows[i].FindControl("CHK24");
                    CheckBox chk25 = (CheckBox)gvInvig.Rows[i].FindControl("CHK25");
                    CheckBox chk26 = (CheckBox)gvInvig.Rows[i].FindControl("CHK26");
                    CheckBox chk27 = (CheckBox)gvInvig.Rows[i].FindControl("CHK27");
                    CheckBox chk28 = (CheckBox)gvInvig.Rows[i].FindControl("CHK28");
                    CheckBox chk29 = (CheckBox)gvInvig.Rows[i].FindControl("CHK29");
                    CheckBox chk30 = (CheckBox)gvInvig.Rows[i].FindControl("CHK30");
                    CheckBox chk31 = (CheckBox)gvInvig.Rows[i].FindControl("CHK31");

                    Label lbl1 = (Label)gvInvig.Rows[i].FindControl("lblChk1");
                    Label lbl2 = (Label)gvInvig.Rows[i].FindControl("lblChk2");
                    Label lbl3 = (Label)gvInvig.Rows[i].FindControl("lblChk3");
                    Label lbl4 = (Label)gvInvig.Rows[i].FindControl("lblChk4");
                    Label lbl5 = (Label)gvInvig.Rows[i].FindControl("lblChk5");
                    Label lbl6 = (Label)gvInvig.Rows[i].FindControl("lblChk6");
                    Label lbl7 = (Label)gvInvig.Rows[i].FindControl("lblChk7");
                    Label lbl8 = (Label)gvInvig.Rows[i].FindControl("lblChk8");
                    Label lbl9 = (Label)gvInvig.Rows[i].FindControl("lblChk9");
                    Label lbl10 = (Label)gvInvig.Rows[i].FindControl("lblChk10");
                    Label lbl11 = (Label)gvInvig.Rows[i].FindControl("lblChk11");
                    Label lbl12 = (Label)gvInvig.Rows[i].FindControl("lblChk12");
                    Label lbl13 = (Label)gvInvig.Rows[i].FindControl("lblChk13");
                    Label lbl14 = (Label)gvInvig.Rows[i].FindControl("lblChk14");
                    Label lbl15 = (Label)gvInvig.Rows[i].FindControl("lblChk15");
                    Label lbl16 = (Label)gvInvig.Rows[i].FindControl("lblChk16");
                    Label lbl17 = (Label)gvInvig.Rows[i].FindControl("lblChk17");
                    Label lbl18 = (Label)gvInvig.Rows[i].FindControl("lblChk18");
                    Label lbl19 = (Label)gvInvig.Rows[i].FindControl("lblChk19");
                    Label lbl20 = (Label)gvInvig.Rows[i].FindControl("lblChk20");
                    Label lbl21 = (Label)gvInvig.Rows[i].FindControl("lblChk21");
                    Label lbl22 = (Label)gvInvig.Rows[i].FindControl("lblChk22");
                    Label lbl23 = (Label)gvInvig.Rows[i].FindControl("lblChk23");
                    Label lbl24 = (Label)gvInvig.Rows[i].FindControl("lblChk24");
                    Label lbl25 = (Label)gvInvig.Rows[i].FindControl("lblChk25");
                    Label lbl26 = (Label)gvInvig.Rows[i].FindControl("lblChk26");
                    Label lbl27 = (Label)gvInvig.Rows[i].FindControl("lblChk27");
                    Label lbl28 = (Label)gvInvig.Rows[i].FindControl("lblChk28");
                    Label lbl29 = (Label)gvInvig.Rows[i].FindControl("lblChk29");
                    Label lbl30 = (Label)gvInvig.Rows[i].FindControl("lblChk30");
                    Label lbl31 = (Label)gvInvig.Rows[i].FindControl("lblChk31");

                    if (chk1.Checked == true) { lbl1.Text = "YES"; } else { lbl1.Text = "NO"; }
                    if (chk2.Checked == true) { lbl2.Text = "YES"; } else { lbl2.Text = "NO"; }
                    if (chk3.Checked == true) { lbl3.Text = "YES"; } else { lbl3.Text = "NO"; }
                    if (chk4.Checked == true) { lbl4.Text = "YES"; } else { lbl4.Text = "NO"; }
                    if (chk5.Checked == true) { lbl5.Text = "YES"; } else { lbl5.Text = "NO"; }
                    if (chk6.Checked == true) { lbl6.Text = "YES"; } else { lbl6.Text = "NO"; }
                    if (chk7.Checked == true) { lbl7.Text = "YES"; } else { lbl7.Text = "NO"; }
                    if (chk8.Checked == true) { lbl8.Text = "YES"; } else { lbl8.Text = "NO"; }
                    if (chk9.Checked == true) { lbl9.Text = "YES"; } else { lbl9.Text = "NO"; }
                    if (chk10.Checked == true) { lbl10.Text = "YES"; } else { lbl10.Text = "NO"; }
                    if (chk11.Checked == true) { lbl11.Text = "YES"; } else { lbl11.Text = "NO"; }
                    if (chk12.Checked == true) { lbl12.Text = "YES"; } else { lbl12.Text = "NO"; }
                    if (chk13.Checked == true) { lbl13.Text = "YES"; } else { lbl13.Text = "NO"; }
                    if (chk14.Checked == true) { lbl14.Text = "YES"; } else { lbl14.Text = "NO"; }
                    if (chk15.Checked == true) { lbl15.Text = "YES"; } else { lbl15.Text = "NO"; }
                    if (chk16.Checked == true) { lbl16.Text = "YES"; } else { lbl16.Text = "NO"; }
                    if (chk17.Checked == true) { lbl17.Text = "YES"; } else { lbl17.Text = "NO"; }
                    if (chk18.Checked == true) { lbl18.Text = "YES"; } else { lbl18.Text = "NO"; }
                    if (chk19.Checked == true) { lbl19.Text = "YES"; } else { lbl19.Text = "NO"; }
                    if (chk20.Checked == true) { lbl20.Text = "YES"; } else { lbl20.Text = "NO"; }
                    if (chk21.Checked == true) { lbl21.Text = "YES"; } else { lbl21.Text = "NO"; }
                    if (chk22.Checked == true) { lbl22.Text = "YES"; } else { lbl22.Text = "NO"; }
                    if (chk23.Checked == true) { lbl23.Text = "YES"; } else { lbl23.Text = "NO"; }
                    if (chk24.Checked == true) { lbl24.Text = "YES"; } else { lbl24.Text = "NO"; }
                    if (chk25.Checked == true) { lbl25.Text = "YES"; } else { lbl25.Text = "NO"; }
                    if (chk26.Checked == true) { lbl26.Text = "YES"; } else { lbl26.Text = "NO"; }                
                    if (chk27.Checked == true) { lbl27.Text = "YES"; } else { lbl27.Text = "NO"; }
                    if (chk28.Checked == true) { lbl28.Text = "YES"; } else { lbl28.Text = "NO"; }
                    if (chk29.Checked == true) { lbl29.Text = "YES"; } else { lbl29.Text = "NO"; }
                    if (chk30.Checked == true) { lbl30.Text = "YES"; } else { lbl30.Text = "NO"; }
                    if (chk31.Checked == true) { lbl31.Text = "YES"; } else { lbl31.Text = "NO"; }

                    chk1.Visible = false; chk2.Visible = false; chk3.Visible = false; chk4.Visible = false;
                    chk5.Visible = false; chk10.Visible = false; chk15.Visible = false; chk20.Visible = false;
                    chk6.Visible = false; chk11.Visible = false; chk16.Visible = false; chk21.Visible = false;
                    chk7.Visible = false; chk12.Visible = false; chk17.Visible = false; chk22.Visible = false;
                    chk8.Visible = false; chk13.Visible = false; chk18.Visible = false; chk23.Visible = false;
                    chk9.Visible = false; chk14.Visible = false; chk19.Visible = false; chk24.Visible = false;
                    chk25.Visible = false; chk28.Visible = false; chk31.Visible = false; 
                    chk26.Visible = false; chk29.Visible = false; 
                    chk27.Visible = false; chk30.Visible = false;

                    TextBox txtTot = (TextBox)gvInvig.Rows[i].FindControl("txtTotalDays");
                    Label lblTot = (Label)gvInvig.Rows[i].FindControl("lblTotalDays");
                    lblTot.Text = txtTot.Text;
    ...
    protected void ddlSlot_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (ddlSlot.SelectedValue != "0")
        {
            string sessionno = ddlSession.SelectedValue;
            //string slot = (ddlDepartment.SelectedValue == "2" || ddlDepartment.SelectedValue == "3" || ddlDepartment.SelectedValue == "5" || ddlDepartment.SelectedValue == "6" || ddlDepartment.SelectedValue == "7" || ddlDepartment.SelectedValue == "8" || ddlDepartment.SelectedValue == "14" || ddlDepartment.SelectedValue == "15" || ddlDepartment.SelectedValue == "16" || ddlDepartment.SelectedValue == "17" ? "1,3" : "2,4");
            string dept = (ddlSlot.SelectedValue == "1" || ddlSlot.SelectedValue == "3" ? "2,3,5,6,7,8,14,15,16,17" : "1,4,9,10,11,12,13,18,19,20,21,22,23,24");
            //objCommon.FillDropDownList(ddlSlot, "ACD_EXAM_TT_SLOT", "SLOTNO", "SLOTNAME", "SLOTNO IN (" + slot + ")", "SLOTNO");
            objCommon.FillDropDownList(ddlDepartment, "ACD_DEPARTMENT", "DEPTNO", "DEPTNAME", "DEPTNO IN (" + dept + ")", "DEPTNO");
        }
        else
        {
