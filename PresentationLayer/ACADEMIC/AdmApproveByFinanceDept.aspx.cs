...
public partial class ACADEMIC_AdmApproveByFinanceDept : System.Web.UI.Page
{
    ...
    private void BindStudentListForApprove()
    {
        try
        {
            ...
            DataSet ds = objSC.GetStudentForAdmApproveByAccount(Convert.ToInt32(ddlAdmbatch.SelectedValue), Convert.ToInt32(ddlClg.SelectedValue), Convert.ToInt32(ddlDegree.SelectedValue), Convert.ToInt32(ddlBranch.SelectedValue));
    ...
    protected void ddlPayType_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        foreach (ListViewDataItem dataitem in lvStudentDetail.Items)
        {
            ...
            string Amount = objCommon.LookUp("ACD_STANDARD_FEES", "SUM(" + semester + ")", "BATCHNO=" + Convert.ToInt32(ddlAdmbatch.SelectedValue) + "AND PAYTYPENO=" + Convert.ToInt32(ddlPayType.SelectedValue) + "AND DEGREENO=" + Convert.ToInt32(ddlDegree.SelectedValue) + "AND BRANCHNO=" + Convert.ToInt32(ddlBranch.SelectedValue) + "AND COLLEGE_ID=" + Convert.ToInt32(ddlClg.SelectedValue) + "AND RECIEPT_CODE='TF'");
    ...
    private void ShowdStudentData(string reportName)
    {
        try
        {
            ...
            ds = objSC.GetNewAdmissionStudentDetailsForFinance(Convert.ToInt32(ddlAdmbatch.SelectedValue), Convert.ToInt32(ddlClg.SelectedValue), Convert.ToInt32(ddlDegree.SelectedValue), Convert.ToInt32(ddlBranch.SelectedValue));
