<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="Automatic_Payment_Update_Convocation.aspx.cs" Inherits="ACADEMIC_Automatic_Payment_Update" %>
                    ...
                    <div class="col-md-12" id="pnlSelection" runat="server">
                       ...
                       <div class="form-group col-lg-2 col-md-3 col-12">
                         ...
                         <div class="form-group col-lg-1 col-md-3 col-12">
                            ...
                            <asp:Button ID="btnStatusReport" runat="server" CssClass="btn btn-info" Text="Online Fees Transaction Log Report(Excel)" OnClick="btnStatusReport_Click" />
                        </div>
                                 </div>
                            </div>
                        <div class="row">
