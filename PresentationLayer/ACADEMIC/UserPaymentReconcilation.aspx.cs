...
public partial class ACADEMIC_UserPaymentReconcilation : System.Web.UI.Page
{
    ...
    private void ShowStudents()
    {
        try
        {           
            DataSet ds = objFees.ShowStudentsForReconcile(Convert.ToInt32(ddlAdmbatch.SelectedValue), Convert.ToInt32(ddlDegree.SelectedValue), txtAppliid.Text.Trim());
            #region Old_code commented on 20190122
            ...
            //}
            #endregion Old_code commented on 20190122
    ...
    private void ClearlvStudentListCash()
    {
        lvStudentCash.DataSource = null;
        lvStudentCash.DataBind();
        lvStudentCash.Visible = false;
    ...
    {
        //if (ddlPaymentType.SelectedValue == "0")                                          ////Commented by Irfan Shaikh 20190123
        ...
        ShowReport("Reconcile Student List", "rptStudentfeesReconcile.rpt", Convert.ToInt32(ddlDegree.SelectedValue));
    }
    ...
    private void Export()
    {
        ...
        DataSet ds = objFees.ShowStudentsByExcel(Convert.ToInt32(ddlAdmbatch.SelectedValue), Convert.ToInt32(ddlDegree.SelectedValue), txtAppliid.Text.Trim());
    ...
    private void ShowReport(string reportTitle, string rptFileName,int DegreeNo)
    {
        try
        {
            string AppId=string.Empty;
            AppId = txtAppliid.Text.Trim() == string.Empty ? string.Empty : txtAppliid.Text.Trim();
            ...
            url += "&param=@P_COLLEGE_CODE=" + Session["colcode"].ToString() + ",@P_ADMBATCH=" + Convert.ToInt32(ddlAdmbatch.SelectedValue) + ",@P_DEGREENO=" + DegreeNo + ",@P_APPLIID=" + AppId;
    ...
    {
        if (rblSelection.SelectedValue == "0")
        {
            divAdmBatch.Visible = true;
            divSearch.Visible = false;
            txtAppliid.Text = string.Empty;
            ddlAdmbatch.Enabled = true;
        }
        else
        {
