...
public partial class ACADEMIC_SeatingArrangement : System.Web.UI.Page
{
    ...
    {
        //objCommon.FillDropDownList(ddlCourse, "ACD_EXAM_DATE E INNER JOIN ACD_COURSE C ON (C.COURSENO = E.COURSENO)", "E.COURSENO", "(E.CCODE +' - ' + C.COURSE_NAME) AS COURSE", "SESSIONNO = " + ddlSession.SelectedValue + " AND EXAM_TT_TYPE=" + ddlExTTType.SelectedValue + " AND EXAMDATE = '" +Convert.TO(txtExamDate.Text) + "' AND SLOTNO = " + ddlSlot.SelectedValue + "", "COURSENO");
        BindCoursesList();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
           // int roomcapacitychk = Convert.ToInt32(objCommon.LookUp("ACD_ROOM", "ROOMCAPACITY", "ROOMNO = " + ddlRoom.SelectedValue + ""));
