                    ...
                    <tr>
                        <td style="width: 50%" valign="top">
                            <table cellpadding="2" cellspacing="2" width="100%">
                                ...
                                <tr>
                                    <%--id="TRexamname" runat="server" visible="false">--%>
                                    ...
                                    <ItemTemplate>
                                        <tr class="item" onmouseout="this.style.backgroundColor='#FFFFFF'" onmouseover="this.style.backgroundColor='#FFFFAA'">
                                            ...
                                            <td align="center">
                                                ...
                                                <%--<%# (Eval("EXAMDATE").ToString() != string.Empty) ? ((DateTime)Eval("EXAMDATE")).ToShortDateString() : Eval("EXAMDATE")%>--%>
                                            </td>
                                            <td align="right" >
                                            ...
                                            <%--<td  align="center">
                                     <asp:Label ID="lblStudCnt" runat="server" Text='<%# Eval("STUD_CNT")%>' ></asp:Label>
