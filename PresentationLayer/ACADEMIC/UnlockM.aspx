<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="UnlockM.aspx.cs" Inherits="ACADEMIC_UnlockM" %>
                        ...
                        <div class="box-body">
                            <div class="col-12">
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-3 col-md-6 col-12" runat="server" id="divSubExamType" visible="true">
                                        <div class="label-dynamic">
                                            <sup>* </sup>
                                    ...
                                    <asp:ListView ID="lvCourse" runat="server" Visible="false">
                                        ...
                                        <ItemTemplate>
                                            <tr id="trCurRow">
                                                ...
                                                <td>
                                                     <asp:CheckBox ID="chklock" runat="server" TabIndex="10" ToolTip='Select to Lock' Checked='<%# Eval("LOCK").ToString() == "True" ? true : false  %>' Enabled='<%#(Convert.ToInt32(Eval("LOCK"))==1 ? true : false)%>' />
