<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true"
    CodeFile="Student_ExamRegistration.aspx.cs" Inherits="ACADEMIC_Student_ExamRegistration" MaintainScrollPositionOnPostback="true" %>
                ...
                <div class="col-md-12 col-sm-12 col-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">EXAM FORM FILLUP</h3>
                        </div>
                        ...
                        <div class="box-body">
                            <div id="divCourses" runat="server" visible="false">
                                ...
                                <div class="col-12" id="tblInfo" runat="server" visible="false">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-12">
                                            <ul class="list-group list-group-unbordered">
                                                ...
                                                <li class="list-group-item"><b></b>
                                                    <a class="sub-label"><asp:Label ID="Label1" runat="server" Font-Bold="True"></asp:Label></a>
                                                </li>        
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12" id="divphotosign" runat="server">
                                        <div class="row">
                                            <div class="form-group col-lg-6 col-md-6 col-12">
                                                <div class=" note-div"> 
                                                    <h5 class="heading">Note</h5> 
                                                    <p><i class="fa fa-star" aria-hidden="true"></i><span> Only Passport Size Photo Allowed</span> </p>
                                                    <p><i class="fa fa-star" aria-hidden="true"></i><span> Kinldy upload Photo in JPEG or JPG format and Size should be less than 250kb.</span> </p>
                                                </div>
                                                <div class="label-dynamic">
                                                    <sup>* </sup>
                                                    <label>Photo</label>
                                            ...
                                            <div class="form-group col-lg-6 col-md-6 col-12">
                                                <div class=" note-div"> 
                                                    <h5 class="heading">Note</h5> 
                                                    <p><i class="fa fa-star" aria-hidden="true"></i><span> Kinldy upload Signature in JPEG or JPG format and Size should be less than 250kb.</span> </p>
                                                </div>
                                                <div class="label-dynamic">
                                                    <sup>* </sup>
                                    ...
                                    <asp:Panel ID="pnlFeeDetails" runat="server" >
                                        ...
                                        <div class="col-12">
                                            <asp:ListView ID="lvCurrentSubjects" runat="server">
                                                <LayoutTemplate>
                                                    <div>
                                                        <div class="sub-heading"><h5>Regular Courses</h5></div>
                                    ...
                                    <div class="col-12">
                                        <asp:ListView ID="lvBacklogSubjects" runat="server">
                                            <LayoutTemplate>
                                                <div>
                                                    <div class="sub-heading"><h5>Backlog Courses</h5></div>
                                                    <div class="col-12">
                                                        <div class="dataTables_header clearfix">
                                                            <div id="table3" class="dataTables_length" runat="server">
                                                                <label>
                                        ...
                                        <asp:ListView ID="lvReAppearedCourse" runat="server">
                                            <LayoutTemplate>
                                                <div class="vista-grid">
                                                    <div class="sub-heading"><h5>Re-Appeared Course Subjects</h5></div>
                                                    <div class="col-12">
                                                        <div class="dataTables_header clearfix">
                                                            <div id="table3" class="dataTables_length" runat="server">
                                                                <label>
                                                    ...
                                                    <table class="table table-striped table-bordered nowrap display" style="width: 100%" id="tblReAppearedSubjects">
                                                        <thead class="bg-light-blue">
                                                            <tr>
                                                                <th>
                                    ...
                                    <div class="col-12">
                                        <asp:Label ID="lblNote" runat="server" Text="Note : Examination Fees For Regular Rs. 1200 and For Backlog Papers Rs. 1000 per Semester.
                                            Please Ensure to submit the Examination Fees by Online Payment get the Exam Admit Card and to Appear in the Examination." Font-Bold="true" ForeColor="Red"></asp:Label>                                       
                                         <span style="color:red;font-weight:bold"></span>
                                    </div>

                                    <div class="col-12 btn-footer">
                                        <asp:Button ID="btnSubmit" runat="server" Text="Submit" OnClick="btnSubmit_Click"
                                            Enabled="false" ValidationGroup="SUBMIT" OnClientClick="return showConfirm();" CssClass="btn btn-primary" />
                                        ...
                                        <asp:Button ID="btnChallan" runat="server" Text="Generate Challan" CssClass="btn btn-primary" Visible="false" OnClick="btnChallan_Click" />
                                        ...
                                        <asp:Button ID="btnOnlinePayment" runat="server" Text="Online Payment"
                                            CssClass="btn btn-primary" OnClick="btnOnlinePayment_Click" Enabled="false" />
                                ...
                                <div class="col-12" id="pnlDept" runat="server" visible="False">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-3 col-md-6 col-12">
                                            ...
                                            <asp:Label ID="lblTotal" runat="server" Font-Bold="true" CssClass="form-control"></asp:Label>
                                        </div>
                                        <div class="form-group col-lg-3 col-md-6 col-12">
                                            <div class="label-dynamic">
                                                <label>Registered Student </label>
                                            </div>
                                            <asp:Label ID="lblRegistered" runat="server" Font-Bold="true" CssClass="form-control"></asp:Label>
                                        </div>
                                        <div class="form-group col-lg-3 col-md-6 col-12">
                                            <div class="label-dynamic">
                                                <label>Remaining Student </label>
                                            </div>
                                            <asp:Label ID="lblPending" runat="server" Font-Bold="true" CssClass="form-control"></asp:Label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <asp:ListView ID="lvStudent" runat="server" OnItemDataBound="lvStudent_ItemDataBound">
                                            <LayoutTemplate>
                                                <div class="sub-heading"><h5>Student List</h5></div>
                                                <div class="col-12">
                                                    <div class="dataTables_header clearfix">
                                                        <div id="table3" class="dataTables_length" runat="server">
                                                            <label>
                                                ...
                                                <table class="table table-striped table-bordered nowrap display" style="width: 100%" id="divsessionlist">
                                                    <thead class="bg-light-blue">
                                                        <tr>
                                                            ...
                                                            <th>Registration No./Student Name
                                                            </th>
                                                            <th>Course Codes
                                                            </th>
                                                            <th>Status
