...
public partial class ACADEMIC_admissionprocess : System.Web.UI.Page
{
    ...
    private void FillAllYearTable()
    {
        ...
        try
        {
            ...
            //blankCell.InnerText = string.Empty;
            //blankCell.Attributes.Add("class", "gv_colfixed");
            //headRow.Cells.Add(blankCell);
            ...
            //while (dr.Read())
            //{
            //    tbl.Rows[GetRowNo(dr["shortname"].ToString())].Cells[GetColNo(dr["category"].ToString())].InnerText = dr["total"].ToString();
            //}
            dr.Close();
    ...
    //private void ExportHtmlTableToExcel(DataTable workTable)
    //{
    ...
    //    string strBody = HtmlTable2ExcelString(tbl);
