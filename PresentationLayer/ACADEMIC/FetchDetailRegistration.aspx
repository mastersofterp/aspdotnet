            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-4 col-md-4 col-12">
                              ...
                              <div class="form-group col-lg-4 col-md-4 col-12">
                                ...
                                <asp:DropDownList ID="ddlBranch" runat="server" TabIndex="3" AppendDataBoundItems="true" AutoPostBack="true"  CssClass="form-control" data-select2-enable="true">
                                    <asp:ListItem Value="0">Please Select</asp:ListItem>
                                </asp:DropDownList>
                                  </div>
                            <div class="form-group col-lg-3 col-md-6 col-12">
                                ...
                                <asp:RadioButtonList ID="rdoStatus" runat="server" RepeatDirection="Horizontal" AutoPostBack="true" OnSelectedIndexChanged="rdoStatus_SelectedIndexChanged" TabIndex="3">
                    ...
                    <div class="col-12 btn-footer">
                        <p class="text-center">
                               <asp:Button ID="btnShowStud" runat="server" TabIndex="4" Text="Show Student List" CssClass="btn btn-primary form-group" ToolTip="Show Student" OnClick="btnShowStud_Click" ValidationGroup="stud" />
                                ...
                                <asp:Button ID="btnAdmissionCount" runat="server" TabIndex="5" Text="Admission Count Report(Excel)" CssClass="btn btn-primary form-group" OnClick="btnAdmissionCount_Click" ToolTip="Export In Excel" />
                                <asp:Button ID="btnExcel" runat="server" TabIndex="5" Text="Admission Detail Report(Excel)" CssClass="btn btn-primary form-group" ToolTip="Export In Excel" OnClick="btnExcel_Click"  ValidationGroup="stud" />
                                <asp:Button ID="btnFormFillExcel" runat="server" TabIndex="6" Text="Form Filling Status(Excel)" OnClientClick="return validateAdmissionBatch();" CssClass="btn btn-info form-group" OnClick="btnFormFillExcel_Click" />
                                <asp:Button ID="btnStudDetails" runat="server" TabIndex="7" Text="Student Complete Data(Excel)" OnClientClick="return validateProgrammeCode();" CssClass="btn btn-info form-group"  ValidationGroup="studData" OnClick="btnStudDetails_Click" />
                                ...
                                <asp:Button ID="btnExcelForeignStud" runat="server" TabIndex="10" Text="Foreign Student Registration List (Excel)" ToolTip="Export Foreign Student Registration List" CssClass="btn btn-primary form-group" OnClick="btnExcelForeignStud_Click" Style="margin-top: 10px"  OnClientClick="return validationForeignStudent();" />
                                <asp:Button ID="btnPaymentDetails" runat="server" TabIndex="10" Text="Online Payment Student Details(Excel)" ToolTip="Online Payment Student Details" CssClass="btn btn-primary form-group" Style="margin-top: 10px" OnClick="btnPaymentDetails_Click"  OnClientClick="return validateProgrammeType();" />
                                <asp:Button ID="btnConfirmStudent" runat="server" TabIndex="11" Text="Student Confirmation List(Excel)" ToolTip="Student Confirmation" CssClass="btn btn-primary form-group" Style="margin-top: 10px" OnClick="btnConfirmStudent_Click"  OnClientClick="return validateProgrammeType();" />
                                <asp:Button ID="btnDocumentList" runat="server" TabIndex="12" Text="Document List Status(Excel)" ToolTip="Document List Status"  CssClass="btn btn-primary form-group" OnClick="btnDocumentList_Click" Style="margin-top: 10px"  />
                                <asp:Button ID="btnPhd" runat="server" TabIndex="12" Text="Phd Students Complete Data(Excel)" CssClass="btn btn-primary" Style="margin-top: 10px" OnClick="btnPhd_Click" OnClientClick="return validateAdmissionBatch();"/> 
                                <asp:Button ID="btnSummaryReport" runat="server" TabIndex="13" Text="Admission Summary Report(Excel)" CssClass="btn btn-primary"  Style="margin-top: 10px" OnClick="btnSummaryReport_Click" ValidationGroup="summary" />
                                <asp:Button ID="btnMinumum" runat="server" TabIndex="14" Text="Minimum Information Report(Excel)" CssClass="btn btn-primary"  Style="margin-top: 10px" OnClick="btnMinumum_Click" ValidationGroup="summary" />
                                <asp:Button ID="btnCancel" runat="server" TabIndex="15" Text="Cancel" CssClass="btn btn-warning" ToolTip="Click to Cancel" OnClick="btnCancel_Click" style="margin-top: 10px" />                             
