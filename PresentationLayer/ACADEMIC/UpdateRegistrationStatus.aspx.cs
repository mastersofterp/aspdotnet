...
public partial class ACADEMIC_UpdateRegistrationStatus : System.Web.UI.Page
{
    ...
    protected void btnGenerateRegNo_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            //objS.IdNo = Convert.ToInt32(idno);
            ...
            if (output != "-99")
            {
                objCommon.DisplayMessage(updSelection, "Record Updated Successfully.", this.Page);
            }
            else
            {
    ...
    protected void rdoMigration_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (rdoMigration.SelectedValue == "1")
        {
            rdoRegStatus.SelectedValue = "2";
        }
        else
        {
            rdoRegStatus.SelectedValue = "1";
        }
    }
}
