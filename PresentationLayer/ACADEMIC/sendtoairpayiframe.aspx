...
<%    
    ...
    //string sAmount = Request.Form["amount"].Trim();

    string sAmount = "01.00";
    string sOrderId = Request.Form["orderid"].Trim();

    //string sRegNo = "1234";
    //string sEmail = "GANJARE.SHEKHAR@GMAIL.COM";
    //string sPhone = "9545450309";
    //string sFName = "abc";
    //string sLName = "PQR";
    //string sAddress = "NA";
    //string sCity = "NA";
    //string sState = "NA";
    //string sCountry = "NA";
    //string sPincode = "400001";
    //string sAmount = "01.00";
    //string sOrderId = "123456789";
            ...
            <tr>
                <td align="center" valign="middle">
                    <form id="Form1" action="https://payments.airpay.co.in/pay/index.php" method="post" runat="server" target="airpayiframe">
                        ...
                        <%--<input type="hidden" name="buyerRegistrationNo" value="1234" />
                        <input type="hidden" name="orderid" value="123456789" />
                        <input type="hidden" name="buyerEmail" value="GANJARE.SHEKHAR@GMAIL.COM" />
                        <input type="hidden" name="buyerPhone" value="9545450309" />
                        <input type="hidden" name="buyerFirstName" value="abc" />
                        <input type="hidden" name="buyerLastName" value="PQR" />
                        <input type="hidden" name="buyerAddress" value="NA" />
                        <input type="hidden" name="buyerCity" value="NA" />
                        <input type="hidden" name="buyerState" value="NA" />
                        <input type="hidden" name="buyerCountry" value="NA" />
                        <input type="hidden" name="buyerPinCode" value="440001" />
                        ...
                        <input type="hidden" name="amount" value="01.00" /><%--value="<%=Request.Form["amount"]%>" />--%>
