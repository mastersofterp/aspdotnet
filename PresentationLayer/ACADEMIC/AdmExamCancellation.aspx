    ...
    <table cellpadding="2" cellspacing="2" border="0" width="100%">
                ...
                <div runat="server" id="divInfo" visible="false">
                    <fieldset class="fieldset">
                        ...
                        <table cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <tr>
                                <td style="width: 20%; text-align: right;">Scheme :
                                </td>
                                <td class="form_left_text">
        ...
        <tr>
            <td colspan="2">
                ...
                <%--<asp:Repeater ID="lvSearchResults" runat="server"><HeaderTemplate><div id="listViewGrid" class="vista-grid"><div class="titlebar">Search Results:</div></div><table id="tblSearchResults" cellpadding="0" cellspacing="0" class="display" style="width: 100%;"><thead><tr class="header"><th>Select</th><th>Enroll. No.</th><th>Name</th><th>DOB</th><th>Degree</th><th>Branch</th><th>Sem.</th><th>Admission Date</th></tr><tr id="itemPlaceholder" runat="server" /><thead><tbody></HeaderTemplate><ItemTemplate><tr class="item" ><td><input id="rdoSelectRecord" name="Student" type="radio" value='<%# Eval("IDNO") %>' /></td><td><%# Eval("ENROLLMENTNO")%></td><td><%# Eval("NAME") %></td><td><%# (Eval("DOB").ToString() != string.Empty) ? ((DateTime)Eval("DOB")).ToShortDateString() : "-" %></td><td><%# Eval("CODE")%></td><td><%# Eval("SHORTNAME")%></td><td><%# Eval("SEMESTERNAME")%></td><td><%# (Eval("ADMDATE").ToString() != string.Empty) ? ((DateTime)Eval("ADMDATE")).ToShortDateString() : "-" %></td></tr></ItemTemplate><FooterTemplate></tbody></table></FooterTemplate></asp:Repeater>--%>
                
            </td>
            
        </tr>
        <tr runat="server" id="trcourse" visible="false">
            <td colspan="2"><fieldset class="fieldset"><legend class="legend">Course list</legend>
