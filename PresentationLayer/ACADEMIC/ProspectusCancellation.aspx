 ...
 <table cellpadding="2" cellspacing="2" border="0" width="100%">
        ...
        <tr>
            <td class="vista_page_title_bar" valign="top" style="height: 30px">
                PROSPECTUS RECEIPT CANCELLATION&nbsp;
...
&nbsp;&nbsp; To Date :
        ...
        <td>
            ...
            <fieldset class="fieldset">
                ...
                <%--<asp:UpdatePanel ID="updStudCan" runat="server">
                <ContentTemplate>--%>
        ...
        <td>
         ...
         <%--<input id="rdoSelectRecord" name="Student" type="radio" value='<%# Eval("PROSNO") %>' />--%> <%--<asp:RadioButton ID="btnCancel" Text="" ToolTip='<%# Eval("PROSNO") %>' runat="server" />--%>
