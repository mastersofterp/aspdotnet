                    ...
                    <fieldset class="fieldset">
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                           ...
                           <%-- <tr>
                                ...
                                <td class="form_left_text">
                                    <asp:DropDownList ID="ddlSession" runat="server" AppendDataBoundItems="True" Width="200px">
                                        <asp:ListItem Value="0">Please Select</asp:ListItem>
                                    </asp:DropDownList>
                                    <asp:RequiredFieldValidator ID="rfvSession" runat="server" ControlToValidate="ddlSession" Display="None" ErrorMessage="Please Select Session" InitialValue="0" SetFocusOnError="True" ValidationGroup="Show"></asp:RequiredFieldValidator>
                                </td>
                            </tr>--%>
                            <tr>
                                <td class="form_left_label" style="width: 148px">
                           ...
                           <%-- <tr>
                                ...
                                <td class="form_left_text">
                                    <asp:DropDownList ID="ddlSemester" runat="server" AppendDataBoundItems="True" OnSelectedIndexChanged="ddlSemester_SelectedIndexChanged" Width="200px">
                                        <asp:ListItem Value="0">Please Select</asp:ListItem>
                                    </asp:DropDownList>
                                    <asp:RequiredFieldValidator ID="rfvSemester" runat="server" ControlToValidate="ddlSemester" Display="None" ErrorMessage="Please Select Semester" InitialValue="0" SetFocusOnError="True" ValidationGroup="Show"></asp:RequiredFieldValidator>
                                </td>
                            </tr>--%>
                          <%--  <tr>
                                <td class="form_left_label">Certificate Name : </td>
                                <td class="form_left_text">
                                    <asp:DropDownList ID="ddlCert" runat="server" AppendDataBoundItems="True" AutoPostBack="True" OnSelectedIndexChanged="ddlCert_SelectedIndexChanged" Width="200px">
                                        <asp:ListItem Value="0">Please Select</asp:ListItem>
                                    </asp:DropDownList>
                                    <asp:RequiredFieldValidator ID="rfvCertificateName" runat="server" ControlToValidate="ddlCert" Display="None" ErrorMessage="Please Select Certificate Name" InitialValue="0" SetFocusOnError="True" ValidationGroup="Show"></asp:RequiredFieldValidator>
                                    <asp:RequiredFieldValidator ID="rfvCertificateNamePrint" runat="server" ControlToValidate="ddlCert" Display="None" ErrorMessage="Please Select Certificate Name" InitialValue="0" SetFocusOnError="True" ValidationGroup="Print"></asp:RequiredFieldValidator>
                                    <asp:RequiredFieldValidator ID="rfvCertificateNameSearch" runat="server" ControlToValidate="ddlCert" Display="None" ErrorMessage="Please Select Certificate Name" InitialValue="0" SetFocusOnError="True" ValidationGroup="Search"></asp:RequiredFieldValidator>
                                </td>
                            </tr>--%>
                            <tr>
