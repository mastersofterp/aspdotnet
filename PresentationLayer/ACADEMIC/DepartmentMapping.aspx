                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-3 col-md-6 col-12">
                                <%--<div class="label-dynamic">
                                 ...
                                 <div class="label-dynamic">
                                    <sup>* </sup>
                                      <label ID="lblDYDept" runat="server"> Department</label>
                        ...
                        <ContentTemplate>
                            <div class="col-12 btn-footer">
                               <%-- <asp:Button ID="btnSave" runat="server" Text="Submit" ToolTip="Submit" ValidationGroup="submit"
                                    CssClass="btn btn-primary" OnClick="btnSave_Click" OnClientClick="return getVal();" />--%>
                                        ...
                                        <table class="table table-striped table-bordered nowrap display" style="width:100%" id="divdepartmentlist">
                                            <thead>
                                                <tr class="bg-light-blue">
                                                    ...
                                                    <th>Faculty /School - Department Mapping </th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                    ...
                                    <tr>
                                        <td style="text-align: center;">
                                            <asp:ImageButton ID="btnDel" runat="server" AlternateText="Delete Record" 
                                                CommandArgument='<%# Eval("col_dept_no") %>' ImageUrl="~/Images/delete.png" 
