...
public partial class Academic_DCR_ReportUI_Crescent : System.Web.UI.Page
{
        ...
        try
        {
            if (!Page.IsPostBack)
            {
                ...
                else
                {
                    ...
                    this.objCommon.FillDropDownList(ddlPaymentMode, "ACD_PAYMENT_MODE_MAS", "PAY_MODE_CODE", "LINK_CAPTION", "LINK_CAPTION IS NOT NULL AND ISNULL(ACTIVESTATUS,0)=1 AND LINK_CAPTION <> ''", "PAY_MODE_NO");
                    ...
                    {
                        rdoShortDcrReport.Visible = true;
    ...
    protected void btnReport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (rdoDatewiseFeeCollectionReport.Checked || rdoBankwiseDDReport.Checked || rdoFeeItemwiseCollectionReport.Checked || rdoShortDcrReport.Checked)
            {
            ...
            if (rdoOutstandingReport.Checked)
            {
                //DateTime repdatefrom = Convert.ToDateTime(txtFromDate.Text.Trim());
                DateTime repdateto = Convert.ToDateTime(txtToDate.Text.Trim());
                if (repdateto > DateTime.Now)
                {
                    ShowMessage("selected date is greater than current date..");
                    return;
                }
            ...
            if ((rdofeecolother.Checked || rdoBankwiseDDReport.Checked || rdoDatewiseFeeCollectionReport.Checked || rdoFeeItemwiseCollectionReport.Checked || rdoOutstandingReport.Checked || rdoTransferReport.Checked || rdomiscregfee.Checked || rdopnbwithcheque.Checked || rdbotherbankwithcheque.Checked) && (ddlReceiptType.SelectedIndex != 0) || rdoShortDcrReport.Checked)
            {
    ...
    {
        if (rdoDatewiseFeeCollectionReport.Checked)
        {
            ...
            else
            {
                ...
                {
                    if (Convert.ToInt32(Session["OrgId"]) == 6 || Convert.ToInt32(Session["OrgId"]) == 1)
                    {
                        reportTitle = "Fee_Collection_Report";
        ...
        else if (rdoBankwiseDDReport.Checked)
        {
        ...
        else if (rdoFeeItemwiseCollectionReport.Checked)
        {
            reportTitle = "Fee_Item_Report";
            rptFileName = "FeeItemReport";
        }
        else if (rdoOutstandingReport.Checked)
        {
        ...
        else if (rdoShortDcrReport.Checked)
        {
    ...
    private DailyFeeCollectionRpt GetReportCriteria()
    {
        ...
        try
        {
            ...
            if (rdoOutstandingReport.Checked == true)
            {
    ...
    private string GetReportParameters(DailyFeeCollectionRpt dcrRpt)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                else if (rdoBankwiseDDReport.Checked == true)
                {
                    param.Append("UserName=" + Session["userfullname"].ToString());
                    param.Append(",@P_COUNTERNO=" + dcrRpt.CounterNo.ToString() + ",@P_PAYMENT_MODE=" + dcrRpt.PaymentMode);
                    param.Append(",@P_RECIEPTCODE=" + dcrRpt.ReceiptTypes + ",@P_DEGREENO=" + dcrRpt.DegreeNo.ToString());
    ...
    protected void btnExcelReport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!rdoBankwiseDDReport.Checked && ddlReceiptType.SelectedIndex == 0)
            {
                ShowMessage("Receipt type is required for this report. \\nPlease select a receipt type.");
                ddlReceiptType.Focus();
                return;
    ...
    protected void rdoOutstandingReport_CheckedChanged(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            rdoOutstandingReport.Checked = false;
    ...
    protected void rdoDatewiseFeeCollectionReport_CheckedChanged(object sender, EventArgs e)
    {
        divrectypesingle.Visible = true;
        divrectype.Visible = false;
    ...
    protected void rdoFeeItemwiseCollectionReport_CheckedChanged(object sender, EventArgs e)
    {
        divrectypesingle.Visible = true;
        divrectype.Visible = false;
        divdetailsumary.Visible = true;
    ...
    protected void btnExcelFormat2_Click(object sender, EventArgs e)
    {
        ...
        ds = objFeeControll.GetCrescentOutstandingReportExcelFormat2(outReport, Admbatch);
    ...
    protected void btnExcelFormat3_Click(object sender, EventArgs e)
    {
        ...
        int Admbatch = (ddlAdmbatch.SelectedIndex > 0) ? Convert.ToInt32(ddlAdmbatch.SelectedValue) : 0;
        DataGrid Gr = new DataGrid();
        ds = objFeeControll.GetCrescentOutstandingReportExcelFormatII(outReport, Admbatch); 
