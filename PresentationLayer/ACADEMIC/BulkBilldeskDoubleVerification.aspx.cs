...
public partial class ACADEMIC_BulkBilldeskDoubleVerification : System.Web.UI.Page
{
    ...
    
    {
        ...
        DataSet ds = objFees.GetAllLABELBULK(txtprnno.Text.Trim().ToString());
    ...
    protected void bind_listview()
    {
        //pnlSelection.Visible = false;
        pnlDetails.Visible = true;
        DataSet ds = objFees.GetAllBULK(txtprnno.Text.Trim().ToString(),ddlCode.SelectedValue);
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        {   
            ...
            DataSet ds = objCommon.FillDropDown("ACD_DCR_TEMP D  INNER JOIN ACD_SEMESTER S ON(D.SEMESTERNO = S.SEMESTERNO) INNER JOIN ACD_RECIEPT_TYPE RT ON(D.RECIEPT_CODE = RT.RECIEPT_CODE) ", "ENROLLNMENTNO", "S.SEMESTERNAME,D.RECIEPT_CODE,RECIEPT_TITLE,D.REC_NO", "ORDER_ID= '" + ViewState["ORDERID"].ToString() + "'", "");
            if (ds != null && ds.Tables[0].Rows.Count > 0)
            {
