        ...
        <tr>
            <td style="padding-left:15px;">
                <fieldset class="fieldsetPay">
                    <legend class="legendPay">Exam Course Registration Report</legend>
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <table cellpadding="2" cellspacing="2" width="90%">
                                <tr style="display: none;">
                                    <td width="200px" class="form_left_label">
                                        Term :
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="form_left_text">
                                        <asp:DropDownList ID="ddlSession" runat="server" Width="300px" AppendDataBoundItems="True"
                                            AutoPostBack="True">
                                        </asp:DropDownList>
                                ...
                                <tr>
                                    ...
                                    <td class="form_left_text">
                                        <asp:DropDownList ID="ddlCourse" runat="server" Width="300px" AppendDataBoundItems="True">
                                            <asp:ListItem Value="0">Please Select</asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                    ...
                    <table cellpadding="2" cellspacing="2" width="90%">
                        <tr>
                            ...
                            <asp:Button ID="btnShow" runat="Server" Text="Show Data" ValidationGroup="Show" OnClick="btnShow_Click" />
                                &nbsp;
                                <asp:Button ID="btnReport" runat="server" Text="Print Report" Width="80px" OnClick="btnReport_Click"
                                    ValidationGroup="Show" />
                                &nbsp;<asp:Button ID="btnConsolidateReport" runat="server" Text="Consolidate Report" 
                                    Width="120px" ValidationGroup="Show" 
                                    onclick="btnConsolidateReport_Click" />
                ...
                <asp:ListView ID="lvStudents" runat="server">
                    <LayoutTemplate>
                        <div class="vista-grid">
                            <div class="titlebar">
                                No. of Students Registered For Exam Courses</div>
