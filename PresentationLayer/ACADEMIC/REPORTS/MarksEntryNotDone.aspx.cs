...
public partial class Academic_REPORTS_MarksEntryNotDone : System.Web.UI.Page
{
    ...
    protected void btnReport2_Click(object sender, EventArgs e)
    {
        ...
        {
            DataSet ds = null;
            string Sessionnos = this.GetSessionNew();
            ...
            string sp_callValues = "" + Sessionnos + "," + Convert.ToInt32(0) + "," + Convert.ToInt32(0) + "," + Convert.ToInt32(ddlSemester.SelectedValue) + "," + ddlTest.SelectedValue.Split('-')[1].ToString() + "," + ddlSubExam.SelectedValue + "";
            ...
            else
            {
                ...
                url += "&param=@P_SESSIONNO=" + Sessionnos + ",@P_COLLEGE_ID=" + Convert.ToInt32(ViewState["college_id"]) + ",@P_COLLEGE_CODE=" + Convert.ToInt32(Session["colcode"]) + ",@P_EXAMNO=" + ddlTest.SelectedValue.Split('-')[1].ToString() + ",@P_SCHEMENO=" + Convert.ToInt32(ViewState["schemeno"]) + ",@P_SEMESTERNO=" + Convert.ToInt32(ddlSemester.SelectedValue) + ",@P_SUBEXAMTYPE=" + ddlSubExam.SelectedValue; // modified on 15-02-2020 by Vaishali
    ...
    protected void btnMarkStatus_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string sp_callValues = "" + Sessionnos + "," + Convert.ToInt32(0) + "," + Convert.ToInt32(ddlSemester.SelectedValue) + "";
    ...
    {
        {
            ...
            string sp_callValues = "" + Sessionnos + "," + Convert.ToInt32(0) + "";
    ...
    {
        {
            ...
            string sp_callValues = "" + Sessionnos + "," + Convert.ToInt32(ddlSemester.SelectedValue) + "," + 0 + "," + 0 + "," + ddlSubType.SelectedValue + "," + ddlPattern.SelectedValue + "";
