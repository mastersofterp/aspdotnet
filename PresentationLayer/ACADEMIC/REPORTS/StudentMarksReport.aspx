<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true"
    CodeFile="StudentMarksReport.aspx.cs" Inherits="ACADEMIC_REPORTS_StudentMarksReport"
    Title=" " %>
                ...
                <fieldset class="fieldset">
                    ...
                    <table style="width: 100%" cellpadding="2" cellspacing="2" width="100%">
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlSession" runat="server" Width="30%" AppendDataBoundItems="true"
                                    TabIndex="1" AutoPostBack="True" OnSelectedIndexChanged="ddlSession_SelectedIndexChanged">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlDegree" runat="server" Width="30%" AppendDataBoundItems="true"
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlBranch" runat="server" Width="30%" AppendDataBoundItems="true"
                                    TabIndex="1" AutoPostBack="True" OnSelectedIndexChanged="ddlBranch_SelectedIndexChanged">
                                    <asp:ListItem Value="0">Please Select</asp:ListItem>
                                </asp:DropDownList>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlScheme" runat="server" Width="30%" AppendDataBoundItems="true"
                                    TabIndex="1" OnSelectedIndexChanged="ddlScheme_SelectedIndexChanged" AutoPostBack="True">
                                    <asp:ListItem Value="0">Please Select</asp:ListItem>
                                </asp:DropDownList>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlSemester" runat="server" Width="30%" AppendDataBoundItems="true"
                                    TabIndex="1" AutoPostBack="true" OnSelectedIndexChanged="ddlSemester_SelectedIndexChanged">
                                    <asp:ListItem Value="0">Please Select</asp:ListItem>
                                </asp:DropDownList>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlCourse" runat="server" Width="30%" AppendDataBoundItems="true"
                                    TabIndex="1">
                                    <asp:ListItem Value="0">Please Select</asp:ListItem>
                                </asp:DropDownList>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlTest" runat="server" Width="30%" AppendDataBoundItems="true"
                                    TabIndex="2" OnSelectedIndexChanged="ddlTest_SelectedIndexChanged" AutoPostBack="True">
                                    <asp:ListItem Value="-1">Please Select</asp:ListItem>
                                    <asp:ListItem Value="1">INTERNAL EXAM</asp:ListItem>
                                    <asp:ListItem Value="2">MID SEM-TH</asp:ListItem>
                                    <asp:ListItem Value="3">END SEM-PR</asp:ListItem>
                                    <asp:ListItem Value="4">END SEM-TH</asp:ListItem>
                                    <asp:ListItem Value="5">IN-SEM MARKS</asp:ListItem>
                                    <asp:ListItem Value="6">TOTAL_PERCENT_MARKS</asp:ListItem>
                                    <asp:ListItem Value="7">GRADE MARKS</asp:ListItem>
                                    <asp:ListItem Value="8">GRADES_WITH_ATTENDANCE</asp:ListItem>
                                </asp:DropDownList>
                        ...
                        <tr>
                            ...
                            <td>
                                &nbsp;<asp:Button ID="btnReport" runat="server" Text="Report" Width="15%" 
                                    ValidationGroup="report" onclick="btnReport_Click" />
                                &nbsp;
                                <asp:Button ID="btnCancel" runat="server" Text="Cancel" Width="15%" 
