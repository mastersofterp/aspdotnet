...
public partial class ACADEMIC_REPORTS_StudentScholarshipReport : System.Web.UI.Page
{
    ...
    private void ExportinExcelforStudentScholarship()
    {
        ...
        string attachment = "attachment; filename=" + "StudentScholarshipReport_" +date+".xls";
       ...
       // DataSet dsfee = feeCntrl.Get_Student_Scholership_Report(Convert.ToInt32(ddlAdmBatch.SelectedValue), Convert.ToInt32(ddlYear.SelectedValue));   //added by saurabh  
        DataSet dsfee = feeCntrl.Get_Student_Scholership_Report(Convert.ToInt32(ddlAcdYear.SelectedValue), Convert.ToInt32(ddlYear.SelectedValue));   //added by saurabh  
    ...
    protected void btnDCRExcelReport_Click(object sender, EventArgs e)
    {
        this.ExportinExcelforStudentScholarshipDCR();
    }

    private void ExportinExcelforStudentScholarshipDCR()
    {
         DateTime date = System.DateTime.Now;
        string attachment = "attachment; filename=" + "StudentScholarshipDCRReport_"+date+".xls";
        Response.ClearContent();
        Response.AddHeader("content-disposition", attachment);
        Response.ContentType = "application/" + "ms-excel";
        StringWriter sw = new StringWriter();
        HtmlTextWriter htw = new HtmlTextWriter(sw);
        DataSet dsfee = feeCntrl.Get_Student_Scholership_DCR_Report(Convert.ToInt32(ddlAcdYear.SelectedValue), Convert.ToInt32(ddlYear.SelectedValue));
