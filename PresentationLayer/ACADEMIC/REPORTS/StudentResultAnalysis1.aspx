<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true"
    CodeFile="StudentResultAnalysis1.aspx.cs" Inherits="ACADEMIC_REPORTS_StudentResultList"
    Title="" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="padding-left: 10px; width: 99%">
                ...
                <fieldset class="fieldset">
                    <legend class="legend">Statistical Report</legend>
                        ...
                        <tr>
                            ...
                            <td class="form_left_text">
                                ...
                                <asp:RequiredFieldValidator ID="rfvBranch" runat="server" ControlToValidate="ddlBranch"
                                    Display="None" ErrorMessage="Please Select Branch" InitialValue="0"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td class="form_left_label">
