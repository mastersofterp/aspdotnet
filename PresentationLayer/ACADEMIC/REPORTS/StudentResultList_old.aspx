<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true"
    CodeFile="StudentResultList_old.aspx.cs" Inherits="ACADEMIC_REPORTS_StudentResultList"
    Title="" %>
                ...
                <fieldset class="fieldset">
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                        ...
                        <tr>
                            <td class="form_left_label">
                                Section :</td>
                            <td class="form_left_text">
                                <asp:DropDownList ID="ddlSection" runat="server" Width="120px" Enabled="False">
                                    <asp:ListItem Value="0">Please Select</asp:ListItem>
                                </asp:DropDownList>
                            </td>
                        </tr>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                        ...
                        <tr>
                            ...
                            <td class="form_left_text">
                           <asp:Button ID="btnIntermediateReport" runat="server"  Text="Intermediate Report"
                                ValidationGroup="report" Width="180px" onclick="btnIntermediateReport_Click" />
                            &nbsp;<asp:Button ID="btnTR" runat="server" OnClick="btnTR_Click" Text="Tabulation Register"
                                ValidationGroup="report" Width="180px" />
                            &nbsp;<asp:Button ID="btnTRDisplay" runat="server" OnClick="btnTRDisplay_Click" Text="Result Gazzette"
                                ValidationGroup="report" Width="180px" />
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="form_left_text">
                                ...
                                ValidationGroup="report" Width="180px" />
                                &nbsp;<asp:Button ID="btnFail" runat="server" Text="Fail Student Roll List"
                                Width="180px" onclick="btnFail_Click" />
                            
                            
                            &nbsp;<asp:Button ID="btnGradeCard" runat="server" OnClick="btnGradeCard_Click" Text="Grade Card"
                                ValidationGroup="report" Width="180px" />
