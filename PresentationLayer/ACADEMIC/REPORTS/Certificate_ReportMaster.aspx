<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="Certificate_ReportMaster.aspx.cs" Inherits="ACADEMIC_REPORTS_Certificate_ReportMaster" %>
            ...
            <div class="box box-primary">
                ...
                <div class="nav-tabs-custom col-12">
                   <%-- <ul class="nav nav-tabs mt-2" role="tablist">
                        <li class="nav-item">
                            <a id="A1" class="nav-link" runat="server" visible="false" data-toggle="tab" href="#tabLC" tabindex="1">Transfer Certificate</a>
                        </li>
                        <li class="nav-item">
                                ...
                                <asp:UpdatePanel ID="updpnlExam2" runat="server">
                                    <ContentTemplate>
                                        <div class="row">
                                            <div class="col-12 pl-0 pr-0">
                                                <div class="box-body">
                                                    <div class="col-12">
                                                      ...
                                                      <div class="col-lg-12 col-md-12 col-12" id="divmigrate" runat="server" visible="false">
                                                                <div class="row">
                                                                    <div class="form-group col-lg-4 col-md-6 col-12">
                                                                        <div class="label-dynamic">
                                                                            <sup>* </sup>
                                                                        ...
                                                                        <asp:RadioButtonList ID="rdomigrate" runat="server" RepeatDirection="Horizontal"  AutoPostBack="true" OnSelectedIndexChanged="rdomigrate_SelectedIndexChanged">
                                                                            <asp:ListItem Value="1">&nbsp;&nbsp;ERP&nbsp;</asp:ListItem>
                                                                            <asp:ListItem Value="2">&nbsp;&nbsp;Migrated</asp:ListItem>
                                                                        </asp:RadioButtonList>
                                                                    </div>
                                         ...
                                         <div class="col-lg-12 col-md-12 col-12" id="dvmigratepanel" runat="server" visible="false">
                                         <div class="row">
                                         <div class="form-group col-lg-3 col-md-6 col-12">
                                         <div class="label-dynamic">
                                              <sup>*</sup>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvdate" runat="server" ControlToValidate="txtFromDate"
                                                Display="None" ErrorMessage="Please Enter From Date" ValidationGroup="ViewReport"></asp:RequiredFieldValidator>
                                    ...
                                    <div class="form-group col-lg-3 col-md-6 col-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator26" runat="server" ControlToValidate="txtTodate"
                                                Display="None" ErrorMessage="Please Enter To Date" ValidationGroup="ViewReport"></asp:RequiredFieldValidator>
                                        ...
                                        ErrorMessage="From Date must be less than To Date."></asp:CompareValidator>--%>
                                             ...
                                             <div class="form-group col-lg-3 col-md-6 col-12">
                                                                        ...
                                                                        <asp:TextBox ID="txtexam" runat="server" CssClass="unwatermarked" MaxLength="30"></asp:TextBox>
                                                                        <asp:RequiredFieldValidator ID="rfvtxtexam" runat="server" ControlToValidate="txtexam" 
                                                                            ErrorMessage="Please Enter Examination Seat No." ValidationGroup="ViewReport" ></asp:RequiredFieldValidator>
                                                                         </div>
                                               <div class="form-group col-lg-3 col-md-6 col-12">
                                                                         <div class="label-dynamic">
                                                                            <sup>* </sup>
                                                                        ...
                                                                        <asp:TextBox ID="txtmonth" runat="server" CssClass="unwatermarked" MaxLength="17"></asp:TextBox>
                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="txtmonth" 
                                                                            ErrorMessage="Please Enter Month and Year."  ValidationGroup="ViewReport"></asp:RequiredFieldValidator>
                                                                         </div>
                                             <div class="form-group col-lg-3 col-md-6 col-12">
                                                                         <div class="label-dynamic">
                                                                            <sup>* </sup>
                                                                        ...
                                                                        <asp:TextBox ID="txtresult" runat="server" CssClass="unwatermarked" ></asp:TextBox>
                                                 <%-- onkeypress="return lettersOnly(event)"--%>
                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="txtresult" 
                                                                            ErrorMessage="Please Enter Result."  ValidationGroup="ViewReport"></asp:RequiredFieldValidator>
                                                                         </div>
                                                                </div>
                                             </div>
