                                                        ...
                                                        <div class="box box-primary">
                                                            ...
                                                            <div class="box-body">
                                                                <div class="col-12">
                                                                    ...
                                                                    <div class="col-12 btn-footer">
                                                                        <asp:Button ID="btnShowData1" runat="server" Text="Show Students" ValidationGroup="Show1" CssClass="btn btn-primary" TabIndex="5" OnClick="btnShowData1_Click" />
                                                                        <asp:Button ID="btnConfirm" runat="server" Text="Confirm" TabIndex="7" CssClass="btn btn-primary" ValidationGroup="Show1" OnClick="btnConfirm_Click" />
                                                                        <asp:Button ID="btnPrint" runat="server" TabIndex="7" Text="Print Report" CssClass="btn btn-info" OnClick="btnPrint_Click" Enabled="false" />
                                                                        <asp:Button ID="btnCancel_LC" runat="server" TabIndex="8" Text="Cancel" CssClass="btn btn-warning" OnClick="btnCancel_LC_Click" />
