...
public partial class ACADEMIC_AdmissionConfirmationReport : System.Web.UI.Page
{
    ...
    private void PopulateDropDown()
    {
        try
        {
            ...
            this.objCommon.FillDropDownList(ddlAdmBatch, "ACD_ADMBATCH", "BATCHNO", "BATCHNAME", "BATCHNO>0", "BATCHNAME DESC");
    ...
    private void BindListView()
    {
        ...
        else
        {
            ...
            objCommon.DisplayMessage(updSelection, "No Records Found.", this.Page);
        }
    }
