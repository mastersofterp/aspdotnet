...
public partial class Academic_Default : System.Web.UI.Page
{
        ...
        try
        {
            ...
            else
            {
                if (Page.Request.Params["__EVENTTARGET"] != null)
                {
                    ...
                    //else if (rbAdmonline.Checked == true)
                    //{
                    //    if (Page.Request.Params["__EVENTTARGET"].ToString().ToLower().Contains("btnsearch1"))
                    //    {
                    //        string[] arg = Page.Request.Params["__EVENTARGUMENT"].ToString().Split(',');
                    //        bindlistsearchonlineadmstud(arg[0], arg[1]);
                    //    }
                    //    if (Page.Request.Params["__EVENTTARGET"].ToString().ToLower().Contains("btncancelmodal"))
                    //    {
                    //        txtSearch.Text = string.Empty;
                    //        lvstudinfoOA.DataSource = null;

                    //        lvstudinfoOA.DataBind();
                    //        lblNoRecords.Text = string.Empty;
                    //    }
                    //}
                    else
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            //if (CheckControlToMandatory("supadmthrough") == true)
            //{
            ...
            else
            {
                ...
                string output = objSC.AddNewStudent(objS, objStud, IUEmail, objUa, USERNO, HostelType, SchType);
                if (output != "-99")
                {
                    if (rdoInstallment.SelectedValue == "1")
                    {
                        ...
                        string ret = objSC.AddInstallmentDetails(objS, "TF", InstallmentNO, Date_string);
                    }
                   ...
                   string demandTamount = objCommon.LookUp("ACD_DEMAND", "ISNULL(TOTAL_AMT,0)TOTAL_AMT", "IDNO=" + output + " AND SEMESTERNO=" + Semester + "AND RECIEPT_CODE= 'TF'" );
                    ...
                    objCommon.DisplayMessage(this.updStudent, "Student Data Saved And Demand Created for Amount  " + demandTamount + "  Successfully.Your Temporary ID No is " + output + "" + " Now you can print Admission Slip.", this.Page);
                    ...
                    // objCommon.FillDropDownList(ddlBranch, "ACD_BRANCH B ON (B.BRANCHNO = CD.BRANCHNO)", "DISTINCT CD.BRANCHNO", "B.LONGNAME", "CD.DEGREENO=" + Convert.ToInt32(ddlDegree.SelectedValue) + " AND CD.BRANCHNO > 0 AND CD.COLLEGE_ID=" + Convert.ToInt32(ddlSchool.SelectedValue), "B.LONGNAME");
                    ...
                    //if (Session["OrgId"].ToString().Equals("1"))
                    //{
                    //    linkName = "https://rcpit.mastersofterp.in/";
                    //}
                    //else if (Session["OrgId"].ToString().Equals("2"))
                    //{
                    //    linkName = "https://crescent.mastersofterp.in/";
                    //}
                    //else if (Session["OrgId"].ToString().Equals("3"))
                    //{
                    //    linkName = "https://cpukota.mastersofterp.in/";
                    //}
                    //else if (Session["OrgId"].ToString().Equals("4"))
                    //{
                    //    linkName = "https://cpuh.mastersofterp.in/";
                    //}
                    //else if (Session["OrgId"].ToString().Equals("5"))
                    //{
                    //    linkName = "https://jecrc.mastersofterp.in/";
                    //}
                    ...
                    if (USERCREATIONCONFIG == "1")
                        ...
                        if (Convert.ToInt32(Session["OrgId"]) == 1 || Convert.ToInt32(Session["OrgId"]) == 6)
                            ...
                            if (Session["Regno"].ToString() == "")
                                {
                                REGNO = Session["IDNO"].ToString();
                                }
                            else
                                {
                    ...
                    if (PARENTUSERCREATIONCONFIG == "1" && (Convert.ToInt32(Session["OrgId"]) != 1 || Convert.ToInt32(Session["OrgId"]) != 6))
                        {
                    ...
                    //{
                    //    objCommon.SendSMS(txtStudMobile.Text, "Thanks for showing interest in RCPIT. Your RCPIT Account has been created successfully! Login with Username : " + srnno + "  Password : " + "" + srnno.ToString() + " Follow this link for further process https://mnr.mastersofterp.in/" + "");
                    //}
                    ...
                    if (Convert.ToInt32(Session["OrgId"]) == 1 || Convert.ToInt32(Session["OrgId"]) == 6)
                        ...
                        StudName = objCommon.LookUp("ACD_STUDENT", "STUDNAME", "IDNO=" + Convert.ToInt32(output));
                        subject = "MIS Login Credentials";
                        message = "Dear "+ StudName +" Thanks for showing interest in " + collegeCode + ".<br/> Your Account has been created successfully!";
                        message += "</br>Login with Username : " + srnno + " and Password : " + pwd + " Follow this link for further process: " + Link + "";
                        ...
                        if (PARENTUSERCREATIONCONFIG == "1")
                            {
                            Username = objCommon.LookUp("USER_ACC", "UA_NAME", " UA_TYPE=14 AND UA_IDNO=" + Convert.ToInt32(output));
                            Password = objCommon.LookUp("USER_ACC", "UA_PWD", " UA_TYPE=14 AND UA_IDNO=" + Convert.ToInt32(output));

                            Password = clsTripleLvlEncyrpt.ThreeLevelDecrypt(Password.ToString());
                            if (Convert.ToInt32(Session["OrgId"]) == 1)
                                {
                                string mobilelink = "https://play.google.com/store/apps/details?id=com.iitms.rcpit";
                                //subject = "<p>Parent Login Credentials</p>";
                                message += "</br></br>Your Parent Account has been created Successfully!";
                                message += "</br>Login with Username : " + Username + " and Password : " + Password + " Follow link for further Process : " + mobilelink;
                                }
                            else if (Convert.ToInt32(Session["OrgId"]) == 6)
                                {

                                string mobilelink = "https://play.google.com/store/apps/details?id=com.iitms.rcpiper";
                                //subject = "<p>Parent Login Credentials.</p>";
                                message += "</br></br>Your Parent Account has been created Successfully!";
                                message += "</br>Login with Username : " + Username + " and Password : " + Password + " Follow link for further Process : " + mobilelink;
                                }
                    ...
                    else if (Convert.ToInt32(Session["OrgId"]) == 8 || Convert.ToInt32(Session["OrgId"]) == 10)
                        {
                        string Username = string.Empty;
                        string Password = string.Empty;
                        string StudName = string.Empty;
                        Username = objCommon.LookUp("USER_ACC", "UA_NAME", " UA_TYPE=2 AND UA_IDNO=" + Convert.ToInt32(output));
                        Password = objCommon.LookUp("USER_ACC", "UA_PWD", " UA_TYPE=2 AND UA_IDNO=" + Convert.ToInt32(output));
                        StudName = objCommon.LookUp("ACD_STUDENT", "STUDNAME", "IDNO=" + Convert.ToInt32(output));
                        Password = clsTripleLvlEncyrpt.ThreeLevelDecrypt(Password.ToString());

                        message = "<p> Dear " + StudName + " Thanks for showing interest in " + collegeCode + ".</p>";
                        message += "<p> Your Account has been created successfully! Login with Username : " + Username + " and Password : " + Password + " Follow this link for further process: " + Link + "</p>";
                        subject = "MIS Login Credentials";
                        }
                    else
                        {
                    ...
                    //    }
                     ...
                     objSendEmail.SendEmail(objS.EmailID, message, subject); //Calling Method
                    }
                    ...
                    if (Convert.ToInt32(Session["OrgId"]) == 16)
                        ...
                        DataSet dssms = useracc.GetSMSTemplate(0, templatename);
                        if (dssms.Tables[0].Rows.Count > 0)
                            {
                            TEMPLATE = dssms.Tables[0].Rows[0]["TEMPLATE"].ToString();
                            TemplateID = dssms.Tables[0].Rows[0]["TEM_ID"].ToString();
                            }
                        ...
                        message = message.Replace("{#var1#}", Password);
                        if (txtStudMobile.Text != string.Empty)
                            {
                            SendSMS(txtStudMobile.Text.Trim(), message, TemplateID);
                            }
                        }
                    ...
                    //else
                    //{
                    //    this.ShowReportnew("Admission_Slip_Report", "AllotmentOfferLetter.rpt", output);
                    //}
                    //this.ShowReport("Admission_Slip_Report", "rptStudentRegistrationSlip.rpt", output);
                    if (Session["OrgId"].ToString().Equals("1") || Session["OrgId"].ToString().Equals("6"))
                    {
                        ClearAllFields();
                    }
    ...
    protected void ddlDegree_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        //if (Convert.ToInt32(ddlDegree.SelectedValue) == 2)
        //{
    ...
    private void ShowReport(string reportTitle, string rptFileName, string regno)
    {
        try
        {
            ...
            //divMsg.InnerHtml += " window.open('" + url + "','" + "Admission_Slip_Report" + "','addressbar=no,menubar=no,scrollbars=1,statusbar=no,resizable=yes');";
    ...
    private void ShowReport_PRMITR(string reportTitle, string rptFileName, string regno)
        {
        try
            {
            string url = Request.Url.ToString().Substring(0, (Request.Url.ToString().ToLower().IndexOf("academic")));
            url += "Reports/commonreport.aspx?";
            url += "pagetitle=" + "Admission_Slip_Report";
            url += "&path=~,Reports,Academic," + "AllotmentOfferLetter_PRMITR.rpt";//"rptStudentRegistrationSlip.rpt";
    ...
    //        url += "Reports/commonreport.aspx?";
    //        url += "pagetitle=" + "Admission_Slip_Report";
    //        url += "&path=~,Reports,Academic," + "AllotmentOfferLetter.rpt";//"rptStudentRegistrationSlip.rpt";
    ...
    protected void btnSearch_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dsStudent != null && dsStudent.Tables.Count > 0)
        {
            if (dsStudent.Tables[0].Rows.Count > 0)
            {
                ...
                ///txtAdmCaste.Text = (dsStudent.Tables[0].Rows[0]["ADMCATEGORYNO"].ToString() == string.Empty ? string.Empty : objCommon.GetDataByIDNo(Convert.ToInt32(dsStudent.Tables[0].Rows[0]["ADMCATEGORYNO"].ToString()), "ACD_CATEGORY", "CATEGORYNO", "CATEGORY"));
                ...
                //txtBloodGrp.Text = (dsStudent.Tables[0].Rows[0]["BLOODGRPNO"].ToString() == string.Empty ? string.Empty : objCommon.GetDataByIDNo(Convert.ToInt32(dsStudent.Tables[0].Rows[0]["BLOODGRPNO"].ToString()), "ACD_BLOODGRP", "BLOODGRPNO", "BLOODGRPNAME"));
                ...
                //}
                // M.TECH CCMT ADMISSION CHANGES
                //if (ddlExamNo.SelectedValue == "7")
                //{
                //    trGetScore.Visible = true;
                //    trCCMT.Visible = true;
                //}
    ...
    protected void btnReport_Click(object sender, EventArgs e)
    {
        ...
        else if (Session["OrgId"].ToString().Equals("10") || Session["OrgId"].ToString().Equals("11") || Session["OrgId"].ToString().Equals("12"))
         {
         this.ShowReport_PRMITR("Admission_Slip_Report", "AllotmentOfferLetter_PRMITR.rpt", "0");
         }
        else
         {
         this.ShowReportnew("Admission_Slip_Report", "AllotmentOfferLetterNew.rpt", "0");
         }
    }
    ...
    //        DataSet ds = objCommon.FillDropDown("Reff", "SMSSVCID", "SMSSVCPWD,SMSProvider", "Errors>0", "Errors");
    ...
    protected void rdoHosteler_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            //if (rdoHosteler.SelectedValue.Equals("0"))

            //{
            //    rdoHosteler.Visible = true;
            //    rdbTransport.Visible = false;
    ...
    protected void rdbTransport_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            //if (rdbTransport.SelectedValue.Equals("0"))
            //{
            //    ddlHosteller.Visible = true;
    ...
    //private void bindlistsearchonlineadmstud(string category, string searchtext)
    //{

    //    StudentController objSC = new StudentController();

    //    if (rbAdmonline.Checked == true)
    //    {
    //        DataSet ds1 = objSC.RetrieveStudentOnlineadmByUsername(searchtext, category);
    //        if (ds1.Tables[0].Rows.Count > 0)
    //        {
    //            lvstudinfoOA.DataSource = ds1;
    //            lvstudinfoOA.DataBind();
    //            lblNoRecords.Text = "Total Records : " + ds1.Tables[0].Rows.Count.ToString();
    //            return;
    //        }
    //        else
    //            lblNoRecords.Text = "Total Records : 0";
            ...
            if (dsStudent != null && dsStudent.Tables.Count > 0)
                ...
                if (dsStudent.Tables[0].Rows.Count > 0)
                    ...
                    if (rdoInstallment.SelectedValue.Equals("0"))
                        ...
                        objCommon.FillDropDownList(ddlinstallmenttype, "ACD_INSTALLMENT_MASTER", "INSTALLMENT_NO", "INSTALLMENT_TYPE", "INSTALLMENT_NO>0 AND ACTIVESTATUS=1", "INSTALLMENT_NO");
    ...
    private void ShowStudentOnlineAdmDetails()
    {
        ...
        if (Session["usertype"].ToString() == "2")
        {
            ds = objSC.getstudbyUsernameOA(txtREGNo.Text);
            txtStudentName.ReadOnly = false;
            txtStudentName.Visible = true;
        }
        else
        ...
        try
            ...
            if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
                ...
                if (sendmail == 1)
                    ...
                    //message += "<p> You are shortlisted for Provisional Allotment of seat in" + "<b> " + college + " </b>" + "in" + "<b> " + Branchname + " </b>" + "You Can Pay Registration Fees using the following Link and credentials. on Following Link. </p>" + "<p> <b>" + MISLink + "</b><br/>" + "USERNAME: " + Username + "<br/>Password: " + Password + "</p>" + "<b>Registration (Provisional Admission) Fee Details:<b><br/> B.Tech. Courses: 	40000/-<br/> All Other Courses: 25000/-<br/> Hostel Booking: 	30000/-<br/> <p>The provisional admission shall be confirmed after establishing your eligibility in the qualifying exam after declaration of the result by the examining Board/University as per the schedule notified by the University. The Registration Fee (at the time of Provisional Admission) paid by you shall be adjusted in the initial fee payable at the time of admission</p>";
                    //message+= "<p>Note: Registration fee shall be adjustable against the fee payable at the time of admissions.</p>";
                    //message+= "<p>Thanks</p>";
                    //message+= "<p>Team Admissions JECRC University </p>";
                    //string message = "";
                    //message += "<table align ='centre'>";
                    //message += "<tr>";
                    //message += "<td style=align:left;> Dear </td>";
                    //message += "<td style=font-weight:bold;> : " + "" + Name + "</td>";
                    //message += "<td style=align:left;></td>";
                    //message += "<td style=font-weight:bold;></td>";
                    //message += "</tr>";
                    //message += "<tr>";
                    //message += "<td style=align:left;>You are shortlisted for Provisional Allotment of seat in" + "<b> " + college + " </b>" + "in" + "<b> " + Branchname + " </b>" + "You Can Pay Registration Fees using the following Link and credentials. on Following Link. </td>";
                    //message += "<td style=font-weight:bold;>: " + MISLink + " </td>";
                    //message += "<td style=align:left;padding-left:25px> Password:  </td>";
                    //message += "<td style=font-weight:bold;>: " + "" + Password + "</td>";
                    //message += "</tr>";
                    //message += "<tr>";
                    //message += "<td style=align:left;> ERP Link </td>";
                    //message += "<td style=font-weight:bold;>: " + "" + "Registration (Provisional Admission) Fee Details:" + "</td>";
                    //message += "<td style=align:left;padding-left:25px> B.Tech. Courses: 	40000/-</td>";
                    //message += "<td style=align:left;padding-left:25px> All Other Courses: 25000/-</td>";
                    //message += "<td style=align:left;padding-left:25px> Hostel Booking: 	30000/-</td>";
                    //message += "<td style=align:left;padding-left:25px> The provisional admission shall be confirmed after establishing your eligibility in the qualifying exam after declaration of the result by the examining Board/University as per the schedule notified by the University. The Registration Fee (at the time of Provisional Admission) paid by you shall be adjusted in the initial fee payable at the time of admission.</td>";
                    //message += "<td>You will be required to submit self attested photo copies of the following documents at the time of final admission,once the University calls for the same.</td>";

                    //message += "<td style=align:left;> Documents required at the time of Confirmation of Admission: Originals along with one set of Self attested Photocopy. </td>";
                    //message += "</tr>";
                    //message += "<tr>";
                    //message += "<td style=align:left;> JEE Mains -2022 Score Card (if appeared/ applicable)</td>";
                    //message += "<td style=align:left;> 10th Mark-sheet</td>";
                    //message += "<td style=align:left;> 12th Mark-sheet</td>";
                    //message += "<td style=align:left;> Graduation Final Year Mark-sheet (for PG Admissions)</td>";
                    //message += "<td style=align:left;> Copy of Aadhar Card (UID)</td>";
                    //message += "<td >3 Passport Size Photographs</td>";
                    //message += "</tr>";
                    //message += "<tr>";
                    //message += "<td style=align:left;> Migration Certificate</td>";
                    //message += "<td style=align:left;> Transfer Certificate</td>";
                    //message += "<td style=align:left;> Character Certificate</td>";
                    //message += "<td style=align:left;> Caste Certificate (if applicable)</td>";
                    //message += "<td style=align:left;> OBC Non Creamy layer Certificate (if applicable)</td>";
                    //message += "<td >Printout of application form (if filled online)</td>";
                    //message += "</tr>";
                    //message += "<p>In case you found ineligible for admission in the said program and denied by admission department after verification at any stage, the complete registration fee shall be refunded and admission will be cancelled";
                    //message += "<p><b>Note:</b></p>";
                    //message += "<p>1. Registration fee shall be adjusted against the fee payable at the time of admission.</p>";
                    //message += "<p>2. All the documents must be uploaded on URL: https://jecrc.mastersofterp.in/ </p>";
                    //message += "<p>3. After submission of registration fees, new user ID will be sent to your registered mail id separately.</p>";
                    //message += "<p>4. Process of fee payment: Login using above credentials in https://jecrc.mastersofterp.in/ </p>";
                    //message += "Academic Menu-->>Student Related-->>Online Payment</p>";
                    //message += "<p><b>Thanks</b></p>";
                    //message += "<p><b>Team Admissions </b></p>";
                    //message += "<p><b>JECRC University, Jaipur </b></p>";
                    string message = "";
                    message += "<p>Dear :<b>" + Name + "</b> </p>";
                    message += "<p></p>You are shortlisted for Provisional Allotment of seat in <b>" + college + "</b> in <b>" + Branchname + "</b>You Can Pay Registration Fees using the following Link and credentials. </td><p style=font-weight:bold;> " + MISLink + " </p><p>Username   : " + Username + " <br/>Password: " + Password + "</p><p style=font-weight:bold;>Registration (Provisional Admission) Fee Details:</p><p>B.Tech. Courses: 	40000/-<br/>All Other Courses: 25000/-<br/>Hostel Booking: 30000/-</p><p>The provisional admission shall be confirmed after establishing your eligibility in the qualifying exam after declaration of the result by the examining Board/University as per the schedule notified by the University. The Registration Fee (at the time of Provisional Admission) paid by you shall be adjusted in the initial fee payable at the time of admission.</p><p>You will be required to submit self attested photo copies of the following documents at the time of final admission,once the University calls for the same.</p><p style=color:blue;>Documents required at the time of Confirmation of Admission: Originals along with one set of Self attested Photocopy.</p>";
                    message += " <table style='border: 1px solid black;border-collapse: collapse;'>";
                    message += " <tr >";
                    message += " <td style='border: 1px solid black;'>";
                    message += "JEE Mains -2022 Score Card (if appeared/ applicable)</td>";
                    message += "<td style='border: 1px solid black;'> Migration Certificate</td></tr>";
                    message += " <tr style='border: 1px solid black;'><td style='border: 1px solid black;'> 10th Mark-sheet</td> <td style='border: 1px solid black;'> Transfer Certificate</td> </tr>";
                    ...
                    message += "<p>In case you found ineligible for admission in the said program and denied by admission department after verification at any stage, the complete registration fee shall be refunded and admission will be cancelled.</p><p><b>Note:</b><br/></p>";
                    message += "<p>1.Registration fee shall be adjusted against the fee payable at the time of admission.<br/>";
                    ...
                    message += "4.Process of fee payment: Login using above credentials in <b> " + MISLink + "</b> Academic Menu-->>Student Related-->>Online Payment.<br/>";
                    message += "5.The fee payment should be made within 7 days of receiving this mail/letter.</p>";
    ...
    protected void CreateUser(string student_Name, string RRNO, string Email)
    {
        try
        {
            ...
            else if (Convert.ToInt32(Session["OrgId"].ToString()) == 5)
            {
            ...
            else if (Convert.ToInt32(Session["OrgId"].ToString()) == 8 || Convert.ToInt32(Session["OrgId"].ToString()) == 10)//Condition for MIT and PRMITR as per Ticket no 46190
                {
                IDNO = Convert.ToInt32(Session["IDNO"]);
                string Username = string.Empty;
                string Password = string.Empty;
                ...
                UA_PWD = clsTripleLvlEncyrpt.ThreeLevelEncrypt(Regno);
                UA_ACC = "0,500,76";              
                }
            else
            {
                IDNO = Convert.ToInt32(Session["IDNO"]);
                UA_PWD = clsTripleLvlEncyrpt.ThreeLevelEncrypt(RRNO.ToString());
                UA_ACC = "0,500,76";
                //RRNO = IDNO.ToString();
            }
    ...
    protected void CreateUserRCPITPIPER( string USERNAME,string PASSWORD, string EMAIL,string student_Name)
        ...
        try
            ...
            int IDNO = 0;
                ...
                UA_ACC = "0,500,76";
                IDNO = Convert.ToInt32(Session["IDNO"]);
                CreateUser_RCPITPIPER(USERNAME, UA_PWD, student_Name, EMAIL, UA_ACC, IDNO, PARENT_USERNAME, PARENT_PASS);
            }
        catch (Exception ex)
            {
            throw;
    ...
    public int CreateUser_RCPITPIPER(string UA_NAME, string UA_PWD, string UA_FULLNAME, string UA_EMAIL, string UA_ACC, int IDNO, string PARENT_USERNAME, string PARENT_PASS)
        {
        int retStatus = 0;
        try
            {
            ...
            object ret = objSQLHelper.ExecuteNonQuerySP("PKG_ACD_USER_CREATION_OA_RCPIT_PIPER", objParams, true);
