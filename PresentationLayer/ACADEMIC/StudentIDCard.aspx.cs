...
public partial class Academic_StudentIDCard : System.Web.UI.Page
{
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {           
                ...
                ds = studCont.GetStudentListForIdentityCard(degreeno, branchno, semesterno, college_id);
    ...
    protected void BindListView()
    {
        try
        {
            ...
            DataSet ds = studCont.GetStudentListForIdentityCard(degreeno, branchno, semesterno, college_id);
            if (ds != null && ds.Tables.Count > 0)
            {
                lvStudentRecords.DataSource = ds.Tables[0];
                lvStudentRecords.DataBind();
