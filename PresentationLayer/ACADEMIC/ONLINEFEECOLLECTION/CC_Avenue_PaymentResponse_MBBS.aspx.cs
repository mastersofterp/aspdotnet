    ...
    protected void Page_Load(object sender, EventArgs e)
        ...
        if (!IsPostBack)
            ...
            try
                ...
                DataSet dscon = objFees.GetOnlinePaymentConfigurationDetails_WithDegree(Convert.ToInt32(OrganizationID), 0, Convert.ToInt32(Session["payactivityno"]), degreeno, 1);
