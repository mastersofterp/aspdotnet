...
public partial class ccavEventRequest : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["studName"] != null)
        {
            ...
            //data.Add("redirect_url", "https://makauttest.mastersofterp.in/ACADEMIC/ONLINEFEECOLLECTION/ccavEventResponse.aspx");   //Responsne Url Local
            //data.Add("cancel_url", "https://makauttest.mastersofterp.in/ACADEMIC/ONLINEFEECOLLECTION/ccavEventResponse.aspx");	   //Responsne Url Local
            //data.Add("redirect_url", "http://localhost:63344/PresentationLayer/ACADEMIC/ONLINEFEECOLLECTION/ccavEventResponse.aspx");   //Responsne Url Local
            //data.Add("cancel_url", "http://localhost:63344/PresentationLayer/ACADEMIC/ONLINEFEECOLLECTION/ccavEventResponse.aspx");	   //Responsne Url Local
            data.Add("redirect_url", "https://makaut.mastersofterp.in/ACADEMIC/ONLINEFEECOLLECTION/ccavEventResponse.aspx");   //Responsne Url Live
            data.Add("cancel_url", "https://makaut.mastersofterp.in/ACADEMIC/ONLINEFEECOLLECTION/ccavEventResponse.aspx");	   //Responsne Url Live
            ...
            data.Add("merchant_param5", Participant);
            //data.Add("promo_code", "");
            //data.Add("customer_identifier", userno);
            data.Add("offer_type", TitleId);
            data.Add("offer_code", TitleId);
            data.Add("eci_value", TitleId);
            data.Add("billing_notes", TitleId);
