...
public partial class ccavExamRequest : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["studName"] != null)
        {
            ...
            //data.Add("redirect_url", "https://makauttest.mastersofterp.in/ACADEMIC/ONLINEFEECOLLECTION/ccavExamResponse.aspx");   //Responsne Url Local
            //data.Add("cancel_url", "https://makauttest.mastersofterp.in/ACADEMIC/ONLINEFEECOLLECTION/ccavExamResponse.aspx");	   //Responsne Url Local
            data.Add("redirect_url", "http://localhost:62778/PresentationLayer/ACADEMIC/ONLINEFEECOLLECTION/ccavExamResponse.aspx");   //Responsne Url Local
            data.Add("cancel_url", "http://localhost:62778/PresentationLayer/ACADEMIC/ONLINEFEECOLLECTION/ccavExamResponse.aspx");	   //Responsne Url Local
            //data.Add("redirect_url", "https://makaut.mastersofterp.in/ACADEMIC/ONLINEFEECOLLECTION/ccavExamResponse.aspx");   //Responsne Url Live
            //data.Add("cancel_url", "https://makaut.mastersofterp.in/ACADEMIC/ONLINEFEECOLLECTION/ccavExamResponse.aspx");	   //Responsne Url Live
