<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ccavEventResponse.aspx.cs" Inherits="ccavEventResponse" %>
                        ...
                        <div class="box box-warning">
                            <div class="box-header">
                                <div class="col-md-2 col-xs-6">
                                    <img src='<%=ResolveUrl("~/imgnew1/MAKAUAT_LOGO.png")%>' class="img-responsive"/>
                                </div>
                            ...
                            <div class="box-body">
                                <div class="well col-xs-12 col-sm-12 col-md-12 ">
                                    <div class="">
                                        <h4 style="text-align:center">Event Registration Payment</h4>
                                                ...
                                                &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                                                    <div class="input-group-btn">
                                                        <asp:LinkButton ID="LinkButton2" runat="server"
                                                            ...
                                                            href="https://makaut.mastersofterp.in"><i class="fa fa-home" ></i> HOME PAGE</a></asp:LinkButton>
                                                    </div>
