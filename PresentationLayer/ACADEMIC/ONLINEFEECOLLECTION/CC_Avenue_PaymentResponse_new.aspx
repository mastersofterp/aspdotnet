<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CC_Avenue_PaymentResponse_new.aspx.cs" Inherits="CC_Avenue_PaymentResponse" %>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 btn-footer">
                                        <h4>
                                            ...
                                            <asp:Label ID="lblErrorLog" runat="server" style="display:none;"></asp:Label>
                                        </h4>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-12">
                                        <ul class="list-group list-group-unbordered">
                                            ...
                                            <asp:Label ID="lblmessage" runat="server" Font-Bold="true"></asp:Label>
                                              <asp:Label ID="lblResponse" runat="server" Font-Bold="true"></asp:Label>
                                              <asp:Label ID="lblErrormsg" runat="server" Font-Bold="true"></asp:Label>
                                            <asp:Label ID="Label1" runat="server" Font-Bold="true"></asp:Label>
                                            <asp:Label ID="lblwork1" runat="server" Font-Bold="true"></asp:Label>
                                            <asp:Label ID="Label2" runat="server" Font-Bold="true"></asp:Label>
                                            <asp:Label ID="lblwork2" runat="server" Font-Bold="true"></asp:Label>
                                            <asp:Label ID="Label3" runat="server" Font-Bold="true"></asp:Label>
                                            <asp:Label ID="lblwork3" runat="server" Font-Bold="true"></asp:Label>
                                              <asp:Label ID="Label4" runat="server" Font-Bold="true"></asp:Label>
                                            <asp:Label ID="lblwork4" runat="server" Font-Bold="true"></asp:Label>
                                            <asp:Label ID="Label5" runat="server" Font-Bold="true"></asp:Label>
                                            <asp:Label ID="lblwork5" runat="server" Font-Bold="true"></asp:Label>
