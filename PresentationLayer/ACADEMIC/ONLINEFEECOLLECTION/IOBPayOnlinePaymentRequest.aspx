<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IOBPayOnlinePaymentRequest.aspx.cs" Inherits="IOBPayOnlinePaymentRequest" %>
...
<%--<body onload="goBackOrClose();"> method="post" action="https://testapp.iobnet.org/iobpay/apitxninit.do"   --%>
<body>

    <form id="form1" runat="server" method="post" action="https://testapp.iobnet.org/iobpay/apitxninit.do">
