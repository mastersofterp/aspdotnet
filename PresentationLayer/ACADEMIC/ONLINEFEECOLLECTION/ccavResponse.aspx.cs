...
public partial class ccavResponse1 : System.Web.UI.Page
{
    #region class
            ...
            try
            {
                ...
                ldlresponceHandling.Text = payId;
                    if (StatusF == "Success")
                    {
                        ...
                        int output = objFees.InsertOnlinePayment_DCR(Idno, recipt, payId, transid, PaymentMode, CashBook, amount, StatusF, Regno, "");
