...
public partial class ACADEMIC_ONLINEFEECOLLECTION_OmniwareOnlinePaymentResponse_Split : System.Web.UI.Page
{
    #region class
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            try
            {
                ...
                ViewState["saltkey"] = ds1.Tables[0].Rows[0]["CHECKSUM_KEY"].ToString();
