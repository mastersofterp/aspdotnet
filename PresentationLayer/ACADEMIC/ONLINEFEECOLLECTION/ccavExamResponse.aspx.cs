...
public partial class ccavExamResponse : System.Web.UI.Page
{
    #region class
            ...
            try
            {
                ...
                ldlresponceHandling.Text = payId;
                    if (StatusF == "Success")
                    {
                        ...
                        int output = objFees.InsertExamPayment_DCR(Idno, recipt, payId, transid, PaymentMode, CashBook, amount, StatusF, Regno);
