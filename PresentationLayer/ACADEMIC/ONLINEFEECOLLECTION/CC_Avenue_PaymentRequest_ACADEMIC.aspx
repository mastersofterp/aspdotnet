<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CC_Avenue_PaymentRequest_ACADEMIC.aspx.cs" Inherits="CC_Avenue_PaymentRequest" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function showConfirm() {
            ...
            //alert(message)
            //form1.action ="http://localhost:61905/PresentationLayer/ACADEMIC/Backlog_ExamRegistration_CC.aspx?pageno=2949";
