<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="DoubleVerification.aspx.cs" Inherits="ACADEMIC_ONLINEFEECOLLECTION_DoubleVerification" %>
                            ...
                            <div id="pnlDetails" runat="server" visible="true">
                                <div id="dvContents" class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-6 col-12">
                                            <ul class="list-group list-group-unbordered">
                                                <li class="list-group-item"><b>Merchant ID :</b>
                                                    <a class="sub-label">
                                        ...
                                        <div class="col-12 btn-footer mt-3">
                                            <asp:Button ID="btnhomered" runat="server" CssClass="btn btn-primary" Text="Go Back" ForeColor="White" OnClick="btnhomered_Click" />

                                            <input id="btnPrint" type="button" value="Print" class="btn btn-info" onclick="PrintDiv();" class="Printbutton" />
