...
public partial class ccavInstallmentRequest : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["studName"] != null)
        {
            ...
            string installno = Session["installno"].ToString();
            ...
            //data.Add("redirect_url", "https://makauttest.mastersofterp.in/ACADEMIC/ONLINEFEECOLLECTION/ccavInstallmentResponse.aspx");   //Responsne Url Local
            //data.Add("cancel_url", "https://makauttest.mastersofterp.in/ACADEMIC/ONLINEFEECOLLECTION/ccavInstallmentResponse.aspx");	   //Responsne Url Local
            //data.Add("redirect_url", "http://localhost:56740/PresentationLayer/ACADEMIC/ONLINEFEECOLLECTION/ccavInstallmentResponse.aspx");   //Responsne Url Local
            //data.Add("cancel_url", "http://localhost:56740/PresentationLayer/ACADEMIC/ONLINEFEECOLLECTION/ccavInstallmentResponse.aspx");	   //Responsne Url Local
            data.Add("redirect_url", "https://makaut.mastersofterp.in/ACADEMIC/ONLINEFEECOLLECTION/ccavInstallmentResponse.aspx");   //Responsne Url Live
            data.Add("cancel_url", "https://makaut.mastersofterp.in/ACADEMIC/ONLINEFEECOLLECTION/ccavInstallmentResponse.aspx");	   //Responsne Url Live
