<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="CashFreeDoubleVerification.aspx.cs" Inherits="ACADEMIC_ONLINEFEECOLLECTION_CashFreeDoubleVerification" %>
                            ...
                            <div class="col-md-12" id="pnlSelection" runat="server" visible="false">
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-3 col-12">
                                        ...
                                        <asp:Button ID="btnSubmit" runat="server" OnClick="btnSubmit_Click" CssClass="btn btn-info" Text="Show" ValidationGroup="Submit" />
