...
public partial class CashFreeBilldeskOnlinePaymentRequest : System.Web.UI.Page
{
    #region class
    ...
    Reprocess:
        ...
        {
            result = objFees.InsertInstallmentOnlinePayment_TempDCR(Convert.ToInt32(Idno), Convert.ToInt32(Session["demandno"]), Convert.ToInt32(Session["paysemester"]), refno, Convert.ToDouble(amount), Convert.ToString(Session["ReceiptType"]), Convert.ToInt32(Session["userno"]), "");
        }
        else
        {
        ...
        if (result > 0)
        {
            ...
            {
                string secret = Convert.ToString(ViewState["SecurityId"]);
                string data = "";
                ...
                formParams.Add("customerName", "Roshan");
                formParams.Add("customerPhone", "9503244325");
                formParams.Add("customerEmail", "patilroshan874@gmail.com");
                ...
                outputHTML += "<form id='redirectForm' method='post' action='" + ViewState["RequestUrl"] + "'>";
                ...
                outputHTML += "<input type='hidden' name='customerName' value='" + "Roshan" + "'/>";
                outputHTML += "<input type='hidden' name='customerEmail' value='" + "patilroshan874@gmail.com" + "'/>";
                outputHTML += "<input type='hidden' name='customerPhone' value='" + "9503244325" + "'/>";
