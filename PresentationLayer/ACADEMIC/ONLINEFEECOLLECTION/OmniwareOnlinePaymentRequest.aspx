<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OmniwareOnlinePaymentRequest.aspx.cs" Inherits="ACADEMIC_ONLINEFEECOLLECTION_OmniwareOnlinePaymentRequest" %>
...
<body>
    ...
    <form id="form1" runat="server" method="post">
        ...
        <asp:TextBox ID="udf5" runat="server" Style="display: none" />

        <asp:TextBox ID="lblmerchantkey" runat="server" Style="display: none" />
        <asp:TextBox ID="lblcity" runat="server" Style="display: none" />
        <asp:TextBox ID="lblcountry" runat="server" Style="display: none" />
        <asp:TextBox ID="lblcurrency" runat="server" Style="display: none" />
        <asp:TextBox ID="lbldescription" runat="server" Style="display: none" />
        <asp:TextBox ID="lblmode" runat="server" Style="display: none" />
        <asp:TextBox ID="lblorder_id" runat="server" Style="display: none" />
        <asp:TextBox ID="lblstate" runat="server" Style="display: none" />
        <asp:TextBox ID="lblzipcode" runat="server" Style="display: none" />
     <%--   
        <asp:TextBox ID="udf4" runat="server" Style="display: none" />
        
        <asp:TextBox ID="udf6" runat="server" Style="display: none" />--%>

         
        <asp:TextBox ID="service_provider" runat="server" Text="Omniware_paisa" Style="display: none" />
        <div class="container">
            <div class="row">
