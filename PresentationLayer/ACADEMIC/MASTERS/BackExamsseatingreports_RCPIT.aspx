<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BackExamsseatingreports_RCPIT.aspx.cs"
    MasterPageFile="~/SiteMasterPage.master" Inherits="examseatingreports" Title="" ViewStateEncryptionMode="Always" EnableViewStateMac="true" %>
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            ...
                            <h3 class="box-title">
                                ...
                                <asp:Label ID="lblRoom" runat="server">BACKDATE SEATING ARRANGEMENT REPORT</asp:Label>
                            </h3>
                        ...
                        <div class="box-body" style="margin-top: -20px;">
                            ...
                            <div class="form-group col-md-12 mr-top-auto">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-3 col-md-6 col-12">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvColleges" runat="server" ControlToValidate="ddlCollege"
                            ...
                            <div class="box-footer" style="margin-top: -40px;">
                                <p class="text-center">
                                    ...
                                    CssClass="btn btn-primary" OnClick="btnQPReportView_Click" />--%><%--<asp:Button ID="btnQPReportExcel" runat="server" Text="Question Paper Report Excel" ValidationGroup="Submit"
