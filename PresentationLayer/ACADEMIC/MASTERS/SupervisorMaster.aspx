<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true"
    CodeFile="SupervisorMaster.aspx.cs" Inherits="ACADEMIC_MASTERS_SupervisorMaster" Title="" %>
                ...
                <div class="col-md-12 col-sm-12 col-12">
                    <div class="box box-primary">
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title">PHD SUPERVISOR MASTER</h3>
                        </div>
                        ...
                        <div class="box-body">
                            <div class="col-12">
                                <div class="row">
                                    <div class="form-group col-lg-3 col-md-6 col-12">
                                        ...
                                        <asp:TextBox ID="txtSupervisorName" runat="server" MaxLength="50" CssClass="form-control"
                                            ToolTip="Please Enter Supervisor Name" />
                                        <asp:RequiredFieldValidator ID="rfvSuperVisorName" runat="server" ControlToValidate="txtSupervisorName"
                                            Display="None" ErrorMessage="Please Enter Supervisor Name" ValidationGroup="submit"
                                    ...
                                    <div class="form-group col-lg-3 col-md-6 col-12">
                                        ...
                                        <asp:DropDownList ID="ddlType" runat="server" CssClass="form-control" data-select2-enable="true"
                            ...
                            <div class="col-12 btn-footer">
                                ...
                                <asp:Button ID="btnShowReport" runat="server" CausesValidation="False" OnClick="btnShowReport_Click"
                                    Text="Report" ToolTip="Show Report" CssClass="btn btn-info" />
                            ...
                            <div class="col-12">
                                <asp:Panel ID="Panel1" runat="server" ScrollBars="Auto">
                                    <asp:Repeater ID="lvSupervisorName" runat="server">
                                        <HeaderTemplate>
                                            <div class="sub-heading">
                                                <h5>Supervisor Name List</h5>
                                            </div>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                <td>
                                                    <asp:ImageButton ID="btnEdit" runat="server" ImageUrl="~/Images/edit.png" CommandArgument='<%# Eval("SUPERVISORNO") %>'
