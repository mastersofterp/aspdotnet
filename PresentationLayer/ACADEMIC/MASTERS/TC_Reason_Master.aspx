<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="TC_Reason_Master.aspx.cs" Inherits="ACADEMIC_MASTERS_TC_Reason_Master" %>
                            ...
                            <div class="col-12">
                                <div class="row">
                                    <div class="form-group col-lg-3 col-md-6 col-12">
                                        ...
                                        <asp:TextBox ID="txtReason" runat="server" AutoComplete="off" CssClass="form-control" TabIndex="1" MaxLength="200"
                                            ToolTip="Please Enter Reason" placeholder="Enter Reason" />
                                        <asp:RequiredFieldValidator ID="rfvReason" runat="server" SetFocusOnError="True"
                                            ErrorMessage="Please Enter Reason" ControlToValidate="txtReason"
                                            Display="None" ValidationGroup="submit" />
                                        <ajaxToolKit:FilteredTextBoxExtender ID="FilteredTextBoxExtender45" runat="server" TargetControlID="txtReason" FilterMode="InvalidChars"
