<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Examsseatingreports_RCPIT_JECRC.aspx.cs"
                                                ...
                                                <ul class="list-group list-group-unbordered">
                                                    <li class="list-group-item pl-md-0 pr-md-0"><b>Seating Plan:</b>
                                                        <a class="sub-label">
                                                            ...
                                                            <asp:RadioButton ID="rdbTriple" runat="server" AutoPostBack="true" Text="Triple" GroupName="SeatingPlan" OnCheckedChanged="RadioButton3_CheckedChanged"/>&nbsp;&nbsp;
                                                        </a>
                                                    </li>
                                                </ul>
