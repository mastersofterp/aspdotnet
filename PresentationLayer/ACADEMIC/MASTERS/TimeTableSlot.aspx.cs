...
public partial class ACADEMIC_MASTERS_TimeTableSlot : System.Web.UI.Page
{
    ...
    private void LoadSlot()
    {
        try
        {
            DataSet ds = objCommon.FillDropDown("ACD_EXAM_TT_SLOT", "SLOTNO", "SLOTNAME,TIMEFROM,TIMETO,(CASE CAST(EXAMTYPE AS NVARCHAR(5)) WHEN 1 THEN 'MID SEM TIME TABLE' WHEN 2 THEN 'END SEM TIME TABLE' ELSE '' END) EXAM_TYPE", "SLOTNO>0", "SLOTNO DESC");
