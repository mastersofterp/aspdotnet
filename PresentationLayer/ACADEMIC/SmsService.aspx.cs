...
//        static string smsConstring = System.Configuration.ConfigurationManager.ConnectionStrings["SMSCONSTRING"].ConnectionString;
        ...
        //protected void btnTemplateSubmit_Click(object sender, EventArgs e)
        //{
        //    objsms.Smscode = txtSmsCode.Text;
        //    objsms.Template = txtTemplate.Text;
        //    objsms.V1 = txtV1.Text == string.Empty ? "" : txtV1.Text;
        //    objsms.V2 = txtV2.Text == string.Empty ? "" : txtV2.Text;
        //    objsms.V3 = txtV3.Text == string.Empty ? "" : txtV3.Text;
        //    objsms.V4 = txtV4.Text == string.Empty ? "" : txtV4.Text;
        //    objsms.V5 = txtV5.Text == string.Empty ? "" : txtV5.Text;
        //    objsms.V6 = txtV6.Text == string.Empty ? "" : txtV6.Text;
        //    objsms.V7 = txtV7.Text == string.Empty ? "" : txtV7.Text;
        //    objsms.V8 = txtV8.Text == string.Empty ? "" : txtV8.Text;
        //    objsms.V9 = txtV9.Text == string.Empty ? "" : txtV9.Text;
        //    objsms.V10 = txtV10.Text == string.Empty ? "" : txtV10.Text;
        //    objsms.PareCount = Convert.ToInt32(txtParaCount.Text);

        //    CustomStatus_sms result = (CustomStatus_sms)objSmsC.AddSmsTemplate(objsms);
        //    if (result == CustomStatus_sms.RecordSaved)
        //    {
        //        objCommon.DisplayMessage("Sms Template Added Successfully!", this.Page);
        //    }
        //    this.BindSmsTemplate();
        //}

        //public void BindSmsTemplate()
        //{
        //    DataSet ds = objCommon.FillDropDown("SMS_TEMPLATE_MASTER", "TEMPLETEID, SMSCODE", "TEMPLATE, PARAMETER_COUNT", "", "");
        //    lvSmsTemplate.DataSource = ds;
        ...
        //protected void txtParaCount_TextChanged(object sender, EventArgs e)
        //{
        //    if (txtParaCount.Text != string.Empty)
        //    {
        //        int count = Convert.ToInt32(txtParaCount.Text);
        ...
        //        if (count > 10)
        //        {
        //            objCommon.DisplayMessage("Please Enter Parameter count between 1 to 10", this.Page);
        //        }
        //    }
        //}
