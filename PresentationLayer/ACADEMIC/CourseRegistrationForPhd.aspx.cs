...
public partial class ACADEMIC_CourseRegistration : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        //if (rbPaymentStatus.SelectedIndex == 0)
        //{
        ...
        //        //objCommon.DisplayMessage("Chalan Reconcile this student", this.Page);
        //    }
        //    else
        //    {
        //        //objCommon.DisplayMessage("Please paid the Fees", this.Page);
        //    }
        //}
               ...
               if (ret > 0)
                 {
                   //SEMESTER PROMOTION FOR SELECTED STUDENT
                    ...
                    //objSReg.UpdateSemesterProAddPromotionNo(studentIDs, currentSemesterNo);
                     }
    ...
    protected void rbYes_CheckedChanged(object sender, EventArgs e)
    {
        ...
        //DataSet dsCurrCourses = objCommon.FillDropDown("ACD_COURSE C INNER JOIN ACD_SUBJECTTYPE S ON (C.SUBID = S.SUBID) LEFT OUTER JOIN ACD_STUDENT_RESULT SR ON (SR.COURSENO = C.COURSENO AND SR.SESSIONNO = " + ddlSession.SelectedValue + " AND SR.IDNO = " + idno + ")", "DISTINCT SR.IDNO,C.COURSENO", "C.CCODE,C.COURSE_NAME,C.SUBID,C.ELECT,C.CREDITS,S.SUBNAME", "C.SCHEMENO = " + lblScheme.ToolTip + " AND C.SEMESTERNO = " + currentSemesterNo, "C.CCODE");
