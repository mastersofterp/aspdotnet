<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="OnlinePayment_Partial_Payment.aspx.cs" Inherits="ACADEMIC_OnlinePayment" %>
                            ...
                            <div id="divDirectPayment" runat="server">
                                <div class="col-12" id="div_Studentdetail" runat="server" visible="false">
                                                    ...
                                                    <ul class="list-group list-group-unbordered">
                                                        ...
                                                        <li class="list-group-item"><b>Total Amount :</b>
                                                            <a class="sub-label">
                                                                ...
                                                                <%--<asp:TextBox ID="lblAmount" runat="server" CssClass="form-control" Font-Bold="true" MaxLength="9" OnTextChanged="lblAmount_TextChanged" AutoPostBack="true" Enabled="false"></asp:TextBox>--%>
                                                                <%--<ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender5" runat="server" FilterMode="ValidChars" FilterType="Custom" TargetControlID="lblAmount" ValidChars="1234567890." />--%>
                                                                ...
                                                                <asp:HiddenField ID="hdfAmountPart" runat="server" />
                                    ...
                                    <div class="row mb-3 mt-4">
                                        <div class="form-group col-lg-3 col-md-6 col-12" runat="server" id="divReceiptType">
                                            <div class="label-dynamic">
                                                <sup>* </sup>
                                        ...
                                        <div class="form-group col-lg-3 col-md-6 col-12" runat="server" id="divStudSemester">
                                            <div class="label-dynamic">
                                                <sup>* </sup>
                                        ...
                                        <div class="form-group col-lg-3 col-md-6 col-12" runat="server" id="divhottrsansport" visible="false" style="display: none">
                                        ...
                                        <div class="form-group col-lg-3 col-md-6 col-12" runat="server" id="divhosteltype" visible="false">
                                            <div class="label-dynamic">
                                                <sup>* </sup>
