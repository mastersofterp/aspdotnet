<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LateFees_New.aspx.cs" MasterPageFile="~/SiteMasterPage.master" Inherits="ACADEMIC_EXAMINATION_LateFees_New" %>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-12 col-12">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-lg-12 col-md-6 col-12 mt-4">
                                                        <div class="label-dynamic">
                                    ...
                                    <tr class="item">
                                        ...
                                        <td>
                                            <asp:ImageButton ID="btnEdit" runat="server" AlternateText="Edit Record" OnClick="btnEdit_Click"
                                                CommandArgument='<%# Eval("COMMON_NO") %>' ImageUrl="~/images/edit.png"
                                                ToolTip="Edit Record" />
                                        ...
                                        <td>
                                            <asp:ImageButton ID="btnDelete" runat="server" AlternateText="Delete Record" OnClick="btnDelete_Click"
                                                OnClientClick="return confirm('Are You Sure,You Want Delete this Entry?')" CommandArgument='<%# Eval("COMMON_NO") %>' ImageUrl="~/Images/delete.png"
