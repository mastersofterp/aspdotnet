...
public partial class Registration_courseLink : System.Web.UI.Page
{
    ...
    private void PopulateDropDownList()
    {
        ...
        {            
            ...
            //DataSet dsSection = objCommon.GetDropDownData("PKG_DROPDOWN.SP_ALL_SECTIONS");
            //ddlSection.DataSource = dsSection;
            //ddlSection.DataTextField = dsSection.Tables[0].Columns[1].ToString();
            //ddlSection.DataValueField = dsSection.Tables[0].Columns[0].ToString();
            //ddlSection.DataBind();
        }
        catch (Exception ex)
        {
    ...
    private void FillScheme()
    {
        try
        {
            ...
            //objParams[0] = new SqlParameter("@P_SESSIONNO", Convert.ToInt32(lblCurrentSession.Text));
