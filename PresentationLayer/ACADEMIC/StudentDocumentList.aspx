...
<%--    <asp:UpdatePanel ID="updDocList" runat="server">
        <ContentTemplate>--%>
                        ...
                        <div class="col-md-12">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-btn"><i class="material-icons left"></i>
                                            <asp:Button ID="btnShow" runat="server" Text="Show" CssClass="btn btn-info" TabIndex="2" ValidationGroup="Show"
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td width="5%" style="text-align: center">
                                                        ...
                                                        <%--<asp:HiddenField ID="hfOriCopy" Value='<%# Eval("ORICOPY")%>' runat="server" /--%>
                                                        <br />
                                                    </td>
                                                    <td width="30%">
                                                    ...
                                                    <td width="20%">
                                                        <asp:FileUpload ID="studentFileUpload" CssClass="btn btn-primary" TabIndex="3" runat="server" />

                                                    </td>
                                                    <td width="10%">
                                                        <asp:Button ID="btndownload" runat="server" OnClick="btndownload_Click" TabIndex="3" CssClass="btn btn-primary" Visible="false" Text="Download" />
                                                        <%--   <asp:Button ID="btndownload" OnClick="btndownload_Click" CssClass="btn btn-primary" Visible="false" Text="Download" runat="server"/>--%>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                        </asp:ListView>
                          ...
                          <div id="divMsg" runat="server"></div>
                                    <div class="row text-center" style="margin-right: 100px">
                                        <asp:Button ID="btnuploadDocuments" runat="server" CssClass="btn btn-primary"
                                        ...
                                        <asp:Button ID="submit" runat="server" Text="submit" Visible="false" ValidationGroup="Show" CssClass="btn btn-success" TabIndex="4"
                                    ...
                                    <asp:UpdatePanel runat="server" ID="updreport">
                                        <ContentTemplate>
                                            <div style="margin-top: -55px; margin-left: 545px">
                                                <asp:Button ID="btnReport" runat="server" Text="Report" CssClass="btn btn-info" TabIndex="6" ToolTip="Click Here For Report" Font-Bold="True" OnClick="btnReport_Click" ValidationGroup="Show" />&nbsp;
                                  <asp:Button ID="btnCancel" runat="server" Text="Cancel" ToolTip="Cancel Student Information"
                                      CausesValidation="false" CssClass="btn btn-danger" TabIndex="7" OnClick="btnCancel_Click"
                                      Font-Bold="True" />
                                            </div>
                                        </ContentTemplate>
                                        <Triggers>
