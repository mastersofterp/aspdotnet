...
public partial class Academic_StudentRoolist : System.Web.UI.Page
{
    ...
    private void ShowReportForExamRegistered(string reportTitle, string rptFileName)
    {
        try
        {
            ...
            //url += "&paramForStudentExamSubjects=collegename=" + Session["coll_name"].ToString() + ",username=" + Session["userfullname"].ToString() + ",@P_SESSIONYEAR=" + ddlSessionNo.SelectedItem.Text;
    ...
    {
       // objCommon.FillDropDownList(ddlSchemeNo, "ACD_SCHEME", "SCHEMENO", "SCHEMENAME", "DEPTNO = " + ddlDepartment.SelectedValue, "SCHEMENO");
    }
