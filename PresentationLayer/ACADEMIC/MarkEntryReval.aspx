<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true"
    CodeFile="MarkEntryReval.aspx.cs" Inherits="Academic_MarkEntryAll" Title="" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                ...
                <div class="col-md-12 col-sm-12 col-12">
                    <div class="box box-primary">
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title">Revaluation Mark Entry <small class="text-capitalize">(Selection Criteria for Reval Marks Entry)</small> </h3>
                        </div>
                        ...
                        <div class="box-body">
                            <asp:Panel ID="pnlSelection" runat="server">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-md-6 col-12">
                                            <div class="row">
                                                ...
                                                <div class="form-group col-lg-4 col-md-6 col-12" id="divCllgName" runat="server" visible="false">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="rfvCname" runat="server" ControlToValidate="ddlClgname" SetFocusOnError="true"
                                                        Display="None" ErrorMessage="Please Select College & Regulation" InitialValue="0" ValidationGroup="MarksModifyReport">
                                                    </asp:RequiredFieldValidator>
                                                </div>


                                                <div class="form-group col-lg-4 col-md-6 col-12" id="divSession" runat="server" visible="false">
                                                    <div class="label-dynamic">
                                                        <sup>* </sup>
                                                        <label>Session</label>
                                                    </div>
                                                ...
                                                <div class="form-group col-lg-3 col-md-6 col-12" id="trSemester" runat="server" visible="false">
                                                    ...
                                                    <asp:DropDownList ID="ddlSemester" runat="server" CssClass="form-control" data-select2-enable="true" AppendDataBoundItems="True"
                                                        AutoPostBack="True" ValidationGroup="show" OnSelectedIndexChanged="ddlSemester_SelectedIndexChanged1">
                                                        <asp:ListItem Value="0">Please Select</asp:ListItem>
                                                    </asp:DropDownList>
                                                ...
                                                <div class="form-group col-lg-4 col-md-6 col-12" id="Div2" runat="server" visible="false">
                                                    <div class="label-dynamic">
                                                        <sup>* </sup>
                                                        <label>Course Name</label>
                                                    </div>
                                                    <asp:DropDownList ID="ddlCourse" runat="server" AppendDataBoundItems="True" data-select2-enable="true" AutoPostBack="true"
                                                ...
                                                <div class="form-group col-lg-3 col-md-6 col-12" id="section" runat="server" visible="false">
                                                    <div class="label-dynamic">
                                                        <sup>* </sup>
                                                        <label>Section</label>
                                                    </div>
                                                    <asp:DropDownList ID="ddlSection" runat="server" AppendDataBoundItems="True" CssClass="form-control" data-select2-enable="true" CausesValidation="false"
                                        ...
                                        <div class="form-group col-lg-3 col-md-12 col-12" id="divNotes" runat="server">
                                            <div class=" note-div">
                                ...
                                <div class="col-12 btn-footer" id="divButton" runat="server" visible="false">
                                    <asp:Button ID="btnShow" runat="server" TabIndex="8" Font-Bold="True" OnClick="btnShow_Click" OnClientClick="return validateField();"
                                        Text="Show Student" ValidationGroup="show"
                                        CssClass="btn btn-primary" />
                                    <%--      <asp:Button ID="Button1" runat="server" Font-Bold="true" OnClick="btnBack_Click"
                                        Text="BACK" CssClass="btn btn-primary" />--%>
                                    <asp:Button ID="Button2" runat="server" Enabled="false" Font-Bold="true"
                                    ...
                                    <%--Text="LAST SAVE" --%>
                                    <asp:Button ID="Button4" runat="server" Enabled="false" Font-Bold="true"
                                    ...
                                    <asp:Button ID="Button5" runat="server" Font-Bold="true"
                                        Text="EXCEL REPORT" CssClass="btn btn-info " OnClick="btnExcelReport_Click" Visible="false" />

                                    <asp:Button ID="Button6" runat="server" Font-Bold="true" Text="Format-I" CssClass="btn btn-info"
                                    ...
                                    <asp:Button ID="Button8" runat="server" Font-Bold="true" Text="PRINT" CssClass="btn btn-info d-none"
                                        OnClientClick="return PrintPanel();" />

                                    <asp:Button ID="Button9" runat="server" Font-Bold="true" OnClick="btnCancel2_Click"
                                        Text="Cancel" CssClass="btn btn-warning" Visible="False" />
                                </div>

                                <div class="col-12" id="divCourselist" runat="server">
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:LinkButton ID="lnkbtnCourse" runat="server" Text='<%# Eval("COURSENAME") %>'
                                                            CommandArgument='<%# Eval("SECTIONNO") + "+" + Eval("BATCHNO") + "+" + Eval("SEMESTERNO") + "+" + Eval("VALUER_UA_NO") %>' ToolTip='<%# Eval("COURSENO")%>'
                            ...
                            <asp:Panel ID="pnlMarkEntry" runat="server">
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-3 col-md-6 col-12" runat="server" id="trCourseName" visible="false">
                                            ...
                                            <asp:HiddenField ID="hdfValueruano" runat="server" />
                                        </div>
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-6 col-md-12 col-12" id="divUFM" runat="server">
                                            <div class=" note-div">
                                                <h5 class="heading">Note </h5>
                                                <p><i class="fa fa-star" aria-hidden="true"></i><span><b>902</b> for Absent</span></p>
                                                <p><i class="fa fa-star" aria-hidden="true"></i><span><b>903</b> for Malpractice</span></p>
                                ...
                                <div class="col-12 btn-footer">
                                    ...
                                    <asp:Button ID="btnSave" runat="server" Enabled="false" Font-Bold="true"
                                        OnClick="btnSave_Click" Text="SAVE" CssClass="btn btn-primary d-none" />
                                    <asp:Button ID="btnLastSave" runat="server" Font-Bold="true" Visible="true"
                                        OnClick="btnLastSave_Click" Text="SAVE" CssClass="btn btn-success" />
                                    <%--Text="LAST SAVE" --%>
                                    <asp:Button ID="btnLock" runat="server" Enabled="false" Font-Bold="true" Visible="true" Style="display: none;"
                                        OnClick="btnLock_Click" OnClientClick="return showLockConfirm();" Text="LOCK"
                                        CssClass="btn btn-danger" />

                                    <asp:Button ID="btnFacultyLock" runat="server" Enabled="false" Font-Bold="true" Visible="false"
                                        OnClick="btnFacultyLock_Click" OnClientClick="return showLockConfirm();" Text="LOCK"
                                        CssClass="btn btn-danger" />

                                    <asp:Button ID="btnFinalLock" runat="server" Enabled="false" Font-Bold="true" Visible="false"
                                        OnClick="btnFinalLock_Click" OnClientClick="return showLockConfirm();" Text="FINAL LOCK"
                                        CssClass="btn btn-danger" />

                                    <%--                                      <asp:Button ID="btnApproved" runat="server" Enabled="false" Font-Bold="true" Visible="false" 
                                        OnClick="btnApproved_Click" Text="Approved"
                                        CssClass="btn btn-primary" />--%>

                                    <asp:Button ID="btnReject" runat="server" Enabled="false" Font-Bold="true" Visible="false"
            ...
            prm.add_endRequest(function () {
                ...
                $("#ctl00_ContentPlaceHolder1_gvStudent .form-control").keyup(function () {
                    ...
                    for (var i = 0; i < grid.rows.length - 1; i++) {
                        ...
                        if (parseFloat(obt.val()) > parseFloat(GreaterMark.val())) {
                            obt.val('');
                            txtTotMark.val('');
                            percnt.val('');
                            Grade.val('');
    ...
    <script language="javascript" type="text/javascript">
        ...
        function validateField() {
            ...
            debugger;
            var uid;
            var temp = document.getElementById("<%=ddlSession.ClientID %>");
            uid = temp.value;
            if (uid == 0) {
        ...
        function isvalidSemester() {
            debugger;
            var uid;
            var temp = document.getElementById("<%=ddlSemester.ClientID %>");
            uid = temp.value;
            if (uid == 0) {
        ...
        function isvalidCourse() {
            var uid;
            var temp = document.getElementById("<%=ddlCourse.ClientID%>");
             uid = temp.value;
             if (uid == 0) {
    ...
    <%-- Added by Sachin To prevent developer tool inspect if the user use dev tools then browser display blur--%>
