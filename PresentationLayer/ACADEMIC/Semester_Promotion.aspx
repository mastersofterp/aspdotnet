...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
        <%--<asp:RequiredFieldValidator ID="rfvSection" runat="server" InitialValue="0" SetFocusOnError="true"
                        ...
                        ErrorMessage="Please Select Section" ValidationGroup="submit"></asp:RequiredFieldValidator>--%>
        <tr>
            ...
            <table width="100%" cellpadding="2" cellspacing="2" border="0">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <%--<ajaxToolKit:CalendarExtender ID="cerecdate" runat="server" Enabled="True" 
                            Format="dd/MM/yyyy" PopupButtonID="imgCalDateOfBirth" 
