<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true"
    CodeFile="DCR_ReportUI_Crescent.aspx.cs" Inherits="Academic_DCR_ReportUI_Crescent" Title="" %>
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="col-12">
                                <div class="row">
                                    <div class="form-group col-12">
                                        ...
                                        <asp:RadioButton ID="rdoBankwiseDDReport" Text="Bank-wise Demand Drafts Report" AutoPostBack="true"
                                            GroupName="ReportType" TabIndex="1" runat="server" OnCheckedChanged="rdoBankwiseDDReport_CheckedChanged" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <asp:RadioButton ID="rdoFeeItemwiseCollectionReport" Text="Fee Item-wise Collections Report" AutoPostBack="true"
                                        ...
                                        <asp:RadioButton ID="rdoOutstandingrptFormat1" Text="Outstanding Report Format I" AutoPostBack="true"
                                           ...
                                           <asp:RadioButton ID="rdoShortDcrReport" Text="Short DCR Report" AutoPostBack="true"
                            ...
                            <div class="col-12">
                                <asp:Panel ID="idDataFilter" runat="server" Visible="false">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-3 col-md-6 col-12" id="divcol" runat="server" visible="false">
                                            <div class="label-dynamic">
                                                <label>College</label>
                                            </div>
                            ...
                            <div class="col-12">
                                <asp:Panel ID="pnlOSReportFormat1" runat="server" Visible="false">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-3 col-md-6 col-12" id="div82" runat="server">
                                            <div class="label-dynamic">
                                                <sup></sup>
                            ...
                            <div class="col-12 btn-footer">
                                ...
                                <asp:Button ID="btnExcelFormat3" runat="server" Text="O/S Report(Excel) Format - II" OnClick="btnExcelFormat3_Click" Visible="false" Enabled="false"
