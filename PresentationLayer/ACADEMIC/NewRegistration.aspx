<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="NewRegistration.aspx.cs" Inherits="ACADEMIC_NewRegistration" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
            <td class="vista_page_title_bar" valign="top" style="height: 30px">New Registration &nbsp;
            ...
            <td>
                <table cellpadding="1" cellspacing="1" width="100%">
                    ...
                    <tr>
                        ...
                        <td class="form_left_label" style="width: 171px">
                            <span class="validstar">* </span>Search Student By Name :
                        </td>
                        <td class="form_left_text" width="10%">
                            <asp:TextBox ID="txtStudent" runat="server" MaxLength="100" TabIndex="1" Width="280px" Style="margin-left: 7px" />
                        ...
                        <td align="left">
                            <a href="#" title="Search Student for Modification" onclick="Modalbox.show($('divdemo2'), {title: this.title, width: 600,overlayClose:false});return false;">
                                <asp:Image ID="imgSearch" runat="server" ImageUrl="~/Images/search.png" TabIndex="1"
                                    AlternateText="Search Student by  Name" ToolTip="Search Student by Name" />
                            </a>
                        </td>
                        <%-- </asp:Panel>--%>
                            ...
                            <fieldset class="fieldset">
                                ...
                                <table width="100%" cellpadding="2" cellspacing="2">
                                    <tr>
                                        ...
                                        <td class="form_left_text" width="40%">
                                            <asp:DropDownList ID="ddlAdmbatch" runat="server" AppendDataBoundItems="true" Width="224px" TabIndex="1" Style="margin-left: 1px">
                                ...
                                <asp:RadioButton ID="rdoFemale" runat="server" Text="Female" GroupName="Sex" />
                                    ...
                                    <tr>
                                        ...
                                        <td class="form_left_label" width="40%">
                                            <asp:TextBox ID="txtadmitted" runat="server" MaxLength="50"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td class="form_left_label" width="40%">
                                            ...
                                            <ajaxToolKit:FilteredTextBoxExtender ID="FilteredTextBoxExtender8" runat="server"
                                                TargetControlID="txtRollNo" FilterType="Custom" FilterMode="InvalidChars"
                                                InvalidChars="!@#$%^&*()_+" />
                                    ...
                                    <%-- <tr>
                                        <td class="form_left_label" width="20%">
                                            <span class="validstar">* </span>Class X Year :
                                        </td>
                                        <td class="form_left_label" width="40%">
                                            <asp:TextBox ID="txtXYear" runat="server"  MaxLength="50"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="rfvYear" runat="server" ControlToValidate="txtXYear"
                                                Display="None" ValidationGroup="Show"
                                    ...
                                    <tr>
                                        ...
                                        <td class="form_left_label" width="40%">
                                            ...
                                            <%--<asp:Image ID="Image1" runat="server" src="../images/calendar.png" Width="16px" />
                                                  <ajaxToolKit:CalendarExtender ID="ceDate" runat="server" Format="yyyy" 
                                                                TargetControlID="txtlastExmYear" PopupButtonID="Image1" Enabled="true"
                                                                EnableViewState="true">
                                                            </ajaxToolKit:CalendarExtender>--%>
                                    ...
                                    <tr>
                                        ...
                                        <td class="form_left_label" width="40%">
                                            <asp:TextBox ID="txtMobile" runat="server" MaxLength="12" Width="125px"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td class="form_left_label" width="40%">
                                            <asp:TextBox ID="txtDomecial" runat="server" MaxLength="50"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td class="form_left_label" width="40%">
                                            <asp:DropDownList ID="ddlNationality" runat="server" AppendDataBoundItems="true" Width="300px" TabIndex="1" Style="margin-left: 0px">
                                                <asp:ListItem Value="0">Please Select </asp:ListItem>
            ...
            <ContentTemplate>
                <table cellpadding="1" cellspacing="1" width="100%">
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlAdmibatch" runat="server" AppendDataBoundItems="true" Width="120px">
                                <asp:ListItem Value="0">Please Select</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:RadioButton ID="rbName" runat="server" Text="Name" GroupName="Name" Checked="true" />
    ...
    <script type="text/javascript" language="javascript">
        ...
        function submitPopup(btnsearch) {
            ...
            val = document.getElementById('<%=ddlAdmibatch.ClientID %>').value;


            __doPostBack(btnsearch, rbText + ',' + searchtxt + ',' + val);
     ...
     function checkDate(sender, args) {
         if (sender._selectedDate > new Date()) {
             alert("You cannot select Greater date than today!");
