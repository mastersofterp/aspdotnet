            ...
            <fieldset class="fieldset" style="width: 98%">
                ...
                <table cellpadding="2" cellspacing="2" width="100%">
                    ...
                    <tr >
                      ...
                      <%--  <td>
                        Room Capacity : <asp:TextBox ID="txtRoomCapacit" runat="server" Width="05%"> </asp:TextBox>
                        </td>--%>
                    ...
                    <tr>
                         <td style="width: 16%">
                                        ...
                                        <td><asp:TextBox ID="txtTotStud" runat="server" CssClass="watermarked" Enabled="false"
                                                Style="text-align: center" Width="30px" />
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Room Capacity: <asp:TextBox ID="txtRoomCapacity" runat="server" CssClass="watermarked" Width="30px" Enabled="false"> </asp:TextBox>
                                            &nbsp;&nbsp;&nbsp;&nbsp; Remaining Capacity: <asp:TextBox ID="txtRemainCapacity" runat="server" CssClass="watermarked" Width="30px" Enabled="false"> </asp:TextBox>
