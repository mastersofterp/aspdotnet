                    ...
                    <td style="padding: 10px">
                        ...
                        <fieldset class="fieldset" style="width: 70%">
                            ...
                            <table cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td class="form_left_text">
                                        ...
                                        <%--<span style="font-weight: bold; color: green;">Select this Provision only for Report</span>--%>
                            ...
                            <td class="form_left_label">
                                <span class="validstar">&nbsp; </span>Report Selection :
                            </td>
                            <td class="form_left_text">
                                <asp:RadioButtonList ID="rblReport" runat="server" TabIndex="4" RepeatDirection="Horizontal" AppendDataBoundItems="true" >
                                    <asp:ListItem Value="0" Selected="True" >Selected</asp:ListItem>
                    ...
                    <asp:ListView ID="lvStudents" runat="server" OnItemDataBound="lvStudents_ItemDataBound">
                        ...
                        <ItemTemplate>
                            <tr class="item" onmouseover="this.style.backgroundColor='#FFFFAA'" onmouseout="this.style.backgroundColor='#FFFFFF'">
                                <%-- <tr class="item" "this.style.backgroundColor='<%# GetStatus(Eval("SELECTED"))%>'">--%>
                                <td>
                                    <%-- <asp:CheckBox ID="chkUser" runat="server" ToolTip='<%# Eval("USERNO")%>' />--%>
