    ...
    private void PopulateDropDown()
{
    ...
    //    ShowReportForSingle("RegistrationCardForSingle", "rptRegistrationCardReport.rpt");
    //}

    //private void ShowReportForSingle(string reportTitle, string rptFileName)
    //{
    //    string IDNO = objCommon.LookUp("ACD_STUDENT", "IDNO", "ENROLLNO='" + txtSearchEnrollno.Text + "'");
