<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true"
    CodeFile="Send_SmsServices.aspx.cs" Inherits="ACADEMIC_EXAMINATION_RevaluationMarkEntry"
    Title="" %>
                                                    ...
                                                    <ItemTemplate>
                                                        <tr class="item" onmouseover="this.style.backgroundColor='#FFFFAA'" onmouseout="this.style.backgroundColor='#FFFFFF'">
                                                            <td>
                                                                ...
                                                                <asp:ImageButton ID="btnEdit" runat="server" ImageUrl="~/IMAGES/edit.gif" CommandName='<%# Eval("SERVICEID") %>'
                                                                    Width="20px" Height="20px" AlternateText="Edit Record" ToolTip="Edit Record"
