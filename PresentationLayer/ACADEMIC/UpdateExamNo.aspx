<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="UpdateExamNo.aspx.cs" Inherits="ACADEMIC_UpdateExamNo" %>
    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">EXAM NO ALLOTMENT</h3>              
            </div>
            <form role="form">
                <div class="box-body">
            ...
            <div class="box-footer">
                <p class="text-center">
                    <asp:Button ID="btnShow" runat="server" Text="Show" CssClass="btn btn-primary"
                                        ValidationGroup="submit" OnClick="btnShow_Click" />
                                        <asp:Button ID="btnGenerate" runat="server"  CssClass="btn btn-primary"
                                            Text="Save" Width="132px" ValidationGroup="submit" OnClick="btnGenerate_Click1" />
                                        <asp:Button ID="btnClear" runat="server" Text="Clear"  CssClass="btn btn-warning"  OnClick="btnClear_Click1" />
                                        
                                        <asp:Button ID="btnReport" runat="server" 
                                            Text="Report"  CssClass="btn btn-info"  ValidationGroup="submit" OnClick="btnReport_Click"/>
            ...
            <table cellpadding="0" cellspacing="0" width="100%">
              <%--  <tr>
                    <td class="vista_page_title_bar" style="height: 30px">EXAM NO ALLOTMENT
...
<%--                <tr>
                    <td style="padding: 10px">
                        ...
                        <fieldset class="fieldset" style="width: 70%">
                            <legend class="legend">Exam No Allotment</legend>
                            <table cellpadding="0" cellspacing="0" width="100%">--%>
                               ...
                               <%-- <tr>
                                    ...
                                    <td class="form_left_text">&nbsp;<asp:Button ID="btnShow" runat="server" Text="Show" Width="80px"
                                        ...
                                        <asp:Button ID="btnGenerate" runat="server"
                                            Text="Save" Width="132px" ValidationGroup="submit" OnClick="btnGenerate_Click1" />
                                        &nbsp;<asp:Button ID="btnClear" runat="server" Text="Clear" Width="80px" OnClick="btnClear_Click1" />
                                        &nbsp;
                                        <asp:Button ID="btnReport" runat="server" 
                                            Text="Report" Width="80px"  ValidationGroup="submit" OnClick="btnReport_Click"/>
                                        <asp:ValidationSummary ID="ValidationSummary1" runat="server" ValidationGroup="submit"
                                            ShowMessageBox="true" ShowSummary="false" DisplayMode="List" />
                                    </td>--%>
                               <%-- </tr>
                    ...
                    <asp:ListView ID="lvStudents" runat="server">
                        ...
                        <ItemTemplate>
                            <tr class="item">
                                ...
                                <td style="width: 20%">
                                    <asp:TextBox ID="txtRollNo" runat="server" Text='<%# Eval("REGNO")%>' Width="90px" />
                                </td>
                                <td style="width: 10%">
                                    <asp:CheckBox ID="cbRow" runat="server" onclick="totSubjects(this)" ToolTip='<%# Eval("IDNO")%>' />
                                </td>
