<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="ADMPBranchChnage.aspx.cs" Inherits="ACADEMIC_POSTADMISSION_ADMPBranchChnage" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="updChangeBranch" runat="server">
        <ContentTemplate>
            <div class="row">
                                        ...
                                        <asp:ListView ID="lvStudent" runat="server">
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:LinkButton ID="lnkId" runat="server" Text='<%# Eval("FIRSTNAME") %>' CommandArgument='<%# Eval("USERNO") %>'
                                                            OnClick="lnkId_Click"></asp:LinkButton>
                                                    </td>
                                                  
                                                  
                                                    <%--<td>
                                                        <asp:Label ID="lblstudentfullname" runat="server" Text='<%# Eval("FIRSTNAME")%>' ToolTip='<%# Eval("USERNO")%>'></asp:Label>
                            ...
                            <div class="col-md-12">
                                     ...
                                     <div class="col-lg-5 col-md-6 col-12">
                                        <ul class="list-group list-group-unbordered">
                                            <li class="list-group-item"><b>Application Id. :</b>
                                                <a class="sub-label">
                                                    <asp:Label ID="lblUserNo" runat="server" Font-Bold="True"></asp:Label>
                                                    <asp:HiddenField ID="hdnAdmbatch" runat="server" Value="0" />
                                                    <asp:HiddenField ID="hdnPaymentType" runat="server" Value="0" />
                                                    <asp:HiddenField ID="hdnAmount" runat="server" Value="0" />
                                                    <asp:HiddenField ID="hdnDegreeNo" runat="server" Value="0" />
                                                    <asp:HiddenField ID="hdnBranchNo" runat="server" Value="0" />
                                ...
                                <div class="row mt-4">
                                    <div class="form-group col-lg-12 col-md-12 col-12">
                                        ...
                                        <asp:RadioButton AutoPostBack="true" name="rdoOpt" value="1" ID="rdWithoutFee" OnCheckedChanged="rdWithoutFee_CheckedChanged" Font-Bold="true" Text="Branch Change if Fees Not Paid" runat="server" GroupName="fees" Visible="false" />&nbsp;&nbsp;&nbsp;
                                ...
                                <asp:Panel ID="pnlBranchChange" runat="server" Visible="false">
                                    <div class="row">
                                        <%--<div class="form-group col-lg-3 col-md-6 col-12" id="dvProgram" runat="server">
                                            <div class="label-dynamic">
                                                <sup>* </sup>
                                                <label>Program Type</label>
                                            </div>

                                            <asp:DropDownList ID="ddlProgramType" runat="server" AppendDataBoundItems="true" Visible="false"
                                                CssClass="form-control" data-select2-enable="true" OnSelectedIndexChanged="ddlProgramType_SelectedIndexChanged"
                                                AutoPostBack="True">
                                                 <asp:ListItem Value="0">Please Select </asp:ListItem>
                                            <asp:ListItem Value="1">UG</asp:ListItem>
                                            <asp:ListItem Value="2">PG</asp:ListItem>
                                            </asp:DropDownList>
                                            <asp:RequiredFieldValidator ID="rfvProgram" runat="server" ControlToValidate="ddlProgramType"
                                                Display="None" ErrorMessage="Please Select Program Type" InitialValue="0"
                                        ...
                                        <div class="form-group col-lg-3 col-md-6 col-12" id="dvNewDegree" runat="server">
                                            ...
                                            <asp:DropDownList ID="ddlDegree" Visible="false" runat="server" AppendDataBoundItems="True" CssClass="form-control" data-select2-enable="true"
                                        ...
                                        <div class="form-group col-lg-6 col-md-6 col-12" id="dvBranch" runat="server">
                                            <div class="label-dynamic">
                                                <sup>* </sup>
    ...
    <script type="text/javascript">
        function ShowConfirm(yourDropDown) {
            ...
            if (!isSimpleBranchChecked) {
                if (confirm("New demand will be create for selected branch if you paid fee only. Are you sure?")) {
