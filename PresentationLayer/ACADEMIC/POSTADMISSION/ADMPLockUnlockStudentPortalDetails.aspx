<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="ADMPLockUnlockStudentPortalDetails.aspx.cs" Inherits="ACADEMIC_POSTADMISSION_ADMPLockUnlockStudentPortalDetails" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolKit" %>

<%--/*                                  
---------------------------------------------------------------------------------------------------------------------------                                  
Created By : Anurag Baghele                                 
Created On : 07-02-2024                           
Purpose    : To get student data                        
Version    : 1.0.0                         
---------------------------------------------------------------------------------------------------------------------------                                  
                            ...
                            <asp:Panel ID="pnlPortal" runat="server">
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div id="Div1" class="form-group col-lg-6 col-md-6 col-12" runat="server" visible="false">
                                            <div class="label-dynamic">
                                                <sup>*</sup>
                                        ...
                                        <div id="Div2" class="form-group col-lg-3 col-md-6 col-12" runat="server" style="display: none">
                                            <div class="label-dynamic">
                                                <sup>*</sup>
                                        ...
                                        <div id="Div3" class="form-group col-lg-3 col-md-6 col-12" runat="server" style="display: none">
                                            <div class="label-dynamic">
                                                <sup>*</sup>
