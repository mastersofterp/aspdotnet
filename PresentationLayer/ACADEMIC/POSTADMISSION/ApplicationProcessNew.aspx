<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="ApplicationProcessNew.aspx.cs" Inherits="ACADEMIC_POSTADMISSION_ApplicationProcessNew" %>
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="col-12">
                                ...
                                <div id="divApplicationProcess" class="col-12" runat="server" style="display: none">
                                    <div class="row">
                                    ...
                                    <asp:Panel ID="Panel1" runat="server">
                                        <asp:ListView ID="lvApplicationProcess" runat="server" Style="display: none" OnPagePropertiesChanging="lvApplicationProcess_PagePropertiesChanging">
                                            <LayoutTemplate>
                                                <div class="table-responsive" style="height: 500px; overflow: scroll; border-top: 1px solid #e5e5e5;">
                                                    <table class="table table-striped table-bordered nowrap" id="tblData1">
                                                        <thead class="bg-light-blue thapplication" style="vertical-align:top">
                                                            <tr>
                                                                <th id="thchkAll" runat="server" visible="false">
                                                                    <asp:CheckBox ID="chkAll" runat="server" onchange="CheckAll(this,1)" />
                                                                    <asp:Label ID="lbltotal" runat="server"></asp:Label>
                                                                </th>
                                                                <th>Sr No</th>
                                                                <th id="thVerify" runat="server" visible="false">Verification</th>
                                                                ...
                                                                <%--  <th style="display: none">Scheduled Slot</th>--%>
                                                                <th>Verify Status</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    <td id="tdchkstud" runat="server" visible="false">
                                                        <asp:CheckBox ID="chkStud" runat="server" /></td>
                                                    <td><%#Eval("SRNO") %></td>
                                                    <td id="tdVerify" runat="server" visible="false">
                                                        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                                            <ContentTemplate>
                                                                <asp:Button ID="btnVerify" runat="server" class="btn btn-primary btn-sm" Text="Verify" OnClick="btnVerify_Click" CommandArgument='<%#Eval("Userno") %>' />
                                                                <%-- OnClientClick="return ModelPopupDocumentVerify()"--%>
                                                            </ContentTemplate>
                                                            <Triggers>
                                                    ...
                                                    <td id="tdFullName" runat="server" visible="false">
                                                        <asp:Label ID="lblFullName" runat="server" Text='<%#Eval("FULLNAME") %>'></asp:Label>
                                                    </td>
                                                    <td id="tdlinkFullName" runat="server" visible="false">
                                                        <%--<a href='https://admissionsrajagiri.mastersofterp.in/default.aspx?Userno=<%# Eval("Userno")%>&UA_TYPE=<%# Eval("UA_TYPE")%>&UA_NO=<%# Eval("UA_NO")%>' target="_blank"><%#Eval("FULLNAME") %></a>--%>
                                                    ...
                                                    <td><%#Eval("APPLICATION_CATEGORY") %></td>
                                                    <td><%#Eval("STAGENAME") %> </td>
                                                    <td style="text-align: center">
                                                        <asp:UpdatePanel ID="UpdatePanel10" runat="server" UpdateMode="Conditional">
                                                            <ContentTemplate>
                                                                <asp:ImageButton ID="btnPreview1" runat="server" OnClick="btnPreviewForm_Click" CommandArgument='<%# Eval("Userno")%>'
                                                    ...
                                                    <td style="text-align: center">
                                                        <asp:UpdatePanel ID="UpdatePanel18" runat="server" UpdateMode="Conditional">
                                                            <ContentTemplate>
                                                                <asp:ImageButton ID="btnDownload1" runat="server" OnClick="btnDownload_Click" CommandArgument='<%# Eval("Userno")+","+Eval("APPLICATION_ID")%>' ImageUrl="~/Images/action_down.png" />
                                                                <%--<asp:ImageButton ID="btnAppliedAndNotPaidDownload" runat="server" ImageUrl="~/Images/action_down.png" />--%>
                                                            </ContentTemplate>
                                                            <Triggers>
                                                    ...
                                                    <%-- <td style="display: none">
                                                        <asp:Label ID="lblScheduled" runat="server" Text='<%#Eval("ExamSchedule") %>'></asp:Label>
                                                        <asp:HiddenField ID="hdnScheduledNo" runat="server" Value='<%#Eval("SCHEDULE_NO") %>' />
                                                        <%--<asp:Label ID="Label1" runat="server" Text='<%#Eval("SCHEDULE_NO") %>'></asp:Label>
                                                    </td>--%>
                                                    <td><%#Eval("VERIFY_STATUS") %></td>

                                                </tr>
                                            </ItemTemplate>
                                        </asp:ListView>
                                        <div style="text-align: left; margin-top: 0px;">
                                            <asp:DataPager ID="DataPager2" runat="server" PagedControlID="lvApplicationProcess" PageSize="500">
                                                <Fields>
                                        ...
                                        <div style="text-align: right; margin-top: 0px;">
                                            <asp:DataPager ID="DataPager1" runat="server" PagedControlID="lvApplicationProcess" PageSize="500">
                                                <Fields>
    ...
    <%--  <script>
        ...
        for (i = 0; i < coll.length; i++) {
            coll[i].addEventListener("click", function () {
                ...
                var contentpreview = this.nextElementSibling;
                if (contentpreview.style.maxHeight) {
                    contentpreview.style.maxHeight = null;
                } else {
                    contentpreview.style.maxHeight = contentpreview.scrollHeight + "px";
                }
            });
        }
    </script>--%>
