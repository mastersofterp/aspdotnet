...
public partial class ACADEMIC_MASTERS_Srcategory : System.Web.UI.Page
{
    ...
    protected void btnshow_Click(object sender, EventArgs e)
    {
        try
        {
           ...
           // DataSet ds = objCommon.FillDropDown("ACD_COLLEGE_DEGREE_BRANCH A INNER JOIN ACD_BRANCH B ON (A.BRANCHNO=B.BRANCHNO) left join ACD_ADMISSION_INTAKE_CATEGORYWISE c on (a.DEGREENO=c.DEGREENO)", "distinct B.BRANCHNO", "B.LONGNAME,c.intake,isnull(c.intakeid,0)intakeid", "A.DEGREENO=" + Convert.ToInt32(ddldegree.SelectedValue), "B.LONGNAME");
