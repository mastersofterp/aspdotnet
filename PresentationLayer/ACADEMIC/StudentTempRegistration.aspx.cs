...
public partial class ACADEMIC_StudentTempRegistration : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            //decimal hscper = (txtHSCPer.Text.Trim() == string.Empty ? 0 : Convert.ToDecimal(txtHSCPer.Text.Trim()));
            ...
            //Check whether City,Caste,Category,State,Mother Tongue, Nationality are new entries
           ...
           // string student_name=txtFatherName.Text.ToUpper()+" "+txtLastName.Text.ToUpper();
            //CustomStatus cs = objReg.PreAdmissionRegistration(sessionno, idno, txtFirstName.Text.Trim().ToUpper(), txtFatherName.Text.Trim().ToUpper(), txtMothersName.Text.Trim().ToUpper(),
            //    txtLastName.Text.Trim().ToUpper(), gender, dob, mtongueno, cityno, txtStdPhone.Text.Trim(), txtPhone.Text.Trim(), txtMobile.Text.Trim(), txtEmail.Text.Trim().ToUpper(),
            ...
            //if (cs != CustomStatus.Error && cs != CustomStatus.Others)
            if(output != "-99")
            {
                this.ClearControls();
                //objCommon.DisplayMessage("Student Registered Successfully!!", this.Page);
