//=================================================================================
// PROJECT NAME  : U-AIMS                                                          
// MODULE NAME   : TO CREATE BulkNoDuesFormGeneration.aspx PAGE                                             
// CREATION DATE : 07-Oct-20019
...
public partial class ACADEMIC_BulkNoDuesFormGeneration : System.Web.UI.Page
{
    ...
    protected void PopulateDropDownList()
    {
        try
        {
            ...
            objCommon.FillDropDownList(ddlColg, "ACD_college_master", "college_id", "college_name", "college_id>0 AND OrganizationId=" + Convert.ToInt32(Session["OrgId"]), "college_id");
    ...
    protected void BindListView(string str)
    {
        try
        {
            DataSet ds;
            // Get List of Student.....
            ds = studCont.GetStudentListForNoDues(Convert.ToInt32(ddlColg.SelectedValue), Convert.ToInt32(ddlAdmbatch.SelectedValue), Convert.ToInt32(ddlDegree.SelectedValue), Convert.ToInt32(ddlBranch.SelectedValue));
    ...
    protected void ddlDegree_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (ddlDegree.SelectedIndex > 0)
        {
            ...
            objCommon.FillDropDownList(ddlBranch, "ACD_BRANCH A INNER JOIN ACD_COLLEGE_DEGREE_BRANCH B ON (A.BRANCHNO=B.BRANCHNO)", "DISTINCT(A.BRANCHNO)", "A.LONGNAME", "A.BRANCHNO > 0 AND B.DEGREENO = " + ddlDegree.SelectedValue + " and B.College_id=" + ddlColg.SelectedValue + " AND B.OrganizationId=" + Convert.ToInt32(Session["OrgId"]), "A.LONGNAME");
            ddlBranch.Focus();
        }
        else
        {
    ...
    protected void btnPrintReport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!string.IsNullOrEmpty(ids))
            {
                ...
                ShowReport(ids, "Admission_Slip_Report", "rptStudentNoDuesForm.rpt");
    ...
    {
        objCommon.FillDropDownList(ddlDegree, "ACD_COLLEGE_DEGREE A INNER JOIN ACD_DEGREE B ON(A.DEGREENO=B.DEGREENO) INNER JOIN ACD_COLLEGE_DEGREE_BRANCH CD ON (CD.DEGREENO=B.DEGREENO)", "DISTINCT(A.DEGREENO)", "B.DEGREENAME", "A.COLLEGE_ID=" + Convert.ToInt32(ddlColg.SelectedValue) + " AND CD.OrganizationId=" + Convert.ToInt32(Session["OrgId"]), "a.DEGREENO");
        lvStudentRecords.DataSource = null;
        lvStudentRecords.DataBind();
        dpPager.Visible = false;
    }
