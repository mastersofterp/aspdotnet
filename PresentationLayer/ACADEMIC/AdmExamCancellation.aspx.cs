    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                //  lblEnrollNo.Text = dtr["REGNO"] == null ? string.Empty : dtr["REGNO"].ToString();
                ...
                //string cnt = objCommon.LookUp("ACD_STUD_PHOTO", "PHOTO", "IDNO = " +Convert.ToInt32(ds.Tables[0].Rows[0]["idno"]));
                //        if (string.IsNullOrEmpty(cnt))
                //            imgStud.ImageUrl = "~/images/nophoto.jpg";
                //        else
                //            imgStud.ImageUrl = "~/showimage.aspx?id=" + dtr["IDNO"].ToString() + "&type=student";
