            ...
            <tr>
                <td>
                    <ajaxToolKit:TabContainer ID="tcSmsService" runat="server" CssClass="ajax__tab_yuitabview-theme"
                                                ...
                                                <asp:ListView ID="lvSmsService" runat="server">
                                                    ...
                                                    <ItemTemplate>
                                                        <tr class="item" onmouseover="this.style.backgroundColor='#FFFFAA'" onmouseout="this.style.backgroundColor='#FFFFFF'">
                                                            <td>
                                                                <%--<asp:ImageButton ID="btnEdit" runat="server" ImageUrl="~/image/edit.gif" CommandName='<%# Eval("SERVICEID") %>' Width="20px" Height="20px" AlternateText="Edit Record" ToolTip="Edit Record" />--%>
                        ...
                        <%--<ajaxToolKit:TabPanel ID="TabPanel1" runat="server" HeaderText="Add MessageServer">
                            <HeaderTemplate>
                                Add Message Template
                            </HeaderTemplate>
                            <ContentTemplate>
                                <fieldset class="fieldset">
                                    <legend class="legend">Add Message Template</legend>
                                    <table width="100%">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtSmsCode" runat="server" Width="50%" TabIndex="1"></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="rfvSmsCode" runat="server" ControlToValidate="txtSmsCode"
                                                    Display="None" ErrorMessage="Please Enter Sms Code" InitialValue="0" SetFocusOnError="True"
                                                    ValidationGroup="showSmsTemp"></asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="form_left_label" style="width: 15%">
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtTemplate" runat="server" Width="50%" TabIndex="2" Height="50px"
                                                    TextMode="MultiLine"></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="rfvTemplate" runat="server" ControlToValidate="txtTemplate"
                                                    Display="None" ErrorMessage="Please Enter Sms Template" InitialValue="0" SetFocusOnError="True"
                                                    ValidationGroup="showSmsTemp"></asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtParaCount" runat="server" Width="50%" TabIndex="4" AutoPostBack="True"
                                                    OnTextChanged="txtParaCount_TextChanged"></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="rfvParaCount" runat="server" ControlToValidate="txtParaCount"
                                                    Display="None" ErrorMessage="Please Enter Web Service" InitialValue="0" SetFocusOnError="True"
                                                    ValidationGroup="showSmsTemp"></asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtV1" runat="server" Width="20%" TabIndex="3"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr id="trV2" runat="server" visible="False">
                                            <td class="form_left_label" style="width: 15%" runat="server">
                                                V2 :
                                            </td>
                                            <td runat="server">
                                                <asp:TextBox ID="txtV2" runat="server" Width="20%" TabIndex="3"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr id="trV3" runat="server" visible="False">
                                            <td class="form_left_label" style="width: 15%" runat="server">
                                                V3 :
                                            </td>
                                            <td runat="server">
                                                <asp:TextBox ID="txtV3" runat="server" Width="20%" TabIndex="3"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr id="trV4" runat="server" visible="False">
                                            <td class="form_left_label" style="width: 15%" runat="server">
                                                V4 :
                                            </td>
                                            <td runat="server">
                                                <asp:TextBox ID="txtV4" runat="server" Width="20%" TabIndex="3"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr id="trV5" runat="server" visible="False">
                                            <td class="form_left_label" style="width: 15%" runat="server">
                                                V5 :
                                            </td>
                                            <td runat="server">
                                                <asp:TextBox ID="txtV5" runat="server" Width="20%" TabIndex="3"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr id="trV6" runat="server" visible="False">
                                            <td class="form_left_label" style="width: 15%" runat="server">
                                                V6 :
                                            </td>
                                            <td runat="server">
                                                <asp:TextBox ID="txtV6" runat="server" Width="20%" TabIndex="3"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr id="trV7" runat="server" visible="False">
                                            <td class="form_left_label" style="width: 15%" runat="server">
                                                V7 :
                                            </td>
                                            <td runat="server">
                                                <asp:TextBox ID="txtV7" runat="server" TabIndex="3" Width="20%"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr id="trV8" runat="server" visible="False">
                                            <td class="form_left_label" style="width: 15%" runat="server">
                                                V8 :
                                            </td>
                                            <td runat="server">
                                                <asp:TextBox ID="txtV8" runat="server" TabIndex="3" Width="20%"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr id="trV9" runat="server" visible="False">
                                            <td class="form_left_label" style="width: 15%" runat="server">
                                                V9 :
                                            </td>
                                            <td runat="server">
                                                <asp:TextBox ID="txtV9" runat="server" TabIndex="3" Width="20%"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr id="trV10" runat="server" visible="False">
                                            <td class="form_left_label" style="width: 15%" runat="server">
                                                V10 :
                                            </td>
                                            <td runat="server">
                                                <asp:TextBox ID="txtV10" runat="server" TabIndex="3" Width="20%"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="form_left_label" style="width: 15%">
                                            ...
                                            <td>
                                                <asp:Button ID="btnTemplateSubmit" runat="server" TabIndex="6" Text="Submit" ValidationGroup="showMsgServer"
                                                    OnClick="btnTemplateSubmit_Click" />
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                <asp:Button ID="btnTemplateCancel" runat="server" TabIndex="7" Text="Cancel" OnClick="btnTemplateCancel_Click" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="form_left_label" style="width: 15%">
                                                ...
                                                <asp:ListView ID="lvSmsTemplate" runat="server">
                                                    <ItemTemplate>
                                                        <tr class="item" onmouseout="this.style.backgroundColor='#FFFFFF'" onmouseover="this.style.backgroundColor='#FFFFAA'">
                                                            <td style="width: 20%">
                                                                <%# Eval("SMSCODE") %>
                                                                <asp:HiddenField ID="hdfIdNo" runat="server" Value='<%# Eval("TEMPLETEID") %>' />
                                                            </td>
                                                            <td style="width: 60%">
                                                                <%# Eval("TEMPLATE") %>
                                                            </td>
                                                            <td style="width: 20%">
                                                                <%# Eval("PARAMETER_COUNT") %>
                                                            </td>
                                                        </tr>
                                                    </ItemTemplate>
                                                    <LayoutTemplate>
                                ...
                                <fieldset class="fieldset">
                                    ...
                                    <table width="100%">
                                        ...
                                        <tr id="Smstr1" runat="server" visible="False">
                                            <td id="Td1" class="form_left_label" style="width: 15%" runat="server">
                                                V2 :
                                            </td>
                                        ...
                                        <tr id="Smstr2" runat="server" visible="False">
                                            <td id="Td3" class="form_left_label" style="width: 15%" runat="server">
                                                V3 :
                                            </td>
                                        ...
                                        <tr id="Smstr3" runat="server" visible="False">
                                            <td id="Td5" class="form_left_label" style="width: 15%" runat="server">
                                                V4 :
                                            </td>
                                        ...
                                        <tr id="Smstr4" runat="server" visible="False">
                                            <td id="Td7" class="form_left_label" style="width: 15%" runat="server">
                                                V5 :
                                            </td>
                                        ...
                                        <tr id="Smstr5" runat="server" visible="False">
                                            <td id="Td9" class="form_left_label" style="width: 15%" runat="server">
                                                V6 :
                                            </td>
                                        ...
                                        <tr id="Smstr6" runat="server" visible="False">
                                            <td id="Td11" class="form_left_label" style="width: 15%" runat="server">
                                                V7 :
                                            </td>
                                        ...
                                        <tr id="Smstr7" runat="server" visible="False">
                                            <td id="Td13" class="form_left_label" style="width: 15%" runat="server">
                                                V8 :
                                            </td>
                                        ...
                                        <tr id="Smstr8" runat="server" visible="False">
                                            <td id="Td15" class="form_left_label" style="width: 15%" runat="server">
                                                V9 :
                                            </td>
                                        ...
                                        <tr id="Smstr9" runat="server" visible="False">
                                            <td id="Td17" class="form_left_label" style="width: 15%" runat="server">
                                                V10 :
                                            </td>
