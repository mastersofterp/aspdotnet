...
public partial class ACADEMIC_UaimsConfiguration : System.Web.UI.Page
{
    ...
    private void BindListView()
    {
        try
        {
            //string configEventNo = objCommon.LookUp("ACD_CONFIG", "count(EVENTNO)", "STATUS='Y'");

            //if (Convert.ToInt32(configEventNo) == 0)
            //{
                ...
                //if (ds.Tables[0].Rows[0]["STATUS"].ToString().Equals("Y"))
                //{
                // //dataItem.FindControl("chkEvent") as CheckBox).Checked == true);
