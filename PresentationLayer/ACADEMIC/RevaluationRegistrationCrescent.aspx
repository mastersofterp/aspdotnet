<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="RevaluationRegistrationCrescent.aspx.cs"
                        ...
                        <div class="col-12" id="divRegCourses" runat="server" visible="false">
                            ...
                            <div class="col-12 btn-footer">
                                ...
                                <asp:Button ID="btnChallan" runat="server" Text="Challan Receipt" Visible="false"
                                      OnClick="btnChallan_Click" CssClass="btn btn-outline-primary" />   <%--OnClientClick="return showChallanConfirm();"--%>
