...
public partial class ACADEMIC_PublicationDetail : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (res == -99)
            {
                objCommon.DisplayMessage(this.updTallyVoucher,"Exception Occure", this.Page);
            ...
            if (res == 1)
            {
                objCommon.DisplayMessage(this.updTallyVoucher,"Record Save Successfully", this.Page);
                return;

            }
            if (res == 2)
            {
                objCommon.DisplayMessage(this.updTallyVoucher,"Record Updated Successfully", this.Page);
                return;
