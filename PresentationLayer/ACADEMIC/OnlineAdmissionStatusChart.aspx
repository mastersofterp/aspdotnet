<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="OnlineAdmissionStatusChart.aspx.cs" Inherits="ACADEMIC_OnlineAdmissionStatusChart" %>
      ...
      <div class="row">
        ...
        <div class="col-md-6 ">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12 san animated rubberBand beauty" id="totalregisteredug" runat="server" visible="false">
             ...
             <div class="col-md-6 col-sm-6 col-xs-12 san animated rubberBand beauty" id="TotalAppFeePaid" runat="server" visible="false">
                <div class="info-box bg-aqua wrong-item item bot" id="Div63">
                    <span class="info-box-icon"><i class="fa fa-users"></i></span>
                    <div class="info-box-content" >
                        <span class="info-box-text" style="font-size :11px">Total Applicants<br/>Application Fee Paid</span>
                         <asp:Label ID="lbladmbatch5" runat="server"></asp:Label>
                        <span class="info-box-number sss"><b>
                            <asp:Label ID="lblTotalFeepaid" runat="server"></asp:Label></b></span>
                        <span class="progress-description"></span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
            ...
            <div class="col-md-6 col-sm-6 col-xs-12 san animated rubberBand beauty" id="TotalAppFeeNotPaid" runat="server" visible="false">
                <div class="info-box bg-aqua wrong-item item bot" id="Div64">
                    <span class="info-box-icon"><i class="fa fa-users"></i></span>
                    <div class="info-box-content" >
                        <span class="info-box-text" style="font-size :11px">Total Applicants<br/>Application Fee Not Paid</span>
                         <asp:Label ID="lbladmbatch10" runat="server"></asp:Label>
                        <span class="info-box-number sss"><b>
                            <asp:Label ID="lblTotalFeeNotpaid" runat="server"></asp:Label></b></span>
                        <span class="progress-description"></span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
             ...
             <div class="col-md-6 col-sm-6 col-xs-12 san animated rubberBand beauty" id="totDetailsNotCompleted" runat="server" visible="false">
                <div class="info-box bg-aqua wrong-item item bot" id="Div65">
                    <span class="info-box-icon"><i class="fa fa-users"></i></span>
                    <div class="info-box-content" >
                        <span class="info-box-text" style="font-size :11px">Total Applicants<br/>Details Not Completed</span>
                         <asp:Label ID="lbladmbatch12" runat="server"></asp:Label>
                        <span class="info-box-number sss"><b>
                            <asp:Label ID="lbltotalDetailsNotCompleted" runat="server"></asp:Label></b></span>
                        <span class="progress-description"></span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
            ...
            <div class="col-md-12 beauty" id="ugstatewise" runat="server" visible="false">
                <div class="box box-primary wrong-item item top" id="one1">
                    ...
                    <div class="box-header with-border">
                        ...
                        <h3 class="box-title">State Wise Applicants (Details Completed) - (<asp:Label ID="lbladmbatch7" runat="server" Text="Label"></asp:Label>)</h3>
...
<%--                              <asp:ImageButton ID="ImageButton1" runat="server" ToolTip="Export to Excel" OnClick="btnyearwise_Click"  style="width:25px;height:20px;margin-left:-30px" ImageUrl="IMAGES/ICON_EX.png" />
            ...
            <div class="col-md-12 beauty" id="Div11" runat="server" visible="false">
                <div class="box box-primary wrong-item item top" id="Div12">
                    ...
                    <div class="box-header with-border">
                        <i class="fa fa-pie-chart"></i>
                        <h3 class="box-title">Degree Wise Applicants (Details Completed) - (<asp:Label ID="lbladmbatch9" runat="server" Text="Label"></asp:Label>)</h3>
        ...
        <div class="col-md-6">
          ...
          <%--  <div class="col-md-6 col-sm-6 col-xs-12 san animated rubberBand beauty" id="totfeepaid" runat="server" visible="false">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12 san animated rubberBand beauty" id="totalSubmitted" runat="server" visible="false">
                <div class="info-box bg-aqua wrong-item item bot" id="test">
                    <span class="info-box-icon"><i class="fa fa-users"></i></span>
                    <div class="info-box-content" >
                        <span class="info-box-text" style="font-size :11px">Total Applicants<br/>Details Completed</span>
            ...
            <div class="col-md-6 col-sm-6 col-xs-12 san animated rubberBand beauty" id="totProvFeePaid" runat="server" visible="false">
                <div class="info-box bg-aqua wrong-item item bot" id="Div66">
                    <span class="info-box-icon"><i class="fa fa-users"></i></span>
                    <div class="info-box-content" >
                        <span class="info-box-text" style="font-size :11px">Total Applicants<br/>Provisional Fee Paid</span>
                         <asp:Label ID="lbladmbatch13" runat="server"></asp:Label>
                        <span class="info-box-number sss"><b>
                            <asp:Label ID="lbltotalProvFeePaid" runat="server"></asp:Label></b></span>
                        <span class="progress-description"></span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
             ...
             <div class="col-md-6 col-sm-6 col-xs-12 san animated rubberBand beauty" id="totfemale" runat="server" visible="false">
                <div class="info-box bg-red wrong-item item bot">
                    <span class="info-box-icon"><i class="fa fa-female"></i></span>
                    <div class="info-box-content">
                        <span class="info-box-text" style="font-size :11px">Total Female Applicants<br />Details Completed </span>
            ...
            <div class="col-md-6 col-sm-6 col-xs-12 san animated rubberBand beauty" id="totmale" runat="server" visible="false">
                <div class="info-box bg-green wrong-item item bot">
                    <span class="info-box-icon"><i class="fa fa-male"></i></span>
                    <div class="info-box-content">
                        <span class="info-box-text" style="font-size :11px">Total Male Applicants<br />Details Completed</span>
            ...
            <div class="col-md-12 beauty" id="applicantregistpg" runat="server" visible="false">
                <div class="box box-primary wrong-item item top" id="one14">
                    ...
                    <div class="box-header with-border">
                        ...
                        <h3 class="box-title">Date Wise Applicants (Details Completed) - (<asp:Label ID="lbladmbatch8" runat="server" Text="Label"></asp:Label>)</h3>
                         <span> <asp:ImageButton ID="btnregistrationcount" runat="server" OnClick="btnregistrationcount_Click" ToolTip="Export to Excel"  style="width:30px;height:25px;margin-left:20px" ImageUrl="../IMAGES/ICON_EX.png" /></span>
                ...
                <div class="box box-primary wrong-item item top" id="Div57">
                    ...
                    <div class="box-header with-border">
                        ...
                        <h3 class="box-title">Application Stages - (<asp:Label ID="lbladmbatch11" runat="server" Text="Label"></asp:Label>)</h3><br />
                         <span> <asp:ImageButton ID="ImageButton1" runat="server" ToolTip="Export to Excel" OnClick="ImageButton1_Click" style="width:30px;height:25px;margin-left:20px" ImageUrl="../IMAGES/ICON_EX.png" /></span>
...
<%-- <span> <asp:ImageButton ID="ImageButton1" runat="server" ToolTip="Export to Excel" OnClick="feecollection_Click" style="width:25px;height:20px;margin-left:-30px" ImageUrl="IMAGES/ICON_Ex.png" /></span>
                        ...
                        <div class="col-md-4">
                            <div class="input-group date">
                                ...
                                <asp:TextBox ID="txtEmpAttendanceDate" CssClass="form-control" runat="server" Enabled="true" Width="100px" OnTextChanged="txtEmpAttendanceDate_TextChanged"
                                   AutoPostBack="true" >
                                </asp:TextBox>
