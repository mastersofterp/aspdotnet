<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true"
    CodeFile="ExamRegistrationIMPROV_CC.aspx.cs" Inherits="Academic_ExamRegistrationIMPROV_CC" Title="" %>
                                        ...
                                        <ItemTemplate>
                                            <tr id="trCurRow" class="item">
                                                ...
                                                <td>
                                                    ...
                                                    <asp:HiddenField ID="hdfExamRegisteredimprovement" runat="server" Value='<%# Eval("EXAM_REGISTERED_IMPROVEMENT") %>' />
                                                    <asp:HiddenField ID="hdfStudRegisteredimprovement" runat="server" Value='<%# Eval("STUD_EXAM_REGISTERED_IMPROVEMENT") %>' />
                                                </td>
                                                <td>
