...
public partial class ACADEMIC_StudentRegistrationShort : System.Web.UI.Page
{
    ...
    //        DataSet ds = objSReg.GetStudentRegistrationdetail(Convert.ToInt32(ddlAdmBatch.SelectedValue), Convert.ToInt32(ddlClgname.SelectedValue), Convert.ToInt32(ddlDegree.SelectedValue), Convert.ToInt32(ddlBranch.SelectedValue));
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            //objstud.CORSUBID = Convert.ToInt32(ddlCore.SelectedValue);
