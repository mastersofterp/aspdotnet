...
public partial class ACADEMIC_BranchChange : System.Web.UI.Page
{
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        ...
        //get idno
        string getidno = objCommon.LookUp("ACD_STUDENT", "IDNO", "rollno = '" + txtStudent.Text.Trim() + "' AND CAN=0 AND ADMCAN=0");
        ...
        else
        {
            ...
            //Check Already Branch Change are not?
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        if (txtStudent.Text != "")
        {
            if (txtRegno.Text != "")
            {
                ...
                //int IDNO = Convert.ToInt32(objCommon.LookUp("ACD_Student", "IDNO", "REGNO=" + txtStudent.Text.Trim()));
                ...
                //int autono = Convert.ToInt32(objCommon.LookUp("ACD_STUDENT", "COUNT(DISTINCT IDNO)", "DEGREENO =" + degreeno + " AND BRANCHNO = " + Convert.ToInt32(ddlBranch.SelectedValue) + " AND BATCHNO ="+lblAdmbatch.Text));

                //string registrno = lblAdmbatch.Text + degreeno + Convert.ToInt32(ddlBranch.SelectedValue) + (autono + 1);
                //objCommon.DisplayMessage(lblAdmbatch.Text + degreeno + Convert.ToInt32(ddlBranch.SelectedValue) +(autono+1), this.Page);
