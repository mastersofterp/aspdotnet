...
public partial class CourseWise_Registration : System.Web.UI.Page
{
    ...
    protected void btnReport_Click(object sender, EventArgs e)
    {
        ...
        {   
            ...
            if (rdbReport.SelectedValue == "1")
                ...
                {
                    ShowCourseStudentCountReport("CoursewiseStudentCount", "rptCoursewiseStudentCount.rpt");
                }
    ...
    {
        if (rdbReport.SelectedValue == "1")
            ShowReportinFormate("xls", "rptCourseWiseStudRegistration.rpt");
        else if (rdbReport.SelectedValue == "2")
        {
            ShowReportinFormate("xls", "rptCoursewiseStudentCount.rpt");
        }
        else if (rdbReport.SelectedValue == "3")
        {
            ShowReportinFormate("xls", "rptRegisteredStudentList.rpt");
        }
        else if (rdbReport.SelectedValue == "4")
        {
            ShowReportinFormate("xls", "CourseRegistrationList.rpt");
