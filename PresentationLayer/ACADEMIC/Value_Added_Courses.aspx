<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="Value_Added_Courses.aspx.cs" Inherits="ACADEMIC_Value_Added_Courses" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <style>
        ...
        #tdcollegesession .btn-group, #tdBranch .btn-group, #tdDegree .btn-group {
                ...
                <div class="box-body">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#tab_1" tabindex="1">Value Added Offered Course</a>
                            </li>
                            <li class="nav-item" id="liCourseTeacher" runat="server" visible="true">
                                <a class="nav-link" data-toggle="tab" href="#tab_5" tabindex="2">Course Teacher Allotment</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tab_2" tabindex="2">Teacher Student Allotment</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tab_3" tabindex="3">Attendance Configuration</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tab_4" tabindex="4">Time Table</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tab_7" tabindex="6">Revised TT</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tab_6" tabindex="7">Cancel TT</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="tab-content" id="my-tab-content">
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-12 btn-footer">
                                                    ...
                                                    <asp:Button ID="btnCancel0" runat="server" Text="Cancel" OnClick="btnCancel0_Click" CssClass="btn btn-warning" CausesValidation="false" />
                                                        ...
                                                        <asp:ListView ID="lvCourse" runat="server" OnItemDataBound="lvCourse_ItemDataBound">
                                                            <LayoutTemplate>
                                                                ...
                                                                <div class="table-responsive" style="height: 200px; overflow: scroll; border-top: 1px solid #e5e5e5;">
                                                                    <table class="table table-striped table-bordered nowrap" style="width: 1700px !important;" id="tblCourseList">
                                                                        <thead class="bg-light-blue" style="position: sticky; z-index: 1; top: 0; box-shadow: rgba(0, 0, 0, 0.2) 0px 0px 1px;">
                                                                            <tr>
                                                                                <th style="width: 100px;">Code </th>
                                                                                <th style="width: 200px;">CourseName </th>
                                                                                <th style="width: 50px;">Credits </th>
                                                                                <th style="width: 50px;">Select </th>
                                                                                <th style="width: 100px;">Max Seat </th>
                                                                                <th style="width: 150px;"><sup>* </sup>Offered To Semester</th>
                                                                                <th style="width: 150px;"><sup>* </sup>Offered To College/session </th>
                                                                                <th style="width: 150px;"><sup>* </sup>Offered To<asp:Label ID="lblDYlvDegree" runat="server" Font-Bold="true"></asp:Label></th>
                                                                                <th style="width: 150px;"><sup>* </sup>Offered To<asp:Label ID="lblDYddlBranch" runat="server" Font-Bold="true"></asp:Label></th>
                                                                                <th style="width: 50px;">Status</th>
                                                                                <th style="width: 150px;"><sup></sup>Assessment Involved</th>
                                                                                <th style="width: 200px;">Show it on grade card</th>
                                                                                <th style="width: 150px;">Duration</th>
                                                                                <th style="width: 250px;" id="thFrmDate" runat="server" visible="false"><sup>* </sup>From Date</th>
                                                                                <th style="width: 250px;" id="thToDate" runat="server" visible="false"><sup>* </sup>To Date</th>
                                                                            </tr>
                                                                        </thead>
                                                                        <tbody>
                                                            ...
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <td style="width: 150px;" id="tdcollegesession">
                                                                        ...
                                                                        <asp:HiddenField ID="hdnCollegeSession" runat="server" />
                                                                    </td>
                                                                    <td style="width: 150px;" id="tdDegree">
                                                                        <asp:ListBox runat="server" ID="lstDegree" AutoPostBack="true" Width="200px" SelectionMode="Multiple" CssClass="form-control multi-select-demo" OnSelectedIndexChanged="lstDegree_SelectedIndexChanged"></asp:ListBox>
                                                                    </td>
                                                                    <td style="width: 150px;" id="tdBranch">
                                                                        <asp:ListBox runat="server" ID="lstBranch" SelectionMode="Multiple" CssClass="form-control multi-select-demo"></asp:ListBox>
                                                                    </td>
                                                                    <td style="width: 50px;" class='text-center; vertical-align:middle'>
                                                                        <label class="switch">
                                                                    ...
                                                                    <td style="width: 150px;">
                                                                        <asp:DropDownList runat="server" ID="ddlAssInvolve" data-select2-enable="true" AppendDataBoundItems="true" CssClass="form-control">
                                                                    ...
                                                                    <td style="width: 200px;">
                                                                        <asp:DropDownList runat="server" ID="ddlShowonGradeCard" data-select2-enable="true" AppendDataBoundItems="true" CssClass="form-control">
                                                                            <asp:ListItem Value="-1">Please Select</asp:ListItem>
                                                                            <asp:ListItem Value="0">No</asp:ListItem>
                                                                            <asp:ListItem Value="1">Yes</asp:ListItem>
                                                                        </asp:DropDownList>
                                                                    ...
                                                                    <td style="width: 150px;">
                                                                        <div class="">
                                                                            <asp:DropDownList runat="server" ID="ddlDuration" data-select2-enable="true" AutoPostBack="true" OnSelectedIndexChanged="ddlDuration_SelectedIndexChanged" AppendDataBoundItems="true" CssClass="form-control">
                                                                                <asp:ListItem Value="0">Please Select</asp:ListItem>
                                                                    ...
                                                                    <td style="width: 250px;" id="dvFrmDate" runat="server" visible="false">
                                                                        <div class="input-group date">
                                                                            <div class="input-group-addon">
                                                                                <i id="dvcal1" runat="server" class="fa fa-calendar text-blue"></i>
                                                                            </div>
                                                                            <asp:TextBox ID="txtDurationStartDate" runat="server" ValidationGroup="submit" onpaste="return false;"
                                                                                TabIndex="3" ToolTip="Please Enter Session Start Date" CssClass="form-control" Style="z-index: 0;" />
                                                                            <ajaxToolKit:CalendarExtender ID="ceDurationStartDate" runat="server" Format="dd/MM/yyyy"
                                                                                TargetControlID="txtDurationStartDate" PopupButtonID="dvcal1" />
                                                                            <ajaxToolKit:MaskedEditExtender ID="meeDurationStartDate" runat="server" OnInvalidCssClass="errordate"
                                                                                TargetControlID="txtDurationStartDate" Mask="99/99/9999" MessageValidatorTip="true" MaskType="Date"
                                                                                DisplayMoney="Left" AcceptNegative="Left" ErrorTooltipEnabled="True" />
                                                                            <ajaxToolKit:MaskedEditValidator ID="mevDurationStartDate" runat="server" ControlExtender="meeDurationStartDate"
                                                                                ControlToValidate="txtDurationStartDate" EmptyValueMessage="Please Enter Start Date"
                                                                    ...
                                                                    <td style="width: 250px;" id="dvTodate" runat="server" visible="false">
                                                                        <div class="input-group date">
                                                                            <div class="input-group-addon">
                                                                                <i id="dvcal2" runat="server" class="fa fa-calendar text-blue"></i>
                                                                            </div>
                                                                            <asp:TextBox ID="txtDurationEndDate" runat="server" ValidationGroup="submit" TabIndex="4"
                                                                                ToolTip="Please Enter Session End Date" CssClass="form-control" Style="z-index: 0;" />
                                                                            <ajaxToolKit:CalendarExtender ID="ceDurationEndDate" runat="server" Format="dd/MM/yyyy"
                                                                                TargetControlID="txtDurationEndDate" PopupButtonID="dvcal2" />
                                                                            <ajaxToolKit:MaskedEditExtender ID="meeDurationEndDate" runat="server" OnInvalidCssClass="errordate"
                                                                                TargetControlID="txtDurationEndDate" Mask="99/99/9999" MessageValidatorTip="true" MaskType="Date"
                                                                                DisplayMoney="Left" AcceptNegative="Left" ErrorTooltipEnabled="True" />
                                                                            <ajaxToolKit:MaskedEditValidator ID="mevDurationEndDate" runat="server" ControlExtender="meeDurationEndDate"
                                                                                ControlToValidate="txtDurationEndDate" EmptyValueMessage="Please Enter Session End Date"
                                                                                InvalidValueMessage="From Date is Invalid (Enter dd/MM/yyyy Format)" Display="None"
                                                        ...
                                                        <asp:ListView ID="lvGLobalOfferedCourses" runat="server">
                                                            ...
                                                            <ItemTemplate>
                                                                <tr class="bg-pista text-darkgray">
                                                                    ...
                                                                    <td>
                                                                        <asp:Label ID="Label5" runat="server" ForeColor='<%# (Convert.ToInt32(Eval("Value_Added") )== 0 ?System.Drawing.Color.Red:System.Drawing.Color.Green)%>'
                                                                            Text='<%# (Convert.ToInt32(Eval("Value_Added") ) == 1 ?  "Active" : "In-Active" )%>' />
                                                                    </td>
                                                                    <%--<td>
                            ...
                            <div class="tab-pane fade" id="tab_5">
                                ...
                                <asp:UpdatePanel ID="updCourseTeacher" Visible="true" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <div class="col-12">
                                            <div class="row">
                                    ...
                                    <ContentTemplate>
                                        <div class="col-12">
                                            ...
                                            <div class="col-12 btn-footer">
                                                ...
                                                <asp:Button ID="btnClear" runat="server" Text="Clear" OnClick="btnClear_Click" CssClass="btn btn-warning" CausesValidation="false"></asp:Button>
                                ...
                                <asp:UpdatePanel ID="updpanelconfig" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        ...
                                        <div class="col-12 btn-footer">
                                            ...
                                            <asp:Button ID="btnCancelAttConfig" runat="server" Text="Cancel" TabIndex="1" OnClick="btnCancelAttConfig_Click" class="btn btn-warning" CausesValidation="false" />
                                ...
                                <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        ...
                                        <div class="col-12 box box-primary">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-lg-3 col-md-6 col-12">
                                                    ...
                                                    <asp:Button ID="btnClearTimeSlot" runat="server" Text="Clear" OnClick="btnClearTimeSlot_Click" CausesValidation="false" CssClass="btn btn-warning"></asp:Button>
                                                                ...
                                                                <tr class="item">
                                                                    <td style="text-align: center">
                                                                        <asp:ImageButton ID="btnEditTimeSlotDetail" runat="server" OnClick="btnEditTimeSlotDetail_Click"
                                                                            CommandArgument='<%# Eval("SRNO") %>' ImageUrl="~/images/edit1.gif" ToolTip='<%# Eval("SRNO")%>' CausesValidation="false" />
                                                                    </td>
                                                                    <td style="text-align: center">
                                        ...
                                        <div class="col-12 btn-footer">
                                            ...
                                            <asp:Button ID="btnCancelTimeTable" runat="server" Text="Cancel" OnClick="btnCancelTimeTable_Click" CssClass="btn btn-warning" CausesValidation="false"></asp:Button>
                                                        ...
                                                        <table class="table table-hover table-bordered mb-0">
                                                            <tr id="MAIN" runat="server" class="col-md-12">
                                                                <td>
                                                                    <tr>
                                                                        <td style="text-align: center; width: 5%">
                                                                            <asp:ImageButton ID="btnEditTimeTable" runat="server" OnClick="btnEditTimeTable_Click" CausesValidation="false"
                            ...
                            <div class="tab-pane fade" id="tab_8">
                                ...
                                <asp:UpdatePanel ID="updReport" runat="server" UpdateMode="Conditional">
                                    ...
                                    <Triggers>
                                        ...
                                        <asp:PostBackTrigger ControlID="btnTTReportFormate1" />
                                    </Triggers>
                                </asp:UpdatePanel>
                            </div>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            { 
                ...
                $.ajax({  
                    type: "POST", 
                    url: '<%=Page.ResolveUrl("~/Value_Added_Courses.aspx/FillTimeSlotDropdown")%>',
                    dataType: "json", 
