<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true"
    CodeFile="CourseRegistrationByStudent.aspx.cs" Inherits="ACADEMIC_CourseRegistrationByStudent"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="divCourses" runat="server" visible="false">   <%--visible="false"--%>
            ...
            <table id="tblSession" runat="server" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    ...
                    <td class="form_left_text">
                        <asp:DropDownList ID="ddlSession" runat="server" AutoPostBack="true" AppendDataBoundItems="True" Width="30%" OnSelectedIndexChanged="ddlSession_SelectedIndexChanged">
                    ...
                    <td colspan="2" style="padding: 10px; text-align: center;">
                        <asp:ListView ID="lvBacklogSubjects" runat="server">
                                ...
                                <div class="vista-grid">
                                    ...
                                    <table id="tblBacklogSubjects" cellpadding="0" cellspacing="0" class="datatable" style="width: 100%;">
                                        <thead>
                                            <tr class="header">
                                               <%-- <th>
                                                    <asp:CheckBox ID="cbHead" runat="server" ToolTip="Select/Select all" onclick="SelectAll(this,2,'chkAccept');" />
                                                </th>--%>
                                                <th>
                            ...
                            <ItemTemplate>
                                <tr id="trCurRow" class="item">
                                    <%--<td>
                                        <asp:CheckBox ID="chkAccept" runat="server" ToolTip="Click to select this subject for registration"  onclick="ChkHeader(2,'cbHead','chkAccept');"/>
                                        <asp:HiddenField ID="hdnRegistered" runat="server" Value='<%# Eval("ACCEPTED") %>'/>
                                    </td>--%>
                                    <td>
                                        <asp:CheckBox ID="chkRegister" runat="server" Value='<%# Eval("EXAM_REGISTERED") %>' ToolTip="Click to select this subject for registration"
