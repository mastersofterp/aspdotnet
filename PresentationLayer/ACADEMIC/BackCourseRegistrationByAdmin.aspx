    ...
    <table cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td class="vista_page_title_bar" style="height: 30px">
               PREVIOUS COURSE REGISTRATION BY ADMIN
                    ...
                    <td colspan="2" style="padding: 10px; text-align: center;">
                        <asp:ListView ID="lvAuditSubjects" runat="server">
                            ...
                            <ItemTemplate>
                                <tr id="trCurRow" class="item">
                                    <%--<td>
                                        <asp:CheckBox ID="chkAccept" runat="server" ToolTip="Click to select this subject for registration" onclick="ChkHeader(3,'cbHead','chkAccept');"/>
                                        <asp:HiddenField ID="hdnRegistered" runat="server" Value='<%# Eval("EXAM_REGISTERED") %>'/>
                                    </td>--%>
                                    <td>
                                        <asp:CheckBox ID="chkRegister" runat="server" Value='<%# Eval("EXAM_REGISTERED") %>' ToolTip="Click to select this subject for registration"
