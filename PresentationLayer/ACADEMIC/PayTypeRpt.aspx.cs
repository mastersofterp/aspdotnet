...
public partial class ACADEMIC_PayTypeRpt : System.Web.UI.Page
{
    ...
    public void PopulateDropDownList()
    {
        ...
        this.objCommon.FillDropDownList(ddlPaymentMode, "ACD_PAYTYPE", "PTYPE_CODE", "PTYPENAME", "PAYNO>0", "PAYNO");
    }
    protected void btnPrintReport_Click(object sender, EventArgs e)
    {
        ...
        DailyFeeCollectionRpt dcrReport = GetReportCriteria();
        DataSet ds = objdfc.GetPayTypeReport(dcrReport);
