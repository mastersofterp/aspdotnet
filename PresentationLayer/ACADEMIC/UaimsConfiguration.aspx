...
// var listView = document.getElementById('<%= lvConfiguration.FindControl("table1").ClientID %>');           
...
//function RegularCourseAmount(chk)
//{

// var chkboxid=chk.id; 
// var chkNo=chkboxid.substring(0,43)+'chkNo';
// var check = document.getElementsByTagName('label');
...
// function RegularCourseAmount_Verify(chk)
//     { 
//           var chkboxid=chk.id;           
//                    
//   	        var chkYes=chkboxid.substring(0,43)+'chkYes';
//   	                
//                    
//              var check = document.getElementsByTagName('label');
//                    
