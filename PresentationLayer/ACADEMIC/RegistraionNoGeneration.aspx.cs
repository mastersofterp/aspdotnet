...
public partial class ACADEMIC_RegistraionNoGeneration : System.Web.UI.Page
{
    ...
    {
        //int Cont=0;
        //if (chkContinueGeneration.Checked == true)
        //{
        //    Cont = 1;
        //}
        //else
    ...
    private void ShowReport(string reportTitle, string rptFileName)
    {
        try
        {
          ...
          //  url += "&param=@P_COLLEGE_CODE="+Session["colcode"].ToString()+ ",@P_ADMBATCH="+ddlAdmBatch.SelectedValue+",@P_DEGREENO="+ddlDegree.SelectedValue+",@P_SEMESTERNO="+Convert.ToInt32(ddlSemester.SelectedValue)+",@P_BRANCHNO="+ ddlBranch.SelectedValue;
