<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="BranchChange1.aspx.cs" Inherits="ACADEMIC_BranchChange" Title="" %>
                            ...
                            <td>
                                ...
                                <td class="form_left_text">
                                    ...
                                    <%--<ajaxToolKit:CalendarExtender ID="ceDateOfBirth" runat="server" Format="dd/MM/yyyy"
                                        TargetControlID="txtAdmDate" PopupButtonID="imgAdmDate" Enabled="true"
                                    ...
                                    <tr>
                                        <td align="center" class="form_left_label" colspan="2">
                                            ...
                                            <asp:Button ID="btnPrint" runat="server" Text="Report" Width="80px"
