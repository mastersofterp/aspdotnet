<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="SendSmstoStudents.aspx.cs" Inherits="ACADEMIC_SendSmstoStudents" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <style>
        ...
        #ctl00_ContentPlaceHolder1_PnlNotPaidStudent .dataTables_scrollHeadInner {
            width: max-content!important;
        }
    </style>
                                                        ...
                                                        <asp:Panel ID="Studpanel" runat="server">
                                                            <div class="sub-heading">
                                                             ...
                                                             <div class="row">
                                                                ...
                                                                <div class="form-group col-lg-3 col-md-6 col-12" id="divsemester1" runat="server">
                                                                    <div class="label-dynamic">
                                                                        <sup id="supSem" runat="server">* </sup>
                                                                        <%--<label>Semester</label>--%>
                                                                        <asp:Label ID="lblDYddlSemester" runat="server" Font-Bold="true"></asp:Label>
                                                                    </div>
                                                                    <asp:DropDownList ID="ddlsemester" runat="server" AppendDataBoundItems="true" TabIndex="1" CssClass="form-control" data-select2-enable="true">
                                                                        <asp:ListItem Value="0">Please Select</asp:ListItem>
                                                                        <asp:ListItem></asp:ListItem>
                                                                    </asp:DropDownList>
                                                            ...
                                                            <asp:ListView ID="lvnotpaid" runat="server">
                                                                ...
                                                                <ItemTemplate>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:Label ID="Label1" runat="server" Text=' <%# Eval("RRN")%>'></asp:Label>
                                                                        </td>
                                                                        <td>
                                                                        ...
                                                                        <td>
                                                                            <asp:Label ID="lblOut" runat="server" Text=' <%# Eval("OUTSTANDING_AMOUNT")%>'></asp:Label>
                                                                        </td>
                                                                        <td>
                                                                            <asp:Label ID="lblStatus" runat="server" Text=' <%# Eval("Admission_status")%>'></asp:Label>
                                                                        </td>
                                                ...
                                                <div class="box-body">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group col-md-3" id="divAttStatus" runat="server" visible="false">
                                                                <div class="label-dynamic">
                                                    ...
                                                    <div class="col-12" runat="server" id="divIAMarks">
                                                        <asp:Panel ID="pnlthird" runat="server" ScrollBars="Vertical" Height="550px">
