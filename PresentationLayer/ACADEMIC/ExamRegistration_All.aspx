<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true"
    CodeFile="ExamRegistration_All.aspx.cs" Inherits="Academic_ExamRegistration" Title="" %>
  ...
  //      }
        ...
        function SumTotal() {
            ...
            try {
                ...
                var Duration = document.getElementById('ctl00_ContentPlaceHolder1_hdfDuration').value;
                var IsFinalSem = document.getElementById('ctl00_ContentPlaceHolder1_hdfSemester').value;
                var finalsemcount = document.getElementById('ctl00_ContentPlaceHolder1_hdffinalsemcount').value;
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <ul class="list-group list-group-unbordered">
                                        ...
                                        <li class="list-group-item"><b>Total Exam Fee :</b>
                                            <a class="sub-label">
                                            ...
                                            <asp:HiddenField ID="hdfExamLastDate" runat="server" />
                                             ...
                                             <asp:HiddenField ID="hdffinalsemcount" runat="server" />
                                ...
                                <div class="col-12">
                                    <asp:Panel ID="pnlFailCourse" runat="server">
                                        ...
                                        <span id="notefinal" runat="server" visible="false" style="color: red; font-weight: 700; font-size: medium;">Note: For Final Semester Students Rs.1700 is added for the following:<br />
                                            Provisional Certificate - Rs. 500/-
                               <br />
                                            Consolidated grade Sheet - Rs. 500/-
                               <br />
                                            Degree Certificate - Rs. 700/- </span>
                                ...
                                <div class="col-12 btn-footer">
                                    <asp:Button ID="btnSubmit" runat="server" OnClick="btnSubmit_Click" Text="Submit & Online Pay" CausesValidation="false"
