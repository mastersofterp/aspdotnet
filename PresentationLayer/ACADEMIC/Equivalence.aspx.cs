...
public partial class ACADEMIC_Equivalence : System.Web.UI.Page
{
    ...
    protected void ddlOldScheme_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            //objCommon.FillDropDownList(ddlOldCourse, "ACD_STUDENT_RESULT", "DISTINCT COURSENO", "CCODE+' - '+COURSENAME AS COURSE_NAME", "SCHEMENO=" + ddlOldScheme.SelectedValue + " AND SESSIONNO=" + ddlSession.SelectedValue + " AND IDNO=" + Convert.ToInt32(ViewState["idno"]), "COURSENO");
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                idno = objCommon.LookUp("ACD_STUDENT", "IDNO", "REGNO='" + regno+"'");
            ...
            {
                //ShowMessage("Please enter USN No.");
                objCommon.DisplayMessage(UpdatePanel1, "Please enter USN No.!!", this.Page);
            }
        }
        catch (Exception ex)
        {
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (chkOldReg == 0)
            {
               ...
               // ShowMessage("Can not allot new course to student because registration for selected old course is not found in any session.");
                return;
            }
            ...
            else
            {
               ...
               // ShowMessage("Can not allot course because the course you are selected is alredy registered.");
            }
        }
        catch (Exception ex)
        {
