<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="StudentAdmissionConform1.aspx.cs" Inherits="ACADEMIC_CheckStudentInfo" Title="" %>
        ...
        <table id="tblStudent" width="100%" style="text-align: left" runat="server">
                            ...
                            <tr runat="server" id="trpayType">
                                ...
                                <td width="35%">
                                        ...
                                        onblur="ValidatePayType(this); UpdateCash_DD_Amount();" MaxLength="1" 
                                                        ToolTip="Enter C for cash payment OR D for payment by demand draft OR I for SBI-Collect payment." 
                                                           ></asp:TextBox>
            ...
            <tr runat="server" id="trmsg">
                <td style="font-size:medium; color:Red">
                    Note : Please enter type of pay Type whether cash(C) or demand draft(D) or sbi-collect(I)
                    </td></tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <%--<asp:Button ID="btnSaveDD_Info" runat="server" Text="Save Demand Draft"
                                                            ValidationGroup="dd_info" TabIndex="11" onclick="btnSaveDD_Info_Click" Visible="false" />--%>
