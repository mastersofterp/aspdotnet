...
public partial class ACADEMIC_SeatingArrangementDeallocation : System.Web.UI.Page
{
    ...
    protected void ddlSlot_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        //{
        //    objCommon.FillDropDownList(ddlCourse, "ACD_EXAM_DATE TS INNER JOIN ACD_EXAM_TT_SLOT TT ON(TT.SLOTNO=TS.SLOTNO) INNER JOIN ACD_STUDENT_RESULT RS ON(TS.COURSENO=RS.COURSENO)", "DISTINCT TS.COURSENO", "RS.CCODE+'~'+COURSENAME AS COURSENAME", "TT.SLOTNO=" + Convert.ToInt32(ddlSlot.SelectedValue), "TS.COURSENO");
        //}
        //else
        //{
