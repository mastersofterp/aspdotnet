...
public partial class Academic_examconfig : System.Web.UI.Page
{
    ...
    private void PopulateDropDownList()
    {
        try
        {
            //objCommon.FillDropDownList(ddlSession, "ACD_SESSION_MASTER", "SESSIONNO", "SESSION_NAME", "SESSIONNO=" + Session["currentsession"].ToString(), string.Empty);
    ...
    {       
        try
        {
            ...
            //objExam.ExamNo = Convert.ToInt32(ddlExamName.SelectedValue);
