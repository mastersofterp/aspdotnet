<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="FacultyDairyReport.aspx.cs" Inherits="ACADEMIC_EXAMINATION_FacultyDairyReport" %>
        ...
        <div class="col-md-12 col-sm-12 col-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">FACULTY DAIRY</h3>
                </div>
                <div class="box-body">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#ACADEMIC" tabindex="1">ACADEMIC</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#EXAMINATION" tabindex="1">EXAMINATION</a>
                            </li>
                            <li class="nav-item d-none">
                                <a class="nav-link" data-toggle="tab" href="#NON_ACADEMIC" tabindex="1">NON-ACADEMIC</a>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content" id="my-tab-content">
                                        ...
                                        <div class="col-12 mt-4">
                                            <div class="row">
                                                <div class="form-group col-lg-4 col-md-6 col-12">
                                                    ...
                                                    <asp:DropDownList ID="ddlSessionAcad" runat="server" CssClass="form-control" ToolTip="Please Select Session"
                                                        AppendDataBoundItems="true" data-select2-enable="true" AutoPostBack="True" TabIndex="1"  >
                                                        <asp:ListItem Value="0">Please Select</asp:ListItem>
                                                    </asp:DropDownList>
                                                    <asp:RequiredFieldValidator ID="rfvSessionAcad" runat="server"
                                                        ControlToValidate="ddlSessionAcad" Display="None"
                                                        ErrorMessage="Please Select Session" InitialValue="0"
                                                        SetFocusOnError="True" ValidationGroup="Acad"></asp:RequiredFieldValidator>
                                                </div>
                                            </div>

                                            <div class="col-12 btn-footer">
                                                    <asp:Button ID="btnAttendanceReport" runat="server" Text="Coursewise Teaching Plan Report (Planned Vs Executed)" ValidationGroup="Acad"
                                        ...
                                        <div class="col-12 mt-4">
                                            <div class="row">
                                                <div class="form-group col-lg-3 col-md-6 col-12">
                                                    ...
                                                    <asp:DropDownList ID="ddlSession" runat="server" CssClass="form-control" ToolTip="Please Select Session"
                                                        AppendDataBoundItems="true" data-select2-enable="true" AutoPostBack="True" TabIndex="1" OnSelectedIndexChanged="ddlSession_SelectedIndexChanged">
                                                        <asp:ListItem Value="0">Please Select</asp:ListItem>
                                                    </asp:DropDownList>
                                                    <asp:RequiredFieldValidator ID="RvfddlSession" runat="server"
                                                ...
                                                <div class="form-group col-lg-3 col-md-6 col-12">
                                                    ...
                                                    <asp:DropDownList ID="ddlCourse" ToolTip="Please Select Course" runat="server" AutoPostBack="true" CssClass="form-control" data-select2-enable="true"
                                                        AppendDataBoundItems="True" TabIndex="1">
                                                        <asp:ListItem Value="0">Please Select</asp:ListItem>
                                                    </asp:DropDownList>
                                                    <asp:RequiredFieldValidator ID="RvfddlCourse" runat="server"
                                                        ControlToValidate="ddlCourse" Display="None"
                                                        ErrorMessage="Please Select Course Name" InitialValue="0"
                                                        SetFocusOnError="True" ValidationGroup="Add"></asp:RequiredFieldValidator>
                                                </div>
                                                <div class="col-12 btn-footer">
                                                    <asp:Button ID="btnInternalExamrpt" runat="server" Text="Internal Exams Report" ValidationGroup="Add"
                                                        ToolTip="Select to Report" CssClass="btn btn-primary" OnClick="btnInternalExamrpt_Click" />
                                                    <asp:Button ID="btnFinalExamrpt" runat="server" Text="Final Exams Report" ValidationGroup="Add"
                            ...
                            <div class="tab-pane fade" id="NON_ACADEMIC">
                                <div>
