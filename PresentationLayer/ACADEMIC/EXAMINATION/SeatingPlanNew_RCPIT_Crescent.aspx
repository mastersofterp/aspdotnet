<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="SeatingPlanNew_RCPIT_Crescent.aspx.cs" Inherits="ACADEMIC_SEATINGARRANGEMENT_SeatingPlanNew" %>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-12">
                                                <ul class="list-group list-group-unbordered">
                                                    <li class="list-group-item pl-md-0 pr-md-0"><b>Seating Plan:</b>
                                                        <a class="sub-label">
                                                            <asp:RadioButton ID="RadioButton1" runat="server" Text="Single" GroupName="Status" />&nbsp;&nbsp;
                                        ...
                                        <asp:Panel ID="PnlMatrix" runat="server" Visible="false" Style="overflow-y: scroll;">
                                            ...
                                            <div class="table-responsive">
                                                <asp:ListView ID="lvMatrix" runat="server">
                                                    <LayoutTemplate>
                                                        <table id="tblMatrix" class="table table-striped table-bordered nowrap" style="width: 100%">
                                                            <thead>
