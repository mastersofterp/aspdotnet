<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="Improvement_Course_Registration.aspx.cs" Inherits="ACADEMIC_EXAMINATION_Improvement_Course_Registration" %>
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-12" id="divCourses" runat="server" visible="false">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <ul class="list-group list-group-unbordered">
                                        ...
                                        <li class="list-group-item"><b>CGPA :</b>
                                            <a class="sub-label">
                                                <asp:Label ID="lblCGPA" runat="server" Font-Bold="true" /></a>
                                        </li>
                                        <li class="list-group-item d-none"><b>Semester :</b>
                                            <%--<a class="sub-label">
                                            ...
                                            <ItemTemplate>
                                                <tr id="trCurRow" class="item">
                                                    <td>
                                                        ...
                                                        <asp:CheckBox ID="chkAccept" runat="server" Checked='<%#(Convert.ToInt32(Eval("IMPROVEMENT"))==1 ? true : false)%>' Enabled='<%#(Convert.ToInt32(Eval("IMPROVEMENT"))==1 ? false : true)%>' onclick="backlogLvChk(this);" />
                                                    </td>
                                                    <td>
                                ...
                                <div class="col-12 btn-footer">
                                    <asp:Button ID="btnSubmit" runat="server" OnClick="btnStudSubmit_Click" Text="Submit" CausesValidation="false"
                                        CssClass="btn btn-primary" TabIndex="8" />
                                    <asp:Button ID="btnPrintRegSlip" runat="server" Text="Improvement Registration slip" OnClick="btnPrintRegSlip_Click" CausesValidation="false"
                                        CssClass="btn btn-primary" TabIndex="9" Visible="false" />
                                    <asp:Button ID="btnStudSubmit" runat="server" Text="Save/Confirm" OnClick="btnStudSubmit_Click"
                                        CssClass="btn btn-primary" TabIndex="9" Visible="false" />
