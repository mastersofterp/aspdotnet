<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true"
    CodeFile="MarkEntryforIA.aspx.cs" Inherits="Academic_MarkEntryforIA" Title="" %>
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        <div class="form-group col-lg-3 col-md-6 col-12">
                                            ...
                                            <asp:DropDownList ID="ddlSession" runat="server" CssClass="form-control" data-select2-enable="true" OnSelectedIndexChanged="ddlSession_SelectedIndexChanged" AutoPostBack="true" AppendDataBoundItems="true" TabIndex="1">
                                            </asp:DropDownList>
                                        </div>
                                        <div class="form-group col-lg-3 col-md-6 col-12">
                                            <div class="label-dynamic">
                                        ...
                                        <div class="col-12 col-md-9 pl-0 pr-0">
                                            <div class="row">
                                                <div id="Div1" class="form-group col-lg-4 col-md-6 col-12" runat="server">
                                                    ...
                                                    <asp:DropDownList ID="ddlSession2" runat="server" AppendDataBoundItems="true" CssClass="form-control " data-select2-enable="true" >
                                                    </asp:DropDownList>
                                                </div>
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <asp:Button ID="btnPrintAll" runat="server" Text="PrintAll" CssClass="btn btn-success" OnClick="btnPrintAll_Click" Enabled="true" Height="26px" />
                        </div>
                    </div>
