                    ...
                    <div class="col-12">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-3 col-md-6 col-12">
                                ...
                                <asp:DropDownList ID="ddlCourse" runat="server" AppendDataBoundItems="True" CssClass="form-control" data-select2-enable="true" AutoPostBack="true" OnSelectedIndexChanged="ddlCourse_SelectedIndexChanged">
                                    <asp:ListItem Value="0">Please Select</asp:ListItem>
                                </asp:DropDownList>
                                ...
                                <div class="col-12 btn-footer">
                                    <asp:Button ID="btnShowResult" runat="server" OnClick="btnShowResult_Click"
                                        Text="Show Data" ValidationGroup="Show" CssClass="btn btn-primary" />
                                    <asp:Button ID="btnSubmit" runat="server" OnClick="btnSubmit_Click" Text="Submit"
                                        ValidationGroup="Show" CssClass="btn btn-primary" Visible="false" />
                            ...
                            <asp:Button ID="btnLock" runat="server"
                                Text="Lock" CssClass="btn btn-primary" ValidationGroup="Show" OnClick="btnLock_Click" Visible="false" />

                                    <asp:Button ID="btnUnlock" runat="server"
                                        Text="Unlock" CssClass="btn btn-primary" ValidationGroup="Show" OnClick="btnUnlock_Click" Visible="false" />
                                    <asp:Button ID="btnCancel" runat="server"
                                        OnClick="btnCancel_Click" Text="Clear" CssClass="btn btn-warning" />
