<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="AbsentStudentEntry.aspx.cs" 
    Inherits="ACADEMIC_EXAMINATION_AbsentStudentEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
   ...
   <%-- <script src="../../jquery/AutoCompleteDD/jquery183.min.js"></script>
    ...
    <asp:UpdatePanel ID="updpnlExam" runat="server">
        <ContentTemplate>
            <div class="row">
                <div class="col-md-12" id="divAbs" runat="server">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">ABSENT STUDENT ENTRY</h3>
                          <div style="color:red;" >Note:<span>&nbsp Disabled CheckedBox Indicate 'I' GRADE Entry </span></div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <%--added by prafull of commaon page--%>


                                             <div class="form-group col-md-4" id="divdegree" runat="server" visible="false">
                                                  <sup>* </sup>
                                                <label>Degree </label>
                                                <asp:DropDownList ID="ddldegree" runat="server" data-select2-enable="true" AppendDataBoundItems="true" CssClass="form-control"
                                                    OnSelectedIndexChanged="ddldegree_SelectedIndexChanged" AutoPostBack="True" TabIndex="4">
                                                    <asp:ListItem Value="0">Please Select</asp:ListItem>
                                                </asp:DropDownList>
                                             ...
                                             <div class="form-group col-md-4" id="divbranch" runat="server" visible="false">
                                                  <sup>* </sup>
                                                <label>Branch </label>
                                                <asp:DropDownList ID="ddlbranch" runat="server" data-select2-enable="true" AppendDataBoundItems="true" CssClass="form-control"
                                                    OnSelectedIndexChanged="ddlbranch_SelectedIndexChanged" AutoPostBack="True" TabIndex="5">
                                                    <asp:ListItem Value="0">Please Select</asp:ListItem>
                                                </asp:DropDownList>
                                             ...
                                             <div class="form-group col-md-4" id="divscheme" runat="server" visible="false">
                                                  <sup>* </sup>
                                                <label>Scheme </label>
                                                <asp:DropDownList ID="ddlscheme" runat="server" data-select2-enable="true" AppendDataBoundItems="true" CssClass="form-control"
                                                    OnSelectedIndexChanged="ddlscheme_SelectedIndexChanged" AutoPostBack="True" TabIndex="6">
                                                    <asp:ListItem Value="0">Please Select</asp:ListItem>
                                                </asp:DropDownList>
                                              ...
                                              <div class="form-group col-md-4" id="divsemester" runat="server" visible="false">
                                                  <sup>* </sup>
                                                <label>Semester </label>
                                                <asp:DropDownList ID="ddlsemester" runat="server" data-select2-enable="true" OnSelectedIndexChanged="ddlsemester_SelectedIndexChanged" AutoPostBack="true" AppendDataBoundItems="true" CssClass="form-control"
                                                    TabIndex="7">
                                                    <asp:ListItem Value="0">Please Select</asp:ListItem>
                                                </asp:DropDownList>
                                            ...
                                            <div class="form-group col-md-4">
                                               ...
                                               <div class="form-group col-md-4">
                                                ...
                                                <div class="form-group col-md-4" id="divexamtype" runat="server" visible="false">
                                                     <sup>* </sup>
                        ...
                        <div class="box-footer">
                            <p class="text-center">
                                ...
                                <p>
                                    ...
                                    <div class="col-md-12" id="div_Result" runat="server" visible="false">
                                                    ...
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td class="td7">
                                                                ...
                                                                <center><asp:CheckBox ID="chk_Absent" runat="server" class="chk_ab" Checked='<%# Eval("SMARK").ToString()=="902.00" ? true:false %>' Enabled='<%# Eval("SMARK").ToString().Equals("AB")?false:true %>'  /></center>
                                                            </td>
                                                         <%--   <td class="td8">
