<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="MarkEntryReports.aspx.cs" Inherits="ACADEMIC_EXAMINATION_MarkEntryReports" %>
                ...
                <div class="col-md-12 col-sm-12 col-12">
                    <div class="box box-primary">
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col-lg-3 col-md-6 col-12 form-group">
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvCollege2" runat="server" ControlToValidate="ddlcollege" Display="None" ErrorMessage="Please Select Institute." InitialValue="0" SetFocusOnError="True"
                                                ValidationGroup="Reports">
                                            </asp:RequiredFieldValidator>
                                            <asp:RequiredFieldValidator ID="rfvCollege3" runat="server" ControlToValidate="ddlcollege" Display="None" ErrorMessage="Please Select Institute." InitialValue="0" SetFocusOnError="True"
                                                ValidationGroup="ReportsDynamic">
                                            </asp:RequiredFieldValidator>
                                        ...
                                        <div class="col-lg-3 col-md-6 col-12 form-group">
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvSessionMarksEntryReport" runat="server" ControlToValidate="ddlSession"
                                                Display="None" ErrorMessage="Please Select Session." InitialValue="0" SetFocusOnError="True"
                                                ValidationGroup="MarksModifyReport"></asp:RequiredFieldValidator>
                                            <asp:RequiredFieldValidator ID="rfvsession2" runat="server" ControlToValidate="ddlSession" Display="None" ErrorMessage="Please Select Session." InitialValue="0" SetFocusOnError="True"
                                                ValidationGroup="Reports">
                                            </asp:RequiredFieldValidator>
                                            <asp:RequiredFieldValidator ID="rfvsession3" runat="server" ControlToValidate="ddlSession" Display="None" ErrorMessage="Please Select Session." InitialValue="0" SetFocusOnError="True"
                                                ValidationGroup="ReportsDynamic">
                                            </asp:RequiredFieldValidator>
                                        ...
                                        <div class="col-lg-3 col-md-6 col-12 form-group">
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvsemester" runat="server" ControlToValidate="ddlsemester"
                                                ...
                                                ValidationGroup="show"></asp:RequiredFieldValidator>
                                            <asp:RequiredFieldValidator ID="rfvsemester1" runat="server" ControlToValidate="ddlsemester" Display="None" ErrorMessage="Please Select Semester." InitialValue="0" SetFocusOnError="True"
                                                ValidationGroup="Reports">
                                            </asp:RequiredFieldValidator>
                                            <asp:RequiredFieldValidator ID="rfvsemester2" runat="server" ControlToValidate="ddlsemester" Display="None" ErrorMessage="Please Select Semester." InitialValue="0" SetFocusOnError="True"
                                                ValidationGroup="ReportsDynamic">
                                            </asp:RequiredFieldValidator>
                                        </div>

                                        <div class="col-lg-3 col-md-6 col-12 form-group" runat="server" visible="true">
                                            <div class="label-dynamic">
                                                <sup>* </sup>
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvSubjectType1" runat="server" ControlToValidate="ddlSubjectType" Display="None" ErrorMessage="Please Select Subject Type." InitialValue="0" SetFocusOnError="True"
                                                ValidationGroup="ReportsDynamic">
                                            </asp:RequiredFieldValidator>
                                        </div>
                                        ...
                                        <div class="col-lg-3 col-md-6 col-12 form-group">
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvCourse" runat="server" ControlToValidate="ddlCourse"
                                                ...
                                                ValidationGroup="show"></asp:RequiredFieldValidator>
                                            <asp:RequiredFieldValidator ID="rfvCourse1" runat="server" ControlToValidate="ddlCourse" Display="None" ErrorMessage="Please Select Course Name." InitialValue="0" SetFocusOnError="True"
                                                ValidationGroup="ReportsDynamic">
                                            </asp:RequiredFieldValidator>
                                        </div>

                                        <div class="col-lg-3 col-md-6 col-12 form-group" runat="server" id="DIVEXAM">
                                            <div class="label-dynamic">
                                                <sup>* </sup>
                                        ...
                                        <div class="col-lg-3 col-md-6 col-12 form-group" id="divSubExamName" runat="server" visible="false">
                                            <div class="label-dynamic">
                                                <sup>* </sup>
                        ...
                        <div class="col-12 btn-footer">
                            ...
                            <asp:Button ID="btnUnlock" runat="server" TabIndex="14" 
                            ...
                            <asp:Button ID="btnReport" TabIndex="15" runat="server" Text="Report" CssClass="btn btn-info"
                                OnClick="btnReport_Click" Enabled="false" Visible="false" />

                            <asp:Button ID="btnMarksModifyReport" TabIndex="15" runat="server"  ValidationGroup="MarksModifyReport"
                                Text="Marks Entry Report" CssClass="btn btn-info" OnClick="btnMarksModifyReport_Click" Visible="false" />

                            <asp:Button ID="btnIntReports" TabIndex="16" runat="server"  ValidationGroup="Reports"
                                Text="Internal Mark Entry Report" CssClass="btn btn-info" OnClick="btnIntReports_Click" Visible="true" />

                            <asp:Button ID="btnExtReports" TabIndex="17" runat="server"  ValidationGroup="Reports"
                                Text="External Mark Entry Report" CssClass="btn btn-info" OnClick="btnExtReports_Click" Visible="true" />

                            <asp:Button ID="btnConsolidatedReport" TabIndex="18" runat="server"  ValidationGroup="ReportsDynamic"
                                Text="Consolidated Mark Entry Report" CssClass="btn btn-info" OnClick="btnConsolidatedReport_Click" Visible="true" />

                            <asp:Button ID="btnWeightarpt" TabIndex="19" runat="server"  ValidationGroup="ReportsDynamic"
                                Text="Internal Weightagewise Report" CssClass="btn btn-info" OnClick="btnWeightarpt_Click" Visible="true" />   

                            <asp:Button ID="btnInternalReport" TabIndex="20" runat="server"  ValidationGroup="ReportsDynamic"
                                Text="Internal Markwise Report" CssClass="btn btn-info" OnClick="btnInternalReport_Click" Visible="true" />

                            <asp:Button ID="btnfinalmarkentry" TabIndex="21" runat="server"  ValidationGroup="MarksModifyReport"
                                Text="Final TH/PR Marks Entry Report" CssClass="btn btn-info" OnClick="btnfinalmarkentry_Click" Visible="false" />

                            <asp:Button ID="btnmarkexcel" TabIndex="22" runat="server"  ValidationGroup="MarksModifyReport"
                            ...
                            <asp:ValidationSummary runat="server" ID="ValidationSummary2" ValidationGroup="MarksModifyReport" DisplayMode="List"
                                ShowSummary="false" ShowMessageBox="true" />
                            <asp:ValidationSummary runat="server" ID="ValidationSummary3" ValidationGroup="Reports" DisplayMode="List"
                                ShowSummary="false" ShowMessageBox="true" />
                            <asp:ValidationSummary runat="server" ID="ValidationSummary4" ValidationGroup="ReportsDynamic" DisplayMode="List"
                                ShowSummary="false" ShowMessageBox="true" />
