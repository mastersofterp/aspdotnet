...
public partial class ACADEMIC_AuditCourseGradeAllotment : System.Web.UI.Page
{
   ...
   protected void btnShowResult_Click(object sender, EventArgs e)
    ...
    protected void ddlSem_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            objCommon.FillDropDownList(ddlCourse, "ACD_COURSE C INNER JOIN ACD_STUDENT_RESULT SR ON C.COURSENO = SR.COURSENO", "DISTINCT SR.COURSENO", "(SR.CCODE + ' - ' + SR.COURSENAME) COURSE_NAME ", "SR.SEMESTERNO = " + ddlSem.SelectedValue + "  AND SR.SESSIONNO =" + Convert.ToInt32(ddlSession.SelectedValue) + "AND SR.SCHEMENO=" + Convert.ToInt32(ViewState["schemeno"])+"AND ISNULL(SR.CREDITS,0)=0", "COURSE_NAME");
        }
        else
        {
            ddlCourse.SelectedIndex = 0;
