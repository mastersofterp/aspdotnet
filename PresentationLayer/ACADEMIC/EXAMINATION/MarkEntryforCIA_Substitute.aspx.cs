...
public partial class ACADEMIC_EXAMINATION_MarkEntryforCIA : System.Web.UI.Page
{
    ...
    {
        DataSet ds = objMarksEntry.GetCourseForTeacher_Substitute(Convert.ToInt16(ddlSession.SelectedValue), Convert.ToInt16(Session["userno"]), Convert.ToInt16(ddlSubjectType.SelectedValue));
    ...
    {
        DataSet ds = objMarksEntry.GetCourse_MarksEntryStatus_Substitute(Convert.ToInt16(ddlSession.SelectedValue), Convert.ToInt16(Session["userno"]), Convert.ToInt16(ddlSubjectType.SelectedValue));
        if (ds != null && ds.Tables[0].Rows.Count > 0)
        {
    ...
    protected void btnPrintReport_Click(object sender, EventArgs e)
    {
        ...
        {
            this.ShowReportMarksEntry("MarksListReport", "rptMarksList1_NEW_Subsitute_crescent.rpt");//rptMarksList1.rpt
        }
    }
    ...
    protected void lbtnPrint_Click(object sender, EventArgs e)
    {
        ...
        string ccode = objCommon.LookUp("ACD_COURSE", "CCODE", "COURSENO=" + Convert.ToInt32(ViewState["courseNo_POP"]));
        lbl_SubjectName.Text = coursename.ToString();
        ViewState["ccode_POP"] = ccode.ToString();
    ...
    protected void btnPrintFront_Click(object sender, EventArgs e)
    {
        ...
        {
            string reportTitle = "MarksListReport";
            string rptFileName = "rptMarksList1_NEW_Subsitute_crescent.rpt";
