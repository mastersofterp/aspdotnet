<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="BacklogExamregEndSem.aspx.cs"
    Inherits="ACADEMIC_EXAMINATION_BacklogExamregEndSem" %>
                            ...
                            <div class="box-body">
                                <div id="divNote" runat="server" visible="true" style="border: 2px solid #C0C0C0; background-color: #FFFFCC; padding: 20px; color: #990000;">
                                    <b>Note : </b>Steps To Follow For Backlog Exam Registration.
                                        <div style="padding-left: 20px; padding-right: 20px">
                                            ...
                                            <p style="padding-top: 5px; padding-bottom: 5px;">
                                                2. Please crosss check Course List before the Submission of Backlog Course.
                                            </p>
                                            <p style="padding-top: 5px; padding-bottom: 5px;">
                                                3. Backlog Course Registration Slip Available after the Approval by the Authority.
                                            </p>

                                             <p style="padding-top: 5px; padding-bottom: 5px;">
                                                4. You can not Modify Backlog Course Registration after Approval.
                                            </p>
                                ...
                                <div class="form-group col-md-12" runat="server" id="divRegMsg" visible="false">
                                    <marquee direction="left">
                                     <span style="color:red"> 
                                         <p>Backlog Exam Registration is done for Selected Session.</p>
                                     </span> 
                                    </marquee>
                                </div>

                                 <div class="form-group col-md-12" runat="server" id="divAppPenRegMsg" visible="false">
                                    <marquee direction="left">
                                     <span style="color:red"> 
                                         <p>Backlog Exam Registration is done for Selected Session but Approval is Pending..</p>
                                     </span> 
                                    </marquee>
                                </div>
                                ...
                                <div class="row" id="divCourses" runat="server" visible="false">
                                    <div class="col-md-12" id="tblInfo" runat="server">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group col-md-4" style="display:none">
                                                  ...
                                                  <%--  <asp:DropDownList ID="ddlBackLogSem" runat="server" AutoPostBack="True" CssClass="form-control" 
                                                        OnSelectedIndexChanged="ddlBackLogSem_SelectedIndexChanged" AppendDataBoundItems="True"
                                        ...
                                        <div class="row" runat="server" id="credits" style="display:none" visible="false">
                                                    ...
                                                    <asp:ListView ID="lvFailCourse" runat="server">
                                                        ...
                                                        <ItemTemplate>
                                                            <tr id="trCurRow" class="item">
                                                                <td>
                                                                    <asp:CheckBox ID="chkAccept" runat="server" onclick="CheckSelectionCount(this)" Checked='<%# (Eval("ACCEPTED").ToString())=="1"? true:false %>'  /><%-- onclick="exefunction(this,'hdncurcredits')"--%>
                                        ...
                                        <div class="row text-center">
                                            ...
                                            <asp:Button ID="btnExamRegistrationApprove" runat="server"
                                                OnClick="btnExamRegistrationApprove_Click" Visible="false" Text="Submit & Approve" CssClass="btn btn-warning" Font-Bold="true" />
                                            
                                           &nbsp; <asp:Button ID="btnReport1" runat="server"
                                                OnClick="btnReport_Click" Text="Print Slip" Visible="false" ValidationGroup="backsem" CssClass="btn btn-warning" Font-Bold="true" />
                    ...
                    <script type="text/javascript" language="javascript">
                        function CheckSelectionCount(chk) {
                            ...
                            for (i = 0; i < document.forms[0].elements.length; i++) {
                                ...
                                if (count == 2) {
                                    chk.checked = false;
                                    alert("You can not register more than two backlog course in Current Semester.!");
                                    return;
                                }
                                else if (count < 2) {
                                    if (e.checked == true) {
                        ...
                        function showConfirm() {
                            var ret = confirm('Do you really want to Submit this Courses for Backlog Exam Registration?');
                            if (ret == true)
                                return true;
                            else
                                return false;
