...
public partial class ACADEMIC_EXAMINATION_Bulk_Ex_Stud_Exam_Registration_Report : System.Web.UI.Page
{
    ...
    private void ShowReport(string reportTitle, string rptFileName)
    {
        try
        {
            ...
            url += "&param=@P_COLLEGE_CODE=" + Session["colcode"].ToString() + ",@P_SESSIONNO=" + Convert.ToInt32(ddlSession.SelectedValue) + ",@P_SCHEMENO=" + Convert.ToInt32(ddlScheme.SelectedValue) + ",@P_SEMESTERNO=" + Convert.ToInt32(ddlSemester.SelectedValue) + ",@P_COURSENO=" + ddlCourse.SelectedValue + ",@P_SECTIONNO=" +ddlSection.SelectedValue+",@P_BRANCHNO="+ddlBranch.SelectedValue;
    ...
    protected void btnReport_Click(object sender, EventArgs e)
    {
        try
        {   
            ShowReport("Ex_Exam_Wise_Registration_Report", "rptBulkExstudentExamwiseStudent.rpt");
        }
        catch (Exception ex)
        {
            if (Convert.ToBoolean(Session["error"]) == true)
    ...
    protected void btnExcel_Click(object sender, EventArgs e)
    {
        ...
        ShowReportinFormate("xls", "rptBulkExstudentExamwiseStudent.rpt");
