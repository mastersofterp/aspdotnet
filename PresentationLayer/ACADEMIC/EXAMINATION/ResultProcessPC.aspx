<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="ResultProcessPC.aspx.cs" 
    Inherits="ACADEMIC_EXAMINATION_ResultProcessPC" %>
    ...
    <asp:UpdatePanel ID="updresult" runat="server">
        <ContentTemplate>
            <table cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td class="vista_page_title_bar" colspan="2" style="height: 30px">PC RESULT PROCESS
            ...
            <div style="padding-left: 10px; width: 99%">
                <fieldset class="fieldset1">
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                        ...
                        <tr>
                            <td class="form_left_label" style="width: 15%;">College / School Name :
                            </td>
                            <td class="form_left_text">
                        ...
                        <tr style="display: none;">
                            <td class="form_left_label">Section :
                            </td>
                            <td class="form_left_text">
                        ...
                        <tr style="display: none;">
                            <td class="form_left_label">Student Type:
                            </td>
                            <td class="form_left_text">
                        ...
                        <tr style="display: none;">
                            <td class="form_left_label">Exam Type:
                            </td>
                            <td class="form_left_text">
                        ...
                        <tr style="display: none;">
                            <td class="form_left_label">Student :
                            </td>
                            <td class="form_left_text">
                        ...
                        <tr>
                            ...
                            <td class="form_left_text">
                                ...
                                <asp:Button ID="btnLock" runat="server"
                                    Text="Lock" ValidationGroup="report" Width="100px" OnClientClick="return ConfirmLock();" Enabled="false" OnClick="btnLock_Click" />
                ...
                <table>
                    <tr>
                        <td colspan="2" style="text-align: center; width: 70%;">
                            <asp:ListView ID="lvStudent" runat="server">
                                ...
                                <ItemTemplate>
                                    <tr class="item" onmouseover="this.style.backgroundColor='#FFFFAA'" onmouseout="this.style.backgroundColor='#FFFFFF'">
                                        ...
                                        <td>
                                            <asp:Label runat="server" ID="lblPstatus" Font-Bold="true" Text='<%# (Eval("PROCESS_STATUS"))%>' ForeColor='<%# (Convert.ToInt32(Eval("pstatus") )== 1 ?  System.Drawing.Color.Green : System.Drawing.Color.Red )%>'></asp:Label>
                                        </td>
                                        <td>&nbsp;
                                        </td>
                                        <td>&nbsp;
