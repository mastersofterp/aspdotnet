<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true"
    CodeFile="Bulk_Ex_Stud_Exam_Registration_Report.aspx.cs" Inherits="ACADEMIC_EXAMINATION_Bulk_Ex_Stud_Exam_Registration_Report" %>
    ...
    <table cellpadding="0" cellspacing="0" width="99%">
        <tr>
            <td class="vista_page_title_bar" style="height: 30px">
                &nbsp;BULK EX-STUDENT REGISTRATION REPORT
        ...
        <tr >
            <td style="padding-left: 15px;">
                <fieldset class="fieldset">
                    <legend class="legend">Bulk Ex-Student Registration Report</legend>
