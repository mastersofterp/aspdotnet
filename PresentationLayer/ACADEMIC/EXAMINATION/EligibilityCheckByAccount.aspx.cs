...
public partial class ACADEMIC_EXAMINATION_EligibilityCheckByAccount : System.Web.UI.Page
{
    ...
    private void show_StudentsForDetaintion()
    {
        try
        {
            ...
            DataSet ds = null;
            ds = detCan.GetStudentListForDetention(Convert.ToInt32(ddlSession.SelectedValue), Convert.ToInt32(ddlScheme.SelectedValue), Convert.ToInt32(ddlSem.SelectedValue), 1);
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                cs = (CustomStatus)detCan.UpdateDetention(sessionNo, idNos, schemono, semesterNo, provDetentions, finalDetentions, collageCode, 1, Remarks, Convert.ToInt32(Session["userno"]), Status);
    ...
    private void ShowReport(string reportTitle, string rptFileName)
    {
        try
        {
            ...
            url += "&param=@P_SESSIONNO=" + Convert.ToInt32(ddlSession.SelectedValue) + ",@P_SCHEMENO=" + Convert.ToInt32(ddlScheme.SelectedValue) + ",@P_SEMESTERNO=" + Convert.ToInt32(ddlSem.SelectedValue) + ",@P_DETANIED_BY=1,@P_COLLEGE_CODE=" + Session["colcode"].ToString() + ",@P_USER_NAME=" + Session["username"].ToString();
