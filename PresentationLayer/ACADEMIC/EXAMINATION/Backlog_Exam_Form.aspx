<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="Backlog_Exam_Form.aspx.cs" Inherits="ACADEMIC_EXAMINATION_Backlog_Exam_Form" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                ...
                <div class="col-md-12 col-sm-12 col-12">
                    <div class="box box-primary">
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title">BACKLOG EXAM FORM FILLUP</h3>
                        </div>
                        ...
                        <div class="box-body">
                            <div id="divCourses" runat="server" visible="false">
                                <div class="col-12" id="tblSession" runat="server" visible="false">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-3 col-md-6 col-12">
                                            ...
                                            <asp:TextBox ID="txtRollNo" CssClass="form-control" runat="server" MaxLength="15" />
                                        </div>
                                ...
                                <div class="col-12" id="tblInfo" runat="server" visible="false">
                                    ...
                                    <div class="row" id="divSemester" runat="server">
                                        <div class="form-group col-lg-3 col-md-6 col-12">
                                            <div class="label-dynamic">
                                                <label>Semester</label>
                                            </div>
                                            <asp:DropDownList ID="ddlSemester" runat="server" AutoPostBack="true" AppendDataBoundItems="true"
                                                OnSelectedIndexChanged="ddlSemester_SelectedIndexChanged" CssClass="form-control" data-select2-enable="true">
                                                <asp:ListItem Value="0">Please Select</asp:ListItem>
                                            </asp:DropDownList>
                                            <asp:RequiredFieldValidator ID="rfvSemester" ControlToValidate="ddlSemester" runat="server" InitialValue="0"
                                                Display="None" ErrorMessage="Please Select Semester" ValidationGroup="SUBMIT" />
                                        </div>
                                    </div>

                                    <div class="form-group col-md-12" id="divphotosign" runat="server" style="display:none">
                                    ...
                                    <div class="col-12">
                                        <asp:Label ID="lblNote" runat="server" Text="Note : Examination Fees For Regular Rs. 1200 and For Backlog Papers Rs. 1000 per Semester.
                                            Please Ensure to submit the Examination Fees by Online Payment to get the Exam Admit Card and to Appear in the Examination." Font-Bold="true" ForeColor="Red"></asp:Label>                                       
                                    ...
                                    <div class="col-md-12" id="pnlDept" runat="server" visible="False">
                                        ...
                                        <div class="col-md-12">
                                            <asp:ListView ID="lvStudent" runat="server" OnItemDataBound="lvStudent_ItemDataBound">
                                                <LayoutTemplate>
                                                    <div class="sub-heading"><h5>Students List</h5></div>
    ...
    <script type="text/javascript" language="JavaScript">
        ...
        function showConfirm() {
            ...
            if (count == 0 && count1 == 0) {
                var ddlSem = document.getElementById("<%=ddlSemester.ClientID%>").value;
                if (ddlSem == 0) {
