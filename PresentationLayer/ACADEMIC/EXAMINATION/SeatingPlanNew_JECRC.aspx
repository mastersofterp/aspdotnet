<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="SeatingPlanNew_JECRC.aspx.cs" Inherits="ACADEMIC_SEATINGARRANGEMENT_SeatingPlanNew" ViewStateEncryptionMode="Always" EnableViewStateMac="true"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function IsNumberExist(txt, headid) {
            ...
            $("#tblroomcapacity TBODY TR").each(function () {
                ...
                // var SeqNum = $(this).find('td').find("input").eq(6).html();
                var SeqNum = $(this).find('td').find("input").eq(3).val();
                //var seqe = SeqNum.val;
                // alert(seqe);
                // alert(SeqNum);
                if (SeqNum == "") {
                    ...
                    $("#tblroomcapacity TBODY TR").each(function () {
                        ...
                        var EnterNum = $(this).find('td').find("input").eq(3).val();
                        if (SeqNum != "" && EnterNum != "") {
                            if (SeqNum == EnterNum && EnterNum > 0) {
                                alert('Sequence ' + EnterNum + ' already exist.');
                                SeqNum.val = '';
                                SeqNum = '';
                                return false;
                            }
    ...
    <%--  <script language="javascript" type="text/javascript">
         function  CheckBranch(chkCourse) {
    ...
    <script type="text/javascript">
        function Navigate() {
            debugger
            // var cheall = document.getElementById("ctl00_ContentPlaceHolder1_lvExamCoursesOnDate_chkCourse1").che;

            if ($("#ctl00_ContentPlaceHolder1_lvExamCoursesOnDate_chkCourse1").prop('checked') == true) {


                var table = document.getElementById('tblExamCourses');
                ...
                for (var i = 0; i < rowLength - 1; i += 1) {
                    ...
                    // $("#ctl00_ContentPlaceHolder1_lvExamCoursesOnDate_ctrl0_chkStudent").prop('checked', true);
                    $("#ctl00_ContentPlaceHolder1_lvExamCoursesOnDate_ctrl" + i + "_chkStudent").prop('checked', true);
                ...
                for (var i = 0; i < rowLength - 1; i += 1) {
                    ...
                    // $("#ctl00_ContentPlaceHolder1_lvExamCoursesOnDate_ctrl0_chkStudent").prop('checked', true);
                    $("#ctl00_ContentPlaceHolder1_lvExamCoursesOnDate_ctrl" + i + "_chkStudent").prop('checked', false);
                                            ...
                                            <div class="col-lg-6 col-md-6 col-12">
                                                <ul class="list-group list-group-unbordered">
                                                    <li class="list-group-item pl-md-0 pr-md-0"><b>Seating Plan:</b>
                                                        <a class="sub-label">
                                                            <asp:RadioButton ID="RadioButton1" runat="server" Text="Single" GroupName="Status" Checked="true"/>&nbsp;&nbsp;
                                                            <asp:RadioButton ID="RadioButton2" runat="server" Text="Double" GroupName="Status" />&nbsp;&nbsp;
                                                            <asp:RadioButton ID="RadioButton3" runat="server" Text="Triple" Visible="false" GroupName="Status" />&nbsp;&nbsp;
                                                ...
                                                <thead>
                                                    <tr class="bg-light-blue">
                                                        ...
                                                        <th style="text-align: left;">Select
                                                             <asp:CheckBox ID="chkCourse1" runat="server" AutoPostBack="true" Visible="false" onclick=" Navigate();" OnCheckedChanged="chkCourse1_CheckedChanged" />
                                                        </th>
                                                        <th>Branch </th>
                                                        <th>Course </th>
                                                        <th>Session Name </th>
                                        ...
                                        <ItemTemplate>
                                            <tr class="item">
                                                <td style="text-align: center;">
                                                    <asp:CheckBox ID="chkStudent" runat="server" ToolTip="Select to view Branch " AutoPostBack="true" OnCheckedChanged="chkStudent_CheckedChanged" />
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <asp:Label ID="Label1" runat="server" Text='<%# Eval("SESSION_NAME")%>' ToolTip='<%# Eval("SESSIONNO")%>' />
                                                </td>
                                                <td>
                            ...
                            <div class="col-12 mt-3">
                                <asp:Panel ID="pnlRoomDetails" runat="server" Visible="false">
                                    ...
                                    <asp:ListView ID="lvRoomDetails" runat="server">
                                        <LayoutTemplate>
                                            <div class="table-responsive">
                                                <table id="tblroomcapacity" class="table table-striped table-bordered nowrap" style="width: 100%;">
                                                    <thead>
                                                        <tr class="bg-light-blue">
                                                            <th>Select Room
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                <td class="text-center">
                                                    <asp:CheckBox ID="chckroom" runat="server" ToolTip='<%# Eval("ROOMNO") %>' onclick="chkIndividualRoom(this,2),EnableTextBox(this);"/>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtRoomSrNo" runat="server" MaxLength="2" OnTextChanged="txtRoomSrNo_TextChanged" Onblur="IsNumberExist(this,2);" Text='<%# Eval("SEQUENCENO")%>'
