<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="MarkEntryforCIA_Substitute.aspx.cs" Inherits="ACADEMIC_EXAMINATION_MarkEntryforCIA" %>
                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">CAT Exam Mark Entry For Substitute</h3>
                        </div>
                        ...
                        <%--<div class="box-header with-border bounce" id="divstatus" runat="server" visible="false">
                            <marquee onmouseover="this.stop();" onmouseout="this.start();><b>This is to inform you that Mark Entry activity(s) For Session :
                                ...
                                <asp:Label ID="lblStopDate" style="color:#3c8dbc;" runat="server"></asp:Label> , so kindly enter the marks and lock for your respective courses !!!!!</b></marquee>
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                          <%--  <div class="col-md-3">
                                                ...
                                                <asp:DropDownList ID="ddlcollege" runat="server" OnSelectedIndexChanged="ddlcollege_SelectedIndexChanged" AutoPostBack="true" AppendDataBoundItems="true" Font-Bold="true" CssClass="form-control">
                                                </asp:DropDownList>
                                            </div>--%>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <asp:DropDownList ID="ddlSession" runat="server" OnSelectedIndexChanged="ddlSession_SelectedIndexChanged" AutoPostBack="true" 
                                                    AppendDataBoundItems="true" Font-Bold="true" CssClass="form-control">
                                                            ...
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <asp:LinkButton ID="lbtnPrint" runat="server" CssClass="btn btn-default" OnClick="lbtnPrint_Click" CommandArgument='<%# Eval("COURSENO")+","+Eval("SECTIONNO")+","+Eval("semesterno")+","+Eval("FLDNAME")+","+Eval("EXAMNO")+","+Eval("EXAMNAME")+","+Eval("COURSENAME") %>'><i class="fa fa-print" aria-hidden="true"></i></asp:LinkButton>
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <asp:DropDownList ID="ddlExam" runat="server" AppendDataBoundItems="True" AutoPostBack="true" CssClass="form-control" 
                                                    OnSelectedIndexChanged="ddlExam_SelectedIndexChanged" ValidationGroup="show">
                                                    <asp:ListItem Value="0">Please Select</asp:ListItem>
                                                </asp:DropDownList>
                                            </div>
                                            <div class="col-md-3">
                                                <sup>* </sup><asp:Label ID="lblSubExamName" runat="server" Text="Sub Exam :" CssClass="label" Style="color: black; font-size: 14px; padding-left: 0px"></asp:Label>
                                        ...
                                        <asp:Repeater ID="rptMarkCodes" runat="server">
                                            <HeaderTemplate>
                                              ...
                                              <%--          <h3 style="margin-top: 5px; margin-bottom: 5px">Note</h3>--%>
                                                        <span style="font-weight: bold; color: Red; font-size: 12px">Note : Please Save and Lock for Final Submission of Marks</span>
                                                    </div>
                                                    ...
                                                    <div id="demo-grid" class="vista-grid">
                                                        ...
                                                        <asp:GridView ID="gvStudent" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered myCss" BackColor="#ffffff" BorderStyle="None" HeaderStyle-CssClass="GridHeader" OnRowDataBound="gvStudent_RowDataBound">
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="RRN" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="2%" HeaderStyle-CssClass="text-center">
                                                                    <ItemTemplate>
                                                                ...
                                                                <asp:TemplateField HeaderText="Adm. No." ItemStyle-HorizontalAlign="Center" ItemStyle-Width="2%" HeaderStyle-CssClass="text-center">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblAdmNo" runat="server" Text='<%# Bind("ENROLLNO") %>' ToolTip='<%# Bind("IDNO") %>'
                                                                            Font-Size="11pt"></asp:Label>
                                                                    </ItemTemplate>
                                                                    <ItemStyle HorizontalAlign="Center" Width="5%" />
                                                                </asp:TemplateField>
                                                                ...
                                                                <asp:BoundField DataField="STUDNAME" HeaderText="Student Name" ItemStyle-HorizontalAlign="Left"
                                                                 ...
                                                                 <%-- <asp:TemplateField HeaderText="Internal Marks" Visible="false" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="2%" HeaderStyle-CssClass="text-center">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblAdmNo" runat="server" Text='<%# Bind("ENROLLNO") %>' ToolTip='<%# Bind("IDNO") %>'
                                                                            Font-Size="11pt"></asp:Label>
                                                                    </ItemTemplate>
                                                            ...
                                                            <FooterStyle BackColor="#F7DFB5" ForeColor="#8C4510" />
                                                            <HeaderStyle BackColor="#6b99c7" Font-Bold="True" ForeColor="White" />
                                                            <PagerStyle ForeColor="#8C4510" HorizontalAlign="Center" />
