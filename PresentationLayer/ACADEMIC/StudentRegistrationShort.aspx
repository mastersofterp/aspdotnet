                            ...
                            <div class="box-footer">
                                <p class="text-center">
                                     <asp:Button ID="btnSubmit" ToolTip="Submit Details" runat="Server" Text="Submit" ValidationGroup="Show"
                                        ...
                                        <asp:Button ID="btnCancel" runat="server" ToolTip="Cancel" Text="Cancel"  CssClass="btn btn-warning" OnClick="btnCancel_Click" />&nbsp;&nbsp;
                                        <asp:Button ID="btnStudlist" ToolTip="View Student List" runat="Server" Text="View Student list"
                                           CssClass="btn btn-info" OnClick="btnStudlist_Click" ValidationGroup="Showlv" />
                                ...
                                <div>  <asp:Label ID="lblStatus" runat="server" SkinID="Errorlbl" /></div>
