<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/SiteMasterPage.master" CodeFile="BulkPrintRegistrationSlip.aspx.cs"
    Inherits="ACADEMIC_BulkPrintRegistrationSlip" %>
                ...
                <div class="col-md-12 col-sm-12 col-12">
                    <div class="box box-primary">
                        ...
                        <div class="box-header with-border">
                            <%-- <h3 class="box-title">Bulk Print Registration-Slip</h3>--%>
                            <h3 class="box-title">
                            ...
                            <div class="col-12">
                                <div class="row">
                                    <div class="form-group col-lg-3 col-md-6 col-12">
                                        ...
                                        <asp:DropDownList ID="ddlAdmbatch" runat="server" TabIndex="1" CssClass="form-control" data-select2-enable="true"
