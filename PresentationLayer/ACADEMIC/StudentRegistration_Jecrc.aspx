<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="StudentRegistration_Jecrc.aspx.cs" Inherits="ACADEMIC_StudentRegistration_Jecrc" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                            ...
                            <div class="box-body">
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-3 col-md-6 col-12" id="divDateofBirth" runat="server" visible="false">
                                            <%--style="display: none"--%>
                                            <div class="label-dynamic">
    ...
    <script>
        function confirmhostel() {
            ...
            debugger;
            if (Page_ClientValidate('academic'))
