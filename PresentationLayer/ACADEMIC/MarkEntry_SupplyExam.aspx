<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="MarkEntry_SupplyExam.aspx.cs"
                ...
                <div class="col-md-12 col-sm-12 col-12">
                    <div class="box box-primary">
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title">Supplementary Mark Entry <small class="text-capitalize">(Selection Criteria for Marks Entry)</small> </h3>
                        </div>
                        ...
                        <div class="box-body">
                            ...
                            <asp:Panel ID="pnlMarkEntry" runat="server">
                                ...
                                <div class="col-12 btn-footer">
                                    ...
                                    <asp:Button ID="btnReport" runat="server" Font-Bold="true" Text="REPORT" CssClass="btn btn-info" Style="display:none;"
                ...
                $("#ctl00_ContentPlaceHolder1_gvStudent .form-control").keyup(function () {
                    ...
                    var grid = document.getElementById("<%= gvStudent.ClientID%>");
                      for (var i = 0; i < grid.rows.length - 1; i++) {
                          ...
                          //if (parseInt(obt.val()) == '902' || parseInt(obt.val()) == '903' || parseInt(obt.val()) == '905') {    

                          //}
                          if (parseFloat(obt.val()) > parseFloat(GreaterMark.val())) {    //Cha
                              obt.val('');
                              txtTotMark.val('');
                              percnt.val('');
                              Grade.val('');
