            ...
            <table cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td colspan="3" style="padding-left: 40%;">
                      ...
                      <%--  <asp:Button ID="btnPayHere" ValidationGroup="submit" runat="server" Text="Pay Here" Style="font-family: Verdana; font-size: 8pt; font-weight: bold; width: 123px;" class="buttonStyle ui-corner-all" />--%>
                    </td>
                </tr>
            </table>
        </form>
