...
<script type="text/javascript">
    ...
    <table style="width: 100%">
        <tr>
            <td style="border: 1px solid #C0C0C0; font-size: 11pt; font-weight: bold; text-align: center;
                background-color: #E1E1E1; color: #993300;">
                ...
                <table cellspacing="2" style="width: 100%">
                    <tr>
                        <td style="width:20%; text-align: right;">
                            Select Branch Preferences. Pref. 1.</td>
                        <td>
