<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="PhotoCopyRegistration.aspx.cs"
    Inherits="ACADEMIC_PhotoCopyRegistration" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                ...
                <div class="col-md-12 col-sm-12 col-12">
                    <div class="box box-primary">
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title">PHOTO COPY APPLY</h3>
                        </div>
                        <div class="box-body" id="divCourses" runat="server" visible="false">
                            <div class="col-12" id="tblSession" runat="server" visible="false">
                                <div class="row">
                                    <div class="form-group col-lg-3 col-md-6 col-12" id="divSession" runat="server">
                                        <div class="label-dynamic">
                                            <sup>*</sup>
                                           <asp:Label ID="lblDYCollegeSession" runat="server" Font-Bold="true"></asp:Label>
                                        </div>
                                    ...
                                    <div class="form-group col-lg-3 col-md-6 col-12" id="divRollNo" runat="server" visible="false">
                                        <div class="label-dynamic">
                                            <sup>*</sup>
                                ...
                                <div class="col-12 btn-footer">
                                    <asp:Button ID="btnShow" runat="server" OnClick="btnShow_Click" Text="Show" Font-Bold="true" ValidationGroup="Show" CssClass="btn btn-outline-primary" />
                            ...
                            <div class="col-12 mt-3" id="tblInfo" runat="server" visible="false">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <ul class="list-group list-group-unbordered">
                                            ...
                                            <li class="list-group-item"><b>Univ. Reg. No. / Adm. No. :</b>
                                                <a class="sub-label">
                        ...
                        <div class="col-12" id="divAllCoursesFromHist" runat="server" visible="false">
                                    ...
                                    <LayoutTemplate>
                                        <div>
                                            <div class=" sub-heading">
                                                <h5>Subject List for Photo Copy</h5>
                                            </div>
                            ...
                            <div class="col-12 btn-footer">
                                ...
                                <asp:Button ID="btnSubmit" runat="server" Text="Submit" OnClick="btnSubmit_Click" Visible="false"
                                    ValidationGroup="Submit" CssClass="btn btn-primary" />   <%--OnClientClick="return showConfirm();"--%>
                                ...
                                <asp:Button ID="btnPrintRegSlip" runat="server" Text="Registration Slip" OnClick="btnPrintRegSlip_Click"
                                   ...
                                   <asp:Button ID="btnPaymentReport" runat="server" Text="Payment Receipt" OnClick="btnPaymentReport_Click"
                                    Visible="false" CssClass="btn btn-info" />
                        ...
                        <div class="col-md-12" id="divRegCourses" runat="server" visible="false">
                            <asp:Panel ID="pnlFinalCourses" runat="server" ScrollBars="Auto">
                                <asp:ListView ID="lvFinalCourses" runat="server">
                                    <LayoutTemplate>
                                        <div>
                                            <h3>
                                                <label class="label label-default">Registered Subject List for Photo Copy</label></h3>
                                    ...
                                    <ItemTemplate>
                                        <tr id="trCurRow">
                                            ...
                                            <%-- <td style="text-align: center;">
                                                        <asp:Label ID="lblMarks" runat="server" Text='<%# Eval("EXTERMARK") %>' />
                                                    </td>--%>
                                            <td style="text-align: center;">
                                                <asp:Label ID="lblAmount" runat="server" Text='<%# Eval("PRF_AMOUNT") %>' />
                                            </td>
                                        </tr>
                                    </ItemTemplate>
                                </asp:ListView>
                            ...
                            <p class="text-center">
                                <asp:Button ID="btnPayOnline" runat="server" Text="Online Payment" OnClick="btnPayOnline_Click1" 
                                    ValidationGroup="Submit"  CssClass="btn btn-primary" />  <%-- OnClientClick="return showPayConfirm();"--%>

                                <asp:Button ID="btnChallan" runat="server" Text="Challan Receipt" Visible="false"
                                    OnClientClick="return showChallanConfirm();" OnClick="btnChallan_Click" CssClass="btn btn-primary" />
    ...
    <script type="text/javascript" language="JavaScript">
        ...
        function showConfirm() {
            var ret = confirm('Do you Really want to Submit this Subjects for Photo Copy?');
            if (ret == true) {
        ...
        function showPayConfirm() {
            var ret = confirm('Applied photocopy details Will be confirmed only after successful payments.Do you Really want to Pay Amount Online ?');
            if (ret == true) {
                //FreezeScreen('Please Wait, Your Data is Being Processed...');
                validate = true;
            }
        ...
        function showChallanConfirm() {
            var ret = confirm('Do you Really want to Print Photo Copy Challan ?');
            if (ret == true) {
                //FreezeScreen('Please Wait, Your Data is Being Processed...');
                validate = true;
            }
