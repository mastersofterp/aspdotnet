...
public partial class ACADEMIC_DegreeSpecMapping : System.Web.UI.Page
{
    ...
    private void BindListViewDegree()
    {
        ...
        catch (Exception ex)
        {
            if (Convert.ToBoolean(Session["error"]) == true)
                objUCommon.ShowError(Page, "OnlineAdmission.DegreeSpecMapping()-> " + ex.Message + " " + ex.StackTrace);
            else
