<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="BranchChangeApproveFirstLevel.aspx.cs" Inherits="ACADEMIC_BranchChangeApproveFirstLevel" %>
                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title"><b>Programme/Branch Change Approval</b></h3>
                                        ...
                                        <asp:ListView ID="lvBranchChange" runat="server" OnItemDataBound="lvBranchChange_ItemDataBound">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:ImageButton ID="btnEdit" runat="server" CausesValidation="false" ImageUrl="~/images/edit1.gif"
                                                    ...
                                                    <td>
                                                        <%# Eval("REGNO")%>
                                                        <asp:Label ID="lblIDNO" runat="server" ToolTip='<%# Eval("REGNO")%>' Text='<%# Eval("IDNO")%>' Visible="false"></asp:Label>
                                                    </td>
                                                    <td>
                                                        <%# Eval("OLD_BRANCH")%>
                                                        <asp:Label ID="lblOldBranch" runat="server" Text='<%# Eval("OLD_BRANCH")%>' ToolTip='<%# Eval("STUDNAME")%>' Visible="false"></asp:Label>
                                                        <asp:HiddenField ID="hdncollege" runat="server" Value='<%# Eval("COLLEGE_NAME") %>' />
                                                    </td>
                                                    <td>
                                                        <%# Eval("NEW_BRANCH")%>
                                                           <asp:Label ID="lblNewBranch" runat="server" Text=' <%# Eval("NEW_BRANCH")%>' ToolTip='<%#Eval("DEGREE") %>' Visible="false"></asp:Label>
                                                    </td>
                                                    <td>
