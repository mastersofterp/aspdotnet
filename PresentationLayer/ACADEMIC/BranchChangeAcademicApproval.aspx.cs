...
public partial class ACADEMIC_BranchChangeAcademicApproval : System.Web.UI.Page
{
    ...
    private void BindListView()
    {
        try
        {
            int colelge_id = ddlCollege.SelectedIndex > 0 ? Convert.ToInt32(ddlCollege.SelectedValue) : 0;
            ...
            ds = objBrn.GetStudentsforBranchangeAcademicApproval(colelge_id,degreeno);
        ...
        try
        {
            ...
            foreach (ListViewDataItem dataitem in lvBranchChange.Items)
            {
                ...
                if (cbRow.Checked == true && cbRow.Enabled == true)
                {
                    ...
                    objBrn.Branch_Change_ACADEMIC_Level(Convert.ToInt32(lblIDNO.Text), Convert.ToInt32(Session["userno"]), txtRemark.Text);
                    count++;
                    TransferToEmail(lblOldBranch.ToolTip,lblIDNO.ToolTip,lblOldBranch.Text, lblNewBranch.Text, txtRemark.Text);
                }
            }
            if (count < 1)
            {
    ...
    {
        string attachment = "attachment; filename=" + "Programme_BranchChangeExcel.xls";
    ...
    protected void ddlCollege_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            objCommon.FillDropDownList(ddlDegree,"ACD_DEGREE D INNER JOIN ACD_COLLEGE_DEGREE_BRANCH CDB ON (CDB.DEGREENO=D.DEGREENO)", "DISTINCT D.DEGREENO", "DEGREENAME", "COLLEGE_ID=" + ddlCollege.SelectedValue, "");
            //BindListView();
        }
    }
          ...
          //  string Session = ddlSession.SelectedItem.Text;
           ...
           string useremail = objCommon.LookUp("ACD_BRANCHCHANGE_EMAIL_CONFIG", "EMAIL_ID", "CONFIG_NO=2");
            ...
            if (dsconfig != null)
            {
                ...
                mailBody.AppendFormat("<br />");
                mailBody.AppendFormat("<b>New College Name  : </b>" + ddlCollege.SelectedItem.Text + ",</b>");
                mailBody.AppendFormat("<br />");
                mailBody.AppendFormat("<br />");
