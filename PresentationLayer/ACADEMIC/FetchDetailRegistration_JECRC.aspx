<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="FetchDetailRegistration_JECRC.aspx.cs" Inherits="ACADEMIC_FetchDetailRegistration_JECRC" %>
                            ...
                            <asp:ListView ID="lvStudent" runat="server" OnItemDataBound="lvStudent_ItemDataBound">
                                ...
                                <ItemTemplate>
                                    <tr class="item">
                                        ...
                                        <td>
                                            <asp:LinkButton ID="lnkUserId" CausesValidation="false" runat="server" Text='<%# Eval("USERNAME") %>' CommandArgument='<%# Eval("USERNO") %>' OnClick="lnkUserId_Click" ToolTip='<%# Eval("APPLICATION_STATUS") %>'></asp:LinkButton>
                                            <%--<%# Eval("USERNAME")%>--%>
                                            <%--<%# Eval("LASTNAME")%>--%> 
                                        ...
                                        <td>
                                            <asp:Label ID="lblAppStatus" runat="server" Text='<%# Eval("APPLICATION_STATUS")%>'></asp:Label>
                                        ...
                                        <td>
                                            <asp:Button ID="btnSendOffer" CausesValidation="false" runat="server" Text="Send Offer" CssClass="btn btn-info" CommandArgument='<%# Eval("USERNO")%>' CommandName='<%# Eval("USERNO")%>' ToolTip='<%# Eval("IDNO") %>' OnClick="btnSendOffer_Click" />
                                        </td>
                                        <%-- <td>
