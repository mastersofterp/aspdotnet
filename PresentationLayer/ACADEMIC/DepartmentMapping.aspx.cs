...
public partial class ACADEMIC_MASTERS_DepartmentMapping : System.Web.UI.Page
{
    ...
    private void BindListView()
    {
        try
        {
            DataSet ds = objCommon.FillDropDown("ACD_COLLEGE_DEPT a inner join acd_dePARTMENT b on(a.dePTno=b.dePTno) inner join  ACD_COLLEGE_MASTER c on(a.college_id=c.college_id)", "a.col_dePT_no,a.college_id", "b.DEPTname,ISNULL(COLLEGE_NAME,'')  COLLEGE_NAME", string.Empty, "a.college_id");
    ...
    public void bindColDept()
    {
        ...
        DataSet ds = objCommon.FillDropDown("ACD_COLLEGE_DEPT a inner join acd_dePARTMENT b on(a.dePTno=b.dePTno) inner join  ACD_COLLEGE_MASTER c on(a.college_id=c.college_id)", "a.col_dePT_no,a.college_id", "b.DEPTname,ISNULL(COLLEGE_NAME,'')COLLEGE_NAME", "a.college_id=" + ddlColg.SelectedValue, "a.college_id");
        lvlist.DataSource = null;
        lvlist.DataBind();
