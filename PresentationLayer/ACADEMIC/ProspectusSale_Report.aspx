                   ...
                   <td width="20%" align="left">
                    ...
                    <td width="20%">
                        ...
                        <%--<ajaxToolKit:CalendarExtender ID="cerecdate" runat="server" Enabled="True" Format="dd/MM/yyyy"
                            PopupButtonID="txtRecDate" TargetControlID="txtRecDate">
                ...
                <tr>
                    ...
                    <td colspan="3">
                       ...
                       <%-- <ajaxToolKit:MaskedEditValidator ID="mevFromDate" runat="server" 
                            ControlExtender="meeFromDate" ControlToValidate="txtRecDate" Display="None" 
                        ...
                        <ajaxToolKit:MaskedEditValidator ID="mevToDate" runat="server" 
                            ...
                            TooltipMessage="Please Enter To Date" ValidationGroup="submit" />--%>
                    </td>
                </tr>
            </table>
       </ContentTemplate>
