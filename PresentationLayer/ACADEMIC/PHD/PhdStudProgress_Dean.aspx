<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="PhdStudProgress_Dean.aspx.cs" Inherits="ACADEMIC_PHD_PhdStudProgress_Dean" %>
                                ...
                                <div id="divmain" runat="server" visible="false">
                                    ...
                                    <asp:Panel ID="pnlWd" runat="server" Visible="true">
                                        <div class="card">
                                            ...
                                            <div id="Div2" class="collapse collapse show">
                                                <div class="card-body">
