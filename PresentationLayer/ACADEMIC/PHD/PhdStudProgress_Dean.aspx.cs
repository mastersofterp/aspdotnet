...
// PROJECT NAME  : UAIMS                                                                
// MODULE NAME   : PHD
// PAGE NAME     : PHD STUD PROGRESS DEAN                                              
...
public partial class ACADEMIC_PHD_PhdStudProgress_Dean : System.Web.UI.Page
{
    ...
    private void CheckPageAuthorization()
    {
        if (Request.QueryString["pageno"] != null)
        {
            ...
            {
                Response.Redirect("~/notauthorized.aspx?page=PhdStudProgress_Dean.aspx");
            }
        }
        else
        {
    ...
    private void ProgressReport()
    {
        try
        {
            ...
            //if (ViewState["usertype"].ToString() == "2")
            //{
            //    ds = objPhdC.GetPROGRESSReport(Convert.ToInt32(Session["idno"]), Convert.ToInt32(ddlsem.SelectedValue));
            //}
            //else
            //{
            if (Request.QueryString["id"] != null)
