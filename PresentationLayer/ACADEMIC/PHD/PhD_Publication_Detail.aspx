<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="PhD_Publication_Detail.aspx.cs" Inherits="ACADEMIC_PHD_PhD_Publication_Detail" %>
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-3 col-md-6 col-12" id="divTitlePaper" runat="server">
                                            ...
                                            <asp:TextBox ID="txttitle" runat="server" CssClass="form-control" TabIndex="5" ToolTip="Enter Title of Paper" MaxLength="100"></asp:TextBox>
