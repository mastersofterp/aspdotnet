<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeFile="StudentRegistration.aspx.cs" Inherits="Academic_Default" %>
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-6 col-md-6 col-12" id="divStudentfullName" runat="server">
                                            ...
                                            <asp:TextBox ID="txtStudentfullName" runat="server" CssClass="form-control" TabIndex="3" ToolTip="Please Enter Student Full Name" onblur="conver_uppercase(this);" onkeyup="conver_uppercase(this);" onkeypress="return alphaOnly(event);" placeholder="Please Enter Student Full Name" autocomplete="off" />
                                       ...
                                       <%-- < added by Rohit on 23_08_2022>--%>
                                        ...
                                        <div class="form-group col-lg-3 col-md-6 col-12" id="divStudMobile" runat="server">
                                            ...
                                            <asp:TextBox ID="txtStudMobile" runat="server" CssClass="form-control" TabIndex="4" MaxLength="10" onkeyup="validateNumeric(this);"
                                                placeholder="Please Enter Student Mobile No." autocomplete="off"></asp:TextBox>
                                        ...
                                        <div class="form-group col-lg-3 col-md-6 col-12" id="divStudentMoblieNo2" runat="server">
                                            ...
                                            <asp:TextBox ID="txtStudMobile2" runat="server" CssClass="form-control" TabIndex="5" MaxLength="10" onkeyup="validateNumeric(this);"
                                                placeholder="Please Enter Student Mobile No.2" autocomplete="off"></asp:TextBox>
                                        ...
                                        <div class="form-group col-lg-3 col-md-6 col-12" id="divParentMobileNo" runat="server">
                                            ...
                                            <asp:TextBox ID="txtParentmobno" runat="server" CssClass="form-control" TabIndex="5" MaxLength="10" onkeyup="validateNumeric(this);"
                                                placeholder="Please Enter Parent Mobile No." autocomplete="off"></asp:TextBox>
                                        ...
                                        <div class="form-group col-lg-3 col-md-6 col-12" id="divPersonalEmail" runat="server">
                                            ...
                                            <asp:TextBox ID="txtStudEmail" runat="server" ToolTip="Please Enter Personal Email" CssClass="form-control"
                                                TabIndex="6" placeholder="Please Enter Student Personal Email." autocomplete="off" />
                                            <%--Change by Rahul Moraskar 2022-07-26--%>
                                            <%--ID="rfvStudEmail"--%>
                                        ...
                                        <div class="form-group col-lg-3 col-md-6 col-12" id="divCity" runat="server">
                                            ...
                                            <asp:DropDownList ID="ddlCity" runat="server" TabIndex="8" AppendDataBoundItems="true"
                                        ...
                                        <div class="form-group col-lg-3 col-md-6 col-12" id="divGender" runat="server">
                                            ...
                                            <asp:RadioButton ID="rdoMale" runat="server" GroupName="Sex" TabIndex="9" Text="Male" />

                                            <asp:RadioButton ID="rdoFemale" runat="server" GroupName="Sex" TabIndex="10" Text="Female" />

                                            <asp:RadioButton ID="rdoTransGender" runat="server" GroupName="Sex" TabIndex="11" Text="Others" />
                                        ...
                                        <div class="form-group col-lg-3 col-md-6 col-12" id="divSchool" runat="server">
                                            ...
                                            <asp:DropDownList ID="ddlSchool" runat="server" ValidationGroup="academic" CssClass="form-control" data-select2-enable="true"
                                                ToolTip="Please Select School Admitted." TabIndex="12" AppendDataBoundItems="True" AutoPostBack="true"
                                        ...
                                        <div class="form-group col-lg-3 col-md-6 col-12" id="divDegree" runat="server">
                                            ...
                                            <asp:DropDownList ID="ddlDegree" runat="server" ValidationGroup="academic" CssClass="form-control" data-select2-enable="true"
                                                ToolTip="Please Select Degree / Program" TabIndex="13" AppendDataBoundItems="True" AutoPostBack="true"
                                        ...
                                        <div class="form-group col-lg-3 col-md-6 col-12" id="divBranch" runat="server">
                                            ...
                                            <asp:DropDownList ID="ddlBranch" runat="server" TabIndex="14" AppendDataBoundItems="True" CssClass="form-control" data-select2-enable="true"
                                        ...
                                        <div class="form-group col-lg-3 col-md-6 col-12" runat="server" id="divSpecialisation" visible="false">
                                            ...
                                            <asp:DropDownList ID="ddlSpecialisation" runat="server" TabIndex="15" AppendDataBoundItems="True" CssClass="form-control" data-select2-enable="true"
                                        ...
                                        <div class="form-group col-lg-3 col-md-6 col-12" id="divadmthrough" runat="server">
                                            ...
                                            <asp:DropDownList ID="ddladmthrough" runat="server" AppendDataBoundItems="true"
                                                CssClass="form-control" data-select2-enable="true" ToolTip="Please Select Admission Type" TabIndex="16">
                                            </asp:DropDownList>
                                        ...
                                        <div class="form-group col-lg-3 col-md-6 col-12" id="divAdmType" runat="server">
                                            ...
                                            <asp:DropDownList ID="ddlAdmType" runat="server" AppendDataBoundItems="true" AutoPostBack="true" OnTextChanged="ddlAdmType_TextChanged"
                                                CssClass="form-control" data-select2-enable="true" ToolTip="Please Select Admission Type" TabIndex="17">
                                                  <asp:ListItem Value="0">Please Select</asp:ListItem>
                                            </asp:DropDownList>
                                        ...
                                        <div class="form-group col-lg-3 col-md-6 col-12" id="divYear" runat="server">
                                            ...
                                            <asp:DropDownList ID="ddlYear" runat="server" TabIndex="18" AppendDataBoundItems="true"
                                        ...
                                        <div class="form-group col-lg-3 col-md-6 col-12" id="divSemester" runat="server">
                                            ...
                                            <asp:DropDownList ID="ddlSemester" runat="server" TabIndex="19" AppendDataBoundItems="true" CssClass="form-control" data-select2-enable="true"
                                        ...
                                        <div class="form-group col-lg-3 col-md-6 col-12" id="divBatch" runat="server">
                                            ...
                                            <asp:DropDownList ID="ddlBatch" runat="server" TabIndex="20" AppendDataBoundItems="true" CssClass="form-control" data-select2-enable="true" ToolTip="Please Select Admission Batch" OnSelectedIndexChanged="ddlPaymentType_SelectedIndexChanged" AutoPostBack="true">
                                        ...
                                        <div class="form-group col-lg-3 col-md-6 col-12" style="display: none;">
                                            ...
                                            <asp:TextBox ID="txtStudentName" runat="server" TabIndex="21"
                                        ...
                                        <div class="form-group col-lg-3 col-md-6 col-12" id="divDateOfReporting" runat="server">
                                            ...
                                            <asp:TextBox ID="txtDateOfReporting" runat="server" TabIndex="22" CssClass="form-control" placeholder="dd/MM/yyyy" />
                                            <%--<asp:Image ID="imgCalDateOfAdmission" runat="server" src="../images/calendar.png" />--%>
                                        ...
                                        <div class="form-group col-lg-3 col-md-6 col-12" hidden="hidden" runat="server">
                                            <div class="label-dynamic">
                                                <sup>* </sup>
