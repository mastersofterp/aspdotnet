<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true"
    CodeFile="ExamRegistration.aspx.cs" Inherits="Academic_ExamRegistration" Title="" %>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-12">
                                    <ul class="list-group list-group-unbordered">
                                        ...
                                        <li class="list-group-item"><b>RRN No :</b>
                                            <a class="sub-label"><asp:Label ID="lblEnrollNo" runat="server" Font-Bold="true" /></a>
                                        </li>
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <ul class="list-group list-group-unbordered">
                                        <li class="list-group-item"><b>Admission Batch :</b>
                                            <a class="sub-label"><asp:Label ID="lblAdmBatch" runat="server" Font-Bold="true" /> </a>
                                        </li>
                                        ...
                                        <li class="list-group-item"><b>Scheme :</b>
                                            <a class="sub-label"><asp:Label ID="lblScheme" runat="server" Font-Bold="true" /></a>
                                        </li>
                                    </ul>
                                </div>
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    <th>
                                                                      ...
                                                                      <asp:CheckBox ID="chkAll" runat="server"  onclick="totAllSubjects(this);" /> Select All
                                                                    ...
                                                                    <th style="text-align:center">Exam Fee                                                                   
                                                                    </th>
                                                                </tr>
                                                ...
                                                <ItemTemplate>
                                                    <tr id="trCurRow" class="item">
                                                        <td>
                                                            ...
                                                            <%--<asp:CheckBox ID="chkAccept" runat="server" Checked='<%#(Convert.ToInt32(Eval("REGISTERED"))==1 ? true : false)%>' Enabled='<%#(Convert.ToInt32(Eval("REGISTERED"))==1 ? true : false)%>' onclick="backlogLvChk(this);" />--%>
                                                        </td>
                                                        <td>
                                ...
                                <div class="col-12 btn-footer">
                                    <asp:Button ID="btnSubmit" runat="server" OnClick="btnSubmit_Click" Text="Submit" CausesValidation="false"
                                        Font-Bold="true" CssClass="btn btn-success" TabIndex="8"/>
                                    <asp:Button ID="btnPrintRegSlip" runat="server" Text="Backlog-Examination Form" OnClick="btnPrintRegSlip_Click"
