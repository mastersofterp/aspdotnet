<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="AttendanceReportByFaculty_New.aspx.cs" Inherits="ACADEMIC_AttendanceReportByFaculty_New" Title="" %>
                        ...
                        <div class="box-body">
                         ...
                         <i class="fa fa-file-pdf-o" aria-hidden="true"></i> Cumulative Attendance</asp:LinkButton>
                                ...
                                <asp:LinkButton ID="btnAttReportWithOD" runat="server" TabIndex="18"
                                    OnClick="btnAttReportWithOD_Click" ValidationGroup="Cumulative" CssClass="btn btn-info">
