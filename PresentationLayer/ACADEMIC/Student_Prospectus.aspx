            ...
            <td>
                <fieldset class="fieldset">
                    ...
                    <table cellpadding="2" cellspacing="2" width="100%">
                        ...
                        <tr>
                            <td style="width: 10%;">
                                <span class="validstar">*</span>Admission Form No:<td style="width: 9%;">
                            ...
                            <td>
                                Sale Date : &nbsp;<asp:TextBox ID="txtSaleDate" runat="server" TabIndex="8" 
                                    ValidationGroup="submit" Width="82px"></asp:TextBox>
                               <%-- <ajaxToolKit:CalendarExtender ID="ceFromDate" runat="server" Enabled="True" 
                                    Format="dd/MM/yyyy" PopupButtonID="imgFromDate" TargetControlID="txtSaleDate">
                                </ajaxToolKit:CalendarExtender>
                                <ajaxToolKit:MaskedEditExtender ID="meFromDate" runat="server" 
                                    CultureAMPMPlaceholder="" CultureCurrencySymbolPlaceholder="" 
                                    CultureDateFormat="" CultureDatePlaceholder="" CultureDecimalPlaceholder="" 
                                    CultureThousandsPlaceholder="" CultureTimePlaceholder="" Enabled="True" 
                                    Mask="99/99/9999" MaskType="Date" OnInvalidCssClass="errordate" 
                                    TargetControlID="txtSaleDate">
                                </ajaxToolKit:MaskedEditExtender>
                                <asp:Image ID="imgSaleDate" runat="server" ImageUrl="~/images/calendar.png" 
                                    Width="16px" />--%>
                            </td>
                            <td style="width: 5%;">
                                &nbsp;</td>
                        ...
                        <tr>
                            <td colspan="4" style="padding: 10px; text-align: center; vertical-align: top">
                            </td>
                            <td>
                            </td>
                        </tr>
