...
public partial class ACADEMIC_Course_Equivalance : System.Web.UI.Page
{
            ...
            if (!Page.IsPostBack)
            {
                ...
                else
                {
                    ...
                    if (Request.QueryString["pageno"] != null)
                    {
                        ...
                        //chkNonequi.Attributes.Add("onclick", "theChecker()");
                    }
                }
                FillDropdown();
            }
    ...
    protected void ddlBranch_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            if (ddlBranch.SelectedIndex <= 0)
            {
                ddlScheme.SelectedIndex = 0;
                ddlSemester.SelectedIndex = 0;
                //lvValuer.Visible = false;
            }
            else
            {
                this.BindEquivalanceCourse();
                //if (lvEquivalanceCourse.Enabled == true)
                //{
            ...
            if (ddlDegree.SelectedValue == "1" && ddlBranch.SelectedValue == "99")
            {
                ...
                //ddlScheme.Items.Add(new ListItem("FIRST YEAR [RTM]", "24"));
    ...
    {
        //string Old_Courseno = string.Empty;
    ...
    //{
    //    ListViewDataItem hd = (ListViewDataItem)lvEquivalanceCourse.FindControl("hdncourse");
    //    ImageButton btnDelete = sender as ImageButton;
    //    HiddenField hdncourseNo = lvEquivalanceCourse.FindControl("hdncourse") as HiddenField;
    //    int a = Convert.ToInt32(btnDelete.CommandArgument);
    //    //string b = hdncourseNo.Value;
    //    string c = hd.ToString();
    //}
    protected void btnReport_Click(object sender, EventArgs e)
    {
       ...
       // }
       // int RCNO = Convert.ToInt32(objCommon.LookUp("ACD_COURSE_EQUIVALENCE E INNER JOIN ACD_COURSE C ON (E.OLD_SCHEMENO = C.SCHEMENO AND E.OLD_COURSENO = C.COURSENO)", "COUNT(EQNO)EQNO", "E.OLD_SCHEMENO=" + Convert.ToInt32(ddlScheme.SelectedValue) + "AND C.SEMESTERNO=" + Convert.ToInt32(ddlSemester.SelectedValue)));
    ...
    //protected void lvEquivalanceCourse_ItemCommand(object sender, ListViewCommandEventArgs e)
    //{
    //    if (e.CommandName == "Delete")
    //    {
    //        //int a = Convert.ToInt32(btnDelete.CommandArgument);
    //        HiddenField s = e.Item.FindControl("hdncourse") as HiddenField;
    //        string a = s.Value;
    //    }
