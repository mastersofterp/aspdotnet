...
public partial class ACADEMIC_StudentForRegistration : System.Web.UI.Page
{
    ...
    //{
    //    objCommon.FillDropDownList(ddlSession, "ACD_SESSION_MASTER", "SESSIONNO", "SESSION_NAME", "FLOCK = 1", "SESSIONNO DESC");
    //}
    ...
    private void UpdateStudentStatus(int studentID)
    {
        try
        {
            ...
            {
                //objCommon.DisplayMessage(updMeritList, "Registerd Successfully", this);
        ...
        //int lookRegisteredStatus = Convert.ToInt32((objCommon.LookUp("ACD_REGISTRATION", "count(REGISTERED)", "REGISTERED=1 and IDNO = " + Convert.ToInt32(txtRegistrationNo.Text) + " and SESSIONNO=" + ddlSession.SelectedValue)));
        //if (lookRegisteredStatus == 0)
        //{                
        //}
        //else
        //{
        //    objCommon.DisplayMessage(updMeritList, "This Student is Already Registerd", this);
        //}
    }
        ...
        try
        {
            ...
            if (dsStudent != null && dsStudent.Tables.Count > 0)
            {
                if (dsStudent.Tables[0].Rows.Count > 0)
                {
                    ...
                    {
                        //lblMinority.Text = dsStudent.Tables[0].Rows[0]["MINORITY"].ToString();
