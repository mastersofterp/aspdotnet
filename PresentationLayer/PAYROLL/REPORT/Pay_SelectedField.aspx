...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <fieldset class="fieldsetPay">
        <legend class="legendPay">Selected Payhead Rport</legend>
            ...
            <tr>
                ...
                <td style="height: 28px">
                    <asp:DropDownList ID="ddlEmployeeNo" runat="server" AppendDataBoundItems="True" 
                        Width="150px" TabIndex="6"></asp:DropDownList>
                </td>
            </tr>
            <tr>
                <td width="25%">
            ...
            <tr>
                ...
                <td>
                    <asp:ListBox ID="lstParticularColumn" runat="server" SelectionMode="Single" 
                        Height="140px" Width="153px" TabIndex="10" AppendDataBoundItems="True">
                    </asp:ListBox>
