<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="Pay_AuthorityNameMas.aspx.cs" Inherits="PAYROLL_MASTERS_Pay_AuthorityNameMas" %>
    ...
    <div class="col-md-12">
        <div class="box box-primary">
            ...
            <div class="box-header with-border">
                <h3 class="box-title">NODUES AUTHORITY NAME</h3>
                        ...
                        <div class="col-md-12">
                            <asp:Panel ID="pnldeducationentry" runat="server">
                                <div class="panel panel-info">
                                    <div class="panel panel-heading">Add/Edit Authority Name</div>
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <div class="form-group col-md-4">
                                                <label>Department Head :<span style="color: Red"></span></label>
                                                 <asp:DropDownList ID="ddluser" runat="server" CssClass="form-control" TabIndex="4" AppendDataBoundItems="true">
                                                  <asp:ListItem Value="0">Please Select</asp:ListItem>
                                                   </asp:DropDownList>
                                                 <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddluser"
                                                    Display="None" InitialValue="0" ErrorMessage="Please Select Department Head " ValidationGroup="quarter"></asp:RequiredFieldValidator>
                                           </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-md-12">
                    <asp:Panel ID="pnlList" runat="server" ScrollBars="Auto">
                        <asp:ListView ID="lvAutho" runat="server">
                            <LayoutTemplate>
                                <div id="lgv1">
                                    <h4 class="box-title">Authority Name List</h4>
                            ...
                            <ItemTemplate>
                                <tr>
                                    <td>
                                        <asp:ImageButton ID="btnEdit" runat="server" ImageUrl="~/images/edit.gif" CommandArgument='<%# Eval("AUTHO_ID") %>'
                                            AlternateText="Edit Record" ToolTip="Edit Record" OnClick="btnEdit_Click" />
                                       
                                    </td>
                                    <td>
                                        <asp:Label ID="lblQtrName" runat="server" Text='<%# Eval("AUTHORITY_NAME") %>' />
                                    </td>
                                    <td>
                                        <asp:Label ID="lbluserName" runat="server" Text='<%# Eval("UA_FULLNAME") %>' />
                                        <asp:HiddenField ID="lblUA_No" runat="server" Value='<%# Eval("UA_NO") %>' />
                                    </td>
