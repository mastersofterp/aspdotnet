...
public partial class PAYROLL_MASTERS_PayDepartment : System.Web.UI.Page
{
    ...
    private void BindListView()
    {
        try
        {
            DataSet ds = objDeptDesig.GetDepartment();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        objPay.DEPARTMENT = txtDeptName.Text.Trim();
        objPay.DEPTSHORTNAME = txtShortName.Text.Trim();
        ...
        if (ViewState["action"] != null)
        {
            ...
            if (ViewState["action"].ToString().Equals("add"))
            {
                ...
                {
                    objPay.SUBDEPTNO = 0;
                    CustomStatus cs = (CustomStatus)objDeptDesig.AddDepartment(objPay);
            ...
            else
            {
                ...
                {
                    ViewState["action"] = "add";
                    objPay.SUBDEPTNO = Convert.ToInt32(ViewState["lblFNO"].ToString().Trim());
                    CustomStatus cs = (CustomStatus)objDeptDesig.AddDepartment(objPay);
                    if (cs.Equals(CustomStatus.RecordUpdated))
                    {
                        BindListView();
    ...
    protected void btnEdit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            txtDeptName.Text = lblDeptName.Text.Trim();
            txtShortName.Text = lblDeptShortName.Text.Trim();
    ...
    public bool CheckPurpose()
    {
        ...
        dsPURPOSE = objCommon.FillDropDown("PAYROLL_SUBDEPT", "*", "", "SUBDEPT='" + txtDeptName.Text + "' AND SUBSDEPT='" + txtShortName.Text + "'", "");
