...
public partial class Masters_qualificationMas : System.Web.UI.Page
{
    ...
    private void Clear()
    {
        ...
        ViewState["qualno"] = null;
    }

    private bool checkQualificationExist()
    {
        bool retVal = false;
        DataSet ds = objCommon.FillDropDown("PAYROLL_QUALIFICATION", "QUALINO", "QUALI", "QUALI='" + txtQualification.Text + "' AND QUALILEVELNO = " + Convert.ToInt32(ddlQType.SelectedValue), "QUALINO");
        if (ds != null)
        {
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ViewState["action"] != null)
            {
                ...
                {
                    if (checkQualificationExist())
                    {
                        ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Qualification Name Already Exist.');", true);
                        Clear();
                        return;
                    }
                    else
