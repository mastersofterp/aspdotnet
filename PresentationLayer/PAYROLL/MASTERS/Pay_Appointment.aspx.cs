...
{   
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            else
            {
                ...
                objCommon.ReportPopUp(btnShowReport, "pagetitle=UAIMS&path=~" + "," + "Reports" + "," + "Payroll" + "," + "Pay_Appoint.rpt&param=@P_COLLEGE_CODE=" + Session["colcode"].ToString() + "," + "@username=" + Session["userfullname"].ToString(), "UAIMS");
            }
    ...
    private void CheckPageAuthorization()
    {
        if (Request.QueryString["pageno"] != null)
        {
            ...
            {
                Response.Redirect("~/notauthorized.aspx?page=Pay_Appointment.aspx");
            }
        }
        else
        {
                ...
                if(ViewState["action"].ToString() == "add")
                {
                    ...
                    else
                    {
                       ...
                       // lblerror.Text = "Check at least one payhead";
                        MessageBox("Check at least one payhead");
                    }
