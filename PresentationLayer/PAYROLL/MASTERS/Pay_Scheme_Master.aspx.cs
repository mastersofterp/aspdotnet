...
public partial class PAYROLL_MASTERS_Pay_Scheme_Master : System.Web.UI.Page
{
    ...
    private void BindListView()
    {
        try
        {
            DataSet ds = objDeptDesig.GetSchemeMaster();
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        objPay.STAFFTYPE = txtStaff.Text.Trim();
        objPay.RETIREMENTAGE = int.Parse(txtRetirmentAge.Text.Trim());
        ...
        if (ViewState["action"] != null)
        {
            ...
            if (ViewState["action"].ToString().Equals("add"))
            {
                ...
                {
                    objPay.STAFFNO = 0;
                    CustomStatus cs = (CustomStatus)objDeptDesig.AddSchemeMaster(objPay);
            ...
            else
            {
                ...
                {
                    ViewState["action"] = "add";
                    objPay.STAFFNO = Convert.ToInt32(ViewState["STAFFNO"].ToString().Trim());
                    CustomStatus cs = (CustomStatus)objDeptDesig.AddSchemeMaster(objPay);
                    if (cs.Equals(CustomStatus.RecordUpdated))
                    {
                        BindListView();
    ...
    protected void btnEdit_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            Label lblretirementage =lst.FindControl("lblretirementage") as Label;
            Label lblisactive = lst.FindControl("lblisactive") as Label;
            Label lblisteaching = lst.FindControl("lblisteaching") as Label;
            txtStaff.Text = lblstaffname.Text.Trim();
            txtRetirmentAge.Text = lblretirementage.Text.Trim();
    ...
    public bool CheckPurpose()
    {
        ...
        dsPURPOSE = objCommon.FillDropDown("PAYROLL_STAFF", "*", "", "STAFF='" + txtStaff.Text + "'and STAFFNO!='" + Convert.ToInt32(ViewState["STAFFNO"]) + "'", "");
