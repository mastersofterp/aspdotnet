...
public partial class PayRoll_Pay_NUDesignation : System.Web.UI.Page
{
    ...
    private void CheckPageAuthorization()
    {
        if (Request.QueryString["pageno"] != null)
        {
            ...
            {
                Response.Redirect("~/notauthorized.aspx?page=Pay_NuDesig.aspx");
            }
        }
        else
        {
    ...
    private void BindListViewList(Int32 staffno)
    {
        ...
        DataSet ds = objDesig.GetNUDesigList(staffno);
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        CustomStatus cs = (CustomStatus)objDesig.AddUpdateNUDesig(objDes);
        Clear();
        BindListViewList(Convert.ToInt32(ddlStaffType.SelectedValue));
    }
