<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="EntityMaster.aspx.cs" Inherits="PAYROLL_MASTERS_EntityMaster" %>
                ...
                <div class="col-md-12 col-sm-12 col-12">
                    <div class="box box-primary">
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title">ENTITY MASTER</h3>
                        </div>
                        <div class="box-body">
                                  ...
                                  <%-- <div class="form-group col-lg-3 col-md-6 col-12">
                                   ...
                                   <asp:DropDownList ID="ddlCollege" runat="server" ToolTip="Select College" CssClass="form-control" AppendDataBoundItems="true" data-select2-enable="true"
                                    ...
                                    <div class="form-group col-lg-3 col-md-6 col-12">
                                            ...
                                            <asp:TextBox ID="txtentityName" runat="server" Text="" CssClass="form-control" IsRequired="True" IsValidate="True"
                                                TabIndex="1" ToolTip="Please Enter Entity Name" onkeypress="return lettersOnly(event)">
                                            </asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator" ControlToValidate="txtentityName" runat="server" ErrorMessage="Enter Entity Name" 
                            ...
                            <div class="col-12">
                                <asp:Panel ID="pnlList" runat="server">
                                    <asp:ListView ID="lvEntityName" runat="server">
                                        <LayoutTemplate>
                                            <div class="sub-heading">
                                                <h5>Entity Master List</h5>
                                            </div>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                <td class="text-left">
                                                    <asp:ImageButton ID="btnEdit" runat="server" ImageUrl="~/Images/edit.png" CommandArgument='<%# Eval("EnityNo") %>'
                                                        AlternateText="Edit Record" ToolTip="Edit Record" OnClick="btnEdit_Click"/>
                                                </td>
                                                <td>
                                                  <asp:Label ID="lblentityname" runat="server" Text='<%# Eval("EnityName") %>'></asp:Label>
                                                </td>
                                                <td>
                                ...
                                <div class="vista-grid_datapager d-none">
                                    <div class="text-center">
                                        <asp:DataPager ID="DataPager1" runat="server"  OnPreRender="DataPager1_PreRender"  PagedControlID="lvEntityName"
                                            PageSize="100">
                                            <Fields>
