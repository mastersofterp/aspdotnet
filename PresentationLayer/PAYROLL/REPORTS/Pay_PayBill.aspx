<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true"
    CodeFile="Pay_PayBill.aspx.cs" Inherits="PAYROLL_REPORTS_Pay_PayBill"  %>
                    ...
                    <td>
                        <div id="divPaySlip" style="padding-left: 15px; width: 90%" runat="server">
                            <fieldset class="fieldsetPay">
                                <legend class="legendPay">Employee Pay Bill</legend>
                                <br />
                                <table width="100%" cellpadding="2" cellspacing="2" border="0">
                                    ...
                                    <tr>
                                        ...
                                        <td class="form_left_text">
                                            <asp:RadioButton ID="radAllEmployees" GroupName="radpay" runat="server" Text="All Employees"
                                    ...
                                    <tr>
                                        ...
                                        <td class="form_left_label">
                                            ...
                                            &nbsp;
                                            <%--<asp:Button ID="btnSalaryCertificate" runat="server" Text="Salary Certificate" OnClick="btnSalaryCertificate_Click"
