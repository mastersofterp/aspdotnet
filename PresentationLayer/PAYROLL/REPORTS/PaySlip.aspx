<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true"
    CodeFile="PaySlip.aspx.cs" Inherits="PAYROLL_REPORTS_PaySlip" Title="" %>
                    ...
                    <div class="box-body">
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-info">
                                <div class="panel-heading">Employee PaySlip Information</div>
                            ...
                            <div class="col-md-12">
                                ...
                                <asp:Button ID="btnShow" runat="server" Text="Show" OnClick="btnShow_Click"
                                    TabIndex="2" ValidationGroup="Payroll" CssClass="btn btn-info" ToolTip="Click To Show Report" />
                ...
                <div id="divPaySlip" style="padding-left: 15px; width: 90%" runat="server">
                    ...
                    <table width="100%" cellpadding="2" cellspacing="2" border="0">
                        ...
                        <tr>
                            ...
                            <td class="form_left_label">
                                <br />
                                <asp:Button ID="btnShow" runat="server" Text="Show" OnClick="btnShow_Click" Width="79px"
