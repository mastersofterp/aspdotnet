...
public partial class PAYROLL_REPORTS_PayOtherReport : System.Web.UI.Page
{
    ...
    private void ShowReport(string reportTitle, string rptFileName)
    {
        try
        {
            ...
            url += "&param=@P_PAYHEADS=" + selectedItem + ",@P_MONYEAR=" + ddlMonth.SelectedItem.Text + ",@P_STAFFNO=" + ddlStaffNo.SelectedValue + ",@P_SHOWINREPORT=" + shoreport + ",@P_COLLEGE_CODE=" + 24 + ",@P_HEAD1=" + b + ",@P_HEAD2=" + c + ",@P_COLLEGE_NO=" + Convert.ToInt32(ddlCollege.SelectedValue);
            divMsg.InnerHtml = " <script type='text/javascript' language='javascript'>";
            divMsg.InnerHtml += " window.open('" + url + "','" + reportTitle + "','addressbar=no,menubar=no,scrollbars=1,statusbar=no,resizable=yes');";
            divMsg.InnerHtml += " </script>";
        }
    ...
    private void ShowReportPayhead(string reportTitle, string rptFileName)
    {
        try
        {
            ...
            url += "pagetitle=" + reportTitle;
            url += "&path=~,Reports,Payroll," + rptFileName;
            url += "&param=@P_PAYHEADS=" + selectedItem + ",@P_MONYEAR=" + ddlMonth.SelectedItem.Text + ",@P_STAFFNO=" + ddlStaffNo.SelectedValue + ",@P_SHOWINREPORT=" + shoreport + ",@P_COLLEGE_CODE=" + 29 + ",@P_HEAD1=" + b + ",@P_COLLEGE_NO=" + Convert.ToInt32(ddlCollege.SelectedValue);
            divMsg.InnerHtml = " <script type='text/javascript' language='javascript'>";
            divMsg.InnerHtml += " window.open('" + url + "','" + reportTitle + "','addressbar=no,menubar=no,scrollbars=1,statusbar=no,resizable=yes');";
            divMsg.InnerHtml += " </script>";
        }
