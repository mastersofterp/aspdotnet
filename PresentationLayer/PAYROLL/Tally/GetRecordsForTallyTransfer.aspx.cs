...
public partial class Tally_Transactions_GetRecordsForTallyTransfer : System.Web.UI.Page
{
    ...
    {
        objCommon.FillDropDownList(ddlPayMonth, "PAYROLL_SALFILE", "MONYEAR", "MONYEAR AS MONYEAR1", "STAFFNO=" + ddlstafftype.SelectedValue, "SALNO DESC");
    }
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            int Count = Convert.ToInt32(objCommon.LookUp("PayHeadTallyTransfer", "Count(PayHead)", "PayMonthYear = '" + PayMonth + "' AND PayStaffId='" + ddlstafftype.SelectedValue + "' AND IsSupliSal = 'N' AND CollegeId = '" + ddlCollegeName.SelectedValue + "' AND EndTime = '9999-12-31'"));
            if (Count > 0)
            {
                objCommon.DisplayMessage(UpdatePanel1, "Salary for the month already proceed, Please Delete the salary before processing..", this.Page);
            ...
            //else
            //{
            //    objCommon.DisplayMessage(UpdatePanel1, "Salary for the month already proceed", this.Page);
            //    btnDelete.Visible = true;
            //    return;
            //}
        }
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            long res = objTTC.AddUpdatePayTallyRecords(ObjTTM, ref Message, Paydate, StaffType, PayMonth, (DataTable)ViewState["dtPay"]);

            if (res == -99)
            {
                objCommon.DisplayMessage(UpdatePanel1, "Exception Occur", this.Page);
                return;
            }
            else if (res == 0)
            {
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            long res = objTTC.DeleteTallyRecords(ObjTTM, ref Message, Paydate, StaffType, PayMonth);
            ...
            {
                objCommon.DisplayMessage(UpdatePanel1, "Record Deleted Successfuly, You can re-transfer salary", this.Page);
    ...
    protected void btnTransfer_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            sb.AppendLine("     <NARRATION>" + ddlstafftype.SelectedItem.Text.ToUpper() + " SALARY TRANSFER FOR THE MONTH OF " + ddlPayMonth.SelectedValue + "</NARRATION>");
