<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage2.master" AutoEventWireup="true" CodeFile="Pay_EmployeeResignation.aspx.cs" Inherits="PAYROLL_TRANSACTIONS_Pay_EmployeeResignation" %>
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Exit Application Form</h3>
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                        <ContentTemplate>
                                                            <asp:TextBox ID="txtresignationremark" runat="server" ControlToValidate="txtresignationremark" TextMode="MultiLine" Height="200px" class="form-control"></asp:TextBox>
