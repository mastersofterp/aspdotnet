...
public partial class PayRoll_Pay_Increment : System.Web.UI.Page
{
    ...
    private void BindListViewList(int staffNo,int incMonth, int collegeNo)
    {
        try
        {
            if (!(Convert.ToInt32(ddlStaff.SelectedValue) == 0 && Convert.ToInt32(ddlIncMonth.SelectedValue) == 0))
            {
                ...
                DataSet ds = objpay.GetIncrementEmployees(staffNo,incMonth,collegeNo);
    ...
    protected void btnSub_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            foreach(ListViewDataItem lvitem in  lvIncrement.Items)
            {
                ...
                CustomStatus cs = (CustomStatus)objpay.UpdateIncerment(Convert.ToInt32(txtOldBasic.ToolTip),Convert.ToInt32(txtOldBasic.Text),Convert.ToInt32(txtBasic.Text),Convert.ToChar(txtInc.Text),Convert.ToDateTime(txtIncDate.Text));
    ...
    protected void BindListViewValidation()
    {
        ...
        else if (Convert.ToInt32(ddlStaff.SelectedIndex) == 0 && Convert.ToInt32(ddlIncMonth.SelectedIndex) > 0)
        {
            ...
            BindListViewList(Convert.ToInt32(ddlStaff.SelectedValue), Convert.ToInt32(ddlIncMonth.SelectedValue), Convert.ToInt32(ddlCollege.SelectedValue));
        }
        //else if (Convert.ToInt32(ddlStaff.SelectedIndex) > 0 && Convert.ToInt32(ddlIncMonth.SelectedIndex) == 0)
        //{
