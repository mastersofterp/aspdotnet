<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="PayMedicalInsurance.aspx.cs" Inherits="PAYROLL_TRANSACTIONS_PayMedicalInsurance" %>
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    <h3 class="box-title">MEDICAL INSURANCE ENTRY</h3>
                    <p class="text-center">
                    </p>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="form-group col-md-10">
                                                    ...
                                                    <asp:DropDownList ID="ddlCollege" AppendDataBoundItems="true" runat="server" CssClass="form-control" TabIndex="2"
                                                        ToolTip="Select College Name" AutoPostBack="true"
                                                ...
                                                <div class="form-group col-md-10">
                                                    ...
                                                    <asp:DropDownList ID="ddlStaff" AppendDataBoundItems="true" runat="server" CssClass="form-control" ToolTip="Select Staff" TabIndex="3"
                                                        AutoPostBack="true"
                                                        OnSelectedIndexChanged="ddlStaff_SelectedIndexChanged">
                                                    </asp:DropDownList>


                                                    <asp:RequiredFieldValidator ID="rfvddlEmployee" runat="server" ControlToValidate="ddlStaff"
                                                        Display="None" SetFocusOnError="true" ErrorMessage="Please Select Staff"
                                                        ValidationGroup="ADD" InitialValue="0"></asp:RequiredFieldValidator>
                                                </div>
                                            ...
                                            <div class="form-group col-md-6">
                                                <div class="form-group col-md-10">
                                                    ...
                                                    <div class="input-group">
                                                        <asp:TextBox ID="txtFromDate" runat="server" TabIndex="4" ToolTip="Enter From Date" CssClass="form-Control" />
                                                ...
                                                <div class="form-group col-md-10">
                                                    ...
                                                    <div class="input-group">
                                                        <asp:TextBox ID="txtToDate" runat="server" TabIndex="5" CssClass="form-control" ToolTip="Enter To Date" />
                                                        <div class="input-group-addon">
                                                ...
                                                <div class="form-group col-md-10">
                                                    ...
                                                    <asp:DropDownList ID="ddlEmployee" AppendDataBoundItems="true" runat="server" CssClass="form-control" TabIndex="6"
                                                        ToolTip="Select Employee Name">
                                                        <asp:ListItem Value="0">Please Select</asp:ListItem>
                                                    </asp:DropDownList>

                                                    <asp:CheckBox ID="chkStopInstall" runat="server" TabIndex="7"
                            ...
                            <asp:Panel ID="pnlList" runat="server">
                                ...
                                <div class="text-center">
                                    <asp:Button ID="btnShow" runat="server" Text="Show"
                                        OnClick="btnShow_Click" ValidationGroup="ADD" CssClass="btn btn-warning" TabIndex="8" ToolTip="Click To Show the List" />
                                    <asp:Button ID="btnSaveData" runat="server" Text="Save"
                                        OnClick="btnSaveVari_Click" ValidationGroup="ADD" CssClass="btn btn-info" TabIndex="9" ToolTip="Click To Save the List" />
                                ...
                                <div class="table-responsive">
                                    <asp:ListView ID="lvMonthlyIstallment" runat="server">
                                        ...
                                        <LayoutTemplate>
                                            <div id="demo-grid">
                                                <div class="titlebar">
                                                    <h4>Medical Insurance Employee list</h4>
                                                </div>
                                                <table class="table table-bordered table-hover table-responsive">
                                                    <tr class="bg-light-blue">
                                                        ...
                                                        <th>EMPLOYER YEARLY CONTRIBUTION
                                                        </th>
                                                        <th>EMPLOYEE MONTHLY CONTRIBUTION
                                                        </th>
                                                        <th>DEDUCTION STARTING DATE
                                                        </th>
                                                        <th>EMPLOYEE TOTAL CONTRIBUTION
                                                        </th>
                                                        <th>REMARK
                                                        </th>
                                                    </tr>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:CheckBox ID="chkIno" runat="server" />
                                                </td>
                                                <td>
                                                    <%# Eval("EMPNAME")%>
                                                </td>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtYearlyPre" runat="server" MaxLength="100" Text='<%#Eval("YearlyPremium")%>'
                                                        ToolTip='<%#Eval("IDNO")%>' CssClass="form-control" onkeyup="return IncrementPercentage(this);" />
                                                    <ajaxToolKit:FilteredTextBoxExtender ID="FilteredTextBoxExtender11" runat="server"
                                                        Enabled="True"
                                                        ValidChars="0123456789."
                                                        FilterMode="ValidChars"
                                                        FilterType="Custom"
                                                        TargetControlID="txtYearlyPre">
                                                    </ajaxToolKit:FilteredTextBoxExtender>

                                                </td>
                                                <td>
                                                    <asp:TextBox ID="txtEMPRCONT" runat="server" MaxLength="100" Text='<%#Eval("EMPR_CONT")%>'
                                                        CssClass="form-control" onkeyup="return IncrementPercentage(this);" />
                                                    <ajaxToolKit:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server"
                                                        Enabled="True"
                                                        ValidChars="0123456789."
                                                        FilterMode="ValidChars"
                                                        FilterType="Custom"
                                                        TargetControlID="txtEMPRCONT">
                                                    </ajaxToolKit:FilteredTextBoxExtender>
                                                </td>
                                                <td>
                                                    <asp:TextBox ID="txtMONAMT" runat="server" MaxLength="100" Text='<%#Eval("MONAMT")%>'
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtStartDate" runat="server" MaxLength="100" Text='<%#Eval("START_DT","{0:dd/MM/yyyy}")%>'
                                                        CssClass="form-control"> </asp:TextBox>
                                                    <ajaxToolKit:MaskedEditExtender ID="meeAllotmentDate" runat="server" TargetControlID="txtStartDate"
                                                    ...
                                                    <ajaxToolKit:MaskedEditValidator ID="MaskedEditValidator1" runat="server" ControlExtender="meeAllotmentDate"
                                                        ControlToValidate="txtStartDate" IsValidEmpty="False" EmptyValueMessage="Increment Date is required"
                                                        InvalidValueMessage="Start date is invalid" EmptyValueBlurredText="*" InvalidValueBlurredMessage="*"
                                                        Display="Dynamic" />


                                                </td>
                                                <td>
                                                    <asp:TextBox ID="txtTotalEmpCon" runat="server" MaxLength="100" Text='<%#Eval("YEARLY_EMP_CONT")%>'
                                                        CssClass="form-control" />
                                                    <ajaxToolKit:FilteredTextBoxExtender ID="FilteredTextBoxExtender3" runat="server"
                                                        ...
                                                        FilterMode="ValidChars"
                                                        FilterType="Custom"
                                                        TargetControlID="txtTotalEmpCon">
                                                    </ajaxToolKit:FilteredTextBoxExtender>
                                                </td>
                                                <td>
                                                    <asp:TextBox ID="txtRemark" runat="server" MaxLength="100" Text='<%#Eval("REMARK")%>'
                                                        CssClass="form-control" />
    ...
    <script type="text/javascript" language="javascript">
        ...
        function IncrementPercentage(me, vall) {
            ...
            if (me.value != "") {
                ...
                var txtYearlyPre = document.getElementById("ctl00_ContentPlaceHolder1_lvMonthlyIstallment_ctrl" + index + "_txtYearlyPre");
                var txtEMPRCONT = document.getElementById("ctl00_ContentPlaceHolder1_lvMonthlyIstallment_ctrl" + index + "_txtEMPRCONT");
                //if (txtYearlyPre.value == "") {
                //    alert("Only Numeric allowed !");
                //    return false;
                //}

                //if (txtEMPRCONT.value == "") {
                //    alert("Only Numeric allowed !");
                //    return false;
                //}
                
                var txtMONAMT = document.getElementById("ctl00_ContentPlaceHolder1_lvMonthlyIstallment_ctrl" + index + "_txtMONAMT");
                var txtTotalEmpCon = document.getElementById("ctl00_ContentPlaceHolder1_lvMonthlyIstallment_ctrl" + index + "_txtTotalEmpCon");
                ...
                var per = ((Number(txtYearlyPre.value) - Number(txtEMPRCONT.value))/12);

               // adsvalue = per.split(".");
                //txtnewbasic.value = roundTens(adsvalue[0]);

                txtMONAMT.value = Number(per);
                txtTotalEmpCon.value = Number(per)*12;
