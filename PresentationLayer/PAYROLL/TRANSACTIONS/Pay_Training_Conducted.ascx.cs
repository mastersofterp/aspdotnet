...
// PAGE NAME     : Pay_Training_Conducted.ascx                                                
...
public partial class PAYROLL_TRANSACTIONS_Pay_Training_Conducted : System.Web.UI.UserControl
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ViewState["action"] != null)
            {
                ...
                {
                    //Add New Help
                    CustomStatus cs = (CustomStatus)objServiceBook.AddTrainingConducted(objSevBook);
                ...
                else
                {
                    ...
                    if (ViewState["tNo"] != null)
                    {
                        ...
                        CustomStatus cs = (CustomStatus)objServiceBook.UpdateTrainingConducted(objSevBook);
