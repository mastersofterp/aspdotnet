...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <style type="text/css">
        ...
        #ctl00_ContentPlaceHolder1_Calendar1 tr table tbody{
            width: 100%;
        }
        #ctl00_ContentPlaceHolder1_Calendar1 tr table tr {
            display: flex;
            justify-content: space-between;
        }
        #ctl00_ContentPlaceHolder1_Calendar1 tr table tr td{
    ...
    <style type="text/css">
     ...
     <script src="https://apis.google.com/js/platform.js" async defer></script> 
      <script type="text/javascript" >
          ...
          function onSocialSignInForAssociatingUser(googleUser) {
              ...
              var sloginid = profile.getId();
              var gmail_id = profile.getEmail();

              $(document).ready(function () {
                  var Ua_no = '<%=Session["userno"] %>';
                  $.ajax({
                      url: '<%=Page.ResolveUrl("~/WEB_API/Stud_Info.asmx/Add_UserGoogleInfo")%>',
                      //  data: { UA_NO: Ua_no, PROFILE: profile, IDTOKEN: id_token, SLOGINDATA: sLoginData},
                      data: { UA_NO: Ua_no, IDTOKEN: gmail_id, SLOGINDATA: sloginid },//, SLOGINDATA: sloginid },
                      type: 'POST',
                      dataType: 'text',

                      success: function (r) {
                          alert('You have successfully registered Google Sign In...!!');
                      },
                      error: function (e) {
                          alert('Try Again..!!');
                      }
    ...
    <asp:UpdatePanel runat="server" ID="updatePanel1">
        <ContentTemplate>
            <%--START--google sign in---on Date 21/09/2020 by Deepali--%>
            <div class="fixed-google">
          <div class="g-signin2" data-onsuccess="onSocialSignInForAssociatingUser" data-theme="dark" title="click here for create google Sign In"></div>
    </div>
            <%--END--google sign in---on Date 21/09/2020 by Deepali--%>
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="box box-primary ">
                        ...
                        <div class="box-body">
                            <div class="offset-md-1 col-md-10 " runat="server" id="divCalendar">
