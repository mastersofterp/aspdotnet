...
public partial class default_HindustanU : System.Web.UI.Page
{
    public class Packet
    {
    ...
    protected void btnLogin_Click(object sender, EventArgs e)
    {
        ...
        string defaultcaptcha = System.Configuration.ConfigurationManager.AppSettings["DefaultCaptcha"].ToString(); //Added by Kajal Jaiswal on 02-08-2023 For Default Cptcha.
        ...
        if (txt_username.Text.Trim() != "" && txt_password.Text.Trim() != "")
        {
            if (Session["Captcha"] != null)
            {
                if (txtcaptcha.Text.ToUpper() == txtcaptcha.Text)
                {
                    ...
                    if (Captcha1.UserValidated || txtcaptcha.Text == defaultcaptcha) //Added condition for Default Cptcha on 02-08-2023
                    {
                        try
                        {
...
StringComparison.OrdinalIgnoreCase) >= 0))
    ...
    public static List<Packet> GetData(string SLOGINDATA, string IDTOKEN)
    {
        ...
        default_HindustanU objdefault = new default_HindustanU();
        Common objCommon = new Common();
    ...
    protected void btnSendUsernamePassword_Click(object sender, EventArgs e)
    {
        ...
        {
            Showmessage("Sorry, Your Account Already Blocked,Please contact Admin Department!");
            //objCommon.DisplayMessage("Sorry, Your Account Already Blocked,Please contact Admin Department!", this.Page);
            return;
        }
