...
public partial class Stores_Transactions_Str_user_Requisition : System.Web.UI.Page
{
    ...
    private void FillRequisitionNo()
    {
        ...
        ////}
        ////ds = objDeptReqController.GenrateReq(mdno);   11/03/2022 Shabina
        //ds = objDeptReqController.GenrateReq(mdno, Convert.ToInt32(Session["OrgId"]));  //09-03-2022 gayatri
        //if (ds.Tables[0].Rows.Count > 0)
        //{
    ...
    {
        txtIndentSlipDate.Text = string.Empty;
