<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="Str_Quotation_Lock.aspx.cs" Inherits="STORES_Transactions_Quotation_Str_Quotation_Lock" %>
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    <h3 class="box-title">QUOTATION LOCK </h3>
                </div>
                                                            ...
                                                            <div class="table-responsive">
                                                                <asp:GridView CssClass="table table-bordered table-hover" HeaderStyle-CssClass="bg-light-blue" ID="grdTenderList" runat="server"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:BoundField HeaderText="Open Date" HeaderStyle-CssClass="bg-light-blue" DataField="TDODATE"
                                                                            DataFormatString="{0:dd/MM/yyyy}">
                                                                            <ItemStyle HorizontalAlign="Left" />
                                                                        </asp:BoundField>
                                                                        <asp:BoundField HeaderText="Last Date Of Sale" HeaderStyle-CssClass="bg-light-blue" DataField="LDATESALE"
                                                                            DataFormatString="{0:dd/MM/yyyy}">
                                                                            <ItemStyle HorizontalAlign="Left" />
                                                                        </asp:BoundField>
                                                                        <asp:BoundField HeaderText="Submission Date" HeaderStyle-CssClass="bg-light-blue" DataField="SUBMITDATE"
                                                                            DataFormatString="{0:dd/MM/yyyy}">
                                                                            <ItemStyle HorizontalAlign="Left" />
                                                                        </asp:BoundField>
