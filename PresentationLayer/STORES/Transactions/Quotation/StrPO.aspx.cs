...
public partial class STORES_Transactions_Quotation_StrPO : System.Web.UI.Page
{
    ...
    {
        lstPO.Items.Clear();
        lstPO.Items.Insert(0, new ListItem("Please Select", "0"));
    ...
    void BindPOTrackByDept(int mdno)
    {
        ...
        ddlPOTrack.Items.Insert(0, new ListItem("Please Select", "0"));
        DataSet ds = objstrPO.GetAllPOByDepartment(mdno);
        if (ds.Tables[0].Rows.Count > 0)
        {
    ...
    {
        lstPOForLock.Items.Clear();
        lstPOForLock.Items.Insert(0, new ListItem("Please Select", "0"));
    ...
    void Clear()
    {
        ...
        objCommon.FillDropDownList(ddlInd, "STORE_INDENT_MAIN", "INDTRNO", "INDNO", "TQSTATUS='D' AND INDNO NOT IN (SELECT INDENTNO FROM STORE_PORDER WHERE ISTYPE='D')", "INDTRNO DESC");
        lstQtNo.SelectedIndex = 0;
        txtOurRerenceNoDPO.Text = string.Empty;  //-----16-03-2023
        txtOurReferenceNoQPO.Text = string.Empty;  //-----16-03-2023
        txtOurRerenceNoTPO.Text = string.Empty;  //-----16-03-2023
        txtNatureofWork.Text = string.Empty; //-----16-03-2023
    }
    ...
    int SavePO(string Colcode)
    {
        ...
        objPO.NatureOfWork = txtNatureofWork.Text;  //------16-03-2023
        objPO.OurReferenceNo = txtOurReferenceNoQPO.Text;//------16-03-2023
        string ItemNos = "";
    ...
    int SaveTenderPO(string Colcode)
    {
        ...
        objPO.BANK_REMARK = txtBankRemark.Text;
        objPO.NatureOfWork = txtNatureofWork.Text;  //------16-03-2023
        objPO.OurReferenceNo = txtOurRerenceNoTPO.Text;//------16-03-2023
    ...
    int SaveDPOPO(string Colcode)
    {
        if (ddlVendor.SelectedIndex > 0)
        {
            ...
            objPO.FOOTER1 = txtFooter.Text;
            objPO.NatureOfWork = txtNatureofWork.Text;  //------16-03-2023
            objPO.OurReferenceNo = txtOurRerenceNoDPO.Text;//------16-03-2023
    ...
    {
        if (lstVendor.SelectedValue != "" || lstVendor.SelectedValue != "0")
        {
    ...
    protected void btnLock_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (lstPOForLock.SelectedIndex == 0)
            {
                DisplayMessage("Please Select Purchase Order.");
                return;
            }
    ...
    protected void btnAddTax_Click(object sender, EventArgs e)
    {
        ...
        if (lstVendor.SelectedIndex != 0)//For Quotation PO
        {
