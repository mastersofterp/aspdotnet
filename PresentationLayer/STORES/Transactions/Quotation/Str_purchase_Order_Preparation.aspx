<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true"
    CodeFile="Str_purchase_Order_Preparation.aspx.cs" Inherits="Stores_Transactions_Quotation_Str_purchase_Order_Preparation"
    Title="" %>
                        ...
                        <div class="tab-content" id="my-tab-content">
                                    ...
                                    <ContentTemplate>
                                        <div class="box-body">
                                            <asp:Panel ID="Panel3" runat="server">
                                                ...
                                                <div class="col-12 ">    <%--Quotaion po grid--%>
                                                    <asp:GridView ID="grdPOitems" runat="server" HeaderStyle-CssClass="bg-light-blue" CssClass="table table-bordered table-hover" AutoGenerateColumns="False"
                                                        DataKeyNames="PINO" EmptyDataText="There is No Data For Vendor" ><%--EnableViewState="false"--%>
                                                        <Columns>
                            ...
                            <div class="tab-pane fade" id="divReports">
                                ...
                                <div class="col-12 btn-footer">
                                    ...
                                    <asp:Button runat="server" ID="btnPOReport" Text="Show Report" CssClass="btn btn-info" OnClick="btnPOReport_Click" />
                                ...
                                <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                                    <ContentTemplate>
                                        <div class="box-body">
                                            ...
                                            <div class="col-12 btn-footer">
                                                <asp:Button ID="btnLock" runat="server" Text="Lock PO" CssClass="btn btn-primary" OnClick="btnLock_Click" OnClientClick="return confirm('Are You Sure. You Want To Lock PO?');" />
                                                    ...
                                                    <div class="col-12" id="divPOPopup" runat="server" visible="false">
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group col-lg-4 col-md-6 col-12">
                                                                ...
                                                                <asp:DropDownList ID="ddlAppUser" runat="server" AppendDataBoundItems="true" CssClass="form-control" > <%-- data-select2-enable="true"--%>
                                                                    <asp:ListItem Selected="True" Value="0">--Please Select--</asp:ListItem>
                                                                </asp:DropDownList>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-lg-3 col-md-6 col-12">
                                                    <div class="label-dynamic">
                                                        <sup></sup>
                                                        <label>PO Tracking</label>
                                                    </div>
                                                    <asp:DropDownList ID="ddlPOTrack" runat="server" CssClass="form-control" data-select2-enable="true" AppendDataBoundItems="true" AutoPostBack="true" OnSelectedIndexChanged="ddlPOTrack_SelectedIndexChanged">
                                                        <asp:ListItem Selected="True" Text="Please Select" Value="0"></asp:ListItem>
                                                    </asp:DropDownList>
                                                </div>
