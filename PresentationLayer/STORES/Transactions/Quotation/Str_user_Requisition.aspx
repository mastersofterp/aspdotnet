<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true"
    MaintainScrollPositionOnPostback="true" CodeFile="Str_user_Requisition.aspx.cs"
    Inherits="Stores_Transactions_Str_user_Requisition" %>
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    <h3 class="box-title">DEPARTMENT PROPOSAL</h3>
                </div>
                                        ...
                                        <div class="form-group col-md-12">
                                            <div class="form-group col-md-6">
                                                <div class="form-group col-md-10">
                                                    ...
                                                    <asp:DropDownList ID="ddlReportIndentSlipNo" TabIndex="1" runat="server" CssClass="form-control"
                            ...
                            <div class="box-body">
                                <div class="col-md-12">
                                    <asp:Panel ID="pnlReqFor" runat="server">
                                        <div class="panel panel-info">
                                            <div class="panel-heading">Select Requisition For</div>
                                            <div class="panel-body">
                                                ...
                                                <div class="col-md-2">
                                                    <asp:Button ID="butReport" Text="ShowReport" runat="server" TabIndex="20" CssClass="btn btn-info" OnClick="butReport_Click" />
                                                </div>
                                                <div class="col-md-2">
                                                    <asp:Button ID="btnTrackReq" runat="server" Text="Track My Requisition" CssClass="btn btn-primary pull-right" OnClick="btnTrackReq_Click" />
                                                </div>
                                            </div>
                                        </div>
                                    </asp:Panel>
                                    ...
                                    <asp:Panel ID="PnlIndentDetails" runat="server" Enabled="True" Visible="false">
                                        <div class="panel panel-info">
                                            <div class="panel-heading">Enter Requisition Number</div>
                                            <div class="panel-body">
                                                <div class="form-group col-md-12">
                                                    <div class="form-group col-md-6">
                                                        <div class="form-group col-md-10">
                                                            <label>
                                                                Requisition Slip No. :<span style="color: #FF0000">*</span>
                                                            </label>
                                                        ...
                                                        <div class="form-group col-md-10">
                                                            <label>Person Name :<span id="span3" style="color: #FF0000">*</span></label>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <div class="form-group col-md-10">
                                                            <label>Department :<span id="span1" style="color: #FF0000">*</span></label>
                                                            <asp:DropDownList runat="server" CssClass="form-control" TabIndex="2" AppendDataBoundItems="true"
                                                         ...
                                                         <div class="form-group col-md-10">
                                                            <label>Requisition Slip Date :<span id="span2" style="color: #FF0000">*</span></label>
                                                        ...
                                                        <div class="form-group col-md-10" id="divBudgetHead" runat="server" visible="false">
                                                            <label>Budget Head :<span id="span6" style="color: #FF0000"></span></label>
                                                            <asp:DropDownList runat="server" TabIndex="4" CssClass="form-control" ID="ddlBudgetHead" AppendDataBoundItems="true" AutoPostBack="true" OnSelectedIndexChanged="ddlBudgetHead_SelectedIndexChanged">
                                                            </asp:DropDownList>
                                                           <%-- <asp:RequiredFieldValidator ID="rfvBudgetHead" runat="server" ControlToValidate="ddlBudgetHead"
                                                                ErrorMessage="Please Select Budget Head" Display="None" ValidationGroup="StoreItem"
                                                                InitialValue="0"></asp:RequiredFieldValidator>--%>
                                                        </div>
                                                        <div class="form-group col-md-10" id="divInstitute" runat="server" visible="false">
                                                            <label></label>
                                                        ...
                                                        <div class="form-group col-md-10" id="divShowAmt" runat="server" visible="false">
                                                            <label>Budget Balance Amount :</label>
                                                            <asp:Label ID="lblBudgetBalAmt" runat="server" Text="" CssClass="form-control"></asp:Label>
                                                        </div>
                                                        <div class="form-group col-md-10" id="divInprocessAmt" runat="server" visible="false">
                                                            <label>Inprocess Requisition Amount :</label>
                                                            <asp:Label ID="lblInprocessAmt" runat="server" Text="" CssClass="form-control"></asp:Label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group col-md-12">
                                                    <b>Passing Path:</b>
                                                    <asp:Label ID="lblPassingPath" Font-Bold="true" runat="server"></asp:Label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                            ...
                            <div class="box-body">
                                <div class="col-md-12">
                                    <asp:Panel ID="pnlItemDetails" runat="server" Visible="false">
                                        <div class="panel panel-info">
                                            <div class="panel-heading">Enter Item Details</div>
                                            <div class="panel-body">
                                                <div class="form-group col-md-12">
                                                    <div class="form-group col-md-5">
                                                        <div class="form-group col-md-12">
                                                            <label>Item Name :<span id="span4" style="color: #FF0000">*</span></label>
                                                            <asp:DropDownList ID="ddlItemName" CssClass="form-control" TabIndex="9" ToolTip="Select Item Name" AppendDataBoundItems="true"
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            <label>Required Qty: <span id="span5" style="color: #FF0000">*</span></label>
                                                            <asp:TextBox ID="txtRequiredQty" runat="server" TabIndex="10" ToolTip="Enter Required Qty" CssClass="form-control" MaxLength="4"
                                                                onKeyUp="return validateNumeric(this)" ValidationGroup="StoreItem"></asp:TextBox>
                                                        ...
                                                        <div class="form-group col-md-6" id="divAppRate" runat="server">
                                                            <label>Unit Price: <span id="span7" style="color: #FF0000">*</span></label>
                                                        ...
                                                        <div class="form-group col-md-12" id="divTecSpe" runat="server" visible="false">
                                                        ...
                                                        <div class="form-group col-md-12" id="divPurJustification" runat="server" visible="false">
                                                        ...
                                                        <div class="form-group col-md-12" id="divItemSpecification" runat="server" visible="false">
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <asp:ImageButton ID="btnEditItem" runat="server" OnClick="btnEdit_Click" CommandArgument='<%# Eval("REQ_TNO") %>'
                                                                                ImageUrl="~/images/edit.gif" ToolTip="Edit Record" AlternateText="Edit Record" />
                                                                            <asp:ImageButton ID="btnDelete" runat="server" OnClick="btnDelete_Click" CommandArgument='<%# Eval("REQ_TNO") %>'
                                                                                ImageUrl="~/images/delete.gif" ToolTip="Delete Record" AlternateText="Delete Record"
                                        ...
                                        <%-- <div class="col-md-12">        --%>
                                        <div class="panel panel-info">
                                            <div class="panel-heading">Purchase Justification</div>
                                            <div class="panel-body">
                                                <div class="form-group col-md-10">
                                        ...
                                        <div class="col-md-12 text-center">
                                            ...
                                            <asp:Button ID="butAddNew" Text="AddNew" runat="server" TabIndex="17" CssClass="btn btn-info" OnClick="butAddNew_Click" />
                                            <asp:Button ID="butModify" Text="Modify" runat="server" TabIndex="18" CssClass="btn btn-warning" OnClick="butModify_Click" />
