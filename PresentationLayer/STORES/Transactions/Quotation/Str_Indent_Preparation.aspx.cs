...
public partial class Stores_Transactions_Quotation_Str_Indent_Preparation : System.Web.UI.Page
{
    ...
    void BindReqListByDepartment()                 //Bind All Requisition 
    {
        DataSet ds = null;
        try
        {
    ...
    protected void grdItemList_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
    {
        ...
        else
        {
            ...
            DisplayMessage("Item Already In Indent List");
        }
    }
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        foreach (GridViewRow row in grdItemList.Rows)
        {
            if (row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (chkRow.Checked)
                {
                    ...
                    ViewState["Req_TNO"] = Req_TNO;//Added By vijay 08-06-2020
                    DataRow dr = objDeptReqController.GetSingleTransDetailByReq_TRNO(Req_TNO).Tables[0].Rows[0];
                    if (!TmpIndent.Rows.Contains(Req_TNO))
                    {
                        TmpIndent.ImportRow(dr);
                    ...
                    {
                        objCommon.DisplayMessage("Item Already Exist", this.Page);                       
                        divItemList.Visible = true;
                    }
        ...
        if (count == 0)
        {
            //objCommon.DisplayUserMessage(updatePanel1, "Please Select At Least One Item.", this.Page);
            DisplayMessage("Please Select At Least One Item.");
            return;
        }
        DataRow dr1 = objDeptReqController.GetSingleTransDetailByReq_TRNO(Convert.ToInt32(ViewState["Req_TNO"].ToString())).Tables[0].Rows[0];
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
                ...
                if (duplicateCkeck == 0)
                {
                    ...
                    if (cs == CustomStatus.RecordSaved)
                    {
                        ...
                        if (cs == CustomStatus.RecordSaved || cs == CustomStatus.RecordUpdated)
                        {
                            ...
                            BindIndentRefNo();
                            btnDivIDBack_Click(sender,e);
                            divIndentDetails.Visible = false; //20-10-2022
                        }
        ...
        else
        {
            ...
            DisplayMessage("Sorry ! There Are No Items For Indent");
    ...
    void Clear()
    {
        ...
        this.InitialiseTempIndentTabl();
        ddlDept.SelectedValue = Session["strdeptcode"].ToString();
        btnDivIDBack.Visible = true;
        ddlIndent.SelectedIndex = 0;
    }
    ...
    protected void btnModify_Click(object sender, EventArgs e)
    {
        ...
        //objCommon.FillDropDownList(ddlIndent, "STORE_INDENT_MAIN", "INDTRNO", "INDNO", "", "INDTRNO DESC");
       // objCommon.FillDropDownList(ddlIndent, "STORE_INDENT_MAIN", "INDTRNO", "INDNO", "MDNO=" + Convert.ToInt32(Session["strdeptcode"]), "INDTRNO DESC");
    ...
    void BindItemsForIndentDuringMod()
    {
       ...
       // DataSet ds = objCommon.FillDropDown("STORE_REQ_TRAN A, STORE_ITEM B,STORE_REQ_MAIN C,STORE_INDENT_MAIN D", "A.REQTRNO ,A.ITEM_NO,ISNULL(A.INDQTY ,0)REQ_QTY,ISNULL(A.RATE,0)RATE,B.ITEM_NAME,C.REQ_NO", "A.REQ_TNO", "A.ITEM_NO=B.ITEM_NO AND C.REQTRNO=A.REQTRNO AND D.INDNO=A.INDENTNO AND D.INDTRNO=" + Convert.ToInt32(ddlIndent.SelectedValue), "");
        ...
        {
            grdItemList.DataSource = ds.Tables[1];
            grdItemList.DataBind();
        }
        else
        {
    ...
    void BindGrdList()   //Bind deapartment wise req list
    {
        DataSet ds = null;
    ...
    {
        //if (chkDept.Checked || chkDate.Checked)
        //{
        //   // if (txtStartDate.Text != string.Empty || txtLastDate.Text != string.Empty || Convert.ToInt32(ddlDepts.SelectedValue) > 0 )
        //    if (Convert.ToInt32(ddlDepts.SelectedValue) > 0 && txtStartDate.Text != string.Empty && txtLastDate.Text != string.Empty)
        //    {
        //        //BindGrdList();
        ...
        //    else
        //    {
        //        DisplayMessage("Please Select Date And Department");
        //        return;
        //    }
        //}
        //else
        ...
        //    {
        //        if (Convert.ToDateTime(txtStartDate.Text) > Convert.ToDateTime(txtLastDate.Text))
        //        {
        //            DisplayMessage("To Date Should Be Greater Than From Date.");
        //            return;
        //        }
        //        BindGrdListByDatewise();
        //    }
