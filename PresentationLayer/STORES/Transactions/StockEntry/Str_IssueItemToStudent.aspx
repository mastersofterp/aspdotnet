<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="Str_IssueItemToStudent.aspx.cs" Inherits="STORES_Transactions_StockEntry_Str_IssueItemToStudent" %>
        ...
        <div class="col-md-12 col-sm-12 col-12">
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    <h3 class="box-title">ISSUE ITEM TO STUDENT/EMPLOYEE</h3>
                </div>
                    ...
                    <asp:Panel ID="pnlJVEntry" runat="server" Visible="true">
                        <div class="col-12">
                            <div class="sub-heading">
                                <h5>Issue Item to Student & Employee</h5>
                            </div>
                            <div class="row">
                            ...
                            <div class="col-12" id="divIssue" runat="server" visible="false">
                                ...
                                <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-lg-4 col-md-6 col-12" id="divTypeOfIssue" runat="server">
                                                ...
                                                <asp:RadioButton ID="rdbRequisition" runat="server" TabIndex="4" AutoPostBack="True" GroupName="rdbIssue"
                                                    OnCheckedChanged="rdbRequisition_CheckedChanged" visible="false" Text="Requisition Wise" Checked="true" />
                                            ...
                                            <div class="col-12" runat="server"  id="divStudent" visible="false"> 
                                            <div class="row">
                                           ...
                                           <div class="form-group col-lg-3 col-md-6 col-12">
                                            ...
                                            <asp:Label ID="lblStudBranhch" runat="server"></asp:Label>
                                        </div>
                                        <div class="form-group col-lg-3 col-md-6 col-12">
                                            <label>Student RollNo. :</label>
                                            <asp:Label ID="lblStudRollNo" runat="server"></asp:Label>
                                        </div>
                                        </div>
                                            ...
                                            <div class="form-group col-lg-3 col-md-6 col-12" id="divreq" runat="server" visible="true">
                                                <div class="label-dynamic" visible="false" runat="server">
                                                    <sup>*</sup>
                                                    <label>Select Requisition</label>
                                                </div>
                                                <asp:DropDownList ID="ddlReq"  visible="false" runat="server" CssClass="form-control" data-select2-enable="true" AppendDataBoundItems="true" AutoPostBack="true"
                                    ...
                                    <div class="col-12" runat="server" id="divAddItem" visible="false">
                                        ...
                                        <asp:DropDownList ID="ddlCategory" data-select2-enable="true" runat="server" CssClass="form-control"  AppendDataBoundItems="true" TabIndex="2" AutoPostBack="true"
                                    ...
                                    <div class="form-group col-lg-3 col-md-6 col-12">
                                        ...
                                        <asp:DropDownList ID="ddlSubCategory" data-select2-enable="true" runat="server" AppendDataBoundItems="true" CssClass="form-control"
                                            ...
                                            <div class="form-group col-lg-3 col-md-6 col-12">
                                                ...
                                                <asp:DropDownList ID="ddlItemIsue" runat="server" CssClass="form-control" data-select2-enable="true" AppendDataBoundItems="true" AutoPostBack="true" OnSelectedIndexChanged="ddlItemIsue_SelectedIndexChanged"
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <asp:TextBox ID="txtIQty" runat="server" Enabled="true" onkeyup="IsNumeric(this);" onblur="return CalOnGRNQty(this);"
                    ...
                    if (chk.checked) {
                     //   alert('ssss');
                       ...
                       // alert('BlQty='+BlQty);
                        ...
                        if (Number(IssuedQty) =0) {
                            alert('please ENter in Issue Quantity.'); 
                          //  alert('eee');
                            return false;
...
function CalOnGRNQty(crl) {
   ...
   // alert('IssueQty='+IssueQty);
    ...
    if (Number(AvlQty) > 0) {
        ...
        document.getElementById('ctl00_ContentPlaceHolder1_lvIssueItem_ctrl' + index + '_txtReqQty').value =  Number(IssueQty).toFixed(2);
