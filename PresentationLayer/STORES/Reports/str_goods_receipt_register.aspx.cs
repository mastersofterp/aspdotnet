...
// PROJECT NAME  : UAIMS                                                                
// MODULE NAME   : STORES
// PAGE NAME     : str_goods_receipt_register.aspx                                               
...
public partial class STORES_Reports_str_goods_receipt_register : System.Web.UI.Page
{
    ...
    protected void btnGRR_Click(object sender, EventArgs e)
    {
      ...
      ShowReport("GoodsReceiptRegister", "Str_GoodsReceiptRegister.rpt");
    ...
    private void ShowReport(string reportTitle, string rptFileName)
    {
        ...
        try
        {
           ...
           // url += "&param=@P_COLLEGE_CODE=" + Session["colcode"].ToString() + ",@P_ReportName=" + reportTitle + ",@P_VENDORNO=" + vendorno + ",@P_VENDORWISE=" + rblSelectAllVendor.SelectedValue + ",@P_FDATE=" + Convert.ToDateTime(Fdate).ToString("dd-MMM-yyyy") + ",@P_TDATE=" + Convert.ToDateTime(Ldate).ToString("dd-MMM-yyyy");
            url += "&param=@P_COLLEGE_CODE=" + Session["colcode"].ToString() + ",@P_ReportName=" + reportTitle + ",@P_VENDORNO=" + vendorno + ",@P_VENDORWISE=" + rblSelectAllVendor.SelectedValue + ",@P_FDATE=" + Convert.ToDateTime(Fdate).ToString("dd-MMM-yyyy") + ",@P_TDATE=" + Convert.ToDateTime(Ldate).ToString("dd-MMM-yyyy") + ",@P_MDNO=" + Convert.ToInt32(Session["strdeptcode"]);
