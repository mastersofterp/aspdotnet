<%@ Page Language="C#" AutoEventWireup="true" CodeFile="default_MITA.aspx.cs" Inherits="default_MITA" %>
...
<head id="Head1" runat="server">
    ...
    <title>MIT | Academy Of Engineering</title>
    <link rel="shortcut icon" href="Images/Login/mita_logo_fv.png" type="image/x-icon">
    ...
    <link href="plugins/newbootstrap/css/login_mita.css" rel="stylesheet" />
    <link href="plugins/virtual-keyboard/keyboard.css" rel="stylesheet" />
    <%--       <link href="Plugin/newbootstrap4/fontawesome-free-5.15.4/css/all.min.css" rel="stylesheet" />--%>
...
<body>
    <form id="frmDefault" runat="server" defaultbutton="btnLogin">
        ...
        <div class="login">
                ...
                <div id="loginCarousel" class="carousel slide" data-ride="carousel" data-interval="4000" data-pause="hover">
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
                            ...
                            <div class="slide" style="background-image: url('Images/Login/bg_mita.jpg'); background-size: cover;"></div>
                            <div class="carousel-caption">
                                <div class="txt-clg animationss a1">
                                    <h1 class="slide__title college-name animations a2">MIT</h1>
                                    <p class="slide__text mb-0 animation a2">Academy Of Engineering</p>
                                </div>
                            </div>
                        </div>
                        <%--<div class="carousel-item">
                        <div class="background-overlay"></div>
                        <div class="slide" style="background-image: url('Images/Login/bg_rajagiri_1.png'); background-size: cover;"></div>
                        <div class="carousel-caption">
                            <div class="txt-clgs animationss a1">
                                <h1 class="slide__title college-name animations a2">RAJAGIRI</h1>
                                <p class="slide__text mb-0 animation a2">Business School</p>
                            </div>
                        </div>
                    </div>--%>
                    </div>
            ...
            <section class="login__right">
                ...
                <div class="college-details text-center mt-2 mb-0">
                    <img src="Images/Login/mita_logo.png" alt="logo" />
                </div>

                <div class="signin-details mt-2">
                    <h5 class="text-center mb-3">Alandi Road, Pune - 412 105, Maharashtra (India)</h5>
                                ...
                                <ContentTemplate>
                                    <div class="input-group">
                                        ...
                                        <cc1:CaptchaControl ID="Captcha1" runat="server" CaptchaBackgroundNoise="Low" CaptchaLength="4"
                                            ...
                                            NoiseColor="#666699" CaptchaInputCSS="BlackTextInput" EnableTheming="true" CaptchaChars="123456789" CaptchaMaxTimeout="240" FontColor="#141d49" class="img-responsive" />
                    ...
                    <div style="margin-top: 5px">
                        ...
                        <%--   <asp:LinkButton class="form-control btn btn-outline-primary text-white pl-2" ID="LinkButton2" TabIndex="4" runat="server" Text="Sign In" ValidationGroup="login">
               Sign In with Google
                        </asp:LinkButton>--%>
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-0 ">
                        ...
                        <div class="play-store">
                            <a href="https://play.google.com/store/apps/details?id=com.iitms.mita" target="_blank" style="cursor: pointer;">
                        ...
                        <div class="Qr-code">
                            <a href="#" target="_blank" style="cursor: pointer;">
                                <img src="Images/QR_Code/MITA.png" alt="App Downloads" width="50px" />
                            </a>
                        </div>
                        <!-- Google Play END -->
    ...
    <script type="text/javascript">
        ...
        //var CLIENTID = '348503370853-04j5d3e1hpapsbaodakvu0mlq0ful1ii.apps.googleusercontent.com';
        //var REDIRECT = 'https://libcloud.mastersofterp.in';

        var CLIENTID = '515284875469-n66qbd4ujjuoci1i6kg8858b37t3mi3v.apps.googleusercontent.com';

        var CLIENTID = <%--'<%=System.Configuration.ConfigurationManager.AppSettings["GoogleClientId"].ToString() %>'--%>;

        var REDIRECT = '<%=System.Configuration.ConfigurationManager.AppSettings["WebServer"].ToString() %>' + '/PresentationLayer/default_MITA.aspx';

        // var REDIRECT = '<%=System.Configuration.ConfigurationManager.AppSettings["WebServer"].ToString() %>';
        //var LOGOUT = 'https://libcloud.mastersofterp.in';
        var TYPE = 'token';
            ...
            $.ajax({
                ...
                success: function (resp) {
                    ...
                    $.ajax({
                        ...
                        type: "POST",
                        //url: "default_MITA.aspx/GoogleSSOAuth",
                        //url: '<%=Page.ResolveUrl("~/WEB_API/Stud_Info.asmx/Get_GoogleUserDetails")%>',
                        url: '<%=Page.ResolveUrl("default_MITA.aspx/GoogleSSOAuth")%>',
                        ...
                        success: function (response) {
                            ...
                            if (firstlog == "False") {
                                ...
                                window.location = "https://aju.mastersofterp.in/changePassword.aspx?IsReset=1";
                            }
                            else {
                                if (lastlogout == "" && Allowpopup == "1") {

                                    window.location = "https://aju.mastersofterp.in/SignoutHold.aspx";
                                }
                                else if (userno == "1") {

                                    var WebServer = '<%=System.Configuration.ConfigurationManager.AppSettings["WebServer"].ToString() %>';
                                    //window.location = "http://localhost:60681/PresentationLayer/principalHome.aspx"

                                    window.location = WebServer + "/PresentationLayer/principalHome.aspx";
                                }
                                else {

                                    window.location = "http://localhost:60681/PresentationLayer/default_MITA.aspx";
                                }
                        }
