<%@ Page Language="C#" AutoEventWireup="true" CodeFile="default_cpu_kota.aspx.cs" Inherits="default_cpu_kota" StylesheetTheme="Theme1" Theme="Theme1" %>
...
<head id="Head1" runat="server">
    ...
    <link rel="shortcut icon" href="Images/Login/CPUK.png" type="image/x-icon">

    <!-- Bootstrap -->
    <link href="plugins/newbootstrap/css/bootstrap.min.css" rel="stylesheet" />
    <link href="plugins/newbootstrap/css/Login_CPU.css" rel="stylesheet" />
    ...
    <style>
        #pnlUserPass input, #pnlChoice input {
            width: auto;
...
<body>
    <div class="sign-in">
        ...
        <div class="container">
            <div class="row">
                <!-- College Details -->
                <div class="col-lg-6 col-md-5 col-12 bg-mobile">
                    <div class="college-details text-white d-block align-items-center ">
                        <div class="logo">
                            <img src="Images/Login/CPUK.png" alt="logo" />
                        </div>
                        <div class="college-name" style="margin-top: 140px;">
                            <h6 c>Welcome to    </h6>
                            <h2>Career Point University Kota
                            </h2>
                            <h4>National Highway 52, Opp Alaniya Mata Ji Mandir,<br />
                                Alaniya, Kota, Rajasthan 325003</h4>
                        </div>
                ...
                <div class=" col-lg-5  col-md-7 col-12">
                    <form id="frmDefault" runat="server" defaultbutton="btnLogin">
                        ...
                        <div class="signin-details ">
                            <h3 class="sign-heading">Sign In</h3>
                            <!-- User Name Start -->
                            ...
                            <div class="form-group mb-0">
                                ...
                                <div id="show_hide_password">
                                    ...
                                    <a href="#" class="eye-icon"><i class="fa fa-eye-slash refresh-icon" aria-hidden="true"></i></a>
                            ...
                            <div class="row  align-items-center mb-0">
                                ...
                                <div class="form-group mb-0 col-lg-6 col-md-6 col-6 mb-0">
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                        <ContentTemplate>
                                            <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/Images/Login/refresh-btn.png" CssClass="mb-0 img-width border-0 p-0" />
                                            <%--  <asp:LinkButton ID="ImageButton1" runat="server" OnClick="imgrefresh_Click">
                                                      <i class="fa fa-sync"></i>
                                                  </asp:LinkButton>--%>
                                            <cc1:CaptchaControl ID="Captcha1" runat="server" CaptchaBackgroundNoise="Low" CaptchaLength="4"
                                                CaptchaHeight="60" CaptchaWidth="135" CaptchaLineNoise="None" CaptchaMinTimeout="5"
                                                CaptchaInputCSS="BlackTextInput" EnableTheming="true" CaptchaChars="123456789" CaptchaMaxTimeout="240" FontColor="#2E5F85" class="captcha-img ml-1" />


                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                                <div class="form-group col-lg-6 col-md-6 col-6 mb-0">
                                    <label for="captcha" class="floating-label">Captcha </label>
                                    <asp:TextBox ID="txtcaptcha" runat="server" TabIndex="3" ValidationGroup="login" CssClass="form-control"></asp:TextBox>
                            ...
                            <!-- Login Button Start -->
                            <asp:LinkButton class="form-control btn btn-sign text-white pl-2" ID="btnLogin" TabIndex="4" runat="server" OnClick="btnLogin_Click" Text="Sign In" ValidationGroup="login"></asp:LinkButton>
                            ...
                            <div class="d-flex justify-content-sm-between flex-wrap justify-content-center align-items-center mt-1">
                                ...
                                <div class="play-store">
                                    <a href="https://play.google.com/store/apps/details?id=com.iitms.cpukota" target="_blank" style="cursor: pointer;">
                                        <span>
                                ...
                                <div class="Qr-code">
                                    <a href="#" target="_blank" style="cursor: pointer;">
                                            <img src="Images/QR_Code/CPU%20Kota.png" alt="App Downloads" width="50px" />
                                    ...
                                    <asp:Panel ID="pnlMobile" runat="server" Visible="false">
                                        <div id="dvmobile">
                                            ...
                                            <div class="form-group" runat="server" visible="false" id="divnewpass">
                                                ...
                                                <asp:TextBox ID="txtnewpass" runat="server" placeholder="Enter New Password" CssClass="form-control mt-1" Enabled="false" MaxLength="20" TextMode="Password" ></asp:TextBox>
                        ...
                        <div >
                            ...
                            <div>
                                 <div class="label-dynamic">
                                   <sup></sup>
                                  <b> <label>Password changed successfully.</label></b>
                               </div>
