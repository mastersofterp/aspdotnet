<%@ Page Language="C#" AutoEventWireup="true" CodeFile="default_VYWS.aspx.cs" Inherits="default_VYWS" %>
...
<head id="Head1" runat="server">
    ...
    <link href="plugins/newbootstrap/css/Login_VYWS.css" rel="stylesheet" />
...
<body>
        ...
        <div class="login">
            ...
            <section class="login__left">
                <div id="loginCarousel" class="carousel slide" data-ride="carousel" data-interval="4000" data-pause="hover">
                    <div class="carousel-inner" role="listbox">
                        <%--<img src="Images/background_VYWS.png" />--%>

                        <div class="carousel-item active ">
                            <div class="background-overlay"></div>
                            <div class="slide" style="background-image: url('Images/Login/bg_slider1.png'); background-size: cover;">
                        ...
                        <div class="carousel-item ">
                            <div class="background-overlay"></div>
                            <div class="slide" style="background-image: url('Images/Login/bg_slider4.png'); background-size: cover;"></div>
                            <div class="carousel-caption">
                                <div class="txt-clg animationss a1">
                        ...
                        <div class="carousel-item">
                            <div class="background-overlay"></div>
                            <div class="slide" style="background-image: url('Images/Login/bg_slider3.png'); background-size: cover;">
                            </div>
                            <div class="carousel-caption">
                                <div class="txt-clg animationss a1">
                                    ...
                                    <h1 class="slide__title college-name animations a2">VYWS</h1>
                                    <%--<h4 class="college-name animations a2">UNIVERSITY</h4>--%>
                                    <p class="slide__text mb-0 animation a2">Institute of Pharmacy & Research</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="carousel-item">
                            <div class="background-overlay"></div>
                            <div class="slide" style="background-image: url('Images/Login/bg_slider2.png'); background-size: cover;">
                            </div>
                            <div class="carousel-caption">
                                <div class="txt-clg animationss a1">
                                    <%-- <img src="Images/Login/JECRC_log.jpg" alt="logo"/> --%>
            ...
            <section class="login__right">
                ...
                <div class="signin-details mt-2">
                    <h2 class="text-center">VYWS
                        <br />
                        <span>Vidarbha Youth Welfare Society's</span></h2>
                    <%--  <h5 class="text-center mb-4">Prof. Ram Meghe Institute of Technology and Research
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-1">
                        ...
                        <div class="d-none">
                            <a href="" target="_blank" style="cursor: pointer;">
                                <span>
                                    <asp:Image ID="ImageAppDownload" runat="server" ImageUrl="~/Images/GPlayImg.png" />
                                </span>
                            </a>
                        </div>
                        <!-- Google Play END -->
    ...
    <script src="<%=Page.ResolveClientUrl("~/plugins/virtual-keyboard/keyboard.js")%>"></script>
