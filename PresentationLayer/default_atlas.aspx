<%@ Page Language="C#" AutoEventWireup="true" CodeFile="default_atlas.aspx.cs" Inherits="altas_login" %>
...
<head id="Head1" runat="server">
    ...
    <title>ATLAS SkillTech University</title>
    <link rel="shortcut icon" href="Images/Login/Atlas_Logo.png" type="image/x-icon">
    ...
    <link href="plugins/newbootstrap/css/login_atlas.css" rel="stylesheet" />
...
<body>
    <form id="frmDefault" runat="server" defaultbutton="btnLogin">
        ...
        <div class="login_atlas">
            <div class="overlay"></div>
            <div class="login_atlas-inner">

                <div class="container-fluid">

                    <div class="row">
                        <div id="txt_view" class="col-md-7 col-lg-7 col-12 order-xs-12 pl-1 pr-1">
                            <div class="form-info">
                                <div class="form-section">
                                    <div class="logo d-block d-md-none  mb-md-0 text-center">
                                        <a href="#">
                                            <img src="Images/login/Atlas_Logo.png" alt="logo" />
                                        </a>
                                    </div>
                                    ...
                                    <div class="">
                                                    ...
                                                    <ContentTemplate>
                                                        <div class="input-group">
                                                            <cc1:CaptchaControl ID="Captcha1" runat="server" CaptchaBackgroundNoise="Low" CaptchaLength="4"
                                                                CaptchaHeight="50" CaptchaWidth="145" CaptchaLineNoise="None" CaptchaMinTimeout="5" Font-Size="12px" BackColor="#f5f5f5"
                                                                NoiseColor="#666699" CaptchaInputCSS="BlackTextInput" EnableTheming="true" CaptchaChars="123456789" CaptchaMaxTimeout="240" FontColor="#039aaa" class="img-responsive" />
                                        ...
                                        <!-- Login Button Start -->
                                        <asp:LinkButton class="form-control btn btn-primary  pl-2" ID="btnLogin" TabIndex="4" runat="server" OnClick="btnLogin_Click" Text="Login" ValidationGroup="login"></asp:LinkButton>
                                        ...
                                        <div class="d-flex justify-content-sm-between justify-content-center align-items-center mt-1 ">
                                            ...
                                            <div class="">
                                                <a data-toggle="modal" data-target="#ModelPopUp" id="lbtForgePass" runat="server" style="cursor: pointer">Forgot Password </a>
                                            </div>
                                            <!-- Forget Password END -->
                                         ...
                                         <div class="d-flex justify-content-between align-items-center mt-1 ">
                                            ...
                                            <div class="play-store">
                                                <a href="https://play.google.com/store/apps/details?id=com.iitms.atlas" target="_blank" style="cursor: pointer;">
                                            ...
                                            <div class="Qr-code">
                                                <a href="#" target="_blank" style="cursor: pointer;">
                                                    <img src="Images/QR_Code/ATLAS.png" alt="App Downloads" width="50px" />
                                                </a>
                                            </div>
                                            <!-- Google Play END -->
                        ...
                        <div id="bg_view" class="col-md-5 col-lg-5  col-12 order-xs-1 d-flex align-items-center justify-content-center ">
                            <div class="bg-text d-none d-md-block">
                                <div class="logo">
                                    <a href="#">
                                        <img src="Images/login/Atlas_Logo.png" alt="logo" />
                                    </a>
                                </div>
                                <div class="college-name d-none">
                                    <h1 style="color: #fff;">ATLAS <span style="color: #17a2b8">SKILLTECH UNIVERSITY</span></h1>
                                </div>
                            </div>
                                        ...
                                        <asp:Panel ID="pnlMobile" runat="server" Visible="false">
                                            <div id="dvmobile">
                                                <div class="form-group">
                                                    ...
                                                    <asp:TextBox ID="txtMobile" runat="server" TabIndex="1" placeholder="Enter Registered Mobile Number" MaxLength="10" CssClass="form-control" onkeypress="return isNumber(event)"></asp:TextBox><br />

                                                    <asp:Button ID="btnSendotp" runat="server" Text="Send OTP" CssClass="btn btn-info btn-sm" OnClick="btnMobileotp_Click" ValidationGroup="logmob" />
                                                ...
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        ...
                                                        <asp:Button ID="btnCancelp" runat="server" CssClass="btn btn-warning" Text="Cancel" OnClientClick="return validateto()" />
                                        ...
                                        <asp:Panel ID="pnlEmail" runat="server" Visible="false">
                                            <div id="dvEmail">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <asp:TextBox ID="txtEmail" runat="server" TabIndex="1" placeholder="Enter Registered Email Address" CssClass="form-control" MaxLength="64"></asp:TextBox><br />

                                                    <asp:Button ID="benotop2" runat="server" Text="Send OTP" CssClass="btn btn-info btn-sm" OnClick="btnEmailotp_Click" ValidationGroup="logmail" />
                                                ...
                                                <div>
                                                    ...
                                                    <asp:Button ID="btnSendUsernamePassword" runat="server" Text="Forgot Password" ValidationGroup="Loginotp" CausesValidation="false" CssClass="btn btn-primary" OnClick="btnSendUsernamePassword_Click" />
                                                    <asp:Button ID="Button1" runat="server" CssClass="btn btn-warning" OnClick="Button1_Click" Text="Cancel" OnClientClick="return validateto()" />
