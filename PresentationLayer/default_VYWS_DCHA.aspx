<%@ Page Language="C#" AutoEventWireup="true" CodeFile="default_VYWS_DCHA.aspx.cs" Inherits="default_VYWS_DCHA" %>
...
<head id="Head1" runat="server">
    ...
    <title>VYWS - DCHA </title>
    <link rel="shortcut icon" href="Images/Login/logo_vyws_dcha.png" type="image/x-icon">
    ...
    <link href="plugins/newbootstrap/css/login_VYWS_DCHA.css" rel="stylesheet" />
        ...
        <div class="login">
                ...
                <div id="loginCarousel" class="carousel slide" data-ride="carousel" data-interval="4000" data-pause="hover">
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active ">
                            ...
                            <div class="slide" style="background-image: url('Images/Login/bg_slider4.png'); background-size: cover;">
            ...
            <section class="login__right">
                ...
                <div class="college-details text-center mt-4 mt-lg-0 mb-0">
                    ...
                    <asp:Image ID="Imagelogo" runat="server" ImageUrl="~/Images/Login/logo_vyws_dcha.png" />
                </div>

                <div class="signin-details mt-2">
                    <h5 class="text-center">Vidarbha Youth Welfare Society's </h5>
                    <h3 class="text-center mb-4">VYWS Dental College & Hospital - Amravati
                    </h3>
